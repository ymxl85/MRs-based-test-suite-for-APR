...
entry:
  ...
  %rr1 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 0, !dbg !206
  %0 = call i8* @memset(i8* %rr1, i32 0, i32 1000)
  %argv12 = getelementptr inbounds [10 x i8]* %argv1, i32 0, i32 0, !dbg !208
  call void @klee_make_symbolic(i8* %argv12, i32 10, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !208
  ...
  %4 = getelementptr inbounds [10 x i8]* %argv1, i32 0, i32 9, !dbg !210
  ...
  store i8* %fp.0.i.i, i8** %tp.i, align 4, !dbg !211
...
bb.i:                                             ; preds = %entry, %bb.i
  ...
  %13 = icmp eq i8 %12, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %13, label %mainQ.exit, label %bb.i, !dbg !214
...
!1 = metadata !{i32 589865, metadata !"v1.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v1.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_com
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v1/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v1/", metadata !2} ; [ DW_TAG_file_type ]
...
!211 = metadata !{i32 537, i32 0, metadata !212, metadata !213}
...
!214 = metadata !{i32 540, i32 0, metadata !212, metadata !213}
!215 = metadata !{i32 560, i32 0, metadata !207, null}
!216 = metadata !{i32 14, i32 0, metadata !98, null}
!217 = metadata !{i32 15, i32 0, metadata !98, null}
!218 = metadata !{i32 16, i32 0, metadata !98, null}
