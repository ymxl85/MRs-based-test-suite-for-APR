...
entry:
  ...
  %argv12 = getelementptr inbounds [50 x i8]* %argv1, i32 0, i32 0, !dbg !206
  call void @klee_make_symbolic(i8* %argv12, i32 50, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !206
  %1 = load i8* %argv12, align 1, !dbg !207
  %2 = icmp ne i8 %1, 0, !dbg !207
  %3 = zext i1 %2 to i32, !dbg !207
  call void @klee_assume(i32 %3) nounwind, !dbg !207
  %4 = getelementptr inbounds [50 x i8]* %argv1, i32 0, i32 49, !dbg !208
  %5 = load i8* %4, align 1, !dbg !208
  %6 = icmp eq i8 %5, 0, !dbg !208
  ...
  store i8* %fp.0.i.i, i8** %tp.i, align 4, !dbg !209
  ...
  br i1 %11, label %mainQ.exit, label %bb.i, !dbg !212
...
bb.i:                                             ; preds = %entry, %bb.i
  ...
  %13 = icmp eq i8 %12, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %13, label %mainQ.exit, label %bb.i, !dbg !212
...
entry:
  %0 = icmp eq i32 %count, 0, !dbg !214
  br i1 %0, label %bb2, label %bb.lr.ph, !dbg !214

bb.lr.ph:                                         ; preds = %entry
  %1 = trunc i32 %s to i8, !dbg !215
  br label %bb

bb:                                               ; preds = %bb, %bb.lr.ph
  %indvar = phi i32 [ 0, %bb.lr.ph ], [ %indvar.next, %bb ]
  %a.05 = getelementptr i8* %dst, i32 %indvar
  volatile store i8 %1, i8* %a.05, align 1, !dbg !215
  %indvar.next = add i32 %indvar, 1
  %exitcond1 = icmp eq i32 %indvar.next, %count
  br i1 %exitcond1, label %bb2, label %bb, !dbg !214
...
!1 = metadata !{i32 589865, metadata !"v3.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v3/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v3.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v3/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_com
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v3/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v3/", metadata !2} ; [ DW_TAG_file_type ]
...
!209 = metadata !{i32 537, i32 0, metadata !210, metadata !211}
!210 = metadata !{i32 589835, metadata !45, i32 531, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!211 = metadata !{i32 558, i32 0, metadata !205, null}
!212 = metadata !{i32 540, i32 0, metadata !210, metadata !211}
!213 = metadata !{i32 560, i32 0, metadata !205, null}
!214 = metadata !{i32 14, i32 0, metadata !108, null}
!215 = metadata !{i32 15, i32 0, metadata !108, null}
!216 = metadata !{i32 16, i32 0, metadata !108, null}
