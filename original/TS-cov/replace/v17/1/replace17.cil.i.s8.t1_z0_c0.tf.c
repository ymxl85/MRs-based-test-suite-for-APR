...
extern int fprintf(FILE * __restrict  __stream , char const   * __restrict  __format 
                   , ...) ;
void Caseerror(int n , char uk_0 ) ;
int addstr(char c , char *outset , int *j , int maxset , char uk_0 ) 
{ 
  bool result ;
  int __cil_tmp6 ;
  int __cil_tmp7 ;
...
char esc(char *s , int *i , char uk_0 ) 
{ 
  char result ;
  int __cil_tmp4 ;
  int __cil_tmp5 ;
...
char *change(char *pat , char *sub , char *line , char uk_0 ) ;
extern int isalnum() ;
void dodash(char delim , char *src , int *i , char *dest , int *j , int maxset , char uk_0 ) 
{ 
  int k ;
  bool junk ;
  char escjunk ;
...
bool getccl(char *arg , int *i , char *pat , int *j , char uk_0 ) 
{ 
  int jstart ;
  bool junk ;
  int tmp ;
...
void stclose(char *pat , int *j , int lastj , char uk_0 ) 
{ 
  int jt ;
  int jp ;
  bool junk ;
...
bool in_set_2(char c , char uk_0 ) 
{ 
  bool __cil_tmp2 ;
...
bool in_pat_set(char c , char uk_0 ) 
{ 
  bool __cil_tmp2 ;
...
int makepat(char *arg , int start , char delim , char *pat , char uk_0 ) 
{ 
  int result ;
  int i ;
  int j ;
...
int getpat(char *arg , char *pat , char uk_0 ) 
{ 
  int makeres ;
  int __cil_tmp4 ;
...
int makesub(char *arg , int from , character delim , char *sub , char uk_0 ) 
{ 
  int result ;
  int i ;
  int j ;
...
bool getsub(char *arg , char *sub , char uk_0 ) 
{ 
  int makeres ;
  bool __cil_tmp4 ;
...
char *subline(char *lin , char *pat , char *sub , char uk_0 ) ;
bool locate(character c , char *pat , int offset , char uk_0 ) 
{ 
  int i ;
  bool flag ;
  int __cil_tmp6 ;
...
extern int abort() ;
bool omatch(char *lin , int *i , char *pat , int j , char uk_0 ) 
{ 
  char advance ;
  bool result ;
  bool tmp ;
...
int patsize(char *pat , int n , char uk_0 ) 
{ 
  int size ;
  bool tmp ;
  bool __cil_tmp5 ;
...
int amatch(char *lin , int offset , char *pat , int j , char uk_0 ) 
{ 
  int i ;
  int k ;
  bool result ;
...
void putsub(char *lin , int s1 , int s2 , char *sub , char *output , int *OL , char uk_0 ) 
{ 
  int i ;
  int j ;
  int __cil_tmp9 ;
...
char *mainQ(char *argv1 , char *argv2 , char *argv3 , char uk_0 ) 
{ 
  string pat ;
  string sub ;
  bool result ;
...
{ 
  ...
  __cil_tmp6 = mainQ("?", "&", "\\n", uk_0);
  __cil_tmp7 = strcmp(__cil_tmp6, "\\n");
  __cil_tmp8 = mainQ("?", "&", "\\xf5", uk_0);
  __cil_tmp9 = strcmp(__cil_tmp8, "\\xf5");
  __cil_tmp10 = mainQ("?", "\\xff", "\\n", uk_0);
  __cil_tmp11 = strcmp(__cil_tmp10, "\\xff\\xff");
  __cil_tmp12 = mainQ("?", "@", "\\n", uk_0);
  __cil_tmp13 = strcmp(__cil_tmp12, "@@");
  __cil_tmp14 = mainQ("%", "&", "\\xff", uk_0);
  __cil_tmp15 = strcmp(__cil_tmp14, "\\xff");
  __cil_tmp16 = mainQ("?", "&", "\\n\\n", uk_0);
  __cil_tmp17 = strcmp(__cil_tmp16, "\\n\\n");
  __cil_tmp18 = mainQ("?", "@", "\\xf5", uk_0);
  __cil_tmp19 = strcmp(__cil_tmp18, "@@@@");
  __cil_tmp20 = mainQ("?", "\\x99", "\\xf5", uk_0);
  __cil_tmp21 = strcmp(__cil_tmp20, "\\x99\\x99\\x99\\x99");
  __cil_tmp22 = mainQ("%", "&", "\\xff\\xff", uk_0);
  __cil_tmp23 = strcmp(__cil_tmp22, "\\xff\\xff");
  __cil_tmp24 = mainQ("$", "&", "\\xf5", uk_0);
  __cil_tmp25 = strcmp(__cil_tmp24, "\\xf5");
  __cil_tmp26 = mainQ("?", "@n", "\\n", uk_0);
  __cil_tmp27 = strcmp(__cil_tmp26, "\n\n");
  __cil_tmp28 = mainQ("%", "@", "\\xff", uk_0);
  __cil_tmp29 = strcmp(__cil_tmp28, "@\\xff");
  __cil_tmp30 = mainQ("%", "&&", "\\xff", uk_0);
  __cil_tmp31 = strcmp(__cil_tmp30, "\\xff");
  __cil_tmp32 = mainQ("?", "&&", "\\xf5", uk_0);
  __cil_tmp33 = strcmp(__cil_tmp32, "\\\\xxff55");
  __cil_tmp34 = mainQ("$", "&", "\\n", uk_0);
  __cil_tmp35 = strcmp(__cil_tmp34, "\\n");
  __cil_tmp36 = mainQ("?", "@t", "\\n", uk_0);
  __cil_tmp37 = strcmp(__cil_tmp36, "\t\t");
  __cil_tmp38 = mainQ("?", "@\\x9b", "\\n", uk_0);
  __cil_tmp39 = strcmp(__cil_tmp38, "\\x9b\\x9b");
  __cil_tmp40 = mainQ("??", "&", "\\xf5", uk_0);
  __cil_tmp41 = strcmp(__cil_tmp40, "\\xf5");
  __cil_tmp42 = mainQ("\\xda", "&", "\\xff", uk_0);
  __cil_tmp43 = strcmp(__cil_tmp42, "\\xff");
  __cil_tmp44 = mainQ("??", "&", "\\xf5\\xf5", uk_0);
  __cil_tmp45 = strcmp(__cil_tmp44, "\\xf5\\xf5");
  __cil_tmp46 = mainQ("[", "&", "\\xff", uk_0);
  __cil_tmp47 = strcmp(__cil_tmp46, "\\xff");
  __cil_tmp48 = mainQ("\\xda", "&", "\\xda", uk_0);
  __cil_tmp49 = strcmp(__cil_tmp48, "\\xda");
  __cil_tmp50 = mainQ("[^]", "&", "\\n", uk_0);
  __cil_tmp51 = strcmp(__cil_tmp50, "\\n");
  __cil_tmp52 = mainQ("[^", "&", "\\n", uk_0);
  __cil_tmp53 = strcmp(__cil_tmp52, "\\n");
  __cil_tmp54 = mainQ("[]", "&", "\\xff", uk_0);
  __cil_tmp55 = strcmp(__cil_tmp54, "\\xff");
  __cil_tmp56 = mainQ("@", "&", "\\n", uk_0);
  __cil_tmp57 = strcmp(__cil_tmp56, "\\n");
  __cil_tmp58 = mainQ("$?", "&", "$", uk_0);
  __cil_tmp59 = strcmp(__cil_tmp58, "$");
  __cil_tmp60 = mainQ("%*", "&", "\\xff", uk_0);
  __cil_tmp61 = strcmp(__cil_tmp60, "\\xff");
  __cil_tmp62 = mainQ("[^]", "&", "\\xf5", uk_0);
  __cil_tmp63 = strcmp(__cil_tmp62, "\\xf5");
  __cil_tmp64 = mainQ("[^", "&", "\\xf5", uk_0);
  __cil_tmp65 = strcmp(__cil_tmp64, "\\xf5");
  __cil_tmp66 = mainQ("?*", "&", "\\n", uk_0);
  __cil_tmp67 = strcmp(__cil_tmp66, "\\n");
  __cil_tmp68 = mainQ("@n", "&", "\\n", uk_0);
  __cil_tmp69 = strcmp(__cil_tmp68, "\\n");
  __cil_tmp70 = mainQ("[-", "&", "\\xd2", uk_0);
  __cil_tmp71 = strcmp(__cil_tmp70, "\\xd2");
  __cil_tmp72 = mainQ("?*", "&", "\\xf5", uk_0);
  __cil_tmp73 = strcmp(__cil_tmp72, "\\xf5");
  __cil_tmp74 = mainQ("@\\x9b", "&", "\\x9b", uk_0);
  __cil_tmp75 = strcmp(__cil_tmp74, "\\x9b");
  __cil_tmp76 = mainQ("@t", "&", "\\t", uk_0);
  __cil_tmp77 = strcmp(__cil_tmp76, "\\t");
  __cil_tmp78 = mainQ("[-", "&", "-", uk_0);
  __cil_tmp79 = strcmp(__cil_tmp78, "-");
  __cil_tmp80 = mainQ("[^-", "&", "-", uk_0);
  __cil_tmp81 = strcmp(__cil_tmp80, "-");
  __cil_tmp82 = mainQ("?*?", "&", "\\n", uk_0);
  __cil_tmp83 = strcmp(__cil_tmp82, "\\n");
  __cil_tmp84 = mainQ("[^-", "&", "\\xf7", uk_0);
  __cil_tmp85 = strcmp(__cil_tmp84, "\\xf7");
  __cil_tmp86 = mainQ("[\\xa2]", "&", "\\xa2", uk_0);
  __cil_tmp87 = strcmp(__cil_tmp86, "\\xa2");
  __cil_tmp88 = mainQ("$*", "&", "$", uk_0);
  __cil_tmp89 = strcmp(__cil_tmp88, "$");
  __cil_tmp90 = mainQ("[-]", "&", "-", uk_0);
  __cil_tmp91 = strcmp(__cil_tmp90, "-");
  __cil_tmp92 = mainQ("[]*", "&", "\\xff", uk_0);
  __cil_tmp93 = strcmp(__cil_tmp92, "\\xff");
  __cil_tmp94 = mainQ("[@@", "&", "\\n", uk_0);
  __cil_tmp95 = strcmp(__cil_tmp94, "\\n");
  __cil_tmp96 = mainQ("[^@@", "&", "\\n", uk_0);
  __cil_tmp97 = strcmp(__cil_tmp96, "\\n");
  __cil_tmp98 = mainQ("[^@\\xbf]", "&", "\\n", uk_0);
  __cil_tmp99 = strcmp(__cil_tmp98, "\\n");
  __cil_tmp100 = mainQ("[^@@n]", "&", "\\xff", uk_0);
  __cil_tmp101 = strcmp(__cil_tmp100, "\\xff");
  __cil_tmp102 = mainQ("[@\\xbf]", "&", "\\xbf", uk_0);
  __cil_tmp103 = strcmp(__cil_tmp102, "\\xbf");
  __cil_tmp104 = mainQ("[^@@t]", "&", "\\xff", uk_0);
  __cil_tmp105 = strcmp(__cil_tmp104, "\\xff");
  __cil_tmp106 = mainQ("[^@@\\x9b]", "&", "\\xff", uk_0);
  __cil_tmp107 = strcmp(__cil_tmp106, "\\xff");
  __cil_tmp108 = mainQ("?[^@@t-]", "\\xff", "\\xff", uk_0);
  __cil_tmp109 = strcmp(__cil_tmp108, "\\xff\\xff");
