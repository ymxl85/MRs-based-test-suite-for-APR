...
bb.i12.i:                                         ; preds = %bb1.backedge.i.i, %bb.lr.ph.i.i
  ...
  %128 = icmp slt i32 %jp.0.in2.i.i, 100
...
addstr.exit11.i:                                  ; preds = %bb2.i8.i, %bb17.i
  ...
  %135 = getelementptr inbounds [10 x i8]* %argv1, i32 0, i32 %i.i.7
...
esc.exit.i:                                       ; preds = %bb7.i.i, %bb5.i.i, %bb3.i.i, %bb1.i.i, %bb.i.i
  %i.i.5 = phi i32 [ %i.i.7, %bb1.i.i ], [ %139, %bb3.i.i ], [ %139, %bb5.i.i ], [ %139, %bb7.i.i ], [ %i.i.7, %bb.i.i ]
  %result.0.i7.i = phi i8 [ 64, %bb1.i.i ], [ 10, %bb3.i.i ], [ 9, %bb5.i.i ], [ %147, %bb7.i.i ], [ %138, %bb.i.i ]
  %148 = icmp slt i32 %j.i.8, 100
...
!1 = metadata !{i32 589865, metadata !"v8.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/coverageTC/v8/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v8.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/coverageTC/v8/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile
