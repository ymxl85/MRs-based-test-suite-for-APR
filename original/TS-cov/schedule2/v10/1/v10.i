# 1 "coverageTC/v10/1/v10.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "coverageTC/v10/1/v10.c"
# 16 "coverageTC/v10/1/v10.c"
...
# 17 "coverageTC/v10/1/v10.c" 2
# 1 "coverageTC/v10/1/schedule2.h" 1
# 41 "coverageTC/v10/1/schedule2.h"
...
extern int schedule(int command, int prio, float ratio, char *r );
...
# 18 "coverageTC/v10/1/v10.c" 2
# 1 "coverageTC/v10/1/processor.h" 1
float getOperand(char * str);

void getAdata(char * str,int *pos, char * s);
# 19 "coverageTC/v10/1/v10.c" 2
