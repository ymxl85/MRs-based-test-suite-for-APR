...
{ int status ;
  ...
  if ((int )*(argv + *pos) != 0) {
    ...
    *prio = atoi(value);
    ...
    case 4: 
    getAdata(argv, pos, value);
    __repair_del_81__8a2: /* CIL Label */ 
    {
    ...
    *prio = atoi(value);
    ...
    __repair_del_87__8a3: /* CIL Label */ 
    {
...
{ int status ;
  ...
  {
  __repair_del_158__8a4: /* CIL Label */ 
  {

  }
  if (status <= 0) {
    __repair_del_156__8a5: /* CIL Label */ 
    {
