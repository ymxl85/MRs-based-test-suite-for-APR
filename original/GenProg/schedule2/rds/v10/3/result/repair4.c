...
{ int status ;
  ...
  if ((int )*(argv + *pos) != 0) {
    ...
    *ratio = tmp___0;
    ...
    case 2: 
    getAdata(argv, pos, value);
    __repair_app_87__a57: /* CIL Label */ 
    {
    *prio = atoi(value);
    *ratio = tmp___1;
    }
...
{ struct process *job ;
  ...
  s[2] = (char)0;
  s[3] = (char)0;
  __repair_swap1_185__a58: /* CIL Label */ 
  s[8] = (char)0;
  s[5] = (char)0;
  s[6] = (char)0;
  s[7] = (char)0;
  __repair_swap1_181__a59: /* CIL Label */ 
  s[4] = (char)0;
  s[9] = (char)0;
  job = get_current();
  if (job) {
    ...
    strcat(r___0, " ");
    strcat(r___0, s);
    __repair_del_174__a5a: /* CIL Label */ 
    {
...
{ 
  ...
  {
  __repair_del_210__a5b: /* CIL Label */ 
  {
...
{ struct process **next ;
  ...
  while (*next) {
    __repair_app_17__a5c: /* CIL Label */ 
    {
    next = & (*next)->next;
