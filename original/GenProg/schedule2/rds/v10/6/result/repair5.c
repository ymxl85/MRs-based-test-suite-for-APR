...
{ int command ;
  ...
  while (a2 > 0) {
    ...
    __repair_app_211__163: /* CIL Label */ 
    {
    a2 --;
    get_current();
    }
...
{ int status ;
  ...
  if ((int )*(argv + *pos) != 0) {
    ...
    *command = atoi(value);
    ...
    case 1: 
    getAdata(argv, pos, value);
    __repair_del_79__164: /* CIL Label */ 
    {
    ...
    *ratio = tmp___1;
    ...
    while (1) {
      if ((int )*(argv + *pos) != 0) {
        __repair_app_202__165: /* CIL Label */ 
        {
        if ((int )*(argv + *pos) != 10) {
...
{ int length ;
  ...
  if ((double )ratio < 0.0) {
    ...
    __repair_swap1_246__166: /* CIL Label */ ;
  }
  ...
  while (1) {
    if (index) {
      if (*next) {
        __repair_swap1_243__167: /* CIL Label */ 
        if ((double )ratio > 1.0) {
          return (-5);
        } else {
