...
mkdir v$x
s=/home/mingyue/experiments/ceti/schedule2/randomTC/v$x
...
#------------------------
    ...
    java processTCEXE /home/mingyue/experiments/GenProg/genprog-source-v3.0/data/schedule2/randomTC/v$x/$i
#-----------------------------
    rm -r correct
    rm -r faulty
    rm -r outputP
