...
{ int command ;
  ...
  value[3] = (char)0;
  value[4] = (char)0;
  __repair_swap1_40__13c: /* CIL Label */ ;
  value[6] = (char)0;
  value[7] = (char)0;
  value[8] = (char)0;
  value[9] = (char)0;
  ...
  while (1) {
    ...
    if (status > 0) {
      __repair_swap1_51__13d: /* CIL Label */ 
      value[5] = (char)0;
    } else {
      break;
    }
...
{ int status ;
  ...
  {
  __repair_swap1_146__13e: /* CIL Label */ 
  return (tmp);
  if (status <= 0) {
    return (status);
  } else {
  ...
  __repair_swap1_142__13f: /* CIL Label */ 
  ...
  if (! current_job) {
    ...
    while (prio > 0) {
      ...
      if (tmp > 0) {
        ...
        __repair_del_193__140: /* CIL Label */ 
        {
