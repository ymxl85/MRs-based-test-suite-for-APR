...
{ int i ;
  ...
  {
  i = 0;
  __repair_app_85__5cc: /* CIL Label */ 
  {
  id = 0;
  ...
  ch1[0] = (char )'\000';
  ch1[1] = (char )'\000';
  __repair_app_48__5cd: /* CIL Label */ 
  {
  ch = get_char(tp);
...
{ char ch1[2] ;
  ...
  if (tmp == 1) {
    __repair_app_126__5ce: /* CIL Label */ 
    {
    return (1);
    return (41);
    }
...
{ 
  ...
  if ((int )*tok == 0) {
    ...
    __repair_app_47__5cf: /* CIL Label */ 
    {
    return (0);
    return (buffer);
    }
  ...
  if (tmp) {
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        ...
        if (tmp___2) {
          __repair_app_200__5d0: /* CIL Label */ 
          {
...
{ int i ;
  ...
  if ((int const   )*(*tmp___0 + (int )*str) & 2048) {
    ...
    __repair_swap1_235__5d1: /* CIL Label */ ;
  }
}
}
static int is_str_constant(token str ) 
{ int i ;
  ...
  if ((int )*str == 34) {
    while ((int )*str != 0) {
      __repair_app_293__5d2: /* CIL Label */ 
      {
      if ((int )*(str + i) == 34) {
        return (1);
      } else {
        __repair_swap1_238__5d3: /* CIL Label */ 
        if ((int )*str != 0) {
          __repair_swap1_231__5d4: /* CIL Label */ 
          return (0);
        } else {
          break;
        }
...
{ int i ;
  ...
  {
  __repair_swap1_258__5d5: /* CIL Label */ 
  tmp___1 = __ctype_b_loc();
  __repair_swap1_257__5d6: /* CIL Label */ 
  i = 1;
...
{ int tmp ;
  ...
  {
  tmp = strcmp((char const   *)str, "(");
  __repair_swap1_293__5d9: /* CIL Label */ 
  __repair_del_308__5d8: /* CIL Label */ 
  __repair_del_308__5d7: /* CIL Label */ ;
  tmp___0 = strcmp((char const   *)str, ")");
  if (tmp___0) {
