...
{ char ch1[2] ;
  ...
  ch1[0] = ch;
  ch1[1] = (char )'\000';
  __repair_app_129__180: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  if (tmp___1) {
    ...
    __repair_app_58__181: /* CIL Label */ 
    {
...
{ int type ;
  ...
  {
  type = token_type(tok);
  __repair_app_97__182: /* CIL Label */ 
  {
  if (type == 0) {
...
{ int i ;
  ...
  if ((int const   )*(*tmp___0 + (int )*str) & 2048) {
    while ((int )*(str + i) != 0) {
      tmp = __ctype_b_loc();
      if ((int const   )*(*tmp + (int )*((str + i) + 1)) & 2048) {
        __repair_app_47__183: /* CIL Label */ 
        {
        i ++;
        return (buffer);
        }
...
{ int tmp ;
  ...
  tmp___4 = strcmp((char const   *)str, "`");
  __repair_swap1_305__184: /* CIL Label */ ;
  tmp___5 = strcmp((char const   *)str, ",");
  if (tmp___5) {
    __repair_swap1_318__185: /* CIL Label */ 
    if (tmp___4) {
