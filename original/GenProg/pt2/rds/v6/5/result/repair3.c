...
{ int i ;
  ...
  __repair_swap1_85__7c6: /* CIL Label */ 
  tmp___2 = is_eof_token(ch1);
  __repair_swap1_84__7c7: /* CIL Label */ 
  ch1[0] = ch;
  if (tmp___2 == 1) {
    ch = unget_char(ch, tp);
    if ((int )ch == 0) {
  ...
  if (tmp___3 == 1) {
    ...
    __repair_del_54__7c8: /* CIL Label */ 
    {
  ...
  __repair_del_90__7ca: /* CIL Label */ 
  __repair_swap1_91__7c9: /* CIL Label */ 
  {

  }
  __repair_swap1_90__7cb: /* CIL Label */ 
  if (id == 0) {
    if ((int )ch == 59) {
      ch = unget_char(ch, tp);
      if ((int )ch == 0) {
...
{ int type ;
  ...
  {
  type = token_type(tok);
  __repair_swap1_185__7cc: /* CIL Label */ 
  if (type == 2) {
  ...
  __repair_swap1_183__7cd: /* CIL Label */ 
  if (type == 0) {
...
{ int i ;
  ...
  if ((int const   )*(*tmp___0 + (int )*str) & 2048) {
    __repair_del_229__7ce: /* CIL Label */ 
    {
...
{ int tmp ;
  ...
  tmp___3 = strcmp((char const   *)str, "\'");
  __repair_swap1_305__7cf: /* CIL Label */ ;
  tmp___4 = strcmp((char const   *)str, "`");
  if (tmp___4) {
  ...
  if (tmp___5) {
    __repair_swap1_316__7d0: /* CIL Label */ 
    if (tmp___3) {
