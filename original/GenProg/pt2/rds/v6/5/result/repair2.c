...
{ token_stream fp ;
  ...
  __repair_app_276__cbf: /* CIL Label */ 
  {
  return (fp);
...
{ char ch1[2] ;
  ...
  __repair_del_114__cc0: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  if (tmp___3) {
    ...
    __repair_del_129__cc1: /* CIL Label */ 
    {
...
{ 
  ...
  {
  __repair_swap1_196__cc2: /* CIL Label */ 
  return (0);
}
}
static int is_keyword(token str ) 
...
{ int i ;
  ...
  if ((int const   )*(*tmp___0 + (int )*str) & 2048) {
    __repair_swap1_227__cc3: /* CIL Label */ 
    tmp = __ctype_b_loc();
    return (1);
  } else {
    return (0);
...
{ int tmp ;
  ...
  if (tmp___0) {
    ...
    __repair_app_255__cc4: /* CIL Label */ 
    {
    return;
    return (1);
    }
