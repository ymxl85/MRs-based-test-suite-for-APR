...
{ int i ;
  ...
  __repair_swap1_45__476: /* CIL Label */ 
  ch = unget_char(ch, tp);
  tmp___3 = is_spec_symbol(ch1);
  __repair_swap1_43__477: /* CIL Label */ 
  unget_error(*tp);
  if (id == 1) {
    i ++;
    buffer[i] = ch;
...
{ char ch1[2] ;
  ...
  if (str_com_id == 1) {
    ...
    __repair_swap1_313__478: /* CIL Label */ ;
  }
  if (str_com_id == 2) {
    if ((int )ch == 10) {
      return (1);
...
{ int type ;
  ...
  if (type == 42) {
    ...
    __repair_del_165__479: /* CIL Label */ 
    {
...
{ unsigned short const   **tmp ;
  ...
  if ((int )*str == 35) {
    ...
    if ((int const   )*(*tmp + (int )*(str + 1)) & 1024) {
      ...
      __repair_app_313__47a: /* CIL Label */ 
      {
      return (0);
...
{ char *fname ;
  ...
  while (1) {
    ...
    if (tmp == 0) {
      __repair_swap1_88__47b: /* CIL Label */ ;
    } else {
      break;
    }
    print_token(tok, r);
