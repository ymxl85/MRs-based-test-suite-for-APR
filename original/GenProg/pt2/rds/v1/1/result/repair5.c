...
{ int i ;
  ...
  __repair_swap1_73__1cb: /* CIL Label */ 
  if ((int )ch == 59) {
    id = 2;
  } else {

  }
  __repair_swap1_72__1cc: /* CIL Label */ 
  if ((int )ch == 34) {
    id = 1;
  } else {
  ...
  if (tmp___2 == 1) {
    __repair_swap1_54__1cd: /* CIL Label */ ;
    if ((int )ch == 0) {
      unget_error(*tp);
    } else {
  ...
  if (tmp___3 == 1) {
    ...
    __repair_swap1_45__1ce: /* CIL Label */ 
    ch = unget_char(ch, tp);
  }
  if (id == 1) {
    i ++;
...
{ int tmp ;
  ...
  __repair_app_124__1cf: /* CIL Label */ 
  {
  if (tmp___4) {
    return (43);
  } else {
...
{ char *fname ;
  ...
  while (1) {
    ...
    if (tmp == 0) {
      __repair_del_313__1d0: /* CIL Label */ 
      {
