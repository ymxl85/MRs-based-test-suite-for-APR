...
{ char c ;
  ...
  if ((int )ch != 0) {
    ...
    __repair_app_246__24a: /* CIL Label */ 
    {
...
{ int i ;
  ...
  if (tmp___0 == 1) {
    ...
    __repair_del_32__24b: /* CIL Label */ 
    {
  ...
  __repair_del_76__24c: /* CIL Label */ 
  {

  }
  tmp___2 = is_eof_token(ch1);
  __repair_app_38__24d: /* CIL Label */ 
  {
  if (tmp___2 == 1) {
    ch = unget_char(ch, tp);
    if ((int )ch == 0) {
  ...
  if (id == 1) {
    ...
    __repair_app_112__24e: /* CIL Label */ 
    {
...
{ int type ;
  ...
  __repair_app_125__24f: /* CIL Label */ 
  {
  return (0);
  return (6);
  }
