...
{ int i ;
  ...
  __repair_del_76__8ea: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  if (tmp) {
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        __repair_del_197__8eb: /* CIL Label */ 
        {
...
{ unsigned short const   **tmp ;
  ...
  if ((int )*str == 35) {
    ...
    if ((int const   )*(*tmp + (int )*(str + 1)) & 1024) {
      ...
      __repair_del_209__8ec: /* CIL Label */ 
      {
...
{ int i ;
  ...
  if ((int const   )*(*tmp___1 + (int )*str) & 1024) {
    ...
    __repair_app_312__8ed: /* CIL Label */ 
    {
    return (1);
    return (0);
    }
...
{ 
  ...
  {
  __repair_app_261__8ee: /* CIL Label */ 
  {
  return (0);
...
{ int tmp ;
  ...
  __repair_swap1_264__8ef: /* CIL Label */ ;
  ...
  if (tmp___3) {
    __repair_swap1_275__8f0: /* CIL Label */ 
    if (tmp___1) {
