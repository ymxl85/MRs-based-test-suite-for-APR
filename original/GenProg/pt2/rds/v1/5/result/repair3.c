...
{ int i ;
  ...
  __repair_swap1_43__416: /* CIL Label */ 
  unget_error(*tp);
  tmp___2 = is_eof_token(ch1);
  if (tmp___2 == 1) {
    ch = unget_char(ch, tp);
    if ((int )ch == 0) {
      __repair_swap1_76__417: /* CIL Label */ 
      ch1[0] = ch;
    } else {
...
{ char ch1[2] ;
  ...
  {
  ch1[0] = ch;
  __repair_app_157__418: /* CIL Label */ 
  {
  ch1[1] = (char )'\000';
...
{ int type ;
  ...
  __repair_app_48__419: /* CIL Label */ 
  {
  if (type == 43) {
    tok ++;
...
{ int tmp ;
  ...
  __repair_app_214__41a: /* CIL Label */ 
  {
  if (tmp___0) {
...
{ int tmp ;
  ...
  __repair_app_54__41b: /* CIL Label */ 
  {
  if (tmp___5) {
