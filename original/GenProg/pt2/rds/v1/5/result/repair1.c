...
{ int i ;
  ...
  __repair_swap1_79__1c3: /* CIL Label */ 
  ...
  __repair_swap1_76__1c4: /* CIL Label */ 
  ch1[0] = ch;
  if (tmp___3 == 1) {
    ch = unget_char(ch, tp);
    if ((int )ch == 0) {
...
{ int tmp ;
  ...
  {
  tmp = is_keyword(tok);
  __repair_swap1_137__1c5: /* CIL Label */ 
  ...
  __repair_swap1_128__1c6: /* CIL Label */ 
  if (tmp) {
    return (1);
  } else {
...
{ int tmp ;
  ...
  __repair_app_82__1c7: /* CIL Label */ 
  {
  if (tmp) {
