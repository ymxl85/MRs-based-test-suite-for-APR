...
{ int i ;
  ...
  __repair_del_76__dc2: /* CIL Label */ 
  {
...
{ int type ;
  ...
  if (type == 42) {
    ...
    __repair_swap1_214__dc3: /* CIL Label */ ;
  }
  if (type == 43) {
    tok ++;
...
{ int tmp ;
  ...
  tmp___0 = strcmp((char const   *)str, ")");
  if (tmp___0) {
    __repair_swap1_302__dc4: /* CIL Label */ 
    tmp___1 = strcmp((char const   *)str, "[");
  } else {
    return (1);
  }
  __repair_swap1_286__dc5: /* CIL Label */ ;
  if (tmp___1) {
  ...
  tmp___2 = strcmp((char const   *)str, "]");
  __repair_swap1_294__dc6: /* CIL Label */ ;
  tmp___3 = strcmp((char const   *)str, "\'");
  if (tmp___3) {
  ...
  tmp___4 = strcmp((char const   *)str, "`");
  if (tmp___4) {
    __repair_swap1_305__dc7: /* CIL Label */ 
    if (tmp___2) {
