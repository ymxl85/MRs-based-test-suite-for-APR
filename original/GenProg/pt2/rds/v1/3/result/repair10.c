...
{ int i ;
  ...
  __repair_swap1_76__84a: /* CIL Label */ 
  ch1[0] = ch;
  ch1[1] = (char )'\000';
  ch = get_char(tp);
  while (1) {
  ...
  __repair_swap1_63__84b: /* CIL Label */ 
  ch1[0] = (char )'\000';
...
{ char ch1[2] ;
  ...
  if (str_com_id == 1) {
    if (((int )ch == 34) | ((int )ch == 10)) {
      ...
      __repair_del_86__84c: /* CIL Label */ 
      {
  ...
  if ((int )ch == 32) {
    ...
    if ((int )ch == 10) {
      ...
      if ((int )ch == 59) {
        __repair_app_267__84d: /* CIL Label */ 
        {
        return (1);
...
{ int tmp ;
  ...
  if (tmp) {
    ...
    __repair_swap1_157__84e: /* CIL Label */ ;
  }
...
{ int type ;
  ...
  if (type == 3) {
    ...
    __repair_swap1_112__84f: /* CIL Label */ ;
  }
  if (type == 41) {
...
{ int tmp ;
  ...
  if (tmp) {
    ...
    if (tmp___0) {
      ...
      __repair_app_269__850: /* CIL Label */ 
      {
      if (tmp___1) {
