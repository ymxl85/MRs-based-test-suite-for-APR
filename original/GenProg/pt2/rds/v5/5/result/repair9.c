...
{ char c ;
  ...
  if ((int )ch != 0) {
    ...
    __repair_swap1_133__376: /* CIL Label */ ;
  }
  if ((int )c == 0) {
    return (c);
  } else {
...
{ int tmp ;
  ...
  if (tmp) {
    ...
    __repair_del_121__377: /* CIL Label */ 
    {
  ...
  if (tmp___5) {
    ...
    __repair_swap1_9__378: /* CIL Label */ ;
  }
...
{ int type ;
  ...
  if (type == 1) {
    ...
    __repair_swap1_235__379: /* CIL Label */ ;
  }
  if (type == 2) {
  ...
  if (type == 42) {
    __repair_app_186__37a: /* CIL Label */ 
    {
...
{ int i ;
  ...
  if ((int )*str == 34) {
    ...
    __repair_del_241__37b: /* CIL Label */ 
    {
