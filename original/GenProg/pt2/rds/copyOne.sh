...
mkdir v$x
s=/home/mingyue/experiments/ceti/printtoken2/randomTC/v$x
...
#------------------------
    ...
    java processTCEXE /home/mingyue/experiments/GenProg/genprog-source-v3.0/data/pt2/randomTC/v$x/$i
#-----------------------------
    rm -r correct
    rm -r faulty
    rm -r outputP
