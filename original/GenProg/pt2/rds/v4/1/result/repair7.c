...
{ char c ;
  ...
  __repair_swap1_11__3f9: /* CIL Label */ 
  return (c);
}
}
char buffer[81]  ;
...
{ int i ;
  ...
  if (tmp___2 == 1) {
    ch = unget_char(ch, tp);
    if ((int )ch == 0) {
      __repair_del_43__3fb: /* CIL Label */ 
      {
...
{ char ch1[2] ;
  ...
  {
  ch1[0] = ch;
  __repair_app_32__3fc: /* CIL Label */ 
  {
  ch1[1] = (char )'\000';
...
{ int tmp ;
  ...
  tmp___1 = strcmp((char const   *)str, "[");
  if (tmp___1) {
    __repair_app_125__3fd: /* CIL Label */ 
    {
...
{ char *tmp ;
  ...
  __repair_app_264__3fe: /* CIL Label */ 
  {
  exit(0);
