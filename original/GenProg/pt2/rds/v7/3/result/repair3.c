...
{ char c ;
  ...
  if ((int )ch != 0) {
    ...
    __repair_app_135__785: /* CIL Label */ 
    {
...
{ int i ;
  ...
  __repair_app_48__786: /* CIL Label */ 
  {
  if (tmp == 1) {
    return (buffer);
  } else {
...
{ char ch1[2] ;
  ...
  if (str_com_id == 2) {
    if ((int )ch == 10) {
      ...
      if ((int )ch == 32) {
        __repair_swap1_193__787: /* CIL Label */ 
        return (0);
      } else {
        return (0);
      }
...
{ int tmp ;
  ...
  __repair_app_303__788: /* CIL Label */ 
  {
  if (tmp___1) {
    return (3);
  } else {
...
{ int type ;
  ...
  __repair_swap1_99__789: /* CIL Label */ 
  return (1);
}
}
int is_eof_token(token tok ) 
...
{ int i ;
  ...
  {
  i = 1;
  __repair_app_124__78a: /* CIL Label */ 
  {
  if ((int )*str == 34) {
    while ((int )*(str + i) != 0) {
      if ((int )*(str + i) == 34) {
...
{ int tmp ;
  ...
  {
  tmp = strcmp((char const   *)str, "(");
  __repair_app_269__78b: /* CIL Label */ 
  {
  if (tmp) {
