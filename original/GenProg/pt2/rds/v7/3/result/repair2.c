...
{ int i ;
  ...
  {
  i = 0;
  __repair_swap1_71__124: /* CIL Label */ 
  ch1[0] = (char )'\000';
  j = 0;
  while (j <= 80) {
    buffer[j] = (char )'\000';
  ...
  __repair_swap1_68__125: /* CIL Label */ 
  id = 0;
  ch1[1] = (char )'\000';
  ch = get_char(tp);
  while (1) {
  ...
  if (id == 0) {
    ...
    __repair_app_83__126: /* CIL Label */ 
    {
...
{ char ch1[2] ;
  ...
  if (str_com_id == 2) {
    if ((int )ch == 10) {
      ...
      if ((int )ch == 32) {
        __repair_swap1_262__127: /* CIL Label */ 
        return (0);
      } else {
        return (0);
      }
...
{ 
  ...
  {
  __repair_swap1_99__128: /* CIL Label */ 
  return (1);
}
}
static void print_spec_symbol(token str , char *r ) 
