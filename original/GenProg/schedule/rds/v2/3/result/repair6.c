...
{ Ele *f_ele ;
  ...
  {
  __repair_swap1_26__bc1: /* CIL Label */ ;
  f_ele = f_list->first;
  i = 1;
  __repair_swap1_29__bc2: /* CIL Label */ 
  f_ele = f_ele->next;
  return (f_ele);
}
}
...
{ 
  ...
  if (! d_list) {
    ...
    if (! d_ele) {
      ...
      __repair_app_39__bc3: /* CIL Label */ 
      {
...
{ 
  ...
  {
  free(ptr);
  __repair_del_50__bc4: /* CIL Label */ 
  {
...
{ char s[10] ;
  ...
  s[6] = (char)0;
  s[7] = (char)0;
  __repair_swap1_56__bc5: /* CIL Label */ ;
  s[9] = (char)0;
  __repair_app_25__bc6: /* CIL Label */ 
  {
  if (cur_proc) {
    ...
    __repair_swap1_66__bc7: /* CIL Label */ 
    s[8] = (char)0;
  }
...
{ int count ;
  ...
  if (block_queue) {
    ...
    if (proc) {
      ...
      __repair_app_89__bc8: /* CIL Label */ 
      {
