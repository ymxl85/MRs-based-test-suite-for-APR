...
{ List *list ;
  ...
  list = (List *)tmp;
  list->first = (Ele *)0;
  __repair_swap1_12__269: /* CIL Label */ 
  return (list);
  __repair_del_11__26a: /* CIL Label */ 
  {

  }
  __repair_swap1_10__26b: /* CIL Label */ 
  list->last = (Ele *)0;
}
}
...
{ Ele *f_ele ;
  ...
  {
  __repair_app_150__26c: /* CIL Label */ 
  {
  if (! f_list) {
    return ((Ele *)0);
  } else {
...
{ int command ;
  ...
  {
  __repair_swap1_152__26d: /* CIL Label */ 
  ...
  while ((int )*(argv + pos) != 0) {
    ...
    if ((int )*(argv + pos) != 0) {
      getAdata(argv, & pos, value);
      __repair_swap1_191__26e: /* CIL Label */ 
      intF = (float )1.0;
      ratio = tmp;
