...
{ 
  ...
  if (! a_list) {
    ...
    __repair_app_14__764: /* CIL Label */ 
    {
  ...
  (a_list->mem_count) ++;
  __repair_del_23__765: /* CIL Label */ 
  {
...
{ Ele *proc ;
  ...
  proc->priority = (short )prio;
  num_processes ++;
  __repair_app_90__766: /* CIL Label */ 
  {
  return (proc);
  return;
  }
...
{ Ele *proc ;
  ...
  __repair_app_126__767: /* CIL Label */ 
  {
  prio_queue[prio] = append_ele(prio_queue[prio], proc);
  if (cur_proc) {
    block_queue = append_ele(block_queue, cur_proc);
...
{ int command ;
  ...
  while ((int )*(argv + pos) != 0) {
    ...
    if ((int )*(argv + pos) != 0) {
      ...
      ratio = tmp;
      __repair_app_191__768: /* CIL Label */ 
      {
