...
{ Ele *ele ;
  ...
  __repair_app_114__b7d: /* CIL Label */ 
  {
  ele = (Ele *)tmp;

  }
  ele->next = (struct _job *)0;
  __repair_swap1_5__b7e: /* CIL Label */ 
  ele->val = new_num;
  __repair_swap1_4__b7f: /* CIL Label */ 
...
{ char s[10] ;
  ...
  s[4] = (char)0;
  s[5] = (char)0;
  __repair_del_64__b80: /* CIL Label */ 
  {
  ...
  if (cur_proc) {
    ...
    strcat(r, " ");
    free_ele(cur_proc);
    __repair_app_234__b81: /* CIL Label */ 
    {
    num_processes --;
...
{ int i ;
  ...
  {
  total = num_processes;
  __repair_app_220__b82: /* CIL Label */ 
  {
  i = 0;
...
{ int count ;
  ...
  __repair_del_103__b83: /* CIL Label */ 
  {
