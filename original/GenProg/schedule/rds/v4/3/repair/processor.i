...
{ float r ;
  ...
  while (1) {
    if (i >= 0) {
      __repair_del_221__de0: /* CIL Label */ 
      {
  ...
  while ((int )*(str + i) != 0) {
    b[j] = *(str + i);
    __repair_swap1_230__de1: /* CIL Label */ 
    if ((int )*(str + i) != 0) {
      __repair_del_229__de2: /* CIL Label */ 
      {
    ...
    __repair_app_261__de3: /* CIL Label */ 
    {
    i ++;
...
{ int i ;
  ...
  *(s + i) = (char )'\000';
  ...
  __repair_del_268__de5: /* CIL Label */ 
  __repair_app_265__de4: /* CIL Label */ 
  {
