...
{ int upward_preferred ;
  ...
  __repair_del_35__383: /* CIL Label */ 
  {
...
{ int enabled ;
  ...
  {
  if (High_Confidence) {
    __repair_app_78__384: /* CIL Label */ 
    {
  ...
  __repair_swap1_83__385: /* CIL Label */ 
  if (tmp___5) {
    tmp___6 = 1;
  } else {
    tmp___6 = 0;
  ...
  alt_sep = 0;
  if (enabled) {
    __repair_app_92__386: /* CIL Label */ 
    {
    if (tcas_equipped) {
      if (intent_not_known) {
        goto _L___0;
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          ...
          __repair_swap1_107__387: /* CIL Label */ 
...
{ int tmp ;
  ...
  tmp___7 = atoi(*(argv + 4));
  tmp___8 = atoi(*(argv + 3));
  __repair_del_123__388: /* CIL Label */ 
  {
