...
{ int enabled ;
  ...
  if (High_Confidence) {
    if (Own_Tracked_Alt_Rate <= 600) {
      if (Cur_Vertical_Sep > 600) {
        __repair_del_64__132: /* CIL Label */ 
        {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      _L___1: /* CIL Label */ 
      if (! tcas_equipped) {
        __repair_swap1_87__133: /* CIL Label */ 
        _L___0: /* CIL Label */ 
        alt_sep = 1;
        if (tmp___1) {
        ...
        if (tmp___4) {
          __repair_swap1_87__134: /* CIL Label */ 
          alt_sep = 1;
          if (tmp___5) {
            tmp___6 = 1;
          } else {
        ...
        if (need_upward_RA) {
          ...
          _L: /* CIL Label */ 
          if (need_upward_RA) {
            __repair_swap1_92__136: /* CIL Label */ 
            __repair_swap1_82__135: /* CIL Label */ 
...
{ int tmp ;
  ...
  __repair_swap1_120__137: /* CIL Label */ 
  tmp___6 = atoi(*(argv + 5));
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  tmp___5 = atoi(*(argv + 6));
  __repair_swap1_116__138: /* CIL Label */ 
  tmp___2 = atoi(*(argv + 9));
  tmp___7 = atoi(*(argv + 4));
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
