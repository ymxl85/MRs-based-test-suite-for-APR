...
{ int upward_preferred ;
  ...
  __repair_swap1_14__411: /* CIL Label */ 
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_del_56__412: /* CIL Label */ 
    {
...
{ int enabled ;
  ...
  {
  __repair_swap1_95__413: /* CIL Label */ 
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_103__414: /* CIL Label */ 
        if (High_Confidence) {
        ...
        __repair_app_94__415: /* CIL Label */ 
        {
...
{ int tmp ;
  ...
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
  __repair_app_119__416: /* CIL Label */ 
  {
