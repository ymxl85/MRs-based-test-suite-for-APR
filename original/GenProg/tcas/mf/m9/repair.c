...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_del_22__cf0: /* CIL Label */ 
    {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_app_57__cf1: /* CIL Label */ 
    {
    ...
    __repair_del_57__cf2: /* CIL Label */ 
    {
...
{ int enabled ;
  ...
  __repair_del_107__cf3: /* CIL Label */ 
  {

  }
  __repair_app_83__cf4: /* CIL Label */ 
  {
  alt_sep = 0;
  if (tmp___5) {
    tmp___6 = 1;
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          ...
          __repair_del_83__cf5: /* CIL Label */ 
          {
...
{ int tmp ;
  ...
  __repair_swap1_120__cf6: /* CIL Label */ 
  tmp___6 = atoi(*(argv + 5));
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  __repair_swap1_122__cf7: /* CIL Label */ 
  tmp___8 = atoi(*(argv + 3));
  __repair_swap1_116__cf8: /* CIL Label */ 
  tmp___2 = atoi(*(argv + 9));
  tmp___7 = atoi(*(argv + 4));
  __repair_swap1_119__cfa: /* CIL Label */ 
  __repair_del_122__cf9: /* CIL Label */ 
  tmp___5 = atoi(*(argv + 6));
  tmp___9 = atoi(*(argv + 2));
