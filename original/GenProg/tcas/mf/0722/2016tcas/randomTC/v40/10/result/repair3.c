...
{ int upward_preferred ;
  ...
  __repair_app_28__3e0: /* CIL Label */ 
  {
...
{ int enabled ;
  ...
  {
  if (High_Confidence) {
    __repair_app_97__3e1: /* CIL Label */ 
    {
...
{ int tmp ;
  ...
  __repair_del_102__3e2: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  __repair_swap1_113__3e3: /* CIL Label */ 
  tmp___9 = atoi(*(argv + 2));
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
  __repair_del_111__3e4: /* CIL Label */ 
  {

  }
  tmp___8 = atoi(*(argv + 3));
  __repair_swap1_106__3e5: /* CIL Label */ 
  tmp___2 = atoi(*(argv + 9));
