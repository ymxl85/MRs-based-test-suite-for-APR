...
case $2 in
  ...
  p19) $1 2296 1 1 7920 112 -10000 3 7952 2246 0 2 0 | diff outputP/O19 - && exit 0 ;;
  p20) $1 6328 1 1 4336 240 -1568 3 2256 3271 0 2 1 | diff outputP/O20 - && exit 0 ;;
  p21) $1 3192 1 1 -2064 240 -3888 3 -6353 8413 0 2 0 | diff outputP/O21 - && exit 0 ;;
  p22) $1 1696 1 1 7920 113 7919 3 7952 8052 0 2 0 | diff outputP/O22 - && exit 0 ;;
  p23) $1 6328 1 1 4336 240 -1568 3 3072 2256 0 2 1 | diff outputP/O23 - && exit 0 ;;
  p24) $1 3192 1 1 -9168 -7584 -10000 3 558 757 0 2 1 | diff outputP/O24 - && exit 0 ;;
  p25) $1 1392 1 1 -2064 241 -2065 3 740 840 0 2 0 | diff outputP/O25 - && exit 0 ;;
  p26) $1 4344 1 1 4336 80 -2096 1 7359 6397 0 2 0 | diff outputP/O26 - && exit 0 ;;
  p27) $1 7384 1 1 -848 80 -5168 1 2256 8387 0 2 1 | diff outputP/O27 - && exit 0 ;;
  p28) $1 3192 1 1 -240 112 -1840 1 -6353 8413 0 2 0 | diff outputP/O28 - && exit 0 ;;
  p29) $1 1344 1 1 4336 81 4335 1 7359 7459 0 2 0 | diff outputP/O29 - && exit 0 ;;
  p30) $1 7384 1 1 -848 80 -5168 1 8188 2256 0 2 1 | diff outputP/O30 - && exit 0 ;;
  p31) $1 2296 1 1 -9104 -9648 -10000 1 383 576 0 2 1 | diff outputP/O31 - && exit 0 ;;
  p32) $1 1392 1 1 -240 113 -241 1 500 600 0 2 0 | diff outputP/O32 - && exit 0 ;;
  ...
  n7) $1 3192 1 1 -9168 -7584 -10000 3 757 757 0 2 1 | diff outputF/O7 - && exit 0 ;;
  n8) $1 2296 1 1 -9104 -9648 -10000 1 576 582 0 2 1 | diff outputF/O8 - && exit 0 ;;
...
let fit=0
  ...
  $1 2296 1 1 7920 112 -10000 3 7952 2246 0 2 0 | diff outputP/O19 - && let fit=$fit+1
  $1 6328 1 1 4336 240 -1568 3 2256 3271 0 2 1 | diff outputP/O20 - && let fit=$fit+1
  $1 3192 1 1 -2064 240 -3888 3 -6353 8413 0 2 0 | diff outputP/O21 - && let fit=$fit+1
  $1 1696 1 1 7920 113 7919 3 7952 8052 0 2 0 | diff outputP/O22 - && let fit=$fit+1
  $1 6328 1 1 4336 240 -1568 3 3072 2256 0 2 1 | diff outputP/O23 - && let fit=$fit+1
  $1 3192 1 1 -9168 -7584 -10000 3 558 757 0 2 1 | diff outputP/O24 - && let fit=$fit+1
  $1 1392 1 1 -2064 241 -2065 3 740 840 0 2 0 | diff outputP/O25 - && let fit=$fit+1
  $1 4344 1 1 4336 80 -2096 1 7359 6397 0 2 0 | diff outputP/O26 - && let fit=$fit+1
  $1 7384 1 1 -848 80 -5168 1 2256 8387 0 2 1 | diff outputP/O27 - && let fit=$fit+1
  $1 3192 1 1 -240 112 -1840 1 -6353 8413 0 2 0 | diff outputP/O28 - && let fit=$fit+1
  $1 1344 1 1 4336 81 4335 1 7359 7459 0 2 0 | diff outputP/O29 - && let fit=$fit+1
  $1 7384 1 1 -848 80 -5168 1 8188 2256 0 2 1 | diff outputP/O30 - && let fit=$fit+1
  $1 2296 1 1 -9104 -9648 -10000 1 383 576 0 2 1 | diff outputP/O31 - && let fit=$fit+1
  $1 1392 1 1 -240 113 -241 1 500 600 0 2 0 | diff outputP/O32 - && let fit=$fit+1
  ...
  $1 3192 1 1 -9168 -7584 -10000 3 757 757 0 2 1 | diff outputF/O7 - && let fit=$fit+1
  $1 2296 1 1 -9104 -9648 -10000 1 576 582 0 2 1 | diff outputF/O8 - && let fit=$fit+1
