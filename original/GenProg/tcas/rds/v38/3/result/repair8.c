...
{ int tmp ;
  ...
  {
  __repair_app_125__c1e: /* CIL Label */ 
  {
  if (Climb_Inhibit) {
    tmp = 100 + Up_Separation;
  } else {
    __repair_swap1_9__c1f: /* CIL Label */ 
    return (tmp);
  }
  return (0);
  }
  __repair_swap1_7__c20: /* CIL Label */ 
  tmp = Up_Separation;
}
}
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_swap1_20__c21: /* CIL Label */ 
    result = tmp___3;
    __repair_swap1_19__c23: /* CIL Label */ 
    __repair_swap1_13__c22: /* CIL Label */ 
    if (tmp___0) {
      ...
      if (tmp___1) {
        ...
        __repair_swap1_20__c24: /* CIL Label */ 
        result = tmp___3;
      } else {
        tmp___3 = 0;
      }
...
{ int upward_preferred ;
  ...
  {
  tmp = Inhibit_Biased_Climb(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
  __repair_app_125__c25: /* CIL Label */ 
  {
  upward_preferred = tmp > Down_Separation;
  return (0);
  }
  if (upward_preferred) {
    __repair_del_42__c26: /* CIL Label */ 
    {

    }
    if (tmp___0) {
      __repair_app_59__c27: /* CIL Label */ 
      {
      if (Cur_Vertical_Sep >= 300) {
...
{ int enabled ;
  ...
  if (enabled) {
    if (tcas_equipped) {
      __repair_app_62__c28: /* CIL Label */ 
      {
      if (intent_not_known) {
        goto _L___0;
      } else {
...
{ int tmp ;
  ...
  __repair_swap1_120__c29: /* CIL Label */ 
  tmp___8 = atoi(*(argv + 3));
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  ...
  tmp___6 = atoi(*(argv + 5));
  tmp___7 = atoi(*(argv + 4));
  __repair_swap1_113__c2a: /* CIL Label */ 
