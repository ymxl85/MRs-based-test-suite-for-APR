  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      if (Alt_Layer_Value == 2) {
        ...
        __repair_swap1_127__1b5: /* CIL Label */ 
        return (0);
      }
    }
  }
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        ...
        if (Down_Separation >= tmp___2) {
          ...
          __repair_del_13__1b6: /* CIL Label */ 
          {
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  __repair_swap1_124__1b7: /* CIL Label */ 
