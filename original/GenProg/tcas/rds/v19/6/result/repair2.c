...
{ 
  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      __repair_app_127__1da: /* CIL Label */ 
      {
      if (Alt_Layer_Value == 2) {
        return (640);
      } else {
        __repair_del_4__1db: /* CIL Label */ 
        {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_app_57__1dc: /* CIL Label */ 
    {
    result = tmp___2;
    result = tmp___6;
    }
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  __repair_swap1_124__1dd: /* CIL Label */ 
  ...
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
  __repair_swap1_118__1de: /* CIL Label */ 
  tmp___4 = atoi(*(argv + 7));
