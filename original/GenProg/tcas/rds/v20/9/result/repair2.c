...
{ int upward_preferred ;
  ...
  __repair_del_34__17a: /* CIL Label */ 
  {
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        ...
        __repair_del_15__17b: /* CIL Label */ 
        {
...
{ int enabled ;
  ...
  if (High_Confidence) {
    if (Own_Tracked_Alt_Rate <= 600) {
      __repair_app_89__17c: /* CIL Label */ 
      {
  ...
  if (Two_of_Three_Reports_Valid) {
    if (Other_RAC == 0) {
      ...
      __repair_swap1_83__17d: /* CIL Label */ 
      if (tmp___5) {
        tmp___6 = 1;
      } else {
        tmp___6 = 0;
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          ...
          __repair_swap1_71__17e: /* CIL Label */ 
          tmp___0 = 0;
        } else {
          tmp___6 = 0;
        }
