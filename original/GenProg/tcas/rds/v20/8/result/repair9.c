  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      if (Alt_Layer_Value == 2) {
        __repair_swap1_127__128: /* CIL Label */ 
        return (0);
      } else {
        return (740);
      }
...
{ int upward_preferred ;
  ...
  {
  __repair_swap1_36__129: /* CIL Label */ 
  return (result);
  ...
  __repair_swap1_33__12a: /* CIL Label */ 
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_del_82__12b: /* CIL Label */ 
          {
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_3__12c: /* CIL Label */ 
  return (640);
}
}
