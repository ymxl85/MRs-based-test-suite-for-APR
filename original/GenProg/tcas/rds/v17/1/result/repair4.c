...
{ int upward_preferred ;
  ...
  {
  __repair_del_33__37c: /* CIL Label */ 
  {

  }
  upward_preferred = tmp > Down_Separation;
  __repair_del_35__37d: /* CIL Label */ 
  {
...
{ int enabled ;
  ...
  if (enabled) {
    if (tcas_equipped) {
      __repair_del_74__37f: /* CIL Label */ 
      {
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  __repair_swap1_120__380: /* CIL Label */ 
  tmp___6 = atoi(*(argv + 5));
  tmp___5 = atoi(*(argv + 6));
  __repair_swap1_118__382: /* CIL Label */ 
  __repair_del_120__381: /* CIL Label */ 
  tmp___4 = atoi(*(argv + 7));
  tmp___7 = atoi(*(argv + 4));
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
