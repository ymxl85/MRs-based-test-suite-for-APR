  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_app_72__207: /* CIL Label */ 
        {
        if (tmp___4) {
        ...
        if (need_upward_RA) {
          ...
          if (need_upward_RA) {
            ...
            if (need_downward_RA) {
              ...
              __repair_del_89__208: /* CIL Label */ 
              {
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  __repair_swap1_121__209: /* CIL Label */ 
  tmp___7 = atoi(*(argv + 4));
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
  __repair_swap1_118__20a: /* CIL Label */ 
  tmp___4 = atoi(*(argv + 7));
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
