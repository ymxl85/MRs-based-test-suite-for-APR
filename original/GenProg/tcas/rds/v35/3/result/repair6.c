...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    __repair_swap1_21__1fd: /* CIL Label */ 
    if (tmp___0) {
    ...
    __repair_swap1_20__1fe: /* CIL Label */ 
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      if (Cur_Vertical_Sep >= 300) {
        __repair_swap1_38__1ff: /* CIL Label */ 
        tmp___2 = 0;
        if (Down_Separation >= tmp___1) {
          tmp___2 = 1;
        } else {
          __repair_swap1_39__200: /* CIL Label */ 
...
{ int enabled ;
  ...
  {
  __repair_app_81__201: /* CIL Label */ 
  {
  if (High_Confidence) {
...
{ int tmp ;
  ...
  {
  __repair_del_113__202: /* CIL Label */ 
  {
