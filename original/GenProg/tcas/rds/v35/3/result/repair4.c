...
{ int upward_preferred ;
  ...
  {
  __repair_del_58__36f: /* CIL Label */ 
  {
...
{ int enabled ;
  ...
  __repair_swap1_72__370: /* CIL Label */ 
  if (Other_RAC == 0) {
    tmp___0 = 1;
  } else {
    __repair_app_67__371: /* CIL Label */ 
    {
    tmp___0 = 0;
    tmp = 0;
    }
  ...
  if (Two_of_Three_Reports_Valid) {
    __repair_swap1_104__372: /* CIL Label */ 
    enabled = tmp;
  } else {
    tmp___0 = 0;
  }
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_app_67__373: /* CIL Label */ 
        {
