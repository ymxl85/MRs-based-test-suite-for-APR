...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      if (Cur_Vertical_Sep >= 300) {
        __repair_swap1_38__31b: /* CIL Label */ 
        tmp___2 = 0;
        if (Down_Separation >= tmp___1) {
          tmp___2 = 1;
        } else {
          __repair_swap1_39__31c: /* CIL Label */ 
...
{ 
  ...
  {
  __repair_del_62__31d: /* CIL Label */ 
  {
...
{ int enabled ;
  ...
  alt_sep = 0;
  if (enabled) {
    __repair_app_105__31e: /* CIL Label */ 
    {
    if (tcas_equipped) {
      if (intent_not_known) {
        goto _L___0;
...
{ int tmp ;
  ...
  {
  __repair_del_113__31f: /* CIL Label */ 
  {
