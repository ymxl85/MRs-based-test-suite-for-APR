...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      ...
      __repair_app_20__686: /* CIL Label */ 
      {
      if (tmp___1) {
...
{ int enabled ;
  ...
  __repair_swap1_103__687: /* CIL Label */ 
  tcas_equipped = Other_Capability == 1;
  __repair_swap1_102__688: /* CIL Label */ 
  enabled = tmp;
...
{ int tmp ;
  ...
  {
  tmp = atoi(*(argv + 12));
  __repair_swap1_118__689: /* CIL Label */ 
  tmp___6 = atoi(*(argv + 5));
  ...
  tmp___4 = atoi(*(argv + 7));
  tmp___5 = atoi(*(argv + 6));
  __repair_swap1_112__68b: /* CIL Label */ 
  __repair_del_118__68a: /* CIL Label */ 
