  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      if (Alt_Layer_Value == 2) {
        __repair_swap1_125__40c: /* CIL Label */ 
        __repair_swap1_4__40b: /* CIL Label */ 
        return (0);
      } else {
        __repair_swap1_3__40a: /* CIL Label */ 
        return (640);
      }
    }
  }
...
{ int upward_preferred ;
  ...
  __repair_app_13__40d: /* CIL Label */ 
  {
  return (result);
  tmp___3 = 1;
  }
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          ...
          __repair_app_105__40e: /* CIL Label */ 
          {
          if (tmp___2) {
            tmp___3 = 1;
          } else {
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_3__40f: /* CIL Label */ 
  return (640);
}
}
