...
{ 
  ...
  if (_coverage_fout == 0) {
    {
    _coverage_fout = fopen("/home/mingyue/experiments/GenProg/genprog-source-v3.0/data/2016tcas/randomTC/v40/10/./coverage.path",
                           "wb");
    }
  }
  }
  ...
  if (enabled) {
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        tmp___1 = Non_Crossing_Biased_Descend(Cur_Vertical_Sep, High_Confidence,
                                              Two_of_Three_Reports_Valid,
                                              Own_Tracked_Alt,
                                              Own_Tracked_Alt_Rate,
                                              Other_Tracked_Alt,
