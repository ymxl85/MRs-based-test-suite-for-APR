...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_swap1_29__fef: /* CIL Label */ 
    result = tmp___6;
    if (tmp___4) {
    ...
    __repair_swap1_27__ff1: /* CIL Label */ 
    __repair_del_29__ff0: /* CIL Label */ 
...
{ int enabled ;
  ...
  __repair_swap1_69__ff2: /* CIL Label */ 
  if (Other_RAC == 0) {
    __repair_swap1_93__ff3: /* CIL Label */ 
    if (tmp___4) {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_67__ff4: /* CIL Label */ 
        tmp___0 = 1;
...
{ int tmp ;
  ...
  {
  __repair_app_109__ff5: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  __repair_swap1_117__ff7: /* CIL Label */ 
  __repair_swap1_121__ff6: /* CIL Label */ 
  tmp___6 = atoi(*(argv + 5));
  tmp___4 = atoi(*(argv + 7));
  tmp___5 = atoi(*(argv + 6));
  __repair_swap1_114__ff8: /* CIL Label */ 
  tmp___3 = atoi(*(argv + 8));
  tmp___7 = atoi(*(argv + 4));
  __repair_swap1_120__ff9: /* CIL Label */ 
  tmp___9 = atoi(*(argv + 2));
  __repair_swap1_119__ffa: /* CIL Label */ 
  tmp___8 = atoi(*(argv + 3));
  __repair_swap1_114__ffb: /* CIL Label */ 
  tmp___3 = atoi(*(argv + 8));
  tmp___11 = mainQ(tmp___10, tmp___9, tmp___8, tmp___7, tmp___6, tmp___5, tmp___4, tmp___3, tmp___2, tmp___1, tmp___0, tmp);
  printf("%d\n", tmp___11);
  __repair_app_96__ffc: /* CIL Label */ 
  {
  return (0);
