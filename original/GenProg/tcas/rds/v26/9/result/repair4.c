  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      if (Alt_Layer_Value == 2) {
        __repair_swap1_125__54d: /* CIL Label */ 
        __repair_app_5__54c: /* CIL Label */ 
        return (0);
      } else {
        return (740);
      }
...
{ int tmp ;
  ...
  {
  __repair_swap1_9__54e: /* CIL Label */ 
  tmp = Up_Separation;
  return (tmp);
}
}
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        ...
        if (Down_Separation >= tmp___2) {
          ...
          __repair_app_35__54f: /* CIL Label */ 
          {
          tmp___3 = 1;
          if (upward_preferred) {
            tmp___0 = Own_Below_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
...
{ int upward_preferred ;
  ...
  {
  __repair_del_58__550: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  __repair_app_116__551: /* CIL Label */ 
  {
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  }
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_3__552: /* CIL Label */ 
  return (640);
}
}
