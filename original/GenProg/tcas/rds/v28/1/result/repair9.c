...
{ int tmp ;
  ...
  if (Climb_Inhibit == 0) {
    ...
    __repair_swap1_11__1ce: /* CIL Label */ 
    return (tmp);
  }
  __repair_swap1_9__1cf: /* CIL Label */ 
  tmp = Up_Separation;
}
}
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_del_31__1d0: /* CIL Label */ 
    {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_83__1d1: /* CIL Label */ 
        if (tmp___5) {
          tmp___6 = 1;
        } else {
          __repair_del_81__1d2: /* CIL Label */ 
          {
        ...
        if (tmp___4) {
          ...
          __repair_swap1_93__1d3: /* CIL Label */ 
          if (tmp___1) {
