...
{ int tmp ;
  ...
  if (Climb_Inhibit == 0) {
    ...
    __repair_swap1_11__317: /* CIL Label */ 
    return (tmp);
  }
  __repair_swap1_9__318: /* CIL Label */ 
  tmp = Up_Separation;
}
}
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_swap1_61__319: /* CIL Label */ 
    return (result);
    if (tmp___3) {
      tmp___4 = Own_Above_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
      if (tmp___4) {
  ...
  __repair_swap1_55__31a: /* CIL Label */ 
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          ...
          if (tmp___5) {
            ...
            __repair_del_81__31b: /* CIL Label */ 
            {
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  __repair_swap1_121__31c: /* CIL Label */ 
  tmp___7 = atoi(*(argv + 4));
  tmp___5 = atoi(*(argv + 6));
  __repair_swap1_123__31d: /* CIL Label */ 
  tmp___9 = atoi(*(argv + 2));
  __repair_swap1_118__31e: /* CIL Label */ 
  tmp___4 = atoi(*(argv + 7));
  tmp___8 = atoi(*(argv + 3));
  __repair_swap1_120__31f: /* CIL Label */ 
  tmp___6 = atoi(*(argv + 5));
