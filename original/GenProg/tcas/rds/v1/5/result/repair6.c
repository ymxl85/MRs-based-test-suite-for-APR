...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    __repair_swap1_14__262: /* CIL Label */ 
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        __repair_swap1_20__264: /* CIL Label */ 
...
{ 
  ...
  {
  __repair_del_63__265: /* CIL Label */ 
  {
...
{ int a ;
  ...
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
  __repair_app_114__266: /* CIL Label */ 
  {
  tmp___7 = atoi(*(argv + 4));
  tmp___0 = atoi(*(argv + 11));
  }
