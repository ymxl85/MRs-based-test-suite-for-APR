...
{ int upward_preferred ;
  ...
  __repair_swap1_36__1d2: /* CIL Label */ 
  return (result);
  __repair_swap1_35__1d3: /* CIL Label */ 
  if (upward_preferred) {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_del_82__1d4: /* CIL Label */ 
          {
...
{ int a ;
  ...
  {
  __repair_del_113__1d5: /* CIL Label */ 
  {

  }
  tmp___0 = atoi(*(argv + 11));
  tmp___1 = atoi(*(argv + 10));
  __repair_swap1_122__1d6: /* CIL Label */ 
  tmp___8 = atoi(*(argv + 3));
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
  tmp___7 = atoi(*(argv + 4));
  __repair_swap1_116__1d7: /* CIL Label */ 
  tmp___2 = atoi(*(argv + 9));
  tmp___9 = atoi(*(argv + 2));
