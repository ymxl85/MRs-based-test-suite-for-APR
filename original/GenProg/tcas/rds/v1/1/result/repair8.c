...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    __repair_swap1_13__b29: /* CIL Label */ 
    tmp___3 = 1;
    if (tmp___0) {
      ...
      if (tmp___1) {
        ...
        if (Down_Separation > tmp___2) {
          ...
          __repair_swap1_20__b2a: /* CIL Label */ 
    ...
    if (tmp___0) {
      if (Cur_Vertical_Sep >= 300) {
        ...
        if (Down_Separation >= tmp___1) {
          __repair_del_37__b2b: /* CIL Label */ 
          {
...
{ 
  ...
  {
  __repair_del_63__b2d: /* CIL Label */ 
  __repair_app_102__b2c: /* CIL Label */ 
  {
