...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_swap1_14__ebd: /* CIL Label */ 
...
{ 
  ...
  {
  __repair_app_63__ebe: /* CIL Label */ 
  {
...
{ int enabled ;
  ...
  enabled = tmp;
  __repair_app_77__ebf: /* CIL Label */ 
  {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_del_94__ec0: /* CIL Label */ 
        {
        ...
        if (tmp___4) {
          ...
          __repair_del_83__ec1: /* CIL Label */ 
          {
        ...
        if (need_upward_RA) {
          ...
          if (need_upward_RA) {
            ...
            __repair_app_87__ec2: /* CIL Label */ 
            {
            if (need_downward_RA) {
              alt_sep = 2;
            } else {
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  __repair_del_118__ec3: /* CIL Label */ 
  {

  }
  __repair_swap1_122__ec4: /* CIL Label */ 
  tmp___8 = atoi(*(argv + 3));
  tmp___6 = atoi(*(argv + 5));
  tmp___7 = atoi(*(argv + 4));
  __repair_swap1_119__ec5: /* CIL Label */ 
  tmp___5 = atoi(*(argv + 6));
  tmp___9 = atoi(*(argv + 2));
  ...
  printf("%d\n", tmp___11);
  __repair_app_119__ec6: /* CIL Label */ 
  {
  return (0);
  tmp___5 = atoi(*(argv + 6));
  }
