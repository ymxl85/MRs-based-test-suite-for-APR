  ...
  if (Alt_Layer_Value == 1) {
    ...
    if (Alt_Layer_Value == 2) {
      ...
      if (Alt_Layer_Value == 3) {
        __repair_swap1_4__737: /* CIL Label */ 
        return (740);
      } else {
        __repair_swap1_127__736: /* CIL Label */ 
        __repair_swap1_3__735: /* CIL Label */ 
        return (0);
      }
    }
  }
...
{ int enabled ;
  ...
  if (Two_of_Three_Reports_Valid) {
    if (Other_RAC == 0) {
      __repair_swap1_75__739: /* CIL Label */ 
      tmp___3 = 1;
    } else {
      tmp___0 = 0;
    }
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          ...
          if (tmp___2) {
            __repair_swap1_70__73a: /* CIL Label */ 
            tmp___0 = 1;
          } else {
            tmp___3 = 0;
          }
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_4__73b: /* CIL Label */ 
  return (740);
}
}
