  ...
  if (Alt_Layer_Value == 1) {
    ...
    if (Alt_Layer_Value == 2) {
      ...
      if (Alt_Layer_Value == 3) {
        ...
        __repair_swap1_127__44b: /* CIL Label */ 
        __repair_del_4__44a: /* CIL Label */ 
        return (0);
      }
    }
  }
...
{ int upward_preferred ;
  ...
  __repair_del_36__44c: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  __repair_swap1_123__44d: /* CIL Label */ 
  tmp___9 = atoi(*(argv + 2));
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  tmp___5 = atoi(*(argv + 6));
  ...
  tmp___7 = atoi(*(argv + 4));
  tmp___8 = atoi(*(argv + 3));
  __repair_swap1_116__44e: /* CIL Label */ 
  tmp___2 = atoi(*(argv + 9));
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_4__44f: /* CIL Label */ 
  return (740);
}
}
