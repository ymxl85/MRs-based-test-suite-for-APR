...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    __repair_del_20__3f5: /* CIL Label */ 
    {

    }
    __repair_app_22__3f6: /* CIL Label */ 
    {
    if (tmp___0) {
    ...
    if (tmp___0) {
      ...
      if (Cur_Vertical_Sep >= 300) {
        ...
        if (Down_Separation >= tmp___1) {
          ...
          __repair_del_38__3f8: /* CIL Label */ 
          {
...
{ int enabled ;
  ...
  {
  if (High_Confidence) {
    __repair_app_101__3f9: /* CIL Label */ 
    {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (need_upward_RA) {
          __repair_app_90__3fa: /* CIL Label */ 
          {
          alt_sep = 0;
          if (need_upward_RA) {
            alt_sep = 1;
