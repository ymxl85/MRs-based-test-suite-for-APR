...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      ...
      __repair_swap1_22__f30: /* CIL Label */ 
      result = tmp___3;
    } else {
      tmp___3 = 1;
    }
    ...
    __repair_swap1_18__f31: /* CIL Label */ 
    if (tmp___1) {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    tmp___0 = Own_Below_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
    if (tmp___0) {
      __repair_swap1_40__f32: /* CIL Label */ 
    ...
    __repair_swap1_40__f33: /* CIL Label */ 
    if (Down_Separation >= tmp___1) {
      tmp___2 = 1;
    } else {
      tmp___2 = 0;
...
{ int enabled ;
  ...
  __repair_swap1_85__f34: /* CIL Label */ 
  alt_sep = 0;
  alt_sep = 0;
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          __repair_del_77__f35: /* CIL Label */ 
          {

          }
          if (tmp___2) {
            __repair_app_90__f36: /* CIL Label */ 
            {
            tmp___3 = 1;
            if (need_upward_RA) {
              alt_sep = 1;
        ...
        if (tmp___4) {
          ...
          __repair_del_84__f38: /* CIL Label */ 
          __repair_del_84__f37: /* CIL Label */ 
          {
        ...
        if (need_upward_RA) {
          __repair_swap1_106__f39: /* CIL Label */ 
