...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        ...
        __repair_swap1_36__52c: /* CIL Label */ 
        return (result);
      } else {
        tmp___3 = 0;
      }
  ...
  __repair_swap1_15__52d: /* CIL Label */ 
...
{ int upward_preferred ;
  ...
  upward_preferred = tmp > Down_Separation;
  if (upward_preferred) {
    __repair_app_40__52e: /* CIL Label */ 
    {
    tmp___0 = Own_Below_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
...
{ int enabled ;
  ...
  __repair_del_107__52f: /* CIL Label */ 
  {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_91__530: /* CIL Label */ 
        if (need_upward_RA) {
          alt_sep = 1;
        } else {
          if (need_downward_RA) {
        ...
        __repair_swap1_83__531: /* CIL Label */ 
        if (tmp___5) {
          tmp___6 = 1;
        } else {
          tmp___6 = 0;
        ...
        if (tmp___4) {
          ...
          __repair_swap1_94__532: /* CIL Label */ 
        ...
        if (need_upward_RA) {
          ...
          __repair_swap1_93__533: /* CIL Label */ 
          _L: /* CIL Label */ 
          if (tmp___1) {
...
{ int tmp ;
  ...
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  __repair_swap1_124__534: /* CIL Label */ 
  tmp___10 = atoi(*(argv + 1));
  tmp___6 = atoi(*(argv + 5));
  tmp___7 = atoi(*(argv + 4));
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
  __repair_swap1_119__535: /* CIL Label */ 
  tmp___5 = atoi(*(argv + 6));
