...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_swap1_13__676: /* CIL Label */ 
    tmp___2 = 1;
    result = tmp___2;
  } else {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    tmp___3 = Own_Above_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
    __repair_app_57__677: /* CIL Label */ 
    {
    if (tmp___3) {
      ...
      __repair_del_53__679: /* CIL Label */ 
      __repair_swap1_56__678: /* CIL Label */ 
      {
    ...
    __repair_swap1_53__67a: /* CIL Label */ 
    tmp___6 = 1;
  }
  return (result);
}
...
{ int enabled ;
  ...
  if (Two_of_Three_Reports_Valid) {
    if (Other_RAC == 0) {
      __repair_del_69__67b: /* CIL Label */ 
      {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_del_81__67c: /* CIL Label */ 
          {
...
{ int tmp ;
  ...
  tmp___6 = atoi(*(argv + 5));
  tmp___7 = atoi(*(argv + 4));
  __repair_del_121__67d: /* CIL Label */ 
  {
