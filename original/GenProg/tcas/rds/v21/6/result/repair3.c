...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    __repair_swap1_15__912: /* CIL Label */ 
    ...
    if (tmp) {
      ...
      if (tmp___0) {
        ...
        __repair_swap1_20__913: /* CIL Label */ 
...
{ int enabled ;
  ...
  if (High_Confidence) {
    if (Own_Tracked_Alt_Rate <= 600) {
      if (Cur_Vertical_Sep > 600) {
        __repair_swap1_82__914: /* CIL Label */ 
        if (tmp___5) {
          tmp___6 = 1;
        } else {
          tmp___6 = 0;
  ...
  __repair_swap1_82__915: /* CIL Label */ 
  if (tmp___5) {
    tmp___6 = 1;
  } else {
    tmp___6 = 0;
  }
  __repair_del_106__916: /* CIL Label */ 
  {
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          ...
          __repair_swap1_63__918: /* CIL Label */ 
          __repair_swap1_105__917: /* CIL Label */ 
          tmp = 1;
        } else {
          tmp___6 = 0;
        }
