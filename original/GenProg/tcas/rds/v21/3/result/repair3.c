...
{ int tmp ;
  ...
  {
  __repair_swap1_9__28f: /* CIL Label */ 
  tmp = Up_Separation;
  return (tmp);
}
}
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp) {
      ...
      if (tmp___0) {
        __repair_del_14__290: /* CIL Label */ 
        {
...
{ int enabled ;
  ...
  if (Two_of_Three_Reports_Valid) {
    __repair_swap1_94__291: /* CIL Label */ 
  ...
  __repair_del_106__292: /* CIL Label */ 
  {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_71__293: /* CIL Label */ 
        if (Other_RAC == 0) {
          tmp___0 = 1;
        } else {
          tmp___0 = 0;
