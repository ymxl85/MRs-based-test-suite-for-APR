...
{ int upward_preferred ;
  ...
  {
  __repair_del_33__4ec: /* CIL Label */ 
  {

  }
  if (upward_preferred) {
    __repair_swap1_17__4ed: /* CIL Label */ 
    ...
    if (tmp) {
      __repair_swap1_20__4ee: /* CIL Label */ 
      ...
      if (tmp___0) {
        ...
        __repair_del_15__4ef: /* CIL Label */ 
        {
...
{ int enabled ;
  ...
  alt_sep = 0;
  if (enabled) {
    __repair_app_80__4f0: /* CIL Label */ 
    {
    if (tcas_equipped) {
      if (intent_not_known) {
        goto _L___0;
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          ...
          if (tmp___5) {
            ...
            __repair_del_80__4f1: /* CIL Label */ 
            {
