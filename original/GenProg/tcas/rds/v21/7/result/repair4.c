...
{ int upward_preferred ;
  ...
  {
  __repair_del_33__6c0: /* CIL Label */ 
  {
  ...
  if (upward_preferred) {
    ...
    __repair_app_17__6c1: /* CIL Label */ 
    {
    result = tmp___2;
    tmp___0 = Own_Below_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
    }
  ...
  __repair_del_35__6c2: /* CIL Label */ 
  {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_del_81__6c3: /* CIL Label */ 
          {
...
{ int tmp ;
  ...
  __repair_swap1_120__6c4: /* CIL Label */ 
  tmp___7 = atoi(*(argv + 4));
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
  __repair_swap1_115__6c5: /* CIL Label */ 
  tmp___2 = atoi(*(argv + 9));
  __repair_del_121__6c6: /* CIL Label */ 
  {
