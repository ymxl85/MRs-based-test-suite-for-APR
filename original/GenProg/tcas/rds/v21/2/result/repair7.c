...
{ int tmp ;
  ...
  {
  __repair_swap1_116__1fb: /* CIL Label */ 
  tmp___3 = atoi(*(argv + 8));
  tmp___0 = atoi(*(argv + 11));
  tmp___1 = atoi(*(argv + 10));
  tmp___2 = atoi(*(argv + 9));
  __repair_swap1_112__1fc: /* CIL Label */ 
  tmp = atoi(*(argv + 12));
  tmp___4 = atoi(*(argv + 7));
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
  tmp___7 = atoi(*(argv + 4));
  __repair_swap1_122__1fd: /* CIL Label */ 
  tmp___9 = atoi(*(argv + 2));
  __repair_swap1_121__1fe: /* CIL Label */ 
  tmp___8 = atoi(*(argv + 3));
