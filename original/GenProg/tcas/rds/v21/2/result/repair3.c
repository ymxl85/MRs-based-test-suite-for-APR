  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      if (Alt_Layer_Value == 2) {
        ...
        __repair_swap1_126__1eb: /* CIL Label */ 
        return (0);
      }
    }
    if (Alt_Layer_Value == 1) {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___3) {
      ...
      __repair_app_38__1ec: /* CIL Label */ 
      {
      tmp___6 = 1;
      tmp___1 = ALIM(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
      }
...
{ int enabled ;
  ...
  if (Two_of_Three_Reports_Valid) {
    __repair_swap1_95__1ed: /* CIL Label */ 
    if (tmp___4) {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_71__1ee: /* CIL Label */ 
        if (Other_RAC == 0) {
          tmp___0 = 1;
        } else {
          tmp___0 = 0;
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_4__1ef: /* CIL Label */ 
  return (740);
}
}
