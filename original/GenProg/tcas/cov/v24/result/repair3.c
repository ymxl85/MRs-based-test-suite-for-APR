...
{ int tmp ;
  ...
  __repair_del_11__107c: /* CIL Label */ 
  {
...
{ int upward_preferred ;
  ...
  __repair_swap1_35__107f: /* CIL Label */ 
  __repair_swap1_19__107e: /* CIL Label */ 
  __repair_swap1_35__107d: /* CIL Label */ 
  if (upward_preferred) {
    ...
    if (tmp___0) {
      ...
      __repair_swap1_34__1080: /* CIL Label */ 
  ...
  __repair_swap1_34__1082: /* CIL Label */ 
  __repair_swap1_34__1081: /* CIL Label */ 
  upward_preferred = tmp > Down_Separation;
  return (result);
}
}
...
{ int upward_preferred ;
  ...
  {
  __repair_del_58__1083: /* CIL Label */ 
  {

  }
  if (upward_preferred) {
    tmp = Own_Below_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
    if (tmp) {
      if (Cur_Vertical_Sep >= 300) {
        tmp___0 = ALIM(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
...
{ int enabled ;
  ...
  {
  __repair_del_102__1084: /* CIL Label */ 
  {

  }
  enabled = tmp;
  __repair_swap1_81__1085: /* CIL Label */ 
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_swap1_104__1086: /* CIL Label */ 
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  __repair_app_115__1087: /* CIL Label */ 
  {
  tmp___4 = atoi(*(argv + 7));
  tmp___2 = atoi(*(argv + 9));
  }
