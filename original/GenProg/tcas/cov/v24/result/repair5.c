...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___2) {
      ...
      __repair_swap1_60__ec: /* CIL Label */ 
      return (result);
    } else {
      tmp___5 = 1;
    }
  ...
  __repair_swap1_53__ed: /* CIL Label */ 
  if (tmp___3) {
...
{ int enabled ;
  ...
  if (Two_of_Three_Reports_Valid) {
    if (Other_RAC == 0) {
      __repair_swap1_106__ee: /* CIL Label */ 
  ...
  __repair_swap1_69__ef: /* CIL Label */ 
  tmp___0 = 1;
  alt_sep = 0;
  if (enabled) {
    if (tcas_equipped) {
