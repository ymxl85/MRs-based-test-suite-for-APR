...
{ 
  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      __repair_app_98__444: /* CIL Label */ 
      {
...
{ int enabled ;
  ...
  {
  __repair_swap1_86__445: /* CIL Label */ 
  alt_sep = 1;
  enabled = tmp;
  __repair_del_104__446: /* CIL Label */ 
  {

  }
  if (Two_of_Three_Reports_Valid) {
    if (Other_RAC == 0) {
      __repair_del_69__447: /* CIL Label */ 
      {
  ...
  __repair_swap1_81__448: /* CIL Label */ 
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      _L___1: /* CIL Label */ 
      if (! tcas_equipped) {
        __repair_swap1_67__449: /* CIL Label */ 
        _L___0: /* CIL Label */ 
        ...
        __repair_app_101__44a: /* CIL Label */ 
        {
        ...
        if (tmp___4) {
          __repair_swap1_107__44b: /* CIL Label */ 
          alt_sep = 0;
          if (tmp___5) {
            tmp___6 = 1;
          } else {
        ...
        __repair_app_67__44c: /* CIL Label */ 
        {
        if (need_upward_RA) {
          if (need_downward_RA) {
            alt_sep = 0;
          ...
          _L: /* CIL Label */ 
          if (need_upward_RA) {
            __repair_swap1_102__44d: /* CIL Label */ 
            if (High_Confidence) {
              __repair_swap1_91__44e: /* CIL Label */ 
