...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (Cur_Vertical_Sep >= 300) {
      __repair_swap1_33__915: /* CIL Label */ 
      return (result);
      if (Up_Separation >= tmp___4) {
        __repair_del_23__916: /* CIL Label */ 
        {
  ...
  __repair_swap1_25__917: /* CIL Label */ 
...
{ int enabled ;
  ...
  if (Two_of_Three_Reports_Valid) {
    __repair_app_79__918: /* CIL Label */ 
    {
    if (Other_RAC == 0) {
      tmp___0 = 1;
    } else {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          tmp___5 = Own_Above_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
          __repair_del_80__919: /* CIL Label */ 
          {
...
{ int tmp ;
  ...
  tmp___4 = atoi(*(argv + 7));
  tmp___5 = atoi(*(argv + 6));
  __repair_app_96__91a: /* CIL Label */ 
  {
  tmp___6 = atoi(*(argv + 5));
