...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_swap1_33__132: /* CIL Label */ 
    return (result);
    result = tmp___5;
  }
  __repair_swap1_28__133: /* CIL Label */ 
...
{ int enabled ;
  ...
  {
  __repair_swap1_80__134: /* CIL Label */ 
  if (tmp___5) {
    tmp___6 = 1;
  } else {
    tmp___6 = 0;
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          ...
          __repair_swap1_100__135: /* CIL Label */ 
          if (High_Confidence) {
...
{ int tmp ;
  ...
  tmp___7 = atoi(*(argv + 4));
  tmp___8 = atoi(*(argv + 3));
  __repair_app_117__136: /* CIL Label */ 
  {
  tmp___9 = atoi(*(argv + 2));
  tmp___6 = atoi(*(argv + 5));
  }
