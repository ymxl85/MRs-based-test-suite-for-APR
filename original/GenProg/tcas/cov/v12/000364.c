...
{ int upward_preferred ;
  ...
  {
  __repair_swap1_25__608: /* CIL Label */ 
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        __repair_app_33__60a: /* CIL Label */ 
        {
    ...
    if (tmp___4) {
      if (Cur_Vertical_Sep >= 300) {
        __repair_swap1_33__609: /* CIL Label */ 
        tmp = Inhibit_Biased_Climb(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
...
{ int upward_preferred ;
  ...
  {
  __repair_app_41__60b: /* CIL Label */ 
  {
  tmp = Inhibit_Biased_Climb(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
  tmp___2 = 0;
  }
...
{ int enabled ;
  ...
  if (High_Confidence) {
    ...
    __repair_del_69__60d: /* CIL Label */ 
    {
  ...
  alt_sep = 0;
  if (enabled) {
    __repair_del_101__60e: /* CIL Label */ 
    {
