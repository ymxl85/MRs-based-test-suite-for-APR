...
{ bool result ;
  ...
  if (_coverage_fout == 0) {
    {
    _coverage_fout = fopen("/home/mingyue/experiments/GenProg/genprog-source-v3.0/data/replace/2016replace/randomTC/v14/2/./coverage.path",
                           "wb");
    }
  }
  }
