...
{ char result ;
  ...
  {
  __repair_swap1_7__40d: /* CIL Label */ 
  result = *(s + *i);
  return (result);
}
}
...
{ int result ;
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
        __repair_del_161__40e: /* CIL Label */ 
        {
...
{ int i ;
  ...
  {
  __repair_swap1_273__410: /* CIL Label */ 
  __repair_app_256__40f: /* CIL Label */ 
  while (1) {
    if (! done) {
      __repair_app_256__411: /* CIL Label */ 
      {
      if ((int )*(pat + j) != 0) {
  ...
  __repair_swap1_272__412: /* CIL Label */ 
  done = (char)0;
  return (offset);
}
}
  ...
  while ((int )*(lin + i) != 0) {
    ...
    if (m == -1) {
      ...
      if (m == i) {
        ...
        if (OL < 2000) {
          O[OL] = *(lin + i);
          __repair_app_275__413: /* CIL Label */ 
          {
          OL ++;
