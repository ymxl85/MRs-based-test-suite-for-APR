...
{ char result ;
  ...
  {
  __repair_del_16__bd5: /* CIL Label */ 
  {

  }
  __repair_swap1_7__bd6: /* CIL Label */ 
  result = *(s + *i);
}
}
...
{ int result ;
  ...
  j = 0;
  i = start;
  __repair_app_147__bd7: /* CIL Label */ 
  {
  lastj = 0;
  result = i;
  }
  __repair_app_151__bd8: /* CIL Label */ 
  {
  done = (char)0;
  i = start;
  }
  ...
  if (done) {
    ...
    if ((int )*(arg + i) != (int )delim) {
      ...
      __repair_app_248__bd9: /* CIL Label */ 
      {
      if (! junk) {
        result = 0;
      } else {
...
{ int result ;
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      __repair_del_162__bda: /* CIL Label */ 
      {
...
{ int i ;
  ...
  while ((int )*(lin + i) != 0) {
    ...
    __repair_app_241__bdb: /* CIL Label */ 
    {
    if (m >= 0) {
      if (lastm != m) {
...
{ string pat ;
  ...
  __repair_app_104__bdc: /* CIL Label */ 
  {
  result = (char )tmp;
  ...
  __repair_app_241__bdd: /* CIL Label */ 
  {
  return (tmp___0);
...
{ char *tmp ;
  ...
  {
  __repair_app_69__bde: /* CIL Label */ 
  {
