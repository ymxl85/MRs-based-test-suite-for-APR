...
{ char result ;
  ...
  {
  __repair_swap1_7__212: /* CIL Label */ 
  result = *(s + *i);
  return (result);
}
}
...
{ int result ;
  ...
  if (done) {
    ...
    if ((int )*(arg + i) != (int )delim) {
      ...
      __repair_swap1_158__213: /* CIL Label */ 
      return (result);
    }
  }
  __repair_swap1_148__214: /* CIL Label */ 
  if (! junk) {
    result = 0;
  } else {
    result = i;
...
{ int i ;
  ...
  {
  i = 0;
  __repair_app_161__215: /* CIL Label */ 
  {
  while ((int )*(sub + i) != 0) {
    if ((int )*(sub + i) == -1) {
      j = s1;
...
{ int i ;
  ...
  __repair_app_275__216: /* CIL Label */ 
  {
  return (O);
