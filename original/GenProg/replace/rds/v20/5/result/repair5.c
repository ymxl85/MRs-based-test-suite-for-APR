...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_swap1_8__9d3: /* CIL Label */ 
    result = (char )'\000';
  }
  __repair_del_17__9d4: /* CIL Label */ 
  {
...
{ int result ;
  ...
  junk = (char )tmp___5;
  __repair_app_134__9d5: /* CIL Label */ 
  {
  if (done) {
    result = 0;
  } else {
...
{ int result ;
  ...
  while (1) {
    ...
    __repair_app_161__9d6: /* CIL Label */ 
    {
    i ++;
...
{ int i ;
  ...
  __repair_del_294__9d7: /* CIL Label */ 
  {
  ...
  while ((int )*(lin + i) != 0) {
    ...
    if (m >= 0) {
      if (lastm != m) {
        ...
        __repair_del_297__9d8: /* CIL Label */ 
        {
