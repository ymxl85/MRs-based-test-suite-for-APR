...
{ bool result ;
  ...
  if (*j >= maxset) {
    ...
    *(outset + *j) = c;
    __repair_app_295__80e: /* CIL Label */ 
    {
    (*j) ++;
...
{ char result ;
  ...
  {
  __repair_swap1_7__80f: /* CIL Label */ 
  result = *(s + *i);
  return (result);
}
}
...
{ int result ;
  ...
  j = 0;
  i = start;
  __repair_swap1_149__810: /* CIL Label */ 
  if ((int )*(arg + i) != (int )delim) {
    result = 0;
  } else {
    __repair_del_148__811: /* CIL Label */ 
    {
  ...
  if (done) {
    ...
    __repair_swap1_152__812: /* CIL Label */ 
    lastj = 0;
  }
  return (result);
}
...
{ int makeres ;
  ...
  {
  __repair_app_239__813: /* CIL Label */ 
  {
...
{ int i ;
  ...
  while ((int )*(sub + i) != 0) {
    if ((int )*(sub + i) == -1) {
      ...
      if (*OL < 2000) {
        *(output + *OL) = *(sub + i);
        __repair_app_204__814: /* CIL Label */ 
        {
        (*OL) ++;
...
{ int i ;
  ...
  {
  OL = 0;
  __repair_swap1_297__815: /* CIL Label */ 
  lastm = m;
  i = 0;
  while ((int )*(lin + i) != 0) {
    m = amatch(lin, i, pat, 0);
    __repair_app_297__816: /* CIL Label */ 
    {
    if (m >= 0) {
      if (lastm != m) {
        putsub(lin, i, m, sub, O, & OL);
        __repair_swap1_315__817: /* CIL Label */ 
        lastm = -1;
      } else {
  ...
  __repair_app_204__818: /* CIL Label */ 
  {
  return (O);
...
{ char *tmp ;
  ...
  {
  __repair_app_138__819: /* CIL Label */ 
  {
