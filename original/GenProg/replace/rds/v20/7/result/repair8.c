...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_swap1_8__2f2: /* CIL Label */ 
    __repair_del_15__2f1: /* CIL Label */ 
    result = (char )'\000';
  }
  __repair_swap1_8__2f3: /* CIL Label */ 
  result = (char )'\000';
}
}
...
{ int result ;
  ...
  while (1) {
    ...
    if ((unsigned int )*(arg + i) == 38U) {
      ...
      __repair_del_167__2f4: /* CIL Label */ 
      {
...
{ int i ;
  ...
  __repair_swap1_329__2f5: /* CIL Label */ 
  return (0);
}
}
char *subline(char *lin , char *pat , char *sub ) ;
...
{ char *tmp ;
  ...
  __repair_swap1_294__2f6: /* CIL Label */ 
  return;
}
}
void Caseerror(int n ) 
