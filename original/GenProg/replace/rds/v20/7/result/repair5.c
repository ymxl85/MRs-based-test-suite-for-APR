...
{ char result ;
  ...
  {
  __repair_swap1_7__3a9: /* CIL Label */ 
  result = *(s + *i);
  return (result);
}
}
...
{ int result ;
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    junk = (char )tmp___1;
    __repair_app_69__3aa: /* CIL Label */ 
    {
    if (! junk) {
      result = 0;
    } else {
...
{ int i ;
  ...
  {
  __repair_app_273__3ab: /* CIL Label */ 
  {
  done = (char)0;
  while (1) {
    if (! done) {
...
{ int i ;
  ...
  __repair_del_294__3ac: /* CIL Label */ 
  {
...
{ int i ;
  ...
  {
  OL = 0;
  __repair_del_315__3ad: /* CIL Label */ 
  {
