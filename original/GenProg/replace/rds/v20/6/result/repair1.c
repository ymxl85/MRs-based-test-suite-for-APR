...
{ bool result ;
  ...
  if (*j >= maxset) {
    ...
    *(outset + *j) = c;
    __repair_swap1_4__671: /* CIL Label */ 
    result = (char)1;
    __repair_swap1_3__672: /* CIL Label */ 
    (*j) ++;
  }
  return ((int )result);
}
...
{ int result ;
  ...
  junk = (char )tmp___5;
  __repair_swap1_147__674: /* CIL Label */ 
  result = i;
  return (result);
}
}
...
{ int makeres ;
  ...
  {
  __repair_app_159__675: /* CIL Label */ 
  {
...
{ int result ;
  ...
  while (1) {
    ...
    __repair_app_69__676: /* CIL Label */ 
    {
    i ++;
