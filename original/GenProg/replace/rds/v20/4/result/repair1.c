...
{ char result ;
  ...
  {
  __repair_del_16__cab: /* CIL Label */ 
  {

  }
  __repair_swap1_7__cac: /* CIL Label */ 
  result = *(s + *i);
}
}
...
{ int result ;
  ...
  while (1) {
    ...
    if ((int )*(arg + i) == 63) {
      ...
      __repair_app_106__cad: /* CIL Label */ 
      {
      if ((int )*(arg + i) == 37) {
        if (i == start) {
          tmp___0 = addstr((char )'%', pat, & j, 100);
...
{ int result ;
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    if (! junk) {
      ...
      __repair_del_173__cae: /* CIL Label */ 
      {
...
{ int i ;
  ...
  __repair_app_275__caf: /* CIL Label */ 
  {
  return (offset);
...
{ int i ;
  ...
  __repair_del_318__cb0: /* CIL Label */ 
  {
...
{ string pat ;
  ...
  __repair_app_294__cb1: /* CIL Label */ 
  {
...
{ char *tmp ;
  ...
  {
  __repair_app_204__cb2: /* CIL Label */ 
  {
