...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_app_12__c7c: /* CIL Label */ 
    {
    if ((int )*(s + (*i + 1)) == 0) {
      result = (char )'\000';
    } else {
...
{ int result ;
  ...
  while (1) {
    __repair_swap1_106__c7d: /* CIL Label */ 
...
{ int result ;
  ...
  while (1) {
    ...
    __repair_app_164__c7e: /* CIL Label */ 
    {
    i ++;
    junk = (char )tmp;
    }
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    junk = (char )tmp___1;
    __repair_app_165__c7f: /* CIL Label */ 
    {
    if (! junk) {
      result = 0;
    } else {
      __repair_app_300__c80: /* CIL Label */ 
      {
      result = i;
  ...
  __repair_app_295__c81: /* CIL Label */ 
  {
  return (result);
...
{ int i ;
  ...
  __repair_app_271__c82: /* CIL Label */ 
  {
  return (offset);
  if ((int )*(pat + j) == 42) {
    tmp = patsize(pat, j);
...
{ int i ;
  ...
  __repair_swap1_329__c83: /* CIL Label */ 
  return (0);
}
}
char *subline(char *lin , char *pat , char *sub ) ;
...
{ int i ;
  ...
  while ((int )*(lin + i) != 0) {
    ...
    __repair_app_315__c84: /* CIL Label */ 
    {
    if (m == -1) {
      goto _L;
    } else {
...
{ string pat ;
  ...
  {
  __repair_app_322__c85: /* CIL Label */ 
  {
...
{ char *tmp ;
  ...
  __repair_swap1_294__c86: /* CIL Label */ 
  return;
}
}
void Caseerror(int n ) 
