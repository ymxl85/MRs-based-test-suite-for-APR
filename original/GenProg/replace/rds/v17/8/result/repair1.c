...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_app_14__28f: /* CIL Label */ 
    {
    if ((int )*(s + (*i + 1)) == 0) {
      result = (char)10;
    } else {
...
{ int result ;
  ...
  while (1) {
    __repair_swap1_106__290: /* CIL Label */ 
...
{ int makeres ;
  ...
  {
  __repair_app_300__291: /* CIL Label */ 
  {
...
{ int i ;
  ...
  while (1) {
    __repair_app_295__292: /* CIL Label */ 
    {
    if (! done) {
      if ((int )*(pat + j) != 0) {
...
{ int i ;
  ...
  __repair_del_318__293: /* CIL Label */ 
  {
