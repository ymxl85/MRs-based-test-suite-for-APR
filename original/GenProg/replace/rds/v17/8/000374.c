...
{ int result ;
  ...
  {
  __repair_app_129__653: /* CIL Label */ 
  {
  j = 0;
  junk = (char )tmp___3;
  }
  ...
  while (1) {
    __repair_swap1_106__654: /* CIL Label */ 
...
{ int result ;
  ...
  while (1) {
    ...
    if ((unsigned int )*(arg + i) == 38U) {
      ...
      escjunk = esc(arg, & i);
      __repair_app_173__655: /* CIL Label */ 
      {
    ...
    __repair_del_170__656: /* CIL Label */ 
    {
...
{ int i ;
  ...
  __repair_app_161__657: /* CIL Label */ 
  {
  while (1) {
    if (! done) {
      if ((int )*(pat + j) != 0) {
...
{ int i ;
  ...
  i = 0;
  while ((int )*(sub + i) != 0) {
    __repair_del_290__658: /* CIL Label */ 
    {
...
{ int i ;
  ...
  OL = 0;
  lastm = -1;
  __repair_app_310__659: /* CIL Label */ 
  {
  i = 0;
  if (m >= 0) {
    if (lastm != m) {
