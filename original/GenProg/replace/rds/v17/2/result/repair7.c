...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_del_15__18d: /* CIL Label */ 
    {

    }
  }
  __repair_del_17__18e: /* CIL Label */ 
  {
...
{ int result ;
  ...
  __repair_app_128__18f: /* CIL Label */ 
  {
  junk = (char )tmp___5;
  tmp___3 = addstr((char )'c', pat, & j, 100);
  }
...
{ int result ;
  ...
  {
  __repair_app_69__190: /* CIL Label */ 
  {
  j = 0;
...
{ string pat ;
  ...
  __repair_app_241__191: /* CIL Label */ 
  {
  result = (char )tmp;
