...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_swap1_8__3c9: /* CIL Label */ 
    result = (char)10;
  }
  __repair_del_17__3ca: /* CIL Label */ 
  {
...
{ int result ;
  ...
  i = from;
  while (1) {
    __repair_swap1_169__3cb: /* CIL Label */ 
    if ((unsigned int )*(arg + i) == 38U) {
      ...
      __repair_swap1_175__3cc: /* CIL Label */ 
      junk = (char )tmp___1;
    }
    __repair_swap1_168__3cd: /* CIL Label */ 
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    __repair_swap1_167__3ce: /* CIL Label */ 
    junk = (char )tmp___0;
    if (! junk) {
      result = 0;
    } else {
  ...
  __repair_del_181__3cf: /* CIL Label */ 
  {
...
{ int i ;
  ...
  __repair_del_294__3d0: /* CIL Label */ 
  {
