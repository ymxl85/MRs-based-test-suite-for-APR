...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_del_15__450: /* CIL Label */ 
    {

    }
  }
  __repair_swap1_8__451: /* CIL Label */ 
  result = (char)10;
}
}
...
{ int result ;
  ...
  i = start;
  lastj = 0;
  __repair_swap1_147__452: /* CIL Label */ 
  result = i;
  while (1) {
    if (! done) {
  ...
  if (done) {
    ...
    if ((int )*(arg + i) != (int )delim) {
      ...
      if (! junk) {
        ...
        __repair_swap1_153__453: /* CIL Label */ 
        done = (char)0;
      }
    }
  }
...
{ int i ;
  ...
  {
  __repair_swap1_273__454: /* CIL Label */ 
  while (1) {
    if (! done) {
      if ((int )*(pat + j) != 0) {
  ...
  __repair_swap1_272__455: /* CIL Label */ 
  done = (char)0;
  return (offset);
}
}
  ...
  while ((int )*(lin + i) != 0) {
    ...
    if (m == -1) {
      ...
      if (m == i) {
        _L: /* CIL Label */ 
        if (OL < 2000) {
          __repair_app_299__456: /* CIL Label */ 
          {
          O[OL] = *(lin + i);
          if (lastm != m) {
            putsub(lin, i, m, sub, O, & OL);
