...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_del_15__238: /* CIL Label */ 
    __repair_del_15__237: /* CIL Label */ 
    {

    }
  }
  __repair_swap1_8__239: /* CIL Label */ 
  result = (char)10;
}
}
...
{ int result ;
  ...
  while (1) {
    __repair_app_105__23a: /* CIL Label */ 
    {
    if (! done) {
...
{ int i ;
  ...
  {
  __repair_app_300__23b: /* CIL Label */ 
  {
  done = (char)0;
