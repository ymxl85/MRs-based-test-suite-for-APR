...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_del_15__630: /* CIL Label */ 
    __repair_app_275__62f: /* CIL Label */ 
    {

    }
  }
  __repair_del_17__631: /* CIL Label */ 
  {
...
{ int result ;
  ...
  i = from;
  while (1) {
    __repair_swap1_162__632: /* CIL Label */ 
    if ((int )*(arg + i) != 0) {
...
{ int i ;
  ...
  {
  __repair_app_104__633: /* CIL Label */ 
  {
  OL = 0;
  ...
  while ((int )*(lin + i) != 0) {
    ...
    __repair_app_300__634: /* CIL Label */ 
    {
    if (m >= 0) {
      if (lastm != m) {
    ...
    if (m == -1) {
      ...
      if (m == i) {
        ...
        __repair_app_196__635: /* CIL Label */ 
        {
        i ++;
