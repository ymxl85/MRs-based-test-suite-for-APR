...
{ char result ;
  ...
  {
  __repair_app_294__f9e: /* CIL Label */ 
  {
  if ((int )*(s + *i) != 64) {
    __repair_app_239__fa1: /* CIL Label */ 
    {
    result = *(s + *i);

    }
  } else {
    __repair_del_15__fa0: /* CIL Label */ 
    __repair_swap1_17__f9f: /* CIL Label */ 
    {
  ...
  __repair_swap1_15__fa2: /* CIL Label */ 
  if ((int )*(s + (*i + 1)) == 0) {
    __repair_del_8__fa3: /* CIL Label */ 
    {
...
{ int result ;
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    __repair_app_175__fa4: /* CIL Label */ 
    {
  ...
  __repair_del_181__fa5: /* CIL Label */ 
  {
...
{ int i ;
  ...
  {
  OL = 0;
  __repair_del_315__fa7: /* CIL Label */ 
  __repair_swap1_295__fa6: /* CIL Label */ 
  {
  ...
  __repair_app_312__fa8: /* CIL Label */ 
  {
  return (O);
  O[OL] = (char )'\000';
  }
...
{ char *tmp ;
  ...
  {
  __repair_app_239__fa9: /* CIL Label */ 
  {
...
{ string pat ;
  ...
  __repair_swap1_324__faa: /* CIL Label */ 
  result = getsub(argv2, sub);
  __repair_swap1_323__fab: /* CIL Label */ 
  result = (char )tmp;
