...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + *i) == 0) {
      ...
      __repair_del_13__e48: /* CIL Label */ 
      {
...
{ int tmp ;
  ...
  if ((int )c == 99) {
    ...
    if ((int )c == 37) {
      __repair_app_102__e49: /* CIL Label */ 
      {
      tmp = 1;
      if ((int )c == 99) {
        tmp = 1;
...
{ int result ;
  ...
  j = 0;
  i = start;
  __repair_del_152__e4a: /* CIL Label */ 
  {
  ...
  while (1) {
    if (! done) {
      if ((int )*(arg + i) != (int )delim) {
        if ((int )*(arg + i) != 0) {
          __repair_swap1_198__e4b: /* CIL Label */ ;
        } else {
          break;
        }
      } else {
    ...
    if ((int )*(arg + i) == 63) {
      ...
      __repair_app_148__e4c: /* CIL Label */ 
      {
      if ((int )*(arg + i) == 37) {
        if (i == start) {
          tmp___0 = addstr((char )'%', pat, & j, 100);
          __repair_del_110__e4e: /* CIL Label */ 
          __repair_app_138__e4d: /* CIL Label */ 
          {
  ...
  if (done) {
    ...
    __repair_del_149__e4f: /* CIL Label */ 
    {
...
{ char advance ;
  ...
  if ((int )*(lin + *i) == 0) {
    ...
    if (tmp___1) {
      ...
      case 37: 
      if (*i == 0) {
        __repair_app_104__e51: /* CIL Label */ 
        {
        advance = (char)0;

        }
      } else {
        __repair_swap1_104__e50: /* CIL Label */ ;
      }
      break;
      case 63: 
      if ((int )*(lin + *i) != 10) {
...
{ int i ;
  ...
  while (1) {
    if (! done) {
      __repair_app_240__e52: /* CIL Label */ 
      {
      if ((int )*(pat + j) != 0) {
...
{ int i ;
  ...
  __repair_del_290__e53: /* CIL Label */ 
  {
...
{ int i ;
  ...
  {
  OL = 0;
  __repair_swap1_311__e54: /* CIL Label */ 
  i = 0;
  __repair_swap1_310__e55: /* CIL Label */ 
  lastm = -1;
  while ((int )*(lin + i) != 0) {
