...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_app_15__32e: /* CIL Label */ 
    {
    if ((int )*(s + *i) == 0) {
      result = (char )'@';
    } else {
...
{ int result ;
  ...
  __repair_del_158__32f: /* CIL Label */ 
  {
...
{ int result ;
  ...
  i = from;
  while (1) {
    __repair_swap1_169__330: /* CIL Label */ 
    ...
    __repair_swap1_168__331: /* CIL Label */ 
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
...
{ int i ;
  ...
  __repair_swap1_314__332: /* CIL Label */ 
  return (O);
  __repair_swap1_313__333: /* CIL Label */ 
  O[OL] = (char )'\000';
}
}
char *change(char *pat , char *sub , char *line ) 
