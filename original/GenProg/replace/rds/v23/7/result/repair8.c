...
{ char result ;
  ...
  {
  __repair_swap1_14__394: /* CIL Label */ 
  if ((int )*(s + *i) == 110) {
    result = (char)10;
  } else {
    if ((int )*(s + *i) == 116) {
...
{ int result ;
  ...
  junk = (char )tmp___5;
  __repair_del_157__395: /* CIL Label */ 
  {
...
{ int result ;
  ...
  i = from;
  while (1) {
    __repair_swap1_167__396: /* CIL Label */ 
    junk = (char )tmp___0;
    if ((unsigned int )*(arg + i) == 38U) {
      ...
      __repair_swap1_168__397: /* CIL Label */ 
      if ((int )*(arg + i) != (int )delim) {
        if ((int )*(arg + i) != 0) {
...
{ int makeres ;
  ...
  __repair_app_18__398: /* CIL Label */ 
  {
...
{ char *tmp ;
  ...
  __repair_app_239__399: /* CIL Label */ 
  {
  return (tmp);
...
{ char *tmp ;
  ...
  __repair_del_324__39a: /* CIL Label */ 
  {
