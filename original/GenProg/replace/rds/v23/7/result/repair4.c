...
{ char result ;
  ...
  {
  __repair_swap1_14__e0: /* CIL Label */ 
  if ((int )*(s + *i) == 110) {
    result = (char)10;
  } else {
    if ((int )*(s + *i) == 116) {
...
{ int result ;
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
        __repair_swap1_175__e1: /* CIL Label */ 
        junk = (char )tmp___1;
      } else {
        break;
      }
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    __repair_swap1_161__e2: /* CIL Label */ ;
    if (! junk) {
      result = 0;
    } else {
      result = i;
...
{ int i ;
  ...
  __repair_del_313__e3: /* CIL Label */ 
  {
