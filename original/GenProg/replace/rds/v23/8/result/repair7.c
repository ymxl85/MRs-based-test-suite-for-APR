...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + *i) == 0) {
      ...
      __repair_del_13__7a6: /* CIL Label */ 
      {
      ...
      if ((int )*(s + *i) == 110) {
        ...
        if ((int )*(s + *i) == 116) {
          ...
          __repair_app_291__7a7: /* CIL Label */ 
          {
          result = *(s + *i);
...
{ int result ;
  ...
  {
  j = 0;
  __repair_swap1_152__7a8: /* CIL Label */ 
  lastj = 0;
  __repair_swap1_151__7a9: /* CIL Label */ 
  i = start;
  done = (char)0;
  while (1) {
    if (! done) {
  ...
  junk = (char )tmp___5;
  __repair_del_157__7aa: /* CIL Label */ 
  {
...
{ int result ;
  ...
  {
  __repair_del_177__7ab: /* CIL Label */ 
  {
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
        __repair_swap1_275__7ac: /* CIL Label */ ;
      } else {
        break;
      }
    } else {
