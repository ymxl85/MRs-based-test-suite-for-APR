...
{ char result ;
  ...
  {
  __repair_swap1_12__2bb: /* CIL Label */ 
  if ((int )*(s + *i) == 116) {
    result = (char)9;
  } else {
    result = *(s + *i);
...
{ int result ;
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
        __repair_swap1_173__2bc: /* CIL Label */ 
        result = i;
      } else {
        break;
      }
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    if (! junk) {
      ...
      __repair_swap1_161__2bd: /* CIL Label */ ;
    }
  }
  return (result);
}
...
{ int i ;
  ...
  while ((int )*(sub + i) != 0) {
    if ((int )*(sub + i) == -1) {
      ...
      *(output + *OL) = *(sub + i);
      __repair_app_275__2be: /* CIL Label */ 
      {
      (*OL) ++;
...
{ int i ;
  ...
  __repair_del_313__2bf: /* CIL Label */ 
  {
