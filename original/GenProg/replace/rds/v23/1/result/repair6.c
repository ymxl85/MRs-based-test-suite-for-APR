...
{ char result ;
  ...
  {
  if ((int )*(s + *i) != 64) {
    __repair_app_12__2f0: /* CIL Label */ 
    {
    result = *(s + *i);
    if ((int )*(s + *i) == 116) {
      result = (char)9;
    ...
    if ((int )*(s + *i) == 0) {
      ...
      __repair_del_13__2ef: /* CIL Label */ 
      {
  ...
  __repair_del_17__2f1: /* CIL Label */ 
  {
...
{ int result ;
  ...
  {
  __repair_del_177__2f2: /* CIL Label */ 
  {
  ...
  __repair_del_181__2f3: /* CIL Label */ 
  {
...
{ int i ;
  ...
  {
  OL = 0;
  __repair_swap1_291__2f4: /* CIL Label */ ;
  i = 0;
  while ((int )*(lin + i) != 0) {
...
{ char *tmp ;
  ...
  __repair_del_316__2f5: /* CIL Label */ 
  {
