...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + *i) == 0) {
      ...
      __repair_del_13__a42: /* CIL Label */ 
      {
  ...
  __repair_app_79__a43: /* CIL Label */ 
  {
  return (result);
  return;
  }
...
{ int result ;
  ...
  j = 0;
  i = start;
  __repair_del_152__a44: /* CIL Label */ 
  {

  }
  done = (char)0;
  __repair_app_241__a45: /* CIL Label */ 
  {
  while (1) {
    if (! done) {
      __repair_app_152__a46: /* CIL Label */ 
      {
  ...
  __repair_app_239__a47: /* CIL Label */ 
  {
  junk = (char )tmp___5;

  }
  __repair_del_157__a48: /* CIL Label */ 
  {
...
{ int result ;
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    __repair_del_175__a49: /* CIL Label */ 
    {
