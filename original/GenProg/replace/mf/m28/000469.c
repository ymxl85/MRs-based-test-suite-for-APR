    ...
    if ((int )*(src + (*i - 1)) == 64) {
      ...
      if ((int )*(src + *i) != 45) {
        ...
        if (*j <= 1) {
          ...
          __repair_del_48__7f3: /* CIL Label */ 
          __repair_del_48__7f2: /* CIL Label */ 
          {
...
{ int jstart ;
  ...
  jstart = *j;
  __repair_del_64__7f4: /* CIL Label */ 
  {
...
{ int makeres ;
  ...
  __repair_app_55__7f5: /* CIL Label */ 
  {
  return (makeres > 0);
  return;
  }
...
{ char advance ;
  ...
  __repair_del_229__7f6: /* CIL Label */ 
  {
...
{ int i ;
  ...
  while (1) {
    __repair_app_250__7f7: /* CIL Label */ 
    {
    if (! done) {
      if ((int )*(pat + j) != 0) {
        __repair_app_255__7f8: /* CIL Label */ 
        {
...
{ int i ;
  ...
  while ((int )*(sub + i) != 0) {
    ...
    __repair_del_289__7f9: /* CIL Label */ 
    {
