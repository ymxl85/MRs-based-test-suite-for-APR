...
{ bool result ;
  ...
  __repair_app_161__30f: /* CIL Label */ 
  {
  return ((int )result);
...
{ char result ;
  ...
  {
  __repair_swap1_7__310: /* CIL Label */ 
  result = *(s + *i);
  return (result);
}
}
...
{ int tmp ;
  ...
  {
  __repair_app_290__311: /* CIL Label */ 
  {
  if ((int )c == 99) {
    tmp = 1;
  } else {
...
{ int result ;
  ...
  {
  __repair_swap1_173__312: /* CIL Label */ 
  result = i;
  i = from;
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    if (! junk) {
      ...
      __repair_swap1_177__313: /* CIL Label */ 
      j = 0;
    }
  }
  return (result);
...
{ char advance ;
  ...
  if ((int )*(lin + *i) == 0) {
    ...
    __repair_app_18__314: /* CIL Label */ 
    {
    if (tmp___1) {
      switch ((int )*(pat + j)) {
      case 99: 
