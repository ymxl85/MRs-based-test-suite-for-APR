...
{ char result ;
  ...
  {
  __repair_swap1_7__2dc: /* CIL Label */ 
  result = *(s + *i);
  return (result);
}
}
  ...
  while (1) {
    if (! done) {
      if ((int )*(arg + i) != (int )delim) {
        if ((int )*(arg + i) != 0) {
          __repair_app_291__2dd: /* CIL Label */ 
          {
...
{ int makeres ;
  ...
  __repair_del_183__2de: /* CIL Label */ 
  {
...
{ int i ;
  ...
  {
  __repair_app_275__2df: /* CIL Label */ 
  {
  OL = 0;
...
{ string pat ;
  ...
  result = (char )tmp;
  __repair_app_320__2e0: /* CIL Label */ 
  {
