...
{ int k ;
  ...
  {
  while (1) {
    __repair_swap1_48__bb7: /* CIL Label */ 
    if ((int )*(src + (*i + 1)) == 0) {
      tmp___1 = addstr((char )'-', dest, j, maxset);
      junk = (char )tmp___1;
    } else {
      tmp___4 = isalnum(*(src + (*i - 1)));
      __repair_swap1_19__bb8: /* CIL Label */ 
      if ((int )*(src + *i) != 0) {
    ...
    if ((int )*(src + (*i - 1)) == 64) {
      ...
      if ((int )*(src + *i) != 45) {
        ...
        if (*j <= 1) {
          ...
          __repair_swap1_51__bb9: /* CIL Label */ 
          if ((int )*(src + *i) != (int )delim) {
            __repair_swap1_47__bba: /* CIL Label */ 
            if (tmp___4) {
              ...
              tmp___3 = addstr((char )'-', dest, j, maxset);
              __repair_del_45__bbb: /* CIL Label */ 
              {
...
{ int jstart ;
  ...
  if ((int )*(arg + *i) == 94) {
    ...
    __repair_app_197__bbc: /* CIL Label */ 
    {
...
{ int result ;
  ...
  while (1) {
    if (! done) {
      if ((int )*(arg + i) != (int )delim) {
        if ((int )*(arg + i) != 0) {
          __repair_swap1_156__bbd: /* CIL Label */ 
          junk = (char )tmp___5;
        } else {
          break;
        }
  ...
  __repair_swap1_104__bbe: /* CIL Label */ ;
  if (done) {
    result = 0;
  } else {
    if ((int )*(arg + i) != (int )delim) {
...
{ int result ;
  ...
  {
  __repair_app_175__bbf: /* CIL Label */ 
  {
  j = 0;
  junk = (char )tmp___1;
  }
...
{ char advance ;
  ...
  if ((int )*(lin + *i) == 0) {
    ...
    if (tmp___1) {
      ...
      if (tmp) {
        __repair_app_184__bc0: /* CIL Label */ 
        {
        advance = (char)1;
