...
u' | diff outputP/O6 - && exit 0 ;;
  p7) $1 'À*'	'b'	'uu' | diff outputP/O7 - && exit 0 ;;
  p8) $1 '?Õ'	'b'	'uu' | diff outputP/O8 - && exit 0 ;;
  p9) $1 'ÀÕ'	'b'	'uu' | diff outputP/O9 - && exit 0 ;;
  p10) $1 '[^]*'	'd'	'
...
u' | diff outputP/O20 - && exit 0 ;;
  p21) $1 '[^]*'	'b'	'uu' | diff outputP/O21 - && exit 0 ;;
  p22) $1 '[À]*'	'b'	'uu' | diff outputP/O22 - && exit 0 ;;
  p23) $1 '[^]Õ'	'b'	'uu' | diff outputP/O23 - && exit 0 ;;
  p24) $1 '[À]Õ'	'b'	'uu' | diff outputP/O24 - && exit 0 ;;
  n1) $1 '?*'	'd'	'
...
u' | diff outputF/O5 - && exit 0 ;;
  n6) $1 '?*'	'b'	'uu' | diff outputF/O6 - && exit 0 ;;
...
u' | diff outputP/O6 - && let fit=$fit+1
  $1 'À*'	'b'	'uu' | diff outputP/O7 - && let fit=$fit+1
  $1 '?Õ'	'b'	'uu' | diff outputP/O8 - && let fit=$fit+1
  $1 'ÀÕ'	'b'	'uu' | diff outputP/O9 - && let fit=$fit+1
  $1 '[^]*'	'd'	'
...
u' | diff outputP/O20 - && let fit=$fit+1
  $1 '[^]*'	'b'	'uu' | diff outputP/O21 - && let fit=$fit+1
  $1 '[À]*'	'b'	'uu' | diff outputP/O22 - && let fit=$fit+1
  $1 '[^]Õ'	'b'	'uu' | diff outputP/O23 - && let fit=$fit+1
  $1 '[À]Õ'	'b'	'uu' | diff outputP/O24 - && let fit=$fit+1
  $1 '?*'	'd'	'
...
u' | diff outputF/O5 - && let fit=$fit+1
  $1 '?*'	'b'	'uu' | diff outputF/O6 - && let fit=$fit+1
