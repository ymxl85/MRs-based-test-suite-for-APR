...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + (*i + 1)) == 0) {
      ...
      __repair_swap1_14__bea: /* CIL Label */ 
      __repair_del_13__be9: /* CIL Label */ 
      if ((int )*(s + *i) == 110) {
        result = (char)10;
      } else {
        if ((int )*(s + *i) == 116) {
      ...
      __repair_swap1_13__bec: /* CIL Label */ 
      __repair_swap1_17__beb: /* CIL Label */ 
      (*i) ++;
    }
  }
  __repair_swap1_14__bed: /* CIL Label */ 
  if ((int )*(s + *i) == 110) {
    result = (char)10;
  } else {
    if ((int )*(s + *i) == 116) {
