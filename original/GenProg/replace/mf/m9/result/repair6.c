...
{ char result ;
  ...
  {
  __repair_app_101__1ad: /* CIL Label */ 
  {
  if ((int )*(s + *i) != 64) {
    result = *(s + *i);
  } else {
      ...
      if ((int )*(src + *i) != 45) {
        ...
        if (*j <= 1) {
          ...
          if ((int )*(src + (*i + 1)) == 0) {
            ...
            __repair_swap1_39__1ae: /* CIL Label */ 
            tmp___5 = isalnum(*(src + (*i + 1)));
            if (tmp___4) {
              __repair_swap1_43__1af: /* CIL Label */ 
    ...
    if ((int )c == 37) {
      ...
      if ((int )c == 36) {
        ...
        if ((int )c == 63) {
          ...
          __repair_del_95__1b0: /* CIL Label */ 
          {
...
{ int result ;
  ...
  while (1) {
    ...
    __repair_app_101__1b1: /* CIL Label */ 
    {
    i ++;
