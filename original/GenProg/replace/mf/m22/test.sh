...
^' | diff outputP/O11 - && exit 0 ;;
  ...
  p13) $1 'À'	'b'	'^^' | diff outputP/O13 - && exit 0 ;;
  p14) $1 '?ÿ'	'b'	'^^' | diff outputP/O14 - && exit 0 ;;
  p15) $1 'Àÿ'	'b'	'^^' | diff outputP/O15 - && exit 0 ;;
  p16) $1 '[À]'	'b'	'^
...
^' | diff outputP/O21 - && exit 0 ;;
  p22) $1 '[À]'	'b'	'^^' | diff outputP/O22 - && exit 0 ;;
  p23) $1 '[^]ÿ'	'b'	'^^' | diff outputP/O23 - && exit 0 ;;
  p24) $1 '[À]ÿ'	'b'	'^^' | diff outputP/O24 - && exit 0 ;;
  n1) $1 '[^]'	'd'	'^
...
^' | diff outputP/O11 - && let fit=$fit+1
  ...
  $1 'À'	'b'	'^^' | diff outputP/O13 - && let fit=$fit+1
  $1 '?ÿ'	'b'	'^^' | diff outputP/O14 - && let fit=$fit+1
  $1 'Àÿ'	'b'	'^^' | diff outputP/O15 - && let fit=$fit+1
  $1 '[À]'	'b'	'^
...
^' | diff outputP/O21 - && let fit=$fit+1
  $1 '[À]'	'b'	'^^' | diff outputP/O22 - && let fit=$fit+1
  $1 '[^]ÿ'	'b'	'^^' | diff outputP/O23 - && let fit=$fit+1
  $1 '[À]ÿ'	'b'	'^^' | diff outputP/O24 - && let fit=$fit+1
  $1 '[^]'	'd'	'^
...
^' | diff outputF/O5 - && let fit=$fit+1
  $1 '[^]'	'b'	'^^' | diff outputF/O6 - && let fit=$fit+1
