...
{ char result ;
  ...
  {
  if ((int )*(s + *i) != 64) {
    __repair_swap1_14__1034: /* CIL Label */ 
    if ((int )*(s + *i) == 110) {
      result = (char)10;
    } else {
      if ((int )*(s + *i) == 116) {
    ...
    if ((int )*(s + (*i + 1)) == 0) {
      __repair_swap1_14__1033: /* CIL Label */ 
      if ((int )*(s + *i) == 110) {
        result = (char)10;
      } else {
        if ((int )*(s + *i) == 116) {
      ...
      (*i) ++;
      __repair_swap1_7__1032: /* CIL Label */ 
      __repair_swap1_8__1031: /* CIL Label */ 
      result = *(s + *i);
    }
  }
  return (result);
  ...
  while (1) {
    ...
    if ((int )*(pat + j) == 42) {
      ...
      while (1) {
        ...
        __repair_app_253__1035: /* CIL Label */ 
        {
        if (! result) {
          done = (char)1;
        } else {
