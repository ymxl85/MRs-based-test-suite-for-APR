...
klee --optimize --write-cvcs --allow-external-sym-calls --only-output-states-covering-new  $v-s.o  > out.log
#  --write-sym-paths --only-output-states-covering-new --libc=uclibc 
...
klee --optimize --allow-external-sym-calls --only-output-states-covering-new  $v-f.o > out.log
