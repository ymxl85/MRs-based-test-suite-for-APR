...
entry:
  ...
  store i8 97, i8* %argv12, align 1, !dbg !209
  %1 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 1, !dbg !209
  store i8 110, i8* %1, align 1, !dbg !209
  %2 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 2, !dbg !209
  store i8 100, i8* %2, align 1, !dbg !209
  %3 = load i8* %argv12, align 1, !dbg !210
  %4 = icmp eq i8 %3, 97, !dbg !210
  %5 = zext i1 %4 to i32, !dbg !210
  call void @klee_assume(i32 %5) nounwind, !dbg !210
  %6 = load i8* %1, align 1, !dbg !211
  %7 = icmp eq i8 %6, 110, !dbg !211
  %8 = zext i1 %7 to i32, !dbg !211
  call void @klee_assume(i32 %8) nounwind, !dbg !211
  %9 = load i8* %2, align 1, !dbg !212
  ...
  store i8* %fp.0.i.i, i8** %tp.i, align 4, !dbg !225
  ...
  br i1 %69, label %mainQ.exit, label %bb.i, !dbg !228
...
bb.i:                                             ; preds = %entry, %bb.i
  ...
  %71 = icmp eq i8 %70, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %71, label %mainQ.exit, label %bb.i, !dbg !228

mainQ.exit:                                       ; preds = %bb.i, %entry
  call void (i8*, ...)* @klee_print_expr(i8* getelementptr inbounds ([4 x i8]* @.str31, i32 0, i32 0), i8* %rr1) nounwind, !dbg !229
  ret i32 0, !dbg !230
}
...
entry:
  %0 = icmp eq i32 %count, 0, !dbg !231
  br i1 %0, label %bb2, label %bb.lr.ph, !dbg !231

bb.lr.ph:                                         ; preds = %entry
  %1 = trunc i32 %s to i8, !dbg !232
  br label %bb

bb:                                               ; preds = %bb, %bb.lr.ph
  %indvar = phi i32 [ 0, %bb.lr.ph ], [ %indvar.next, %bb ]
  %a.05 = getelementptr i8* %dst, i32 %indvar
  volatile store i8 %1, i8* %a.05, align 1, !dbg !232
  %indvar.next = add i32 %indvar, 1
  %exitcond1 = icmp eq i32 %indvar.next, %count
  br i1 %exitcond1, label %bb2, label %bb, !dbg !231
...
!1 = metadata !{i32 589865, metadata !"v1-s.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR2/v1/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v1-s.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR2/v1/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR2/v1/source/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR2/v1/source/", metadata !2} ; [ DW_TAG_file_type ]
...
!209 = metadata !{i32 554, i32 0, metadata !207, null}
!210 = metadata !{i32 555, i32 0, metadata !207, null}
!211 = metadata !{i32 556, i32 0, metadata !207, null}
!212 = metadata !{i32 557, i32 0, metadata !207, null}
!213 = metadata !{i32 558, i32 0, metadata !207, null}
!214 = metadata !{i32 559, i32 0, metadata !207, null}
!215 = metadata !{i32 560, i32 0, metadata !207, null}
!216 = metadata !{i32 561, i32 0, metadata !207, null}
!217 = metadata !{i32 562, i32 0, metadata !207, null}
!218 = metadata !{i32 563, i32 0, metadata !207, null}
!219 = metadata !{i32 564, i32 0, metadata !207, null}
!220 = metadata !{i32 565, i32 0, metadata !207, null}
!221 = metadata !{i32 566, i32 0, metadata !207, null}
!222 = metadata !{i32 567, i32 0, metadata !207, null}
!223 = metadata !{i32 568, i32 0, metadata !207, null}
!224 = metadata !{i32 569, i32 0, metadata !207, null}
!225 = metadata !{i32 537, i32 0, metadata !226, metadata !227}
!226 = metadata !{i32 589835, metadata !45, i32 531, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!227 = metadata !{i32 571, i32 0, metadata !207, null}
!228 = metadata !{i32 540, i32 0, metadata !226, metadata !227}
!229 = metadata !{i32 573, i32 0, metadata !207, null}
!230 = metadata !{i32 574, i32 0, metadata !207, null}
!231 = metadata !{i32 14, i32 0, metadata !108, null}
!232 = metadata !{i32 15, i32 0, metadata !108, null}
!233 = metadata !{i32 16, i32 0, metadata !108, null}
