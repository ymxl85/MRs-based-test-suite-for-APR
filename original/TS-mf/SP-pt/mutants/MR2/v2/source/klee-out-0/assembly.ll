...
entry:
  ...
  store i8 97, i8* %argv12, align 1, !dbg !210
  %1 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 1, !dbg !210
  store i8 110, i8* %1, align 1, !dbg !210
  %2 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 2, !dbg !210
  store i8 100, i8* %2, align 1, !dbg !210
  %3 = load i8* %argv12, align 1, !dbg !211
  %4 = icmp eq i8 %3, 97, !dbg !211
  %5 = zext i1 %4 to i32, !dbg !211
  call void @klee_assume(i32 %5) nounwind, !dbg !211
  %6 = load i8* %1, align 1, !dbg !212
  %7 = icmp eq i8 %6, 110, !dbg !212
  %8 = zext i1 %7 to i32, !dbg !212
  call void @klee_assume(i32 %8) nounwind, !dbg !212
  %9 = load i8* %2, align 1, !dbg !213
  %10 = icmp eq i8 %9, 100, !dbg !213
  %11 = zext i1 %10 to i32, !dbg !213
  call void @klee_assume(i32 %11) nounwind, !dbg !213
  %12 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 3, !dbg !214
  %13 = load i8* %12, align 1, !dbg !214
  %14 = icmp eq i8 %13, 10, !dbg !214
  %15 = zext i1 %14 to i32, !dbg !214
  call void @klee_assume(i32 %15) nounwind, !dbg !214
  %16 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 4, !dbg !215
  %17 = load i8* %16, align 1, !dbg !215
  %.off = add i8 %17, -97
  %18 = icmp ult i8 %.off, 26
  %19 = zext i1 %18 to i32, !dbg !215
  call void @klee_assume(i32 %19) nounwind, !dbg !215
  %20 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 5, !dbg !216
  %21 = load i8* %20, align 1, !dbg !216
  %.off1 = add i8 %21, -48
  %22 = icmp ugt i8 %.off1, 74
  %23 = icmp ne i8 %21, 32, !dbg !216
  %24 = and i1 %22, %23
  %25 = icmp ne i8 %21, 10, !dbg !216
  %26 = and i1 %24, %25
  %27 = icmp ne i8 %21, 0, !dbg !216
  %28 = and i1 %26, %27
  %29 = zext i1 %28 to i32, !dbg !216
  call void @klee_assume(i32 %29) nounwind, !dbg !216
  %30 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 6, !dbg !217
  %31 = load i8* %30, align 1, !dbg !217
  %.off2 = add i8 %31, -97
  %32 = icmp ult i8 %.off2, 26
  %33 = zext i1 %32 to i32, !dbg !217
  call void @klee_assume(i32 %33) nounwind, !dbg !217
  %34 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 7, !dbg !218
  %35 = load i8* %34, align 1, !dbg !218
  %36 = icmp eq i8 %35, 10, !dbg !218
  %37 = zext i1 %36 to i32, !dbg !218
  call void @klee_assume(i32 %37) nounwind, !dbg !218
  %38 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 8, !dbg !219
  %39 = load i8* %38, align 1, !dbg !219
  %40 = icmp eq i8 %39, 34, !dbg !219
  %41 = zext i1 %40 to i32, !dbg !219
  call void @klee_assume(i32 %41) nounwind, !dbg !219
  %42 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 9, !dbg !220
  %43 = load i8* %42, align 1, !dbg !220
  %.off3 = add i8 %43, -97
  %44 = icmp ult i8 %.off3, 26
  %45 = zext i1 %44 to i32, !dbg !220
  call void @klee_assume(i32 %45) nounwind, !dbg !220
  %46 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 10, !dbg !221
  %47 = load i8* %46, align 1, !dbg !221
  %48 = icmp eq i8 %47, 10, !dbg !221
  %49 = zext i1 %48 to i32, !dbg !221
  call void @klee_assume(i32 %49) nounwind, !dbg !221
  %50 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 11, !dbg !222
  %51 = load i8* %50, align 1, !dbg !222
  %.off4 = add i8 %51, -48
  %52 = icmp ult i8 %.off4, 10
  %53 = zext i1 %52 to i32, !dbg !222
  call void @klee_assume(i32 %53) nounwind, !dbg !222
  %54 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 12, !dbg !223
  %55 = load i8* %54, align 1, !dbg !223
  %.off5 = add i8 %55, -97
  %56 = icmp ult i8 %.off5, 26
  %57 = zext i1 %56 to i32, !dbg !223
  call void @klee_assume(i32 %57) nounwind, !dbg !223
  %58 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 13, !dbg !224
  %59 = load i8* %58, align 1, !dbg !224
  %60 = icmp eq i8 %59, 10, !dbg !224
  %61 = zext i1 %60 to i32, !dbg !224
  call void @klee_assume(i32 %61) nounwind, !dbg !224
  %62 = getelementptr inbounds [15 x i8]* %argv1, i32 0, i32 14, !dbg !225
  %63 = load i8* %62, align 1, !dbg !225
  %64 = icmp eq i8 %63, 0, !dbg !225
  %65 = zext i1 %64 to i32, !dbg !225
  call void @klee_assume(i32 %65) nounwind, !dbg !225
  %66 = load i8* %argv12, align 1
  %67 = icmp eq i8 %66, 0
  %fp.0.i.i = select i1 %67, i8* null, i8* %argv12
  store i8* %fp.0.i.i, i8** %tp.i, align 4, !dbg !226
  call fastcc void @get_token(i8** %tp.i) nounwind
  %68 = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  %69 = icmp eq i8 %68, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %69, label %mainQ.exit, label %bb.i, !dbg !229

bb.i:                                             ; preds = %entry, %bb.i
  call fastcc void @get_token(i8** %tp.i) nounwind
  %70 = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  %71 = icmp eq i8 %70, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %71, label %mainQ.exit, label %bb.i, !dbg !229

mainQ.exit:                                       ; preds = %bb.i, %entry
  call void (i8*, ...)* @klee_print_expr(i8* getelementptr inbounds ([4 x i8]* @.str31, i32 0, i32 0), i8* %rr1) nounwind, !dbg !230
  ret i32 0, !dbg !231
}
...
entry:
  %0 = icmp eq i32 %count, 0, !dbg !232
  br i1 %0, label %bb2, label %bb.lr.ph, !dbg !232

bb.lr.ph:                                         ; preds = %entry
  %1 = trunc i32 %s to i8, !dbg !233
  br label %bb

bb:                                               ; preds = %bb, %bb.lr.ph
  %indvar = phi i32 [ 0, %bb.lr.ph ], [ %indvar.next, %bb ]
  %a.05 = getelementptr i8* %dst, i32 %indvar
  volatile store i8 %1, i8* %a.05, align 1, !dbg !233
  %indvar.next = add i32 %indvar, 1
  %exitcond1 = icmp eq i32 %indvar.next, %count
  br i1 %exitcond1, label %bb2, label %bb, !dbg !232
...
!1 = metadata !{i32 589865, metadata !"v2-s.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR2/v2/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v2-s.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR2/v2/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR2/v2/source/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR2/v2/source/", metadata !2} ; [ DW_TAG_file_type ]
...
!210 = metadata !{i32 555, i32 0, metadata !208, null}
!211 = metadata !{i32 556, i32 0, metadata !208, null}
!212 = metadata !{i32 557, i32 0, metadata !208, null}
!213 = metadata !{i32 558, i32 0, metadata !208, null}
!214 = metadata !{i32 559, i32 0, metadata !208, null}
!215 = metadata !{i32 560, i32 0, metadata !208, null}
!216 = metadata !{i32 561, i32 0, metadata !208, null}
!217 = metadata !{i32 562, i32 0, metadata !208, null}
!218 = metadata !{i32 563, i32 0, metadata !208, null}
!219 = metadata !{i32 564, i32 0, metadata !208, null}
!220 = metadata !{i32 565, i32 0, metadata !208, null}
!221 = metadata !{i32 566, i32 0, metadata !208, null}
!222 = metadata !{i32 567, i32 0, metadata !208, null}
!223 = metadata !{i32 568, i32 0, metadata !208, null}
!224 = metadata !{i32 569, i32 0, metadata !208, null}
!225 = metadata !{i32 570, i32 0, metadata !208, null}
!226 = metadata !{i32 538, i32 0, metadata !227, metadata !228}
!227 = metadata !{i32 589835, metadata !45, i32 532, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!228 = metadata !{i32 572, i32 0, metadata !208, null}
!229 = metadata !{i32 541, i32 0, metadata !227, metadata !228}
!230 = metadata !{i32 574, i32 0, metadata !208, null}
!231 = metadata !{i32 575, i32 0, metadata !208, null}
!232 = metadata !{i32 14, i32 0, metadata !98, null}
!233 = metadata !{i32 15, i32 0, metadata !98, null}
!234 = metadata !{i32 16, i32 0, metadata !98, null}
