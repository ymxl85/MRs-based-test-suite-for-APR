...
bb:                                               ; preds = %bb, %entry
  ...
  %scevgep33 = getelementptr [81 x i8]* @buffer, i32 0, i32 %j.023
  store i8 0, i8* %scevgep33, align 1, !dbg !112
...
bb16.us:                                          ; preds = %bb16.preheader, %get_char.exit17.us
  %indvar = phi i32 [ %phitmp34, %get_char.exit17.us ], [ 1, %bb16.preheader ]
  ...
  %26 = icmp eq i8 %25, 0
  br i1 %26, label %bb17, label %bb5.i.us

get_char.exit17.us:                               ; preds = %bb15.us, %bb.i16.us
  %phitmp34 = add i32 %indvar, 1
...
bb5.i.us:                                         ; preds = %bb16.us
  switch i8 %ch.1.us, label %bb15.us [
    i8 34, label %bb17
    i8 10, label %bb17
  ]

bb15:                                             ; preds = %bb18.i, %is_token_end.exit
  store i8 %ch.1, i8* %scevgep32, align 1, !dbg !123
...
get_char.exit17:                                  ; preds = %bb15, %bb.i16
  %phitmp = add i32 %indvar29, 1
  br label %bb16, !dbg !122

bb16:                                             ; preds = %bb16.preheader, %get_char.exit17
  %indvar29 = phi i32 [ %phitmp, %get_char.exit17 ], [ 1, %bb16.preheader ]
  %ch.1 = phi i8 [ %33, %get_char.exit17 ], [ %19, %bb16.preheader ]
  %scevgep32 = getelementptr [81 x i8]* @buffer, i32 0, i32 %indvar29
...
bb4.i:                                            ; preds = %bb16
  br i1 %17, label %is_token_end.exit, label %bb15.i
...
is_token_end.exit:                                ; preds = %bb4.i
  %ch.off.i = add i8 %ch.1, -9
  %phitmp20 = icmp ugt i8 %ch.off.i, 1
  br i1 %phitmp20, label %bb15, label %bb17, !dbg !124

bb17:                                             ; preds = %bb16.us, %bb5.i.us, %bb5.i.us, %bb18.i, %bb18.i, %bb18.i, %bb15.i, %bb16, %is_token_end.exit
  %ch.1.lcssa = phi i8 [ %ch.1, %is_token_end.exit ], [ %ch.1, %bb16 ], [ %ch.1, %bb15.i ], [ %ch.1, %bb18.i ], [ %ch.1, %bb18.i ], [ %ch.1, %bb18.i ], [ %ch.1.us, %bb5.i.us ], [ %ch.1.us, %bb5.i.us ], [ %ch.1.us, %bb16.us ]
  %i.0.lcssa = phi i32 [ %indvar29, %is_token_end.exit ], [ %indvar29, %bb16 ], [ %indvar29, %bb15.i ], [ %indvar29, %bb18.i ], [ %indvar29, %bb18.i ], [ %indvar29, %bb18.i ], [ %indvar, %bb5.i.us ], [ %indvar, %bb5.i.us ], [ %indvar, %bb16.us ]
...
bb22:                                             ; preds = %bb17
  ...
  br i1 %43, label %unget_char.exit7, label %bb27, !dbg !127
...
bb28:                                             ; preds = %bb27
  %46 = getelementptr inbounds [81 x i8]* @buffer, i32 0, i32 %i.0.lcssa, !dbg !128
  store i8 %ch.1.lcssa, i8* %46, align 1, !dbg !128
  br label %bb35, !dbg !129

bb30:                                             ; preds = %bb27
  %47 = icmp eq i8 %ch.1.lcssa, 59, !dbg !130
  br i1 %47, label %unget_char.exit, label %bb35, !dbg !130
...
!1 = metadata !{i32 589865, metadata !"v9-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR1/v9/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v9-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR1/v9/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR1/v9/follow/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR1/v9/follow/", metadata !2} ; [ DW_TAG_file_type ]
