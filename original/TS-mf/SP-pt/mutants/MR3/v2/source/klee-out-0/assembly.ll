...
entry:
  ...
  %24 = load i8* %argv12, align 1
  %25 = icmp eq i8 %24, 0
  %fp.0.i.i = select i1 %25, i8* null, i8* %argv12
  store i8* %fp.0.i.i, i8** %tp.i, align 4, !dbg !216
  call fastcc void @get_token(i8** %tp.i) nounwind
  %26 = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  %27 = icmp eq i8 %26, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %27, label %mainQ.exit, label %bb.i, !dbg !219

bb.i:                                             ; preds = %entry, %bb.i
  call fastcc void @get_token(i8** %tp.i) nounwind
  %28 = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  %29 = icmp eq i8 %28, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %29, label %mainQ.exit, label %bb.i, !dbg !219

mainQ.exit:                                       ; preds = %bb.i, %entry
  call void (i8*, ...)* @klee_print_expr(i8* getelementptr inbounds ([4 x i8]* @.str31, i32 0, i32 0), i8* %rr1) nounwind, !dbg !220
  ret i32 0, !dbg !221
}
...
entry:
  %0 = icmp eq i32 %count, 0, !dbg !222
  br i1 %0, label %bb2, label %bb.lr.ph, !dbg !222

bb.lr.ph:                                         ; preds = %entry
  %1 = trunc i32 %s to i8, !dbg !223
  br label %bb

bb:                                               ; preds = %bb, %bb.lr.ph
  %indvar = phi i32 [ 0, %bb.lr.ph ], [ %indvar.next, %bb ]
  %a.05 = getelementptr i8* %dst, i32 %indvar
  volatile store i8 %1, i8* %a.05, align 1, !dbg !223
  %indvar.next = add i32 %indvar, 1
  %exitcond1 = icmp eq i32 %indvar.next, %count
  br i1 %exitcond1, label %bb2, label %bb, !dbg !222
...
!1 = metadata !{i32 589865, metadata !"v2-s.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v2/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v2-s.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v2/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v2/source/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v2/source/", metadata !2} ; [ DW_TAG_file_type ]
...
!216 = metadata !{i32 538, i32 0, metadata !217, metadata !218}
!217 = metadata !{i32 589835, metadata !45, i32 532, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!218 = metadata !{i32 563, i32 0, metadata !208, null}
!219 = metadata !{i32 541, i32 0, metadata !217, metadata !218}
!220 = metadata !{i32 565, i32 0, metadata !208, null}
!221 = metadata !{i32 566, i32 0, metadata !208, null}
!222 = metadata !{i32 14, i32 0, metadata !98, null}
!223 = metadata !{i32 15, i32 0, metadata !98, null}
!224 = metadata !{i32 16, i32 0, metadata !98, null}
