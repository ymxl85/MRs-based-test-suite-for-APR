...
entry:
  ...
  %argv1 = alloca [6 x i8], align 1
  %f = alloca [6 x i8], align 1
  %rr1 = getelementptr inbounds [100 x i8]* %rr, i32 0, i32 0, !dbg !207
  %0 = call i8* @memset(i8* %rr1, i32 0, i32 100)
  %argv12 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 0, !dbg !209
  call void @klee_make_symbolic(i8* %argv12, i32 6, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !209
  ...
  %4 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 1, !dbg !211
  %5 = load i8* %4, align 1, !dbg !211
  %6 = icmp eq i8 %5, 10, !dbg !211
  %7 = zext i1 %6 to i32, !dbg !211
  call void @klee_assume(i32 %7) nounwind, !dbg !211
  %8 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 2, !dbg !212
  %9 = load i8* %8, align 1, !dbg !212
  %.off1 = add i8 %9, -48
  %10 = icmp ult i8 %.off1, 10
  %11 = zext i1 %10 to i32, !dbg !212
  call void @klee_assume(i32 %11) nounwind, !dbg !212
  %12 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 3, !dbg !213
  %13 = load i8* %12, align 1, !dbg !213
  %.off2 = add i8 %13, -97
  %14 = icmp ult i8 %.off2, 26
  %15 = zext i1 %14 to i32, !dbg !213
  call void @klee_assume(i32 %15) nounwind, !dbg !213
  %16 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 4, !dbg !214
  %17 = load i8* %16, align 1, !dbg !214
  %18 = icmp eq i8 %17, 10, !dbg !214
  %19 = zext i1 %18 to i32, !dbg !214
  call void @klee_assume(i32 %19) nounwind, !dbg !214
  %20 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 5, !dbg !215
  %21 = load i8* %20, align 1, !dbg !215
  %22 = icmp eq i8 %21, 0, !dbg !215
  %23 = zext i1 %22 to i32, !dbg !215
  call void @klee_assume(i32 %23) nounwind, !dbg !215
  %f8 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 0, !dbg !216
  call void @klee_make_symbolic(i8* %f8, i32 6, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !216
  %24 = load i8* %argv12, align 1, !dbg !217
  store i8 %24, i8* %f8, align 1, !dbg !217
  %25 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 1, !dbg !218
  store i8 49, i8* %25, align 1, !dbg !218
  %26 = load i8* %4, align 1, !dbg !219
  %27 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 2, !dbg !219
  store i8 %26, i8* %27, align 1, !dbg !219
  %28 = load i8* %8, align 1, !dbg !220
  %29 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 3, !dbg !220
  store i8 %28, i8* %29, align 1, !dbg !220
  %30 = load i8* %16, align 1, !dbg !221
  %31 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 4, !dbg !221
  store i8 %30, i8* %31, align 1, !dbg !221
  %32 = load i8* %20, align 1, !dbg !222
  %33 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 5, !dbg !222
  store i8 %32, i8* %33, align 1, !dbg !222
  %34 = load i8* %f8, align 1, !dbg !223
  %35 = load i8* %argv12, align 1, !dbg !223
  %36 = icmp eq i8 %34, %35, !dbg !223
  %37 = zext i1 %36 to i32, !dbg !223
  call void @klee_assume(i32 %37) nounwind, !dbg !223
  %38 = load i8* %25, align 1, !dbg !224
  %39 = icmp eq i8 %38, 49, !dbg !224
  %40 = zext i1 %39 to i32, !dbg !224
  call void @klee_assume(i32 %40) nounwind, !dbg !224
  %41 = load i8* %27, align 1, !dbg !225
  %42 = load i8* %4, align 1, !dbg !225
  %43 = icmp eq i8 %41, %42, !dbg !225
  %44 = zext i1 %43 to i32, !dbg !225
  call void @klee_assume(i32 %44) nounwind, !dbg !225
  %45 = load i8* %29, align 1, !dbg !226
  %46 = load i8* %8, align 1, !dbg !226
  %47 = icmp eq i8 %45, %46, !dbg !226
  %48 = zext i1 %47 to i32, !dbg !226
  call void @klee_assume(i32 %48) nounwind, !dbg !226
  %49 = load i8* %31, align 1, !dbg !227
  %50 = load i8* %16, align 1, !dbg !227
  %51 = icmp eq i8 %49, %50, !dbg !227
  %52 = zext i1 %51 to i32, !dbg !227
  call void @klee_assume(i32 %52) nounwind, !dbg !227
  %53 = load i8* %33, align 1, !dbg !228
  %54 = load i8* %20, align 1, !dbg !228
  %55 = icmp eq i8 %53, %54, !dbg !228
  %56 = zext i1 %55 to i32, !dbg !228
  call void @klee_assume(i32 %56) nounwind, !dbg !228
  %57 = load i8* %f8, align 1
  %58 = icmp eq i8 %57, 0
  %fp.0.i.i = select i1 %58, i8* null, i8* %f8
  ...
  br i1 %60, label %mainQ.exit, label %bb.i, !dbg !232

bb.i:                                             ; preds = %entry, %bb.i
  call fastcc void @get_token(i8** %tp.i) nounwind
  %61 = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  %62 = icmp eq i8 %61, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %62, label %mainQ.exit, label %bb.i, !dbg !232
...
!1 = metadata !{i32 589865, metadata !"v2-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v2/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v2-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v2/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v2/follow/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v2/follow/", metadata !2} ; [ DW_TAG_file_type ]
...
!216 = metadata !{i32 565, i32 0, metadata !208, null}
!217 = metadata !{i32 566, i32 0, metadata !208, null}
!218 = metadata !{i32 567, i32 0, metadata !208, null}
!219 = metadata !{i32 568, i32 0, metadata !208, null}
!220 = metadata !{i32 569, i32 0, metadata !208, null}
!221 = metadata !{i32 570, i32 0, metadata !208, null}
!222 = metadata !{i32 571, i32 0, metadata !208, null}
!223 = metadata !{i32 572, i32 0, metadata !208, null}
!224 = metadata !{i32 573, i32 0, metadata !208, null}
!225 = metadata !{i32 574, i32 0, metadata !208, null}
!226 = metadata !{i32 575, i32 0, metadata !208, null}
!227 = metadata !{i32 576, i32 0, metadata !208, null}
!228 = metadata !{i32 577, i32 0, metadata !208, null}
!229 = metadata !{i32 538, i32 0, metadata !230, metadata !231}
!230 = metadata !{i32 589835, metadata !45, i32 532, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!231 = metadata !{i32 579, i32 0, metadata !208, null}
!232 = metadata !{i32 541, i32 0, metadata !230, metadata !231}
!233 = metadata !{i32 581, i32 0, metadata !208, null}
!234 = metadata !{i32 582, i32 0, metadata !208, null}
!235 = metadata !{i32 14, i32 0, metadata !108, null}
!236 = metadata !{i32 15, i32 0, metadata !108, null}
!237 = metadata !{i32 16, i32 0, metadata !108, null}
