...
bb1.i2.i:                                         ; preds = %bb.i1.i
  ...
  %5 = icmp eq i32 %4, 0
  br i1 %5, label %bb2, label %bb2.i.i

bb2.i.i:                                          ; preds = %bb1.i2.i
  ...
  %7 = icmp eq i32 %6, 0
  br i1 %7, label %bb2, label %bb3.i3.i

bb3.i3.i:                                         ; preds = %bb2.i.i
  ...
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %bb2, label %bb4.i5.i

bb4.i5.i:                                         ; preds = %bb3.i3.i
...
bb1.i6.i:                                         ; preds = %bb5.i.i
  ...
  %29 = and i32 %28, 1024
  %30 = icmp eq i32 %29, 0
  br i1 %30, label %bb2.i7.i, label %bb3.i8.i
...
bb2.i7.i:                                         ; preds = %bb1.i6.i
  ...
  %37 = and i32 %36, 2048
  %38 = icmp eq i32 %37, 0
  br i1 %38, label %bb5.i, label %bb3.i8.i

bb3.i8.i:                                         ; preds = %bb2.i7.i, %bb1.i6.i
  %phitmp.i.i = add i32 %indvar.i9.i, 1
  br label %bb5.i.i

bb5.i.i:                                          ; preds = %bb3.i, %bb3.i8.i
  %indvar.i9.i = phi i32 [ %phitmp.i.i, %bb3.i8.i ], [ 1, %bb3.i ]
  %scevgep.i10.i = getelementptr [81 x i8]* @buffer, i32 0, i32 %indvar.i9.i
  %39 = load i8* %scevgep.i10.i, align 1
  %40 = icmp eq i8 %39, 0
  br i1 %40, label %bb6, label %bb1.i6.i

bb5.i:                                            ; preds = %bb2.i7.i, %bb3.i
...
bb1.i.i:                                          ; preds = %bb4.i.i
  %tmp13.i = add i32 %indvar.i.i, 2
  %scevgep.i.i = getelementptr [81 x i8]* @buffer, i32 0, i32 %tmp13.i
  ...
  %55 = and i32 %54, 2048
  %56 = icmp eq i32 %55, 0
  br i1 %56, label %bb7.i, label %bb4.i.i

bb4.i.i:                                          ; preds = %bb5.i, %bb1.i.i
  %indvar.i.i = phi i32 [ %tmp.i, %bb1.i.i ], [ 0, %bb5.i ]
  %tmp.i = add i32 %indvar.i.i, 1
  %scevgep2.i.i = getelementptr [81 x i8]* @buffer, i32 0, i32 %tmp.i
  %57 = load i8* %scevgep2.i.i, align 1
  %58 = icmp eq i8 %57, 0
...
bb7.i:                                            ; preds = %bb1.i.i, %bb5.i
  ...
  %60 = icmp eq i8 %59, 34
  br i1 %60, label %bb4.i4.i, label %bb9.i

bb1.i1.i:                                         ; preds = %bb4.i4.i
  %61 = load i8* %scevgep.i3.i, align 1
  %62 = icmp eq i8 %61, 34
...
bb4.i4.i:                                         ; preds = %bb7.i, %bb3.i.i
  %indvar.i = phi i32 [ %phitmp.i, %bb3.i.i ], [ 1, %bb7.i ]
  %scevgep.i3.i = getelementptr [81 x i8]* @buffer, i32 0, i32 %indvar.i
  %63 = load i8* %scevgep.i3.i, align 1
  %64 = icmp eq i8 %63, 0
  br i1 %64, label %bb9thread-pre-split.i, label %bb1.i1.i

bb9thread-pre-split.i:                            ; preds = %bb4.i4.i
...
bb2:                                              ; preds = %bb4.i5.i, %bb3.i3.i, %bb2.i.i, %bb1.i2.i, %bb.i1.i, %entry
...
entry:
  ...
  %argv12 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 0, !dbg !208
  call void @klee_make_symbolic(i8* %argv12, i32 6, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !208
  ...
  %4 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 1, !dbg !210
  %5 = load i8* %4, align 1, !dbg !210
  %6 = icmp eq i8 %5, 10, !dbg !210
  %7 = zext i1 %6 to i32, !dbg !210
  call void @klee_assume(i32 %7) nounwind, !dbg !210
  %8 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 2, !dbg !211
  ...
  %12 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 3, !dbg !212
  ...
  %16 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 4, !dbg !213
  %17 = load i8* %16, align 1, !dbg !213
  %18 = icmp eq i8 %17, 10, !dbg !213
  %19 = zext i1 %18 to i32, !dbg !213
  call void @klee_assume(i32 %19) nounwind, !dbg !213
  %20 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 5, !dbg !214
  %21 = load i8* %20, align 1, !dbg !214
  %22 = icmp eq i8 %21, 0, !dbg !214
  %23 = zext i1 %22 to i32, !dbg !214
  call void @klee_assume(i32 %23) nounwind, !dbg !214
  %f8 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 0, !dbg !215
  call void @klee_make_symbolic(i8* %f8, i32 6, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !215
  %24 = load i8* %argv12, align 1, !dbg !216
  store i8 %24, i8* %f8, align 1, !dbg !216
  %25 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 1, !dbg !217
  store i8 49, i8* %25, align 1, !dbg !217
  %26 = load i8* %4, align 1, !dbg !218
  %27 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 2, !dbg !218
  store i8 %26, i8* %27, align 1, !dbg !218
  %28 = load i8* %8, align 1, !dbg !219
  %29 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 3, !dbg !219
  store i8 %28, i8* %29, align 1, !dbg !219
  %30 = load i8* %16, align 1, !dbg !220
  %31 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 4, !dbg !220
  store i8 %30, i8* %31, align 1, !dbg !220
  %32 = load i8* %20, align 1, !dbg !221
  %33 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 5, !dbg !221
  store i8 %32, i8* %33, align 1, !dbg !221
  %34 = load i8* %f8, align 1, !dbg !222
  %35 = load i8* %argv12, align 1, !dbg !222
  %36 = icmp eq i8 %34, %35, !dbg !222
  %37 = zext i1 %36 to i32, !dbg !222
  call void @klee_assume(i32 %37) nounwind, !dbg !222
  %38 = load i8* %25, align 1, !dbg !223
  %39 = icmp eq i8 %38, 49, !dbg !223
  %40 = zext i1 %39 to i32, !dbg !223
  call void @klee_assume(i32 %40) nounwind, !dbg !223
  %41 = load i8* %27, align 1, !dbg !224
  %42 = load i8* %4, align 1, !dbg !224
  %43 = icmp eq i8 %41, %42, !dbg !224
  %44 = zext i1 %43 to i32, !dbg !224
  call void @klee_assume(i32 %44) nounwind, !dbg !224
  %45 = load i8* %29, align 1, !dbg !225
  %46 = load i8* %8, align 1, !dbg !225
  %47 = icmp eq i8 %45, %46, !dbg !225
  %48 = zext i1 %47 to i32, !dbg !225
  call void @klee_assume(i32 %48) nounwind, !dbg !225
  %49 = load i8* %31, align 1, !dbg !226
  %50 = load i8* %16, align 1, !dbg !226
  %51 = icmp eq i8 %49, %50, !dbg !226
  %52 = zext i1 %51 to i32, !dbg !226
  call void @klee_assume(i32 %52) nounwind, !dbg !226
  %53 = load i8* %33, align 1, !dbg !227
  %54 = load i8* %20, align 1, !dbg !227
  %55 = icmp eq i8 %53, %54, !dbg !227
  %56 = zext i1 %55 to i32, !dbg !227
  call void @klee_assume(i32 %56) nounwind, !dbg !227
  store i8* %f8, i8** %tp.i, align 4, !dbg !228
  ...
  br i1 %58, label %mainQ.exit, label %bb.i, !dbg !231
...
bb.i:                                             ; preds = %entry, %bb.i
  ...
  %60 = icmp eq i8 %59, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %60, label %mainQ.exit, label %bb.i, !dbg !231

mainQ.exit:                                       ; preds = %bb.i, %entry
  call void (i8*, ...)* @klee_print_expr(i8* getelementptr inbounds ([4 x i8]* @.str31, i32 0, i32 0), i8* %rr1) nounwind, !dbg !232
  ret i32 0, !dbg !233
}
...
entry:
  %0 = icmp eq i32 %count, 0, !dbg !234
  br i1 %0, label %bb2, label %bb.lr.ph, !dbg !234

bb.lr.ph:                                         ; preds = %entry
  %1 = trunc i32 %s to i8, !dbg !235
  br label %bb

bb:                                               ; preds = %bb, %bb.lr.ph
  %indvar = phi i32 [ 0, %bb.lr.ph ], [ %indvar.next, %bb ]
  %a.05 = getelementptr i8* %dst, i32 %indvar
  volatile store i8 %1, i8* %a.05, align 1, !dbg !235
  %indvar.next = add i32 %indvar, 1
  %exitcond1 = icmp eq i32 %indvar.next, %count
  br i1 %exitcond1, label %bb2, label %bb, !dbg !234
...
!1 = metadata !{i32 589865, metadata !"v6-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v6/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v6-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v6/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v6/follow/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v6/follow/", metadata !2} ; [ DW_TAG_file_type ]
...
!215 = metadata !{i32 559, i32 0, metadata !207, null}
!216 = metadata !{i32 560, i32 0, metadata !207, null}
!217 = metadata !{i32 561, i32 0, metadata !207, null}
!218 = metadata !{i32 562, i32 0, metadata !207, null}
!219 = metadata !{i32 563, i32 0, metadata !207, null}
!220 = metadata !{i32 564, i32 0, metadata !207, null}
!221 = metadata !{i32 565, i32 0, metadata !207, null}
!222 = metadata !{i32 566, i32 0, metadata !207, null}
!223 = metadata !{i32 567, i32 0, metadata !207, null}
!224 = metadata !{i32 568, i32 0, metadata !207, null}
!225 = metadata !{i32 569, i32 0, metadata !207, null}
!226 = metadata !{i32 570, i32 0, metadata !207, null}
!227 = metadata !{i32 571, i32 0, metadata !207, null}
!228 = metadata !{i32 533, i32 0, metadata !229, metadata !230}
!229 = metadata !{i32 589835, metadata !45, i32 531, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!230 = metadata !{i32 573, i32 0, metadata !207, null}
!231 = metadata !{i32 536, i32 0, metadata !229, metadata !230}
!232 = metadata !{i32 575, i32 0, metadata !207, null}
!233 = metadata !{i32 576, i32 0, metadata !207, null}
!234 = metadata !{i32 14, i32 0, metadata !108, null}
!235 = metadata !{i32 15, i32 0, metadata !108, null}
!236 = metadata !{i32 16, i32 0, metadata !108, null}
