...
entry:
  ...
  %argv12 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 0, !dbg !206
  call void @klee_make_symbolic(i8* %argv12, i32 6, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !206
  ...
  %4 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 1, !dbg !208
  %5 = load i8* %4, align 1, !dbg !208
  %6 = icmp eq i8 %5, 10, !dbg !208
  %7 = zext i1 %6 to i32, !dbg !208
  call void @klee_assume(i32 %7) nounwind, !dbg !208
  %8 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 2, !dbg !209
  ...
  %12 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 3, !dbg !210
  ...
  %16 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 4, !dbg !211
  %17 = load i8* %16, align 1, !dbg !211
  %18 = icmp eq i8 %17, 10, !dbg !211
  %19 = zext i1 %18 to i32, !dbg !211
  call void @klee_assume(i32 %19) nounwind, !dbg !211
  %20 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 5, !dbg !212
  %21 = load i8* %20, align 1, !dbg !212
  %22 = icmp eq i8 %21, 0, !dbg !212
  %23 = zext i1 %22 to i32, !dbg !212
  call void @klee_assume(i32 %23) nounwind, !dbg !212
  %f8 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 0, !dbg !213
  call void @klee_make_symbolic(i8* %f8, i32 6, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !213
  %24 = load i8* %argv12, align 1, !dbg !214
  store i8 %24, i8* %f8, align 1, !dbg !214
  %25 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 1, !dbg !215
  store i8 49, i8* %25, align 1, !dbg !215
  %26 = load i8* %4, align 1, !dbg !216
  %27 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 2, !dbg !216
  store i8 %26, i8* %27, align 1, !dbg !216
  %28 = load i8* %8, align 1, !dbg !217
  %29 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 3, !dbg !217
  store i8 %28, i8* %29, align 1, !dbg !217
  %30 = load i8* %16, align 1, !dbg !218
  %31 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 4, !dbg !218
  store i8 %30, i8* %31, align 1, !dbg !218
  %32 = load i8* %20, align 1, !dbg !219
  %33 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 5, !dbg !219
  store i8 %32, i8* %33, align 1, !dbg !219
  %34 = load i8* %f8, align 1, !dbg !220
  %35 = load i8* %argv12, align 1, !dbg !220
  %36 = icmp eq i8 %34, %35, !dbg !220
  %37 = zext i1 %36 to i32, !dbg !220
  call void @klee_assume(i32 %37) nounwind, !dbg !220
  %38 = load i8* %25, align 1, !dbg !221
  %39 = icmp eq i8 %38, 49, !dbg !221
  %40 = zext i1 %39 to i32, !dbg !221
  call void @klee_assume(i32 %40) nounwind, !dbg !221
  %41 = load i8* %27, align 1, !dbg !222
  %42 = load i8* %4, align 1, !dbg !222
  %43 = icmp eq i8 %41, %42, !dbg !222
  %44 = zext i1 %43 to i32, !dbg !222
  call void @klee_assume(i32 %44) nounwind, !dbg !222
  %45 = load i8* %29, align 1, !dbg !223
  %46 = load i8* %8, align 1, !dbg !223
  %47 = icmp eq i8 %45, %46, !dbg !223
  %48 = zext i1 %47 to i32, !dbg !223
  call void @klee_assume(i32 %48) nounwind, !dbg !223
  %49 = load i8* %31, align 1, !dbg !224
  %50 = load i8* %16, align 1, !dbg !224
  %51 = icmp eq i8 %49, %50, !dbg !224
  %52 = zext i1 %51 to i32, !dbg !224
  call void @klee_assume(i32 %52) nounwind, !dbg !224
  %53 = load i8* %33, align 1, !dbg !225
  %54 = load i8* %20, align 1, !dbg !225
  %55 = icmp eq i8 %53, %54, !dbg !225
  %56 = zext i1 %55 to i32, !dbg !225
  call void @klee_assume(i32 %56) nounwind, !dbg !225
  ...
  br i1 %60, label %mainQ.exit, label %bb.i, !dbg !229
...
bb.i:                                             ; preds = %entry, %bb.i
  ...
  %62 = icmp eq i8 %61, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %62, label %mainQ.exit, label %bb.i, !dbg !229
...
!1 = metadata !{i32 589865, metadata !"v3-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v3/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v3-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v3/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v3/follow/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v3/follow/", metadata !2} ; [ DW_TAG_file_type ]
...
!213 = metadata !{i32 564, i32 0, metadata !205, null}
!214 = metadata !{i32 565, i32 0, metadata !205, null}
!215 = metadata !{i32 566, i32 0, metadata !205, null}
!216 = metadata !{i32 567, i32 0, metadata !205, null}
!217 = metadata !{i32 568, i32 0, metadata !205, null}
!218 = metadata !{i32 569, i32 0, metadata !205, null}
!219 = metadata !{i32 570, i32 0, metadata !205, null}
!220 = metadata !{i32 571, i32 0, metadata !205, null}
!221 = metadata !{i32 572, i32 0, metadata !205, null}
!222 = metadata !{i32 573, i32 0, metadata !205, null}
!223 = metadata !{i32 574, i32 0, metadata !205, null}
!224 = metadata !{i32 575, i32 0, metadata !205, null}
!225 = metadata !{i32 576, i32 0, metadata !205, null}
!226 = metadata !{i32 537, i32 0, metadata !227, metadata !228}
!227 = metadata !{i32 589835, metadata !45, i32 531, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!228 = metadata !{i32 578, i32 0, metadata !205, null}
!229 = metadata !{i32 540, i32 0, metadata !227, metadata !228}
