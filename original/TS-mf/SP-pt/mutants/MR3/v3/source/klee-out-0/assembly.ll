...
entry:
  ...
  store i8* %fp.0.i.i, i8** %tp.i, align 4, !dbg !213
  ...
  br i1 %27, label %mainQ.exit, label %bb.i, !dbg !216
...
bb.i:                                             ; preds = %entry, %bb.i
  ...
  %29 = icmp eq i8 %28, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %29, label %mainQ.exit, label %bb.i, !dbg !216

mainQ.exit:                                       ; preds = %bb.i, %entry
  call void (i8*, ...)* @klee_print_expr(i8* getelementptr inbounds ([4 x i8]* @.str31, i32 0, i32 0), i8* %rr1) nounwind, !dbg !217
  ret i32 0, !dbg !218
}
...
entry:
  %0 = icmp eq i32 %count, 0, !dbg !219
  br i1 %0, label %bb2, label %bb.lr.ph, !dbg !219

bb.lr.ph:                                         ; preds = %entry
  %1 = trunc i32 %s to i8, !dbg !220
  br label %bb

bb:                                               ; preds = %bb, %bb.lr.ph
  %indvar = phi i32 [ 0, %bb.lr.ph ], [ %indvar.next, %bb ]
  %a.05 = getelementptr i8* %dst, i32 %indvar
  volatile store i8 %1, i8* %a.05, align 1, !dbg !220
  %indvar.next = add i32 %indvar, 1
  %exitcond1 = icmp eq i32 %indvar.next, %count
  br i1 %exitcond1, label %bb2, label %bb, !dbg !219
...
!1 = metadata !{i32 589865, metadata !"v3-s.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v3/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v3-s.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v3/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v3/source/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v3/source/", metadata !2} ; [ DW_TAG_file_type ]
...
!213 = metadata !{i32 537, i32 0, metadata !214, metadata !215}
!214 = metadata !{i32 589835, metadata !45, i32 531, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!215 = metadata !{i32 562, i32 0, metadata !205, null}
!216 = metadata !{i32 540, i32 0, metadata !214, metadata !215}
!217 = metadata !{i32 564, i32 0, metadata !205, null}
!218 = metadata !{i32 565, i32 0, metadata !205, null}
!219 = metadata !{i32 14, i32 0, metadata !88, null}
!220 = metadata !{i32 15, i32 0, metadata !88, null}
!221 = metadata !{i32 16, i32 0, metadata !88, null}
