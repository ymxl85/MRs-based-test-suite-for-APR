...
bb4.i5.i:                                         ; preds = %bb7.i, %bb3.i.i
  ...
  %64 = icmp eq i8 %63, 0
  br i1 %64, label %bb10, label %bb1.i1.i

bb9.i:                                            ; preds = %bb7.i
  %65 = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  %66 = icmp eq i8 %65, 35
...
bb.i.i:                                           ; preds = %bb9.i
  ...
  %73 = and i32 %72, 1024
  %74 = icmp eq i32 %73, 0
  br i1 %74, label %bb11thread-pre-split.i, label %bb12

bb11thread-pre-split.i:                           ; preds = %bb.i.i
  %.pr.i = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  br label %bb11.i

bb11.i:                                           ; preds = %bb11thread-pre-split.i, %bb9.i
  %75 = phi i8 [ %.pr.i, %bb11thread-pre-split.i ], [ %65, %bb9.i ]
  %76 = icmp eq i8 %75, 59
...
!1 = metadata !{i32 589865, metadata !"v5-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v5/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v5-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v5/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v5/follow/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v5/follow/", metadata !2} ; [ DW_TAG_file_type ]
