...
entry:
  ...
  store i8* %argv12, i8** %tp.i, align 4, !dbg !214
  call fastcc void @get_token(i8** %tp.i) nounwind
  %24 = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  %25 = icmp eq i8 %24, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %25, label %mainQ.exit, label %bb.i, !dbg !217
...
!1 = metadata !{i32 589865, metadata !"v4-s.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v4/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v4-s.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v4/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v4/source/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v4/source/", metadata !2} ; [ DW_TAG_file_type ]
...
!214 = metadata !{i32 533, i32 0, metadata !215, metadata !216}
!215 = metadata !{i32 589835, metadata !45, i32 531, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!216 = metadata !{i32 557, i32 0, metadata !206, null}
!217 = metadata !{i32 536, i32 0, metadata !215, metadata !216}
!218 = metadata !{i32 559, i32 0, metadata !206, null}
