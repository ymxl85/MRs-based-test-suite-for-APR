...
entry:
  ...
  %argv12 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 0, !dbg !207
  call void @klee_make_symbolic(i8* %argv12, i32 6, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !207
  ...
  %4 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 1, !dbg !209
  %5 = load i8* %4, align 1, !dbg !209
  %6 = icmp eq i8 %5, 10, !dbg !209
  %7 = zext i1 %6 to i32, !dbg !209
  call void @klee_assume(i32 %7) nounwind, !dbg !209
  %8 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 2, !dbg !210
  ...
  %12 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 3, !dbg !211
  ...
  %16 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 4, !dbg !212
  %17 = load i8* %16, align 1, !dbg !212
  %18 = icmp eq i8 %17, 10, !dbg !212
  %19 = zext i1 %18 to i32, !dbg !212
  call void @klee_assume(i32 %19) nounwind, !dbg !212
  %20 = getelementptr inbounds [6 x i8]* %argv1, i32 0, i32 5, !dbg !213
  %21 = load i8* %20, align 1, !dbg !213
  %22 = icmp eq i8 %21, 0, !dbg !213
  %23 = zext i1 %22 to i32, !dbg !213
  call void @klee_assume(i32 %23) nounwind, !dbg !213
  %f8 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 0, !dbg !214
  call void @klee_make_symbolic(i8* %f8, i32 6, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !214
  %24 = load i8* %argv12, align 1, !dbg !215
  store i8 %24, i8* %f8, align 1, !dbg !215
  %25 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 1, !dbg !216
  store i8 49, i8* %25, align 1, !dbg !216
  %26 = load i8* %4, align 1, !dbg !217
  %27 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 2, !dbg !217
  store i8 %26, i8* %27, align 1, !dbg !217
  %28 = load i8* %8, align 1, !dbg !218
  %29 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 3, !dbg !218
  store i8 %28, i8* %29, align 1, !dbg !218
  %30 = load i8* %16, align 1, !dbg !219
  %31 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 4, !dbg !219
  store i8 %30, i8* %31, align 1, !dbg !219
  %32 = load i8* %20, align 1, !dbg !220
  %33 = getelementptr inbounds [6 x i8]* %f, i32 0, i32 5, !dbg !220
  store i8 %32, i8* %33, align 1, !dbg !220
  %34 = load i8* %f8, align 1, !dbg !221
  %35 = load i8* %argv12, align 1, !dbg !221
  %36 = icmp eq i8 %34, %35, !dbg !221
  %37 = zext i1 %36 to i32, !dbg !221
  call void @klee_assume(i32 %37) nounwind, !dbg !221
  %38 = load i8* %25, align 1, !dbg !222
  %39 = icmp eq i8 %38, 49, !dbg !222
  %40 = zext i1 %39 to i32, !dbg !222
  call void @klee_assume(i32 %40) nounwind, !dbg !222
  %41 = load i8* %27, align 1, !dbg !223
  %42 = load i8* %4, align 1, !dbg !223
  %43 = icmp eq i8 %41, %42, !dbg !223
  %44 = zext i1 %43 to i32, !dbg !223
  call void @klee_assume(i32 %44) nounwind, !dbg !223
  %45 = load i8* %29, align 1, !dbg !224
  %46 = load i8* %8, align 1, !dbg !224
  %47 = icmp eq i8 %45, %46, !dbg !224
  %48 = zext i1 %47 to i32, !dbg !224
  call void @klee_assume(i32 %48) nounwind, !dbg !224
  %49 = load i8* %31, align 1, !dbg !225
  %50 = load i8* %16, align 1, !dbg !225
  %51 = icmp eq i8 %49, %50, !dbg !225
  %52 = zext i1 %51 to i32, !dbg !225
  call void @klee_assume(i32 %52) nounwind, !dbg !225
  %53 = load i8* %33, align 1, !dbg !226
  %54 = load i8* %20, align 1, !dbg !226
  %55 = icmp eq i8 %53, %54, !dbg !226
  %56 = zext i1 %55 to i32, !dbg !226
  call void @klee_assume(i32 %56) nounwind, !dbg !226
  %57 = load i8* %f8, align 1
  %58 = icmp eq i8 %57, 0
  %fp.0.i.i = select i1 %58, i8* null, i8* %f8
  store i8* %fp.0.i.i, i8** %tp.i, align 4, !dbg !227
  call fastcc void @get_token(i8** %tp.i) nounwind
  %59 = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  %60 = icmp eq i8 %59, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %60, label %mainQ.exit, label %bb.i, !dbg !230
...
bb.i:                                             ; preds = %entry, %bb.i
  ...
  %62 = icmp eq i8 %61, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %62, label %mainQ.exit, label %bb.i, !dbg !230

mainQ.exit:                                       ; preds = %bb.i, %entry
  call void (i8*, ...)* @klee_print_expr(i8* getelementptr inbounds ([4 x i8]* @.str31, i32 0, i32 0), i8* %rr1) nounwind, !dbg !231
  ret i32 0, !dbg !232
}
...
entry:
  %0 = icmp eq i32 %count, 0, !dbg !233
  br i1 %0, label %bb2, label %bb.lr.ph, !dbg !233

bb.lr.ph:                                         ; preds = %entry
  %1 = trunc i32 %s to i8, !dbg !234
  br label %bb

bb:                                               ; preds = %bb, %bb.lr.ph
  %indvar = phi i32 [ 0, %bb.lr.ph ], [ %indvar.next, %bb ]
  %a.05 = getelementptr i8* %dst, i32 %indvar
  volatile store i8 %1, i8* %a.05, align 1, !dbg !234
  %indvar.next = add i32 %indvar, 1
  %exitcond1 = icmp eq i32 %indvar.next, %count
  br i1 %exitcond1, label %bb2, label %bb, !dbg !233
...
!1 = metadata !{i32 589865, metadata !"v7-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v7/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v7-f.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v7/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v7/follow/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/SP-pt/mutants/MR3/v7/follow/", metadata !2} ; [ DW_TAG_file_type ]
...
!214 = metadata !{i32 564, i32 0, metadata !206, null}
!215 = metadata !{i32 565, i32 0, metadata !206, null}
!216 = metadata !{i32 566, i32 0, metadata !206, null}
!217 = metadata !{i32 567, i32 0, metadata !206, null}
!218 = metadata !{i32 568, i32 0, metadata !206, null}
!219 = metadata !{i32 569, i32 0, metadata !206, null}
!220 = metadata !{i32 570, i32 0, metadata !206, null}
!221 = metadata !{i32 571, i32 0, metadata !206, null}
!222 = metadata !{i32 572, i32 0, metadata !206, null}
!223 = metadata !{i32 573, i32 0, metadata !206, null}
!224 = metadata !{i32 574, i32 0, metadata !206, null}
!225 = metadata !{i32 575, i32 0, metadata !206, null}
!226 = metadata !{i32 576, i32 0, metadata !206, null}
!227 = metadata !{i32 537, i32 0, metadata !228, metadata !229}
!228 = metadata !{i32 589835, metadata !45, i32 531, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!229 = metadata !{i32 578, i32 0, metadata !206, null}
!230 = metadata !{i32 540, i32 0, metadata !228, metadata !229}
!231 = metadata !{i32 580, i32 0, metadata !206, null}
!232 = metadata !{i32 581, i32 0, metadata !206, null}
!233 = metadata !{i32 14, i32 0, metadata !88, null}
!234 = metadata !{i32 15, i32 0, metadata !88, null}
!235 = metadata !{i32 16, i32 0, metadata !88, null}
