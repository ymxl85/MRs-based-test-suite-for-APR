...
bb2.i.i28:                                        ; preds = %bb1.i.i27, %bb2.i.i28
  ...
  %132 = getelementptr inbounds %struct.Ele* %f_ele.04.i.i, i32 0, i32 0
  %f_ele.0.i.i = load %struct.Ele** %132, align 4
  %133 = icmp ne %struct.Ele* %f_ele.0.i.i, null
  %134 = icmp slt i32 %tmp.i.i, %128
...
find_nth.exit.i:                                  ; preds = %bb2.i.i28, %bb1.i.i27
  ...
  br i1 %135, label %bb36, label %bb2.i4.i
...
bb2.i4.i:                                         ; preds = %find_nth.exit.i
  ...
  br i1 %138, label %bb4.i.i, label %bb3.i5.i
...
bb7.i.i:                                          ; preds = %bb5.i.i
  ...
  store %struct.Ele* %152, %struct.Ele** %129, align 4
  br label %del_ele.exit.i

del_ele.exit.i:                                   ; preds = %bb6.i.i, %bb7.i.i
  %153 = load i32* %123, align 4
  %154 = add nsw i32 %153, -1
  store i32 %154, i32* %123, align 4
  ...
  br i1 %160, label %bb.i.i29, label %bb1.i1.i
...
bb1.i1.i:                                         ; preds = %bb.i.i29, %del_ele.exit.i
  %a_list_addr.0.i.i30 = phi %struct.List* [ %162, %bb.i.i29 ], [ %159, %del_ele.exit.i ]
  %168 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i30, i32 0, i32 1
  ...
  br i1 %172, label %bb3.i.i31, label %bb2.i2.i
...
bb3.i.i31:                                        ; preds = %bb1.i1.i
  %175 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i30, i32 0, i32 0
...
append_ele.exit.i32:                              ; preds = %bb3.i.i31, %bb2.i2.i
  ...
  %177 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i30, i32 0, i32 2
  %178 = load i32* %177, align 4
  %179 = add nsw i32 %178, 1
  store i32 %179, i32* %177, align 4
  store %struct.List* %a_list_addr.0.i.i30, %struct.List** %158, align 4
  br label %bb36

bb20:                                             ; preds = %bb12
  %180 = icmp slt i32 %52, 12, !dbg !190
  br i1 %180, label %bb22, label %bb24, !dbg !190

bb22:                                             ; preds = %bb20
  %181 = getelementptr inbounds [15 x i32]* %arg, i32 0, i32 %52, !dbg !191
  %182 = load i32* %181, align 4, !dbg !191
  %183 = add i32 %index.4, 2, !dbg !192
  %184 = icmp slt i32 %183, 12, !dbg !193
  br i1 %184, label %bb23, label %bb24, !dbg !193

bb23:                                             ; preds = %bb22
  %185 = getelementptr inbounds [15 x i32]* %arg, i32 0, i32 %183, !dbg !194
  %186 = load i32* %185, align 4, !dbg !194
  %187 = sitofp i32 %186 to double, !dbg !195
  switch i32 %186, label %bb9.i17 [
...
bb8.i16:                                          ; preds = %bb23, %bb23, %bb23, %bb23, %bb23, %bb23, %bb23, %bb23, %bb23
  %188 = fmul double %187, 1.000000e-01, !dbg !195
  br label %getOperand.exit20, !dbg !195

bb9.i17:                                          ; preds = %bb23
  %189 = fmul double %187, 1.000000e-02, !dbg !196
  br label %getOperand.exit20, !dbg !196

getOperand.exit20:                                ; preds = %bb8.i16, %bb9.i17
  %r.0.in.i18 = phi double [ %188, %bb8.i16 ], [ %189, %bb9.i17 ]
  %r.0.i19 = fptrunc double %r.0.in.i18 to float
  %190 = add i32 %index.4, 3, !dbg !197
  br label %bb24, !dbg !197

bb24:                                             ; preds = %bb20, %getOperand.exit20, %bb22
  %prio.121 = phi i32 [ %182, %getOperand.exit20 ], [ %182, %bb22 ], [ %prio.3, %bb20 ]
  %ratio.1 = phi float [ %r.0.i19, %getOperand.exit20 ], [ %ratio.2, %bb22 ], [ %ratio.2, %bb20 ]
  %index.2 = phi i32 [ %190, %getOperand.exit20 ], [ %183, %bb22 ], [ %52, %bb20 ]
  %prio.1.off = add i32 %prio.121, -1
  %191 = icmp ugt i32 %prio.1.off, 2
  br i1 %191, label %bb26, label %bb27, !dbg !198

bb26:                                             ; preds = %bb24
  %192 = load %struct._IO_FILE** @stdout, align 4, !dbg !199
  %193 = bitcast %struct._IO_FILE* %192 to i8*, !dbg !199
  %194 = call i32 @fwrite(i8* getelementptr inbounds ([21 x i8]* @.str6, i32 0, i32 0), i32 1, i32 20, i8* %193) nounwind, !dbg !199
  br label %return, !dbg !199

bb27:                                             ; preds = %bb24
  %195 = icmp sgt i32 %prio.121, 2
  br i1 %195, label %bb36, label %bb.i34

bb.i34:                                           ; preds = %bb27
  %196 = getelementptr inbounds [4 x %struct.List*]* @prio_queue, i32 0, i32 %prio.121
  %197 = load %struct.List** %196, align 4
  %198 = add nsw i32 %prio.121, 1
  ...
  br i1 %203, label %bb2.i35, label %bb36
...
bb2.i35:                                          ; preds = %bb.i34
  ...
  br i1 %208, label %bb36, label %bb1.i.i38

bb1.i.i38:                                        ; preds = %bb2.i35
  %209 = getelementptr inbounds %struct.List* %197, i32 0, i32 0
  %f_ele.01.i.i36 = load %struct.Ele** %209, align 4
  %210 = icmp ne %struct.Ele* %f_ele.01.i.i36, null
  %211 = icmp sgt i32 %207, 1
  %or.cond2.i.i37 = and i1 %210, %211
...
bb2.i.i45:                                        ; preds = %bb1.i.i38, %bb2.i.i45
  ...
  %212 = getelementptr inbounds %struct.Ele* %f_ele.04.i.i40, i32 0, i32 0
  %f_ele.0.i.i42 = load %struct.Ele** %212, align 4
  %213 = icmp ne %struct.Ele* %f_ele.0.i.i42, null
  %214 = icmp slt i32 %tmp.i.i41, %207
  %or.cond.i.i43 = and i1 %213, %214
...
find_nth.exit.i47:                                ; preds = %bb2.i.i45, %bb1.i.i38
  ...
  %215 = icmp eq %struct.Ele* %.0.i.i46, null
  br i1 %215, label %bb36, label %bb2.i4.i48

bb2.i4.i48:                                       ; preds = %find_nth.exit.i47
  %216 = getelementptr inbounds %struct.Ele* %.0.i.i46, i32 0, i32 0
  %217 = load %struct.Ele** %216, align 4
  %218 = icmp eq %struct.Ele* %217, null
  br i1 %218, label %bb4.i.i50, label %bb3.i5.i49

bb3.i5.i49:                                       ; preds = %bb2.i4.i48
  %219 = load %struct.Ele** %216, align 4
  %220 = getelementptr inbounds %struct.Ele* %.0.i.i46, i32 0, i32 1
  %221 = load %struct.Ele** %220, align 4
  %222 = getelementptr inbounds %struct.Ele* %219, i32 0, i32 1
  store %struct.Ele* %221, %struct.Ele** %222, align 4
  br label %bb5.i.i51

bb4.i.i50:                                        ; preds = %bb2.i4.i48
  %223 = getelementptr inbounds %struct.Ele* %.0.i.i46, i32 0, i32 1
  %224 = load %struct.Ele** %223, align 4
  %225 = getelementptr inbounds %struct.List* %197, i32 0, i32 1
  store %struct.Ele* %224, %struct.Ele** %225, align 4
  br label %bb5.i.i51

bb5.i.i51:                                        ; preds = %bb4.i.i50, %bb3.i5.i49
  %226 = getelementptr inbounds %struct.Ele* %.0.i.i46, i32 0, i32 1
  %227 = load %struct.Ele** %226, align 4
  %228 = icmp eq %struct.Ele* %227, null
  br i1 %228, label %bb7.i.i53, label %bb6.i.i52

bb6.i.i52:                                        ; preds = %bb5.i.i51
  %229 = load %struct.Ele** %226, align 4
  %230 = load %struct.Ele** %216, align 4
  %231 = getelementptr inbounds %struct.Ele* %229, i32 0, i32 0
  store %struct.Ele* %230, %struct.Ele** %231, align 4
  br label %bb8.i.i54

bb7.i.i53:                                        ; preds = %bb5.i.i51
  %232 = load %struct.Ele** %216, align 4
  store %struct.Ele* %232, %struct.Ele** %209, align 4
  br label %bb8.i.i54

bb8.i.i54:                                        ; preds = %bb7.i.i53, %bb6.i.i52
  %233 = load i32* %201, align 4
  %234 = add nsw i32 %233, -1
  store i32 %234, i32* %201, align 4
  %235 = trunc i32 %prio.121 to i16
  %236 = getelementptr inbounds %struct.Ele* %.0.i.i46, i32 0, i32 3
  store i16 %235, i16* %236, align 4
  %237 = icmp eq %struct.List* %200, null
  br i1 %237, label %bb.i.i55, label %bb1.i1.i57

bb.i.i55:                                         ; preds = %bb8.i.i54
  %238 = call noalias i8* @malloc(i32 12) nounwind
  %239 = bitcast i8* %238 to %struct.List*
  %240 = bitcast i8* %238 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %240, align 4
  %241 = getelementptr inbounds i8* %238, i32 4
  %242 = bitcast i8* %241 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %242, align 4
  %243 = getelementptr inbounds i8* %238, i32 8
  %244 = bitcast i8* %243 to i32*
  store i32 0, i32* %244, align 4
  br label %bb1.i1.i57

bb1.i1.i57:                                       ; preds = %bb.i.i55, %bb8.i.i54
  %a_list_addr.0.i.i56 = phi %struct.List* [ %239, %bb.i.i55 ], [ %200, %bb8.i.i54 ]
  %245 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i56, i32 0, i32 1
  %246 = load %struct.Ele** %245, align 4
  store %struct.Ele* %246, %struct.Ele** %226, align 4
  %247 = load %struct.Ele** %245, align 4
  %248 = icmp eq %struct.Ele* %247, null
  br i1 %248, label %bb3.i.i59, label %bb2.i2.i58

bb2.i2.i58:                                       ; preds = %bb1.i1.i57
  %249 = load %struct.Ele** %245, align 4
  %250 = getelementptr inbounds %struct.Ele* %249, i32 0, i32 0
  store %struct.Ele* %.0.i.i46, %struct.Ele** %250, align 4
  br label %append_ele.exit.i60

bb3.i.i59:                                        ; preds = %bb1.i1.i57
  %251 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i56, i32 0, i32 0
  store %struct.Ele* %.0.i.i46, %struct.Ele** %251, align 4
  br label %append_ele.exit.i60

append_ele.exit.i60:                              ; preds = %bb3.i.i59, %bb2.i2.i58
  store %struct.Ele* %.0.i.i46, %struct.Ele** %245, align 4
  store %struct.Ele* null, %struct.Ele** %216, align 4
  %252 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i56, i32 0, i32 2
...
bb28:                                             ; preds = %bb12
  %255 = icmp slt i32 %52, 12, !dbg !200
  br i1 %255, label %bb29, label %bb30, !dbg !200

bb29:                                             ; preds = %bb28
  %256 = getelementptr inbounds [15 x i32]* %arg, i32 0, i32 %52, !dbg !201
  %257 = load i32* %256, align 4, !dbg !201
  %258 = add i32 %index.4, 2, !dbg !202
  br label %bb30, !dbg !202

bb30:                                             ; preds = %bb29, %bb28
  %prio.2 = phi i32 [ %257, %bb29 ], [ %prio.3, %bb28 ]
  %index.3 = phi i32 [ %258, %bb29 ], [ %52, %bb28 ]
  %prio.2.off = add i32 %prio.2, -1
  %259 = icmp ugt i32 %prio.2.off, 2
  br i1 %259, label %bb32, label %bb33, !dbg !203

bb32:                                             ; preds = %bb30
  %260 = load %struct._IO_FILE** @stdout, align 4, !dbg !204
  %261 = bitcast %struct._IO_FILE* %260 to i8*, !dbg !204
  %262 = call i32 @fwrite(i8* getelementptr inbounds ([21 x i8]* @.str6, i32 0, i32 0), i32 1, i32 20, i8* %261) nounwind, !dbg !204
  br label %return, !dbg !204

bb33:                                             ; preds = %bb30
  %263 = load i32* @alloc_proc_num, align 4
  %264 = add nsw i32 %263, 1
  store i32 %264, i32* @alloc_proc_num, align 4
  %265 = call noalias i8* @malloc(i32 16) nounwind
  %266 = bitcast i8* %265 to %struct.Ele*
  %267 = bitcast i8* %265 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %267, align 4
  %268 = getelementptr inbounds i8* %265, i32 4
  %269 = bitcast i8* %268 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %269, align 4
  %270 = getelementptr inbounds i8* %265, i32 8
  %271 = bitcast i8* %270 to i32*
  store i32 %263, i32* %271, align 4
  %272 = trunc i32 %prio.2 to i16
  %273 = getelementptr inbounds i8* %265, i32 12
  %274 = bitcast i8* %273 to i16*
  store i16 %272, i16* %274, align 4
  %275 = load i32* @num_processes, align 4
  %276 = add nsw i32 %275, 1
  store i32 %276, i32* @num_processes, align 4
  %277 = getelementptr inbounds [4 x %struct.List*]* @prio_queue, i32 0, i32 %prio.2
  %278 = load %struct.List** %277, align 4
  %279 = icmp eq %struct.List* %278, null
  br i1 %279, label %bb.i.i61, label %bb1.i.i63

bb.i.i61:                                         ; preds = %bb33
  %280 = call noalias i8* @malloc(i32 12) nounwind
  %281 = bitcast i8* %280 to %struct.List*
  %282 = bitcast i8* %280 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %282, align 4
  %283 = getelementptr inbounds i8* %280, i32 4
  %284 = bitcast i8* %283 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %284, align 4
  %285 = getelementptr inbounds i8* %280, i32 8
  %286 = bitcast i8* %285 to i32*
  store i32 0, i32* %286, align 4
  br label %bb1.i.i63

bb1.i.i63:                                        ; preds = %bb.i.i61, %bb33
  %a_list_addr.0.i.i62 = phi %struct.List* [ %281, %bb.i.i61 ], [ %278, %bb33 ]
  %287 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i62, i32 0, i32 1
  %288 = load %struct.Ele** %287, align 4
  store %struct.Ele* %288, %struct.Ele** %269, align 4
  %289 = load %struct.Ele** %287, align 4
  %290 = icmp eq %struct.Ele* %289, null
  br i1 %290, label %bb3.i.i65, label %bb2.i.i64

bb2.i.i64:                                        ; preds = %bb1.i.i63
  %291 = load %struct.Ele** %287, align 4
  %292 = getelementptr inbounds %struct.Ele* %291, i32 0, i32 0
  store %struct.Ele* %266, %struct.Ele** %292, align 4
  br label %add_process.exit

bb3.i.i65:                                        ; preds = %bb1.i.i63
  %293 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i62, i32 0, i32 0
  store %struct.Ele* %266, %struct.Ele** %293, align 4
  br label %add_process.exit

add_process.exit:                                 ; preds = %bb2.i.i64, %bb3.i.i65
  store %struct.Ele* %266, %struct.Ele** %287, align 4
  store %struct.Ele* null, %struct.Ele** %267, align 4
  %294 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i62, i32 0, i32 2
  %295 = load i32* %294, align 4
  %296 = add nsw i32 %295, 1
  store i32 %296, i32* %294, align 4
  store %struct.List* %a_list_addr.0.i.i62, %struct.List** %277, align 4
  br label %bb36, !dbg !205

bb34:                                             ; preds = %bb12
  %297 = load i32* @num_processes, align 4, !dbg !206
  %298 = icmp sgt i32 %297, 0, !dbg !209
  br i1 %298, label %bb.i, label %bb36, !dbg !209

bb.i:                                             ; preds = %bb34, %finish_process.exit.i
  %length.0 = phi i32 [ %length.1, %finish_process.exit.i ], [ %length.2, %bb34 ]
  %i.01.i = phi i32 [ %310, %finish_process.exit.i ], [ 0, %bb34 ]
  call fastcc void @schedule() nounwind
  %299 = load %struct.Ele** @cur_proc, align 4, !dbg !210
  %300 = icmp eq %struct.Ele* %299, null, !dbg !210
  br i1 %300, label %finish_process.exit.i, label %bb.i.i, !dbg !210

bb.i.i:                                           ; preds = %bb.i
  %301 = load %struct.Ele** @cur_proc, align 4, !dbg !212
  %302 = getelementptr inbounds %struct.Ele* %301, i32 0, i32 2, !dbg !212
  %303 = load i32* %302, align 4, !dbg !212
  %304 = getelementptr inbounds [10 x i32]* %result, i32 0, i32 %length.0, !dbg !212
  store i32 %303, i32* %304, align 4, !dbg !212
  %305 = add nsw i32 %length.0, 1, !dbg !213
  %306 = load %struct.Ele** @cur_proc, align 4, !dbg !214
  %307 = call i32 (...)* @free(%struct.Ele* %306) nounwind
  %308 = load i32* @num_processes, align 4, !dbg !215
  %309 = add nsw i32 %308, -1, !dbg !215
  store i32 %309, i32* @num_processes, align 4, !dbg !215
  br label %finish_process.exit.i, !dbg !215

finish_process.exit.i:                            ; preds = %bb.i.i, %bb.i
  %length.1 = phi i32 [ %length.0, %bb.i ], [ %305, %bb.i.i ]
  %310 = add nsw i32 %i.01.i, 1, !dbg !209
  %exitcond = icmp eq i32 %310, %297
  br i1 %exitcond, label %bb36, label %bb.i, !dbg !209

bb36:                                             ; preds = %finish_process.exit.i, %append_ele.exit.i60, %find_nth.exit.i47, %bb2.i35, %bb.i34, %bb27, %append_ele.exit.i32, %find_nth.exit.i, %bb19, %bb34, %append_ele.exit.i15, %bb16, %append_ele.exit.i,
  ...
  %311 = icmp slt i32 %index.4, 12, !dbg !216
  br i1 %311, label %bb12, label %bb37, !dbg !216

bb37:                                             ; preds = %bb36
  %result38 = getelementptr inbounds [10 x i32]* %result, i32 0, i32 0, !dbg !217
  %312 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([7 x i8]* @.str7, i32 0, i32 0), i32* %result38) nounwind, !dbg !217
...
!1 = metadata !{i32 589865, metadata !"v2-f.c", metadata !"/home/mingyue/experiments/ceti/schedule/SP-sh/mutants/MR3/v2/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v2-f.c", metadata !"/home/mingyue/experiments/ceti/schedule/SP-sh/mutants/MR3/v2/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
...
!145 = metadata !{i32 346, i32 0, metadata !134, null}
!146 = metadata !{i32 347, i32 0, metadata !134, null}
...
!150 = metadata !{i32 351, i32 0, metadata !134, null}
!151 = metadata !{i32 352, i32 0, metadata !134, null}
!152 = metadata !{i32 353, i32 0, metadata !134, null}
!153 = metadata !{i32 354, i32 0, metadata !134, null}
...
!157 = metadata !{i32 358, i32 0, metadata !134, null}
!158 = metadata !{i32 300, i32 0, metadata !159, metadata !160}
!159 = metadata !{i32 589835, metadata !47, i32 299, i32 0, metadata !1, i32 16} ; [ DW_TAG_lexical_block ]
!160 = metadata !{i32 361, i32 0, metadata !134, null}
!161 = metadata !{i32 301, i32 0, metadata !159, metadata !160}
!162 = metadata !{i32 364, i32 0, metadata !134, null}
!163 = metadata !{i32 369, i32 0, metadata !134, null}
!164 = metadata !{i32 370, i32 0, metadata !134, null}
!165 = metadata !{i32 371, i32 0, metadata !134, null}
...
!168 = metadata !{i32 374, i32 0, metadata !134, null}
...
!173 = metadata !{i32 256, i32 0, metadata !174, metadata !175}
!174 = metadata !{i32 589835, metadata !43, i32 255, i32 0, metadata !1, i32 12} ; [ DW_TAG_lexical_block ]
!175 = metadata !{i32 377, i32 0, metadata !134, null}
!176 = metadata !{i32 257, i32 0, metadata !174, metadata !175}
!177 = metadata !{i32 259, i32 0, metadata !174, metadata !175}
!178 = metadata !{i32 245, i32 0, metadata !179, metadata !180}
!179 = metadata !{i32 589835, metadata !42, i32 243, i32 0, metadata !1, i32 11} ; [ DW_TAG_lexical_block ]
!180 = metadata !{i32 380, i32 0, metadata !134, null}
!181 = metadata !{i32 246, i32 0, metadata !179, metadata !180}
!182 = metadata !{i32 248, i32 0, metadata !179, metadata !180}
!183 = metadata !{i32 249, i32 0, metadata !179, metadata !180}
!184 = metadata !{i32 383, i32 0, metadata !134, null}
!185 = metadata !{i32 384, i32 0, metadata !134, null}
!186 = metadata !{i32 309, i32 0, metadata !187, metadata !185}
!187 = metadata !{i32 589835, metadata !48, i32 306, i32 0, metadata !1, i32 17} ; [ DW_TAG_lexical_block ]
!188 = metadata !{i32 311, i32 0, metadata !187, metadata !185}
!189 = metadata !{i32 385, i32 0, metadata !134, null}
!190 = metadata !{i32 389, i32 0, metadata !134, null}
!191 = metadata !{i32 390, i32 0, metadata !134, null}
!192 = metadata !{i32 391, i32 0, metadata !134, null}
!193 = metadata !{i32 393, i32 0, metadata !134, null}
!194 = metadata !{i32 394, i32 0, metadata !134, null}
!195 = metadata !{i32 309, i32 0, metadata !187, metadata !194}
!196 = metadata !{i32 311, i32 0, metadata !187, metadata !194}
!197 = metadata !{i32 395, i32 0, metadata !134, null}
!198 = metadata !{i32 397, i32 0, metadata !134, null}
!199 = metadata !{i32 398, i32 0, metadata !134, null}
!200 = metadata !{i32 405, i32 0, metadata !134, null}
!201 = metadata !{i32 406, i32 0, metadata !134, null}
!202 = metadata !{i32 407, i32 0, metadata !134, null}
!203 = metadata !{i32 408, i32 0, metadata !134, null}
!204 = metadata !{i32 409, i32 0, metadata !134, null}
!205 = metadata !{i32 413, i32 0, metadata !134, null}
...
!208 = metadata !{i32 416, i32 0, metadata !134, null}
...
!216 = metadata !{i32 367, i32 0, metadata !134, null}
!217 = metadata !{i32 421, i32 0, metadata !134, null}
!218 = metadata !{i32 399, i32 0, metadata !134, null}
