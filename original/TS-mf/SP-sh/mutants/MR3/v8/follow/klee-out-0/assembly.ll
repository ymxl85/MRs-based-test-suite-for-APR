...
bb8.i.i54:                                        ; preds = %bb7.i.i53, %bb6.i.i52
  ...
  %235 = icmp eq %struct.List* %200, null
  br i1 %235, label %bb.i.i55, label %bb1.i1.i57

bb.i.i55:                                         ; preds = %bb8.i.i54
  %236 = call noalias i8* @malloc(i32 12) nounwind
  %237 = bitcast i8* %236 to %struct.List*
  %238 = bitcast i8* %236 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %238, align 4
  %239 = getelementptr inbounds i8* %236, i32 4
  %240 = bitcast i8* %239 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %240, align 4
  %241 = getelementptr inbounds i8* %236, i32 8
  %242 = bitcast i8* %241 to i32*
  store i32 0, i32* %242, align 4
  br label %bb1.i1.i57

bb1.i1.i57:                                       ; preds = %bb.i.i55, %bb8.i.i54
  %a_list_addr.0.i.i56 = phi %struct.List* [ %237, %bb.i.i55 ], [ %200, %bb8.i.i54 ]
  %243 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i56, i32 0, i32 1
  %244 = load %struct.Ele** %243, align 4
  store %struct.Ele* %244, %struct.Ele** %226, align 4
  %245 = load %struct.Ele** %243, align 4
  %246 = icmp eq %struct.Ele* %245, null
  br i1 %246, label %bb3.i.i59, label %bb2.i2.i58

bb2.i2.i58:                                       ; preds = %bb1.i1.i57
  %247 = load %struct.Ele** %243, align 4
  %248 = getelementptr inbounds %struct.Ele* %247, i32 0, i32 0
  store %struct.Ele* %.0.i.i46, %struct.Ele** %248, align 4
  br label %append_ele.exit.i60

bb3.i.i59:                                        ; preds = %bb1.i1.i57
  %249 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i56, i32 0, i32 0
  store %struct.Ele* %.0.i.i46, %struct.Ele** %249, align 4
  br label %append_ele.exit.i60

append_ele.exit.i60:                              ; preds = %bb3.i.i59, %bb2.i2.i58
  store %struct.Ele* %.0.i.i46, %struct.Ele** %243, align 4
  store %struct.Ele* null, %struct.Ele** %216, align 4
  %250 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i56, i32 0, i32 2
...
bb28:                                             ; preds = %bb12
  %253 = icmp slt i32 %52, 12, !dbg !200
  br i1 %253, label %bb29, label %bb30, !dbg !200

bb29:                                             ; preds = %bb28
  %254 = getelementptr inbounds [15 x i32]* %arg, i32 0, i32 %52, !dbg !201
  %255 = load i32* %254, align 4, !dbg !201
  %256 = add i32 %index.4, 2, !dbg !202
  br label %bb30, !dbg !202

bb30:                                             ; preds = %bb29, %bb28
  %prio.2 = phi i32 [ %255, %bb29 ], [ %prio.3, %bb28 ]
  %index.3 = phi i32 [ %256, %bb29 ], [ %52, %bb28 ]
  %prio.2.off = add i32 %prio.2, -1
  %257 = icmp ugt i32 %prio.2.off, 2
  br i1 %257, label %bb32, label %bb33, !dbg !203

bb32:                                             ; preds = %bb30
  %258 = load %struct._IO_FILE** @stdout, align 4, !dbg !204
  %259 = bitcast %struct._IO_FILE* %258 to i8*, !dbg !204
  %260 = call i32 @fwrite(i8* getelementptr inbounds ([21 x i8]* @.str6, i32 0, i32 0), i32 1, i32 20, i8* %259) nounwind, !dbg !204
  br label %return, !dbg !204

bb33:                                             ; preds = %bb30
  %261 = load i32* @alloc_proc_num, align 4
  %262 = add nsw i32 %261, 1
  store i32 %262, i32* @alloc_proc_num, align 4
  %263 = call noalias i8* @malloc(i32 16) nounwind
  %264 = bitcast i8* %263 to %struct.Ele*
  %265 = bitcast i8* %263 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %265, align 4
  %266 = getelementptr inbounds i8* %263, i32 4
  %267 = bitcast i8* %266 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %267, align 4
  %268 = getelementptr inbounds i8* %263, i32 8
  %269 = bitcast i8* %268 to i32*
  store i32 %261, i32* %269, align 4
  %270 = trunc i32 %prio.2 to i16
  %271 = getelementptr inbounds i8* %263, i32 12
  %272 = bitcast i8* %271 to i16*
  store i16 %270, i16* %272, align 4
  %273 = load i32* @num_processes, align 4
  %274 = add nsw i32 %273, 1
  store i32 %274, i32* @num_processes, align 4
  %275 = getelementptr inbounds [4 x %struct.List*]* @prio_queue, i32 0, i32 %prio.2
  %276 = load %struct.List** %275, align 4
  %277 = icmp eq %struct.List* %276, null
  br i1 %277, label %bb.i.i61, label %bb1.i.i63

bb.i.i61:                                         ; preds = %bb33
  %278 = call noalias i8* @malloc(i32 12) nounwind
  %279 = bitcast i8* %278 to %struct.List*
  %280 = bitcast i8* %278 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %280, align 4
  %281 = getelementptr inbounds i8* %278, i32 4
  %282 = bitcast i8* %281 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %282, align 4
  %283 = getelementptr inbounds i8* %278, i32 8
  %284 = bitcast i8* %283 to i32*
  store i32 0, i32* %284, align 4
  br label %bb1.i.i63

bb1.i.i63:                                        ; preds = %bb.i.i61, %bb33
  %a_list_addr.0.i.i62 = phi %struct.List* [ %279, %bb.i.i61 ], [ %276, %bb33 ]
  %285 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i62, i32 0, i32 1
  %286 = load %struct.Ele** %285, align 4
  store %struct.Ele* %286, %struct.Ele** %267, align 4
  %287 = load %struct.Ele** %285, align 4
  %288 = icmp eq %struct.Ele* %287, null
  br i1 %288, label %bb3.i.i65, label %bb2.i.i64

bb2.i.i64:                                        ; preds = %bb1.i.i63
  %289 = load %struct.Ele** %285, align 4
  %290 = getelementptr inbounds %struct.Ele* %289, i32 0, i32 0
  store %struct.Ele* %264, %struct.Ele** %290, align 4
  br label %add_process.exit

bb3.i.i65:                                        ; preds = %bb1.i.i63
  %291 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i62, i32 0, i32 0
  store %struct.Ele* %264, %struct.Ele** %291, align 4
  br label %add_process.exit

add_process.exit:                                 ; preds = %bb2.i.i64, %bb3.i.i65
  store %struct.Ele* %264, %struct.Ele** %285, align 4
  store %struct.Ele* null, %struct.Ele** %265, align 4
  %292 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i62, i32 0, i32 2
  %293 = load i32* %292, align 4
  %294 = add nsw i32 %293, 1
  store i32 %294, i32* %292, align 4
  store %struct.List* %a_list_addr.0.i.i62, %struct.List** %275, align 4
  br label %bb36, !dbg !205

bb34:                                             ; preds = %bb12
  %295 = load i32* @num_processes, align 4, !dbg !206
  %296 = icmp sgt i32 %295, 0, !dbg !209
  br i1 %296, label %bb.i, label %bb36, !dbg !209

bb.i:                                             ; preds = %bb34, %finish_process.exit.i
  %length.0 = phi i32 [ %length.1, %finish_process.exit.i ], [ %length.2, %bb34 ]
  %i.01.i = phi i32 [ %308, %finish_process.exit.i ], [ 0, %bb34 ]
  call fastcc void @schedule() nounwind
  %297 = load %struct.Ele** @cur_proc, align 4, !dbg !210
  %298 = icmp eq %struct.Ele* %297, null, !dbg !210
  br i1 %298, label %finish_process.exit.i, label %bb.i.i, !dbg !210

bb.i.i:                                           ; preds = %bb.i
  %299 = load %struct.Ele** @cur_proc, align 4, !dbg !212
  %300 = getelementptr inbounds %struct.Ele* %299, i32 0, i32 2, !dbg !212
  %301 = load i32* %300, align 4, !dbg !212
  %302 = getelementptr inbounds [10 x i32]* %result, i32 0, i32 %length.0, !dbg !212
  store i32 %301, i32* %302, align 4, !dbg !212
  %303 = add nsw i32 %length.0, 1, !dbg !213
  %304 = load %struct.Ele** @cur_proc, align 4, !dbg !214
  %305 = call i32 (...)* @free(%struct.Ele* %304) nounwind
  %306 = load i32* @num_processes, align 4, !dbg !215
  %307 = add nsw i32 %306, -1, !dbg !215
  store i32 %307, i32* @num_processes, align 4, !dbg !215
  br label %finish_process.exit.i, !dbg !215

finish_process.exit.i:                            ; preds = %bb.i.i, %bb.i
  %length.1 = phi i32 [ %length.0, %bb.i ], [ %303, %bb.i.i ]
  %308 = add nsw i32 %i.01.i, 1, !dbg !209
  %exitcond = icmp eq i32 %308, %295
...
bb36:                                             ; preds = %finish_process.exit.i, %append_ele.exit.i60, %find_nth.exit.i47, %bb2.i35, %bb.i34, %bb27, %append_ele.exit.i32, %find_nth.exit.i, %bb19, %bb34, %append_ele.exit.i15, %bb16, %append_ele.exit.i,
  ...
  %309 = icmp slt i32 %index.4, 12, !dbg !216
  br i1 %309, label %bb12, label %bb37, !dbg !216

bb37:                                             ; preds = %bb36
  %result38 = getelementptr inbounds [10 x i32]* %result, i32 0, i32 0, !dbg !217
  %310 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([7 x i8]* @.str7, i32 0, i32 0), i32* %result38) nounwind, !dbg !217
...
!1 = metadata !{i32 589865, metadata !"v8-f.c", metadata !"/home/mingyue/experiments/ceti/schedule/SP-sh/mutants/MR3/v8/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v8-f.c", metadata !"/home/mingyue/experiments/ceti/schedule/SP-sh/mutants/MR3/v8/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
