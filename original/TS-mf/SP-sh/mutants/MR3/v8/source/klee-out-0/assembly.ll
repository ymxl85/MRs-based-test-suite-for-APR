...
bb8.i.i89:                                        ; preds = %bb7.i.i88, %bb6.i.i87
  ...
  %234 = icmp eq %struct.List* %199, null
  br i1 %234, label %bb.i.i90, label %bb1.i1.i92

bb.i.i90:                                         ; preds = %bb8.i.i89
  %235 = call noalias i8* @malloc(i32 12) nounwind
  %236 = bitcast i8* %235 to %struct.List*
  %237 = bitcast i8* %235 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %237, align 4
  %238 = getelementptr inbounds i8* %235, i32 4
  %239 = bitcast i8* %238 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %239, align 4
  %240 = getelementptr inbounds i8* %235, i32 8
  %241 = bitcast i8* %240 to i32*
  store i32 0, i32* %241, align 4
  br label %bb1.i1.i92

bb1.i1.i92:                                       ; preds = %bb.i.i90, %bb8.i.i89
  %a_list_addr.0.i.i91 = phi %struct.List* [ %236, %bb.i.i90 ], [ %199, %bb8.i.i89 ]
  %242 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i91, i32 0, i32 1
  %243 = load %struct.Ele** %242, align 4
  store %struct.Ele* %243, %struct.Ele** %225, align 4
  %244 = load %struct.Ele** %242, align 4
  %245 = icmp eq %struct.Ele* %244, null
  br i1 %245, label %bb3.i.i94, label %bb2.i2.i93

bb2.i2.i93:                                       ; preds = %bb1.i1.i92
  %246 = load %struct.Ele** %242, align 4
  %247 = getelementptr inbounds %struct.Ele* %246, i32 0, i32 0
  store %struct.Ele* %.0.i.i81, %struct.Ele** %247, align 4
  br label %append_ele.exit.i95

bb3.i.i94:                                        ; preds = %bb1.i1.i92
  %248 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i91, i32 0, i32 0
  store %struct.Ele* %.0.i.i81, %struct.Ele** %248, align 4
  br label %append_ele.exit.i95

append_ele.exit.i95:                              ; preds = %bb3.i.i94, %bb2.i2.i93
  store %struct.Ele* %.0.i.i81, %struct.Ele** %242, align 4
  store %struct.Ele* null, %struct.Ele** %215, align 4
  %249 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i91, i32 0, i32 2
...
bb33:                                             ; preds = %bb17
  %252 = icmp slt i32 %51, %48, !dbg !199
  br i1 %252, label %bb34, label %bb35, !dbg !199

bb34:                                             ; preds = %bb33
  %253 = getelementptr inbounds [20 x i32]* %arg, i32 0, i32 %51, !dbg !200
  %254 = load i32* %253, align 4, !dbg !200
  %255 = add i32 %index.4, 2, !dbg !201
  br label %bb35, !dbg !201

bb35:                                             ; preds = %bb34, %bb33
  %index.3 = phi i32 [ %255, %bb34 ], [ %51, %bb33 ]
  %prio.2 = phi i32 [ %254, %bb34 ], [ %prio.3, %bb33 ]
  %prio.2.off = add i32 %prio.2, -1
  %256 = icmp ugt i32 %prio.2.off, 2
  br i1 %256, label %bb37, label %bb38, !dbg !202

bb37:                                             ; preds = %bb35
  %257 = load %struct._IO_FILE** @stdout, align 4, !dbg !203
  %258 = bitcast %struct._IO_FILE* %257 to i8*, !dbg !203
  %259 = call i32 @fwrite(i8* getelementptr inbounds ([21 x i8]* @.str4, i32 0, i32 0), i32 1, i32 20, i8* %258) nounwind, !dbg !203
  br label %return, !dbg !203

bb38:                                             ; preds = %bb35
  %260 = load i32* @alloc_proc_num, align 4
  %261 = add nsw i32 %260, 1
  store i32 %261, i32* @alloc_proc_num, align 4
  %262 = call noalias i8* @malloc(i32 16) nounwind
  ...
  %269 = trunc i32 %prio.2 to i16
  %270 = getelementptr inbounds i8* %262, i32 12
  %271 = bitcast i8* %270 to i16*
  store i16 %269, i16* %271, align 4
  %272 = load i32* @num_processes, align 4
  %273 = add nsw i32 %272, 1
  store i32 %273, i32* @num_processes, align 4
  %274 = getelementptr inbounds [4 x %struct.List*]* @prio_queue, i32 0, i32 %prio.2
  %275 = load %struct.List** %274, align 4
  %276 = icmp eq %struct.List* %275, null
  br i1 %276, label %bb.i.i96, label %bb1.i.i98

bb.i.i96:                                         ; preds = %bb38
  %277 = call noalias i8* @malloc(i32 12) nounwind
  %278 = bitcast i8* %277 to %struct.List*
  %279 = bitcast i8* %277 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %279, align 4
  %280 = getelementptr inbounds i8* %277, i32 4
  %281 = bitcast i8* %280 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %281, align 4
  %282 = getelementptr inbounds i8* %277, i32 8
  %283 = bitcast i8* %282 to i32*
  store i32 0, i32* %283, align 4
  br label %bb1.i.i98

bb1.i.i98:                                        ; preds = %bb.i.i96, %bb38
  %a_list_addr.0.i.i97 = phi %struct.List* [ %278, %bb.i.i96 ], [ %275, %bb38 ]
  %284 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i97, i32 0, i32 1
  %285 = load %struct.Ele** %284, align 4
  store %struct.Ele* %285, %struct.Ele** %266, align 4
  %286 = load %struct.Ele** %284, align 4
  %287 = icmp eq %struct.Ele* %286, null
  br i1 %287, label %bb3.i.i100, label %bb2.i.i99

bb2.i.i99:                                        ; preds = %bb1.i.i98
  %288 = load %struct.Ele** %284, align 4
  %289 = getelementptr inbounds %struct.Ele* %288, i32 0, i32 0
  store %struct.Ele* %263, %struct.Ele** %289, align 4
  br label %add_process.exit

bb3.i.i100:                                       ; preds = %bb1.i.i98
  %290 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i97, i32 0, i32 0
  store %struct.Ele* %263, %struct.Ele** %290, align 4
  br label %add_process.exit

add_process.exit:                                 ; preds = %bb2.i.i99, %bb3.i.i100
  store %struct.Ele* %263, %struct.Ele** %284, align 4
  store %struct.Ele* null, %struct.Ele** %264, align 4
  %291 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i97, i32 0, i32 2
  %292 = load i32* %291, align 4
  %293 = add nsw i32 %292, 1
  store i32 %293, i32* %291, align 4
  store %struct.List* %a_list_addr.0.i.i97, %struct.List** %274, align 4
  br label %bb41, !dbg !204

bb39:                                             ; preds = %bb17
  %294 = load i32* @num_processes, align 4, !dbg !205
  %295 = icmp sgt i32 %294, 0, !dbg !208
  br i1 %295, label %bb.i, label %bb41, !dbg !208

bb.i:                                             ; preds = %bb39, %finish_process.exit.i
  %length.0 = phi i32 [ %length.1, %finish_process.exit.i ], [ %length.2, %bb39 ]
  %i.01.i = phi i32 [ %307, %finish_process.exit.i ], [ 0, %bb39 ]
  call fastcc void @schedule() nounwind
  %296 = load %struct.Ele** @cur_proc, align 4, !dbg !209
  %297 = icmp eq %struct.Ele* %296, null, !dbg !209
  br i1 %297, label %finish_process.exit.i, label %bb.i.i, !dbg !209

bb.i.i:                                           ; preds = %bb.i
  %298 = load %struct.Ele** @cur_proc, align 4, !dbg !211
  %299 = getelementptr inbounds %struct.Ele* %298, i32 0, i32 2, !dbg !211
  %300 = load i32* %299, align 4, !dbg !211
  %301 = getelementptr inbounds [10 x i32]* %result, i32 0, i32 %length.0, !dbg !211
  store i32 %300, i32* %301, align 4, !dbg !211
  %302 = add nsw i32 %length.0, 1, !dbg !212
  %303 = load %struct.Ele** @cur_proc, align 4, !dbg !213
  %304 = call i32 (...)* @free(%struct.Ele* %303) nounwind
  %305 = load i32* @num_processes, align 4, !dbg !214
  %306 = add nsw i32 %305, -1, !dbg !214
  store i32 %306, i32* @num_processes, align 4, !dbg !214
  br label %finish_process.exit.i, !dbg !214

finish_process.exit.i:                            ; preds = %bb.i.i, %bb.i
  %length.1 = phi i32 [ %length.0, %bb.i ], [ %302, %bb.i.i ]
  %307 = add nsw i32 %i.01.i, 1, !dbg !208
  %exitcond = icmp eq i32 %307, %294
...
bb41:                                             ; preds = %finish_process.exit.i, %append_ele.exit.i95, %find_nth.exit.i82, %bb2.i70, %bb.i69, %bb32, %append_ele.exit.i67, %find_nth.exit.i, %bb24, %bb39, %append_ele.exit.i13, %bb21, %append_ele.exit.i,
  ...
  %308 = icmp slt i32 %index.4, %48, !dbg !215
  br i1 %308, label %bb17, label %bb42, !dbg !215

bb42:                                             ; preds = %bb41
  %result43 = getelementptr inbounds [10 x i32]* %result, i32 0, i32 0, !dbg !216
  %309 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([7 x i8]* @.str5, i32 0, i32 0), i32* %result43) nounwind, !dbg !216
...
!1 = metadata !{i32 589865, metadata !"v8-s.c", metadata !"/home/mingyue/experiments/ceti/schedule/SP-sh/mutants/MR3/v8/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v8-s.c", metadata !"/home/mingyue/experiments/ceti/schedule/SP-sh/mutants/MR3/v8/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
