...
bb8.i.i52:                                        ; preds = %bb7.i.i51, %bb6.i.i50
  ...
  %221 = icmp eq %struct.List* %186, null
  br i1 %221, label %bb.i.i53, label %bb1.i1.i55

bb.i.i53:                                         ; preds = %bb8.i.i52
  %222 = call noalias i8* @malloc(i32 12) nounwind
  %223 = bitcast i8* %222 to %struct.List*
  %224 = bitcast i8* %222 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %224, align 4
  %225 = getelementptr inbounds i8* %222, i32 4
  %226 = bitcast i8* %225 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %226, align 4
  %227 = getelementptr inbounds i8* %222, i32 8
  %228 = bitcast i8* %227 to i32*
  store i32 0, i32* %228, align 4
  br label %bb1.i1.i55

bb1.i1.i55:                                       ; preds = %bb.i.i53, %bb8.i.i52
  %a_list_addr.0.i.i54 = phi %struct.List* [ %223, %bb.i.i53 ], [ %186, %bb8.i.i52 ]
  %229 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i54, i32 0, i32 1
  %230 = load %struct.Ele** %229, align 4
  store %struct.Ele* %230, %struct.Ele** %212, align 4
  %231 = load %struct.Ele** %229, align 4
  %232 = icmp eq %struct.Ele* %231, null
  br i1 %232, label %bb3.i.i57, label %bb2.i2.i56

bb2.i2.i56:                                       ; preds = %bb1.i1.i55
  %233 = load %struct.Ele** %229, align 4
  %234 = getelementptr inbounds %struct.Ele* %233, i32 0, i32 0
  store %struct.Ele* %.0.i.i44, %struct.Ele** %234, align 4
  br label %append_ele.exit.i58

bb3.i.i57:                                        ; preds = %bb1.i1.i55
  %235 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i54, i32 0, i32 0
...
append_ele.exit.i58:                              ; preds = %bb3.i.i57, %bb2.i2.i56
  ...
  %236 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i54, i32 0, i32 2
...
bb26:                                             ; preds = %bb10
  %239 = icmp slt i32 %38, 7, !dbg !191
  br i1 %239, label %bb27, label %bb28, !dbg !191

bb27:                                             ; preds = %bb26
  %240 = getelementptr inbounds [10 x i32]* %arg, i32 0, i32 %38, !dbg !192
  %241 = load i32* %240, align 4, !dbg !192
  %242 = add i32 %index.4, 2, !dbg !193
  br label %bb28, !dbg !193

bb28:                                             ; preds = %bb27, %bb26
  %prio.2 = phi i32 [ %241, %bb27 ], [ %prio.3, %bb26 ]
  %index.3 = phi i32 [ %242, %bb27 ], [ %38, %bb26 ]
  %prio.2.off = add i32 %prio.2, -1
  %243 = icmp ugt i32 %prio.2.off, 2
  br i1 %243, label %bb30, label %bb31, !dbg !194

bb30:                                             ; preds = %bb28
  %244 = load %struct._IO_FILE** @stdout, align 4, !dbg !195
  %245 = bitcast %struct._IO_FILE* %244 to i8*, !dbg !195
  %246 = call i32 @fwrite(i8* getelementptr inbounds ([21 x i8]* @.str4, i32 0, i32 0), i32 1, i32 20, i8* %245) nounwind, !dbg !195
  br label %return, !dbg !195

bb31:                                             ; preds = %bb28
  %247 = load i32* @alloc_proc_num, align 4
  %248 = add nsw i32 %247, 1
  store i32 %248, i32* @alloc_proc_num, align 4
  %249 = call noalias i8* @malloc(i32 16) nounwind
  %250 = bitcast i8* %249 to %struct.Ele*
  %251 = bitcast i8* %249 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %251, align 4
  %252 = getelementptr inbounds i8* %249, i32 4
  %253 = bitcast i8* %252 to %struct.Ele**
  store %struct.Ele* null, %struct.Ele** %253, align 4
  %254 = getelementptr inbounds i8* %249, i32 8
  %255 = bitcast i8* %254 to i32*
  store i32 %247, i32* %255, align 4
  %256 = trunc i32 %prio.2 to i16
  %257 = getelementptr inbounds i8* %249, i32 12
  %258 = bitcast i8* %257 to i16*
  store i16 %256, i16* %258, align 4
  %259 = load i32* @num_processes, align 4
  %260 = add nsw i32 %259, 1
  store i32 %260, i32* @num_processes, align 4
  %261 = getelementptr inbounds [4 x %struct.List*]* @prio_queue, i32 0, i32 %prio.2
  %262 = load %struct.List** %261, align 4
  %263 = icmp eq %struct.List* %262, null
  br i1 %263, label %bb.i.i59, label %bb1.i.i61

bb.i.i59:                                         ; preds = %bb31
  %264 = call noalias i8* @malloc(i32 12) nounwind
  %265 = bitcast i8* %264 to %struct.List*
...
bb1.i.i61:                                        ; preds = %bb.i.i59, %bb31
  %a_list_addr.0.i.i60 = phi %struct.List* [ %265, %bb.i.i59 ], [ %262, %bb31 ]
  %271 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i60, i32 0, i32 1
  %272 = load %struct.Ele** %271, align 4
  store %struct.Ele* %272, %struct.Ele** %253, align 4
  %273 = load %struct.Ele** %271, align 4
  %274 = icmp eq %struct.Ele* %273, null
  br i1 %274, label %bb3.i.i63, label %bb2.i.i62

bb2.i.i62:                                        ; preds = %bb1.i.i61
  %275 = load %struct.Ele** %271, align 4
  %276 = getelementptr inbounds %struct.Ele* %275, i32 0, i32 0
  store %struct.Ele* %250, %struct.Ele** %276, align 4
  br label %add_process.exit

bb3.i.i63:                                        ; preds = %bb1.i.i61
  %277 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i60, i32 0, i32 0
  store %struct.Ele* %250, %struct.Ele** %277, align 4
  br label %add_process.exit

add_process.exit:                                 ; preds = %bb2.i.i62, %bb3.i.i63
  store %struct.Ele* %250, %struct.Ele** %271, align 4
  store %struct.Ele* null, %struct.Ele** %251, align 4
  %278 = getelementptr inbounds %struct.List* %a_list_addr.0.i.i60, i32 0, i32 2
  %279 = load i32* %278, align 4
  %280 = add nsw i32 %279, 1
  store i32 %280, i32* %278, align 4
  store %struct.List* %a_list_addr.0.i.i60, %struct.List** %261, align 4
  br label %bb34, !dbg !196

bb32:                                             ; preds = %bb10
  %281 = load i32* @num_processes, align 4, !dbg !197
  %282 = icmp sgt i32 %281, 0, !dbg !200
  br i1 %282, label %bb.i, label %bb34, !dbg !200

bb.i:                                             ; preds = %bb32, %finish_process.exit.i
  %length.0 = phi i32 [ %length.1, %finish_process.exit.i ], [ %length.2, %bb32 ]
  %i.01.i = phi i32 [ %294, %finish_process.exit.i ], [ 0, %bb32 ]
  call fastcc void @schedule() nounwind
  %283 = load %struct.Ele** @cur_proc, align 4, !dbg !201
  %284 = icmp eq %struct.Ele* %283, null, !dbg !201
  br i1 %284, label %finish_process.exit.i, label %bb.i.i, !dbg !201

bb.i.i:                                           ; preds = %bb.i
  %285 = load %struct.Ele** @cur_proc, align 4, !dbg !203
  %286 = getelementptr inbounds %struct.Ele* %285, i32 0, i32 2, !dbg !203
  %287 = load i32* %286, align 4, !dbg !203
  %288 = getelementptr inbounds [10 x i32]* %result, i32 0, i32 %length.0, !dbg !203
  store i32 %287, i32* %288, align 4, !dbg !203
  %289 = add nsw i32 %length.0, 1, !dbg !204
  %290 = load %struct.Ele** @cur_proc, align 4, !dbg !205
  %291 = call i32 (...)* @free(%struct.Ele* %290) nounwind
  %292 = load i32* @num_processes, align 4, !dbg !206
  %293 = add nsw i32 %292, -1, !dbg !206
  store i32 %293, i32* @num_processes, align 4, !dbg !206
  br label %finish_process.exit.i, !dbg !206

finish_process.exit.i:                            ; preds = %bb.i.i, %bb.i
  %length.1 = phi i32 [ %length.0, %bb.i ], [ %289, %bb.i.i ]
  %294 = add nsw i32 %i.01.i, 1, !dbg !200
  %exitcond = icmp eq i32 %294, %281
...
bb34:                                             ; preds = %finish_process.exit.i, %append_ele.exit.i58, %find_nth.exit.i45, %bb2.i33, %bb.i32, %bb25, %append_ele.exit.i30, %find_nth.exit.i, %bb17, %bb32, %append_ele.exit.i13, %bb14, %append_ele.exit.i,
  ...
  %295 = icmp slt i32 %index.4, 7, !dbg !207
  br i1 %295, label %bb10, label %bb35, !dbg !207

bb35:                                             ; preds = %bb34
  %result36 = getelementptr inbounds [10 x i32]* %result, i32 0, i32 0, !dbg !208
  %296 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([7 x i8]* @.str5, i32 0, i32 0), i32* %result36) nounwind, !dbg !208
...
!1 = metadata !{i32 589865, metadata !"v8-f.c", metadata !"/home/mingyue/experiments/ceti/schedule/SP-sh/mutants/MR4/v8/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v8-f.c", metadata !"/home/mingyue/experiments/ceti/schedule/SP-sh/mutants/MR4/v8/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
