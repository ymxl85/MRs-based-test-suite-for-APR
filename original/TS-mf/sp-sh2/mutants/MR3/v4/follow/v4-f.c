...
char *mainQ(char *argv,char *r) /* n3, n2, n1 : # of processes at prio3 ... */
{
    int command, prio;
    float ratio;
...
main()
{
     ...
     klee_assume(argv1[0]>='0' & argv1[0]<='3'); //a3
     klee_assume(argv1[1]==' ');
     klee_assume(argv1[2]=='2'); //a2
     klee_assume(argv1[3]==' ');
     klee_assume(argv1[4]>='0' & argv1[4]<='2'); //a1
     klee_assume(argv1[5]=='\n');
     klee_assume(argv1[6]=='1');
     klee_assume(argv1[7]==' ');
     klee_assume(argv1[8]=='2');
     klee_assume(argv1[9]=='\n');
     
     i=10;
     x=argv1[0]-'0';  
     for(j=0;j<x;j++) //finish Q3
     {
      klee_assume(argv1[i]=='6');i++;
      klee_assume(argv1[i]=='\n');i++;
     }
     x=argv1[2]-'0';
     for(j=0;j<=x;j++)// block Q2
     {
      klee_assume(argv1[i]=='3');i++;
      klee_assume(argv1[i]=='\n');i++;
     }
      klee_assume(argv1[i]=='4');i++;
      klee_assume(argv1[i]==' ');i++;
      klee_assume(argv1[i]=='1');i++; 
      klee_assume(argv1[i]=='0');i++; 
      //unblock the last one in the blocked queue, that is, the new job
      klee_assume(argv1[i]=='\n');i++;
     for(j=0;j<x;j++)// unblock Q2
     {
      klee_assume(argv1[i]=='4');i++;
      klee_assume(argv1[i]==' ');i++;
      klee_assume(argv1[i]=='0');i++;
      ...
      klee_assume(argv1[i]=='7');i++;
      klee_assume(argv1[i]=='\n');i++;
      klee_assume(argv1[i]=='\0');
    
    //------------------------------------------------------------------------
     char argv2[100];
     klee_make_symbolic(&argv2,sizeof(argv2),"argv2");
     klee_assume(argv2[0]=argv1[0]);
     klee_assume(argv2[1]=argv1[1]);
     klee_assume(argv2[2]=argv1[2]);
     klee_assume(argv2[3]=argv1[3]);
     klee_assume(argv2[4]=argv1[4]);
     klee_assume(argv2[5]=argv1[5]);
     klee_assume(argv2[6]=='1');
     klee_assume(argv2[7]==' ');
     klee_assume(argv2[8]=='1');
     klee_assume(argv2[9]=='\n');
     klee_assume(argv2[10]=='2');
     klee_assume(argv2[11]==' ');
     klee_assume(argv2[12]=='1');
     klee_assume(argv2[13]==' ');
     klee_assume(argv2[14]=='1');
     klee_assume(argv2[15]=='0');
     klee_assume(argv2[16]=='\n');
     klee_assume(argv2[17]=='2');
     klee_assume(argv2[18]==' ');
     klee_assume(argv2[19]=='2');
     klee_assume(argv2[20]==' ');
     klee_assume(argv2[21]=='1');
     klee_assume(argv2[22]=='0');
     klee_assume(argv2[23]=='\n');
     klee_assume(argv2[24]=='7');
     klee_assume(argv2[25]=='\n');
     klee_assume(argv2[26]=='\0');
////////////////////////////////////////////////////////////////////////////
     mainQ(argv2,rr);
