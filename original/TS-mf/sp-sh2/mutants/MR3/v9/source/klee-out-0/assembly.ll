...
entry:
  %0 = icmp eq i64 %z, 0, !dbg !3455
  br i1 %0, label %bb, label %return, !dbg !3455
...
entry:
  %0 = icmp eq i32 %count, 0, !dbg !3459
  br i1 %0, label %bb2, label %bb.lr.ph, !dbg !3459

bb.lr.ph:                                         ; preds = %entry
  %1 = trunc i32 %s to i8, !dbg !3460
  br label %bb

bb:                                               ; preds = %bb, %bb.lr.ph
  %indvar = phi i32 [ 0, %bb.lr.ph ], [ %indvar.next, %bb ]
  %a.05 = getelementptr i8* %dst, i32 %indvar
  volatile store i8 %1, i8* %a.05, align 1, !dbg !3460
  %indvar.next = add i32 %indvar, 1
  %exitcond1 = icmp eq i32 %indvar.next, %count
  br i1 %exitcond1, label %bb2, label %bb, !dbg !3459
...
!1 = metadata !{i32 589865, metadata !"v9-s.c", metadata !"/home/mingyue/experiments/ceti/schedule2/sp-SH/mutants/MR3/v9/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v9-s.c", metadata !"/home/mingyue/experiments/ceti/schedule2/sp-SH/mutants/MR3/v9/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} 
...
!7 = metadata !{i32 589865, metadata !"schedule2.h", metadata !"/home/mingyue/experiments/ceti/schedule2/sp-SH/mutants/MR3/v9/source/", metadata !2} ; [ DW_TAG_file_type ]
...
!3455 = metadata !{i32 13, i32 0, metadata !3456, null}
!3456 = metadata !{i32 589835, metadata !2371, i32 12, i32 0, metadata !2372, i32 0} ; [ DW_TAG_lexical_block ]
!3457 = metadata !{i32 14, i32 0, metadata !3456, null}
!3458 = metadata !{i32 15, i32 0, metadata !3456, null}
!3459 = metadata !{i32 14, i32 0, metadata !2412, null}
!3460 = metadata !{i32 15, i32 0, metadata !2412, null}
!3461 = metadata !{i32 16, i32 0, metadata !2412, null}
