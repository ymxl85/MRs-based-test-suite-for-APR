...
klee --optimize --allow-external-sym-calls --only-output-states-covering-new --libc=uclibc $v-s.o > out.log
...
klee --optimize --allow-external-sym-calls  --only-output-states-covering-new --libc=uclibc $v-f.o > out.log
