...
bb6.i.i:                                          ; preds = %bb12.i
  %83 = icmp slt i32 %64, %62
  %84 = icmp sgt i32 %60, 299, !dbg !126
  %or.cond.i.i = and i1 %83, %84
  br i1 %or.cond.i.i, label %bb13.i, label %bb8.i.i, !dbg !126
...
bb13.i:                                           ; preds = %bb6.i.i
  %.old.old.pre.i = icmp slt i32 %62, %64, !dbg !130
  br i1 %.old.old.pre.i, label %bb6.i16.i, label %bb15.i, !dbg !119
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %80, label %bb.i8.i, label %bb16.i.bb6.i16.i_crit_edge, !dbg !132

bb16.i.bb6.i16.i_crit_edge:                       ; preds = %bb16.i
  %.pre = icmp slt i32 %64, %62
  br i1 %.pre, label %bb8.i17.i, label %bb23.i, !dbg !135

bb.i8.i:                                          ; preds = %bb16.i
  %86 = icmp sge i32 %62, %64, !dbg !136
  %87 = icmp slt i32 %60, 300, !dbg !136
...
ALIM.exit6.i14.i:                                 ; preds = %bb5.i4.i12.i, %bb4.i3.i11.i, %bb2.i2.i10.i, %bb2.i9.i
  ...
  %88 = icmp sle i32 %.0.i5.i13.i, %67, !dbg !136
  %89 = icmp slt i32 %64, %62, !dbg !140
  %or.cond34.i = and i1 %88, %89
  br i1 %or.cond34.i, label %bb20.i, label %bb23.i, !dbg !136

bb6.i16.i:                                        ; preds = %bb13.i
  br i1 %83, label %bb8.i17.i, label %alt_sep_test.exit, !dbg !135

bb8.i17.i:                                        ; preds = %bb16.i.bb6.i16.i_crit_edge, %bb6.i16.i
  %iftmp.7.0.i1013 = phi i32 [ %iftmp.7.0.i, %bb16.i.bb6.i16.i_crit_edge ], [ 1, %bb6.i16.i ]
...
ALIM.exit.i22.i:                                  ; preds = %bb5.i.i20.i, %bb4.i.i19.i, %bb2.i.i18.i, %bb8.i17.i
  ...
  %90 = icmp sgt i32 %.0.i.i21.i, %66, !dbg !135
  br i1 %90, label %bb23.i, label %bb20.i, !dbg !135

bb20.i:                                           ; preds = %ALIM.exit.i22.i, %ALIM.exit6.i14.i
  %iftmp.7.0.i9 = phi i32 [ %iftmp.7.0.i1013, %ALIM.exit.i22.i ], [ %iftmp.7.0.i, %ALIM.exit6.i14.i ]
  %91 = icmp eq i32 %iftmp.7.0.i9, 0, !dbg !145
...
bb23.i:                                           ; preds = %bb16.i.bb6.i16.i_crit_edge, %ALIM.exit.i22.i, %ALIM.exit6.i14.i, %bb.i8.i
  %iftmp.7.0.i11 = phi i32 [ %iftmp.7.0.i1013, %ALIM.exit.i22.i ], [ %iftmp.7.0.i, %ALIM.exit6.i14.i ], [ %iftmp.7.0.i, %bb.i8.i ], [ %iftmp.7.0.i, %bb16.i.bb6.i16.i_crit_edge ]
  %92 = icmp eq i32 %iftmp.7.0.i11, 0, !dbg !146
  br i1 %92, label %bb25.i, label %alt_sep_test.exit, !dbg !146

bb25.i:                                           ; preds = %bb20.i, %bb23.i
  %iftmp.8.030.i12 = phi i32 [ 0, %bb23.i ], [ 2, %bb20.i ]
  br label %alt_sep_test.exit, !dbg !147

alt_sep_test.exit:                                ; preds = %bb6.i16.i, %entry, %bb9.i, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %entry ], [ 0, %bb9.i ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.8.030.i12, %bb25.i ], [ 1, %bb6.i16.i ]
...
!1 = metadata !{i32 589865, metadata !"v4-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v4/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v4-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v4/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [
...
!135 = metadata !{i32 211, i32 0, metadata !133, metadata !134}
...
!142 = metadata !{i32 34, i32 0, metadata !123, metadata !135}
!143 = metadata !{i32 35, i32 0, metadata !123, metadata !135}
!144 = metadata !{i32 36, i32 0, metadata !123, metadata !135}
