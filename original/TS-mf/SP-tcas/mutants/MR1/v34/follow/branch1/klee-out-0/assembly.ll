...
bb13:                                             ; preds = %bb12, %bb
  ...
  %60 = icmp ne i32 %Two_of_Three_Reports_Valid.0, 0, !dbg !119
  %61 = icmp eq i32 %43, 0, !dbg !119
  %.demorgan.i = and i1 %60, %61
  %or.cond1.not.i = xor i1 %or.cond1.i, true
  %brmerge.not.i = and i1 %46, %or.cond1.not.i
  %or.cond3.not.i = and i1 %.demorgan.i, %brmerge.not.i
  %.not4.i = xor i1 %46, true
  %brmerge5.i = or i1 %or.cond3.not.i, %.not4.i
  br i1 %brmerge5.i, label %bb12.i, label %alt_sep_test.exit, !dbg !120
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %or.cond33.i = and i1 %69, %.old.i
  br i1 %or.cond33.i, label %bb16.i, label %bb15.i, !dbg !132
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %64, label %bb.i9.i, label %bb6.i17.i, !dbg !138

bb.i9.i:                                          ; preds = %bb16.i
  %70 = icmp sge i32 %38, %39, !dbg !141
  %71 = icmp slt i32 %Cur_Vertical_Sep.0, 300, !dbg !141
  %or.cond.i8.i = or i1 %71, %70
  br i1 %or.cond.i8.i, label %bb23.i, label %bb2.i10.i, !dbg !141

bb2.i10.i:                                        ; preds = %bb.i9.i
  switch i32 %40, label %bb5.i4.i13.i [
    i32 0, label %ALIM.exit6.i15.i
    i32 1, label %bb2.i2.i11.i
    i32 2, label %bb4.i3.i12.i
  ]

bb2.i2.i11.i:                                     ; preds = %bb2.i10.i
  br label %ALIM.exit6.i15.i, !dbg !142

bb4.i3.i12.i:                                     ; preds = %bb2.i10.i
  br label %ALIM.exit6.i15.i, !dbg !143

bb5.i4.i13.i:                                     ; preds = %bb2.i10.i
  br label %ALIM.exit6.i15.i, !dbg !144

ALIM.exit6.i15.i:                                 ; preds = %bb5.i4.i13.i, %bb4.i3.i12.i, %bb2.i2.i11.i, %bb2.i10.i
  %.0.i5.i14.i = phi i32 [ 500, %bb2.i2.i11.i ], [ 640, %bb4.i3.i12.i ], [ 740, %bb5.i4.i13.i ], [ 400, %bb2.i10.i ]
  %72 = icmp sle i32 %.0.i5.i14.i, %42, !dbg !141
  %73 = icmp slt i32 %39, %38, !dbg !145
  %or.cond35.i = and i1 %72, %73
  br i1 %or.cond35.i, label %bb20.i, label %bb23.i, !dbg !141

bb6.i17.i:                                        ; preds = %bb16.i
  %74 = icmp slt i32 %39, %38
  br i1 %74, label %bb8.i18.i, label %bb23.i, !dbg !147

bb8.i18.i:                                        ; preds = %bb6.i17.i
  switch i32 %40, label %bb5.i.i21.i [
    i32 0, label %ALIM.exit.i23.i
    i32 1, label %bb2.i.i19.i
    i32 2, label %bb4.i.i20.i
  ]

bb2.i.i19.i:                                      ; preds = %bb8.i18.i
  br label %ALIM.exit.i23.i, !dbg !148

bb4.i.i20.i:                                      ; preds = %bb8.i18.i
  br label %ALIM.exit.i23.i, !dbg !149

bb5.i.i21.i:                                      ; preds = %bb8.i18.i
  br label %ALIM.exit.i23.i, !dbg !150

ALIM.exit.i23.i:                                  ; preds = %bb5.i.i21.i, %bb4.i.i20.i, %bb2.i.i19.i, %bb8.i18.i
  %.0.i.i22.i = phi i32 [ 500, %bb2.i.i19.i ], [ 640, %bb4.i.i20.i ], [ 740, %bb5.i.i21.i ], [ 400, %bb8.i18.i ]
  %75 = icmp sgt i32 %.0.i.i22.i, %41, !dbg !147
  br i1 %75, label %bb23.i, label %bb20.i, !dbg !147

bb20.i:                                           ; preds = %ALIM.exit.i23.i, %ALIM.exit6.i15.i
  %76 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !151
  br i1 %76, label %bb25.i, label %alt_sep_test.exit, !dbg !151

bb23.i:                                           ; preds = %ALIM.exit.i23.i, %bb6.i17.i, %ALIM.exit6.i15.i, %bb.i9.i
  %77 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !152
  br i1 %77, label %bb25.i, label %alt_sep_test.exit, !dbg !152

bb25.i:                                           ; preds = %bb20.i, %bb23.i
  %iftmp.8.031.i2 = phi i32 [ 0, %bb23.i ], [ 2, %bb20.i ]
  br label %alt_sep_test.exit, !dbg !153

alt_sep_test.exit:                                ; preds = %bb13, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %bb13 ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.8.031.i2, %bb25.i ]
  %78 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i32 %alt_sep.0.i) nounwind, !dbg !154
...
!1 = metadata !{i32 589865, metadata !"v34-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v34/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v34-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v34/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!61 = metadata !{i32 590081, metadata !25, metadata !"src", metadata !26, i32 12, metadata !30, i32 0} ; [ DW_TAG_arg_variable ]
!62 = metadata !{i32 590081, metadata !25, metadata !"count", metadata !26, i32 12, metadata !31, i32 0} ; [ DW_TAG_arg_variable ]
...
!67 = metadata !{i32 590080, metadata !64, metadata !"b", metadata !26, i32 14, metadata !68, i32 0} ; [ DW_TAG_auto_variable ]
...
!79 = metadata !{i32 416, i32 0, metadata !80, null}
!80 = metadata !{i32 589835, metadata !13, i32 402, i32 0, metadata !1, i32 8} ; [ DW_TAG_lexical_block ]
!81 = metadata !{i32 417, i32 0, metadata !80, null}
!82 = metadata !{i32 418, i32 0, metadata !80, null}
!83 = metadata !{i32 419, i32 0, metadata !80, null}
!84 = metadata !{i32 420, i32 0, metadata !80, null}
!85 = metadata !{i32 421, i32 0, metadata !80, null}
!86 = metadata !{i32 422, i32 0, metadata !80, null}
!87 = metadata !{i32 423, i32 0, metadata !80, null}
!88 = metadata !{i32 424, i32 0, metadata !80, null}
!89 = metadata !{i32 425, i32 0, metadata !80, null}
!90 = metadata !{i32 426, i32 0, metadata !80, null}
!91 = metadata !{i32 427, i32 0, metadata !80, null}
!92 = metadata !{i32 428, i32 0, metadata !80, null}
!93 = metadata !{i32 429, i32 0, metadata !80, null}
!94 = metadata !{i32 430, i32 0, metadata !80, null}
...
!98 = metadata !{i32 440, i32 0, metadata !80, null}
!99 = metadata !{i32 441, i32 0, metadata !80, null}
...
!104 = metadata !{i32 448, i32 0, metadata !80, null}
!105 = metadata !{i32 449, i32 0, metadata !80, null}
!106 = metadata !{i32 450, i32 0, metadata !80, null}
!107 = metadata !{i32 451, i32 0, metadata !80, null}
!108 = metadata !{i32 453, i32 0, metadata !80, null}
!109 = metadata !{i32 443, i32 0, metadata !80, null}
!110 = metadata !{i32 438, i32 0, metadata !80, null}
!111 = metadata !{i32 454, i32 0, metadata !80, null}
!112 = metadata !{i32 457, i32 0, metadata !113, null}
!113 = metadata !{i32 589835, metadata !80, i32 457, i32 0, metadata !1, i32 9} ; [ DW_TAG_lexical_block ]
!114 = metadata !{i32 459, i32 0, metadata !113, null}
!115 = metadata !{i32 461, i32 0, metadata !113, null}
...
!118 = metadata !{i32 475, i32 0, metadata !80, null}
!119 = metadata !{i32 300, i32 0, metadata !117, metadata !118}
!120 = metadata !{i32 306, i32 0, metadata !117, metadata !118}
...
!125 = metadata !{i32 308, i32 0, metadata !117, metadata !118}
...
!140 = metadata !{i32 332, i32 0, metadata !117, metadata !118}
...
!145 = metadata !{i32 278, i32 0, metadata !146, metadata !140}
!146 = metadata !{i32 589835, metadata !10, i32 277, i32 0, metadata !1, i32 5} ; [ DW_TAG_lexical_block ]
!147 = metadata !{i32 211, i32 0, metadata !139, metadata !140}
...
!151 = metadata !{i32 355, i32 0, metadata !117, metadata !118}
!152 = metadata !{i32 360, i32 0, metadata !117, metadata !118}
!153 = metadata !{i32 365, i32 0, metadata !117, metadata !118}
!154 = metadata !{i32 476, i32 0, metadata !80, null}
!155 = metadata !{i32 477, i32 0, metadata !80, null}
!156 = metadata !{i32 13, i32 0, metadata !157, null}
!157 = metadata !{i32 589835, metadata !34, i32 12, i32 0, metadata !35, i32 0} ; [ DW_TAG_lexical_block ]
