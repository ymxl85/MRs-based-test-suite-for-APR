...
entry:
  ...
  %41 = load i32* %argv4, align 4, !dbg !96
  %42 = load i32* %argv7, align 4, !dbg !97
  %43 = load i32* %argv9, align 4, !dbg !98
  %44 = load i32* %argv10, align 4, !dbg !99
  %45 = load i32* %argv11, align 4, !dbg !100
  %46 = icmp eq i32 %37, 0, !dbg !101
  %47 = icmp sgt i32 %40, 600, !dbg !101
  %or.cond.i = or i1 %46, %47
  %48 = icmp slt i32 %36, 601, !dbg !101
  %or.cond1.i = or i1 %or.cond.i, %48
  %49 = icmp eq i32 %45, 1, !dbg !104
  %50 = icmp ne i32 %38, 0, !dbg !105
  %51 = icmp eq i32 %44, 0, !dbg !105
  %.demorgan.i = and i1 %50, %51
  %or.cond1.not.i = xor i1 %or.cond1.i, true
  %brmerge.not.i = and i1 %49, %or.cond1.not.i
  %or.cond3.not.i = and i1 %.demorgan.i, %brmerge.not.i
  %.not4.i = xor i1 %49, true
  %brmerge5.i = or i1 %or.cond3.not.i, %.not4.i
  br i1 %brmerge5.i, label %bb12.i, label %alt_sep_test.exit, !dbg !106

bb12.i:                                           ; preds = %entry
  %52 = load i32* %argv12, align 4, !dbg !107
  %53 = icmp eq i32 %52, 0, !dbg !108
  %54 = add nsw i32 %43, 100, !dbg !108
  %iftmp.0.0.i.i.i = select i1 %53, i32 %43, i32 %54
  %55 = icmp sgt i32 %iftmp.0.0.i.i.i, %43, !dbg !110
  br i1 %55, label %bb.i.i, label %bb6.i.i, !dbg !113

bb.i.i:                                           ; preds = %bb12.i
  %56 = icmp slt i32 %39, %41
  br i1 %56, label %bb2.i.i, label %bb15.i, !dbg !114

bb2.i.i:                                          ; preds = %bb.i.i
  switch i32 %42, label %bb5.i4.i.i [
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %60 = icmp sle i32 %.0.i.i.i, %43, !dbg !119
  %.old.i = icmp slt i32 %39, %41, !dbg !123
  %or.cond33.i = and i1 %60, %.old.i
  br i1 %or.cond33.i, label %bb16.i, label %bb15.i, !dbg !119
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %55, label %bb.i9.i, label %bb6.i17.i, !dbg !125

bb.i9.i:                                          ; preds = %bb16.i
  %61 = icmp sge i32 %39, %41, !dbg !128
  %62 = icmp slt i32 %36, 300, !dbg !128
  %or.cond.i8.i = or i1 %62, %61
  br i1 %or.cond.i8.i, label %bb23.i, label %bb2.i10.i, !dbg !128

bb2.i10.i:                                        ; preds = %bb.i9.i
  switch i32 %42, label %bb5.i4.i13.i [
...
bb2.i2.i11.i:                                     ; preds = %bb2.i10.i
  br label %ALIM.exit6.i15.i, !dbg !129

bb4.i3.i12.i:                                     ; preds = %bb2.i10.i
  br label %ALIM.exit6.i15.i, !dbg !130

bb5.i4.i13.i:                                     ; preds = %bb2.i10.i
  br label %ALIM.exit6.i15.i, !dbg !131
...
ALIM.exit6.i15.i:                                 ; preds = %bb5.i4.i13.i, %bb4.i3.i12.i, %bb2.i2.i11.i, %bb2.i10.i
  ...
  %63 = icmp sle i32 %.0.i5.i14.i, %43, !dbg !128
  %64 = icmp slt i32 %41, %39, !dbg !132
  %or.cond35.i = and i1 %63, %64
  br i1 %or.cond35.i, label %bb20.i, label %bb23.i, !dbg !128

bb6.i17.i:                                        ; preds = %bb16.i
  %65 = icmp slt i32 %41, %39
  br i1 %65, label %bb8.i18.i, label %bb23.i, !dbg !134

bb8.i18.i:                                        ; preds = %bb6.i17.i
  switch i32 %42, label %bb5.i.i21.i [
...
bb2.i.i19.i:                                      ; preds = %bb8.i18.i
  br label %ALIM.exit.i23.i, !dbg !135

bb4.i.i20.i:                                      ; preds = %bb8.i18.i
  br label %ALIM.exit.i23.i, !dbg !136

bb5.i.i21.i:                                      ; preds = %bb8.i18.i
  br label %ALIM.exit.i23.i, !dbg !137
...
ALIM.exit.i23.i:                                  ; preds = %bb5.i.i21.i, %bb4.i.i20.i, %bb2.i.i19.i, %bb8.i18.i
  ...
  %66 = icmp sgt i32 %.0.i.i22.i, %43, !dbg !134
...
alt_sep_test.exit:                                ; preds = %entry, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %entry ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.8.031.i2, %bb25.i ]
...
!1 = metadata !{i32 589865, metadata !"v34-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v34/follow/branch2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v34-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v34/follow/branch2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!103 = metadata !{i32 463, i32 0, metadata !73, null}
!104 = metadata !{i32 299, i32 0, metadata !102, metadata !103}
!105 = metadata !{i32 300, i32 0, metadata !102, metadata !103}
!106 = metadata !{i32 306, i32 0, metadata !102, metadata !103}
!107 = metadata !{i32 448, i32 0, metadata !73, null}
...
!112 = metadata !{i32 308, i32 0, metadata !102, metadata !103}
...
!127 = metadata !{i32 332, i32 0, metadata !102, metadata !103}
...
!138 = metadata !{i32 355, i32 0, metadata !102, metadata !103}
!139 = metadata !{i32 360, i32 0, metadata !102, metadata !103}
!140 = metadata !{i32 365, i32 0, metadata !102, metadata !103}
!141 = metadata !{i32 464, i32 0, metadata !73, null}
!142 = metadata !{i32 465, i32 0, metadata !73, null}
