...
entry:
  ...
  %62 = load i32* %argv3, align 4, !dbg !99
  %63 = load i32* %argv4, align 4, !dbg !100
  %64 = load i32* %argv5, align 4, !dbg !101
  %65 = load i32* %argv6, align 4, !dbg !102
  %66 = load i32* %argv7, align 4, !dbg !103
  %67 = load i32* %argv8, align 4, !dbg !104
  %68 = load i32* %argv9, align 4, !dbg !105
  %69 = load i32* %argv10, align 4, !dbg !106
  %70 = load i32* %argv11, align 4, !dbg !107
  %71 = icmp eq i32 %61, 0, !dbg !108
  %72 = icmp sgt i32 %64, 600, !dbg !108
  %or.cond.i = or i1 %71, %72
  %73 = icmp slt i32 %60, 601, !dbg !108
  %or.cond1.i = or i1 %or.cond.i, %73
  %74 = icmp eq i32 %70, 1, !dbg !111
  %75 = icmp ne i32 %62, 0, !dbg !112
  %76 = icmp eq i32 %69, 0, !dbg !112
  %.demorgan.i = and i1 %75, %76
  %or.cond1.not.i = xor i1 %or.cond1.i, true
  %brmerge.not.i = and i1 %74, %or.cond1.not.i
  %or.cond3.not.i = and i1 %.demorgan.i, %brmerge.not.i
  %.not4.i = xor i1 %74, true
  %brmerge5.i = or i1 %or.cond3.not.i, %.not4.i
  br i1 %brmerge5.i, label %bb12.i, label %alt_sep_test.exit, !dbg !113

bb12.i:                                           ; preds = %entry
  %77 = load i32* %argv12, align 4, !dbg !114
  %78 = icmp eq i32 %77, 0, !dbg !115
  %79 = add nsw i32 %67, 100, !dbg !115
  %iftmp.0.0.i.i.i = select i1 %78, i32 %67, i32 %79
  %80 = icmp sgt i32 %iftmp.0.0.i.i.i, %68, !dbg !117
  br i1 %80, label %bb.i.i, label %bb6.i.i, !dbg !120

bb.i.i:                                           ; preds = %bb12.i
  %81 = icmp slt i32 %63, %65
  br i1 %81, label %bb2.i.i, label %bb15.i, !dbg !121

bb2.i.i:                                          ; preds = %bb.i.i
  switch i32 %66, label %bb5.i4.i.i [
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %85 = icmp sle i32 %.0.i.i.i, %67, !dbg !126
  %.old.i = icmp slt i32 %63, %65, !dbg !130
  %or.cond33.i = and i1 %85, %.old.i
  br i1 %or.cond33.i, label %bb16.i, label %bb15.i, !dbg !126
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %80, label %bb.i9.i, label %bb6.i17.i, !dbg !132

bb.i9.i:                                          ; preds = %bb16.i
  %86 = icmp sge i32 %63, %65, !dbg !135
  %87 = icmp slt i32 %60, 300, !dbg !135
  %or.cond.i8.i = or i1 %87, %86
  br i1 %or.cond.i8.i, label %bb23.i, label %bb2.i10.i, !dbg !135

bb2.i10.i:                                        ; preds = %bb.i9.i
  switch i32 %66, label %bb5.i4.i13.i [
...
bb2.i2.i11.i:                                     ; preds = %bb2.i10.i
  br label %ALIM.exit6.i15.i, !dbg !136

bb4.i3.i12.i:                                     ; preds = %bb2.i10.i
  br label %ALIM.exit6.i15.i, !dbg !137

bb5.i4.i13.i:                                     ; preds = %bb2.i10.i
  br label %ALIM.exit6.i15.i, !dbg !138
...
ALIM.exit6.i15.i:                                 ; preds = %bb5.i4.i13.i, %bb4.i3.i12.i, %bb2.i2.i11.i, %bb2.i10.i
  ...
  %88 = icmp sle i32 %.0.i5.i14.i, %68, !dbg !135
  %89 = icmp slt i32 %65, %63, !dbg !139
  %or.cond35.i = and i1 %88, %89
  br i1 %or.cond35.i, label %bb20.i, label %bb23.i, !dbg !135

bb6.i17.i:                                        ; preds = %bb16.i
  %90 = icmp slt i32 %65, %63
  br i1 %90, label %bb8.i18.i, label %bb23.i, !dbg !141

bb8.i18.i:                                        ; preds = %bb6.i17.i
  switch i32 %66, label %bb5.i.i21.i [
...
bb2.i.i19.i:                                      ; preds = %bb8.i18.i
  br label %ALIM.exit.i23.i, !dbg !142

bb4.i.i20.i:                                      ; preds = %bb8.i18.i
  br label %ALIM.exit.i23.i, !dbg !143

bb5.i.i21.i:                                      ; preds = %bb8.i18.i
  br label %ALIM.exit.i23.i, !dbg !144
...
ALIM.exit.i23.i:                                  ; preds = %bb5.i.i21.i, %bb4.i.i20.i, %bb2.i.i19.i, %bb8.i18.i
  ...
  %91 = icmp sgt i32 %.0.i.i22.i, %67, !dbg !141
...
bb25.i:                                           ; preds = %bb20.i, %bb23.i
  %iftmp.8.031.i9 = phi i32 [ 0, %bb23.i ], [ 2, %bb20.i ]
  br label %alt_sep_test.exit, !dbg !147

alt_sep_test.exit:                                ; preds = %entry, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %entry ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.8.031.i9, %bb25.i ]
...
!1 = metadata !{i32 589865, metadata !"v34-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v34/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v34-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v34/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
...
!104 = metadata !{i32 451, i32 0, metadata !73, null}
!105 = metadata !{i32 452, i32 0, metadata !73, null}
!106 = metadata !{i32 453, i32 0, metadata !73, null}
!107 = metadata !{i32 454, i32 0, metadata !73, null}
!108 = metadata !{i32 298, i32 0, metadata !109, metadata !110}
!109 = metadata !{i32 589835, metadata !11, i32 293, i32 0, metadata !1, i32 6} ; [ DW_TAG_lexical_block ]
!110 = metadata !{i32 468, i32 0, metadata !73, null}
!111 = metadata !{i32 299, i32 0, metadata !109, metadata !110}
!112 = metadata !{i32 300, i32 0, metadata !109, metadata !110}
!113 = metadata !{i32 306, i32 0, metadata !109, metadata !110}
!114 = metadata !{i32 455, i32 0, metadata !73, null}
...
!119 = metadata !{i32 308, i32 0, metadata !109, metadata !110}
...
!134 = metadata !{i32 332, i32 0, metadata !109, metadata !110}
...
!145 = metadata !{i32 355, i32 0, metadata !109, metadata !110}
!146 = metadata !{i32 360, i32 0, metadata !109, metadata !110}
!147 = metadata !{i32 365, i32 0, metadata !109, metadata !110}
!148 = metadata !{i32 469, i32 0, metadata !73, null}
!149 = metadata !{i32 470, i32 0, metadata !73, null}
