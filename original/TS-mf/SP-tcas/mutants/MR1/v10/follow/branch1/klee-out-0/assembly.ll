...
bb.i.i:                                           ; preds = %bb12.i
  %65 = icmp sgt i32 %38, %39
  br i1 %65, label %bb15.i, label %bb2.i.i, !dbg !127
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %.old.i = icmp sgt i32 %38, %39, !dbg !136
  %or.cond32.i = or i1 %69, %.old.i
  br i1 %or.cond32.i, label %bb15.i, label %bb16.i, !dbg !132
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %64, label %bb.i8.i, label %bb6.i16.i, !dbg !138

bb.i8.i:                                          ; preds = %bb16.i
  %70 = icmp sgt i32 %38, %39, !dbg !141
  %71 = icmp slt i32 %Cur_Vertical_Sep.0, 300, !dbg !141
  %or.cond.i7.i = or i1 %71, %70
  br i1 %or.cond.i7.i, label %bb23.i, label %bb2.i9.i, !dbg !141
...
bb2.i2.i10.i:                                     ; preds = %bb2.i9.i
  br label %ALIM.exit6.i14.i, !dbg !142
...
ALIM.exit6.i14.i:                                 ; preds = %bb5.i4.i12.i, %bb4.i3.i11.i, %bb2.i2.i10.i, %bb2.i9.i
  ...
  %72 = icmp sgt i32 %.0.i5.i13.i, %42, !dbg !141
  %73 = icmp sgt i32 %39, %38, !dbg !145
  %or.cond34.i = or i1 %72, %73
  br i1 %or.cond34.i, label %bb23.i, label %bb20.i, !dbg !141

bb6.i16.i:                                        ; preds = %bb16.i
  %74 = icmp sgt i32 %39, %38
  br i1 %74, label %bb23.i, label %bb8.i17.i, !dbg !147
...
ALIM.exit.i22.i:                                  ; preds = %bb5.i.i20.i, %bb4.i.i19.i, %bb2.i.i18.i, %bb8.i17.i
  ...
  %75 = icmp sgt i32 %.0.i.i21.i, %41, !dbg !147
...
alt_sep_test.exit:                                ; preds = %bb13, %bb9.i, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %bb13 ], [ 0, %bb9.i ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.8.030.i2, %bb25.i ]
...
!llvm.dbg.lv.memmove = !{!68, !69, !70, !71, !75}
...
!1 = metadata !{i32 589865, metadata !"v10-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v10/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v10-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v10/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!68 = metadata !{i32 590081, metadata !35, metadata !"dst", metadata !36, i32 12, metadata !40, i32 0} ; [ DW_TAG_arg_variable ]
!69 = metadata !{i32 590081, metadata !35, metadata !"src", metadata !36, i32 12, metadata !40, i32 0} ; [ DW_TAG_arg_variable ]
!70 = metadata !{i32 590081, metadata !35, metadata !"count", metadata !36, i32 12, metadata !41, i32 0} ; [ DW_TAG_arg_variable ]
!71 = metadata !{i32 590080, metadata !72, metadata !"a", metadata !36, i32 13, metadata !73, i32 0} ; [ DW_TAG_auto_variable ]
...
!75 = metadata !{i32 590080, metadata !72, metadata !"b", metadata !36, i32 14, metadata !76, i32 0} ; [ DW_TAG_auto_variable ]
...
!157 = metadata !{i32 589835, metadata !44, i32 12, i32 0, metadata !45, i32 0} ; [ DW_TAG_lexical_block ]
