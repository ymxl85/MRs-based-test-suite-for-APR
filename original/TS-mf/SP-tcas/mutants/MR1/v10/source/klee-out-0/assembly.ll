...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %or.cond32.i = or i1 %85, %.old.i
  br i1 %or.cond32.i, label %bb15.i, label %bb16.i, !dbg !126
...
ALIM.exit6.i14.i:                                 ; preds = %bb5.i4.i12.i, %bb4.i3.i11.i, %bb2.i2.i10.i, %bb2.i9.i
  ...
  %88 = icmp sgt i32 %.0.i5.i13.i, %67, !dbg !135
  %89 = icmp sgt i32 %64, %62, !dbg !139
  %or.cond34.i = or i1 %88, %89
  br i1 %or.cond34.i, label %bb23.i, label %bb20.i, !dbg !135

bb6.i16.i:                                        ; preds = %bb16.i
  %90 = icmp sgt i32 %64, %62
  br i1 %90, label %bb23.i, label %bb8.i17.i, !dbg !141
...
!1 = metadata !{i32 589865, metadata !"v10-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v10/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v10-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v10/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
