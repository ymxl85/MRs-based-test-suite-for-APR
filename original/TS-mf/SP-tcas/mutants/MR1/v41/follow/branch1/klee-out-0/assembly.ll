...
bb2.i.i:                                          ; preds = %bb.i.i
  switch i32 %40, label %bb5.i3.i.i [
...
bb2.i1.i.i:                                       ; preds = %bb2.i.i
  br label %ALIM.exit5.i.i, !dbg !128

bb4.i2.i.i:                                       ; preds = %bb2.i.i
  br label %ALIM.exit5.i.i, !dbg !130

bb5.i3.i.i:                                       ; preds = %bb2.i.i
  br label %ALIM.exit5.i.i, !dbg !131
...
ALIM.exit5.i.i:                                   ; preds = %bb5.i3.i.i, %bb4.i2.i.i, %bb2.i1.i.i, %bb2.i.i
  ...
  %66 = icmp sgt i32 %.0.i4.i.i, %42, !dbg !127
  br i1 %66, label %bb16.i, label %bb15.i, !dbg !127

bb6.i.i:                                          ; preds = %bb12.i
  %67 = icmp slt i32 %Cur_Vertical_Sep.0, 300, !dbg !132
  br i1 %67, label %bb15.i, label %bb7.i.i, !dbg !132
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb7.i.i
  ...
  %68 = icmp sle i32 %.0.i.i.i, %41, !dbg !132
  %.old.i = icmp slt i32 %38, %39, !dbg !136
  %or.cond24.i = and i1 %68, %.old.i
  br i1 %or.cond24.i, label %bb16.i, label %bb15.i, !dbg !132
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit5.i.i
  ...
  br i1 %64, label %bb.i7.i, label %bb6.i10.i, !dbg !138

bb.i7.i:                                          ; preds = %bb16.i
  %69 = icmp sge i32 %38, %39, !dbg !141
  %70 = icmp slt i32 %Cur_Vertical_Sep.0, 300, !dbg !141
  %or.cond.i.i = or i1 %70, %69
  br i1 %or.cond.i.i, label %bb23.i, label %bb2.i8.i, !dbg !141
...
ALIM.exit6.i.i:                                   ; preds = %bb5.i4.i.i, %bb4.i3.i.i, %bb2.i2.i.i, %bb2.i8.i
  ...
  %71 = icmp sle i32 %.0.i5.i.i, %42, !dbg !141
  %72 = icmp slt i32 %39, %38, !dbg !145
  %or.cond26.i = and i1 %71, %72
  br i1 %or.cond26.i, label %bb20.i, label %bb23.i, !dbg !141

bb6.i10.i:                                        ; preds = %bb16.i
  %73 = icmp slt i32 %39, %38
  br i1 %73, label %bb8.i.i, label %bb23.i, !dbg !147

bb8.i.i:                                          ; preds = %bb6.i10.i
  switch i32 %40, label %bb5.i.i13.i [
...
bb2.i.i11.i:                                      ; preds = %bb8.i.i
  br label %ALIM.exit.i15.i, !dbg !148

bb4.i.i12.i:                                      ; preds = %bb8.i.i
  br label %ALIM.exit.i15.i, !dbg !149

bb5.i.i13.i:                                      ; preds = %bb8.i.i
  br label %ALIM.exit.i15.i, !dbg !150
...
ALIM.exit.i15.i:                                  ; preds = %bb5.i.i13.i, %bb4.i.i12.i, %bb2.i.i11.i, %bb8.i.i
  ...
  %74 = icmp sgt i32 %.0.i.i14.i, %41, !dbg !147
  br i1 %74, label %bb23.i, label %bb20.i, !dbg !147

bb20.i:                                           ; preds = %ALIM.exit.i15.i, %ALIM.exit6.i.i
  %75 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !151
  br i1 %75, label %bb25.i, label %alt_sep_test.exit, !dbg !151

bb23.i:                                           ; preds = %ALIM.exit.i15.i, %bb6.i10.i, %ALIM.exit6.i.i, %bb.i7.i
  %76 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !152
  br i1 %76, label %bb25.i, label %alt_sep_test.exit, !dbg !152

bb25.i:                                           ; preds = %bb20.i, %bb23.i
  %iftmp.8.022.i2 = phi i32 [ 0, %bb23.i ], [ 2, %bb20.i ]
  br label %alt_sep_test.exit, !dbg !153

alt_sep_test.exit:                                ; preds = %bb13, %bb9.i, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %bb13 ], [ 0, %bb9.i ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.8.022.i2, %bb25.i ]
...
!1 = metadata !{i32 589865, metadata !"v41-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v41/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v41-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v41/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!98 = metadata !{i32 428, i32 0, metadata !80, null}
!99 = metadata !{i32 429, i32 0, metadata !80, null}
!100 = metadata !{i32 430, i32 0, metadata !80, null}
!101 = metadata !{i32 433, i32 0, metadata !80, null}
!102 = metadata !{i32 434, i32 0, metadata !80, null}
!103 = metadata !{i32 435, i32 0, metadata !80, null}
!104 = metadata !{i32 436, i32 0, metadata !80, null}
!105 = metadata !{i32 437, i32 0, metadata !80, null}
!106 = metadata !{i32 438, i32 0, metadata !80, null}
!107 = metadata !{i32 439, i32 0, metadata !80, null}
!108 = metadata !{i32 441, i32 0, metadata !80, null}
!109 = metadata !{i32 431, i32 0, metadata !80, null}
!110 = metadata !{i32 426, i32 0, metadata !80, null}
!111 = metadata !{i32 442, i32 0, metadata !80, null}
!112 = metadata !{i32 445, i32 0, metadata !113, null}
!113 = metadata !{i32 589835, metadata !80, i32 445, i32 0, metadata !1, i32 9} ; [ DW_TAG_lexical_block ]
!114 = metadata !{i32 447, i32 0, metadata !113, null}
!115 = metadata !{i32 449, i32 0, metadata !113, null}
...
!118 = metadata !{i32 463, i32 0, metadata !80, null}
...
!125 = metadata !{i32 296, i32 0, metadata !117, metadata !118}
...
!132 = metadata !{i32 128, i32 0, metadata !124, metadata !125}
...
!136 = metadata !{i32 252, i32 0, metadata !137, metadata !125}
!137 = metadata !{i32 589835, metadata !9, i32 251, i32 0, metadata !1, i32 4} ; [ DW_TAG_lexical_block ]
!138 = metadata !{i32 173, i32 0, metadata !139, metadata !140}
!139 = metadata !{i32 589835, metadata !8, i32 156, i32 0, metadata !1, i32 3} ; [ DW_TAG_lexical_block ]
!140 = metadata !{i32 320, i32 0, metadata !117, metadata !118}
!141 = metadata !{i32 175, i32 0, metadata !139, metadata !140}
...
!145 = metadata !{i32 268, i32 0, metadata !146, metadata !140}
!146 = metadata !{i32 589835, metadata !10, i32 267, i32 0, metadata !1, i32 5} ; [ DW_TAG_lexical_block ]
!147 = metadata !{i32 201, i32 0, metadata !139, metadata !140}
...
!152 = metadata !{i32 348, i32 0, metadata !117, metadata !118}
!153 = metadata !{i32 353, i32 0, metadata !117, metadata !118}
!154 = metadata !{i32 464, i32 0, metadata !80, null}
!155 = metadata !{i32 465, i32 0, metadata !80, null}
