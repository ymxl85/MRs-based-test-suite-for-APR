...
entry:
  ...
  %37 = icmp eq i32 %36, 0, !dbg !99
  %38 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i32 0) nounwind, !dbg !102
  call void @exit(i32 0) noreturn nounwind, !dbg !103
  unreachable, !dbg !103
}
...
entry:
  %0 = icmp eq i64 %z, 0, !dbg !104
  br i1 %0, label %bb, label %return, !dbg !104
...
!1 = metadata !{i32 589865, metadata !"v12-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v12/follow/branch3/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v12-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v12/follow/branch3/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!98 = metadata !{i32 439, i32 0, metadata !80, null}
...
!101 = metadata !{i32 463, i32 0, metadata !80, null}
!102 = metadata !{i32 464, i32 0, metadata !80, null}
!103 = metadata !{i32 465, i32 0, metadata !80, null}
!104 = metadata !{i32 13, i32 0, metadata !105, null}
!105 = metadata !{i32 589835, metadata !26, i32 12, i32 0, metadata !27, i32 0} ; [ DW_TAG_lexical_block ]
!106 = metadata !{i32 14, i32 0, metadata !105, null}
!107 = metadata !{i32 15, i32 0, metadata !105, null}
