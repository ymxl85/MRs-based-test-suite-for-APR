...
bb13:                                             ; preds = %bb12, %bb
  ...
  br i1 %57, label %bb.i, label %bb9.i, !dbg !116

bb.i:                                             ; preds = %bb13
  %58 = icmp slt i32 %Own_Tracked_Alt_Rate.0, 601, !dbg !116
  %59 = icmp sgt i32 %Cur_Vertical_Sep.0, 600, !dbg !116
  %or.cond.i = and i1 %58, %59
  br i1 %or.cond.i, label %bb9.i, label %alt_sep_test.exit, !dbg !116

bb9.i:                                            ; preds = %bb.i, %bb13
  ...
  br i1 %brmerge.i, label %bb12.i, label %alt_sep_test.exit, !dbg !120
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %or.cond31.i = and i1 %69, %.old.i
  br i1 %or.cond31.i, label %bb16.i, label %bb15.i, !dbg !132
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %64, label %bb.i7.i, label %bb6.i15.i, !dbg !138

bb.i7.i:                                          ; preds = %bb16.i
  %70 = icmp sge i32 %38, %39, !dbg !141
  %71 = icmp slt i32 %Cur_Vertical_Sep.0, 300, !dbg !141
  %or.cond.i6.i = or i1 %71, %70
  br i1 %or.cond.i6.i, label %bb23.i, label %bb2.i8.i, !dbg !141
...
bb5.i4.i11.i:                                     ; preds = %bb2.i8.i
  br label %ALIM.exit6.i13.i, !dbg !144
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %72 = icmp sle i32 %.0.i5.i12.i, %42, !dbg !141
  %73 = icmp slt i32 %39, %38, !dbg !145
  %or.cond33.i = and i1 %72, %73
  br i1 %or.cond33.i, label %bb20.i, label %bb23.i, !dbg !141

bb6.i15.i:                                        ; preds = %bb16.i
  %74 = icmp slt i32 %39, %38
  br i1 %74, label %bb8.i16.i, label %bb23.i, !dbg !147
...
bb5.i.i19.i:                                      ; preds = %bb8.i16.i
  br label %ALIM.exit.i21.i, !dbg !150
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  %75 = icmp sgt i32 %.0.i.i20.i, %41, !dbg !147
...
!1 = metadata !{i32 589865, metadata !"v12-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v12/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v12-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v12/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!157 = metadata !{i32 589835, metadata !26, i32 12, i32 0, metadata !27, i32 0} ; [ DW_TAG_lexical_block ]
