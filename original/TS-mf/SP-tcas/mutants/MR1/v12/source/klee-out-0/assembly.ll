...
entry:
  ...
  %68 = load i32* %argv10, align 4, !dbg !105
  %69 = load i32* %argv11, align 4, !dbg !106
  %70 = load i32* %argv12, align 4, !dbg !107
  %71 = icmp eq i32 %61, 0, !dbg !108
  br i1 %71, label %bb.i, label %bb9.i, !dbg !108

bb.i:                                             ; preds = %entry
  %72 = load i32* %argv5, align 4, !dbg !111
  %73 = icmp slt i32 %72, 601, !dbg !108
  %74 = icmp sgt i32 %60, 600, !dbg !108
  %or.cond.i = and i1 %73, %74
  br i1 %or.cond.i, label %bb9.i, label %alt_sep_test.exit, !dbg !108

bb9.i:                                            ; preds = %bb.i, %entry
  %75 = icmp eq i32 %69, 1, !dbg !112
  %76 = icmp ne i32 %62, 0, !dbg !113
  %77 = icmp eq i32 %68, 0, !dbg !113
  %.demorgan.i = and i1 %76, %77
  %or.cond2.demorgan.i = and i1 %75, %.demorgan.i
  %.not3.i = xor i1 %75, true
  %brmerge.i = or i1 %or.cond2.demorgan.i, %.not3.i
  br i1 %brmerge.i, label %bb12.i, label %alt_sep_test.exit, !dbg !114

bb12.i:                                           ; preds = %bb9.i
  %78 = icmp eq i32 %70, 0, !dbg !115
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %.old.i = icmp slt i32 %63, %64, !dbg !130
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %80, label %bb.i7.i, label %bb6.i15.i, !dbg !132

bb.i7.i:                                          ; preds = %bb16.i
  %86 = icmp sge i32 %63, %64, !dbg !135
  %87 = icmp slt i32 %60, 300, !dbg !135
  %or.cond.i6.i = or i1 %87, %86
  br i1 %or.cond.i6.i, label %bb23.i, label %bb2.i8.i, !dbg !135
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %88 = icmp sle i32 %.0.i5.i12.i, %67, !dbg !135
  %89 = icmp slt i32 %64, %63, !dbg !139
  %or.cond33.i = and i1 %88, %89
  br i1 %or.cond33.i, label %bb20.i, label %bb23.i, !dbg !135

bb6.i15.i:                                        ; preds = %bb16.i
  %90 = icmp slt i32 %64, %63
  br i1 %90, label %bb8.i16.i, label %bb23.i, !dbg !141
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  %91 = icmp sgt i32 %.0.i.i20.i, %66, !dbg !141
...
alt_sep_test.exit:                                ; preds = %bb.i, %bb9.i, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %bb9.i ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.8.029.i9, %bb25.i ], [ 0, %bb.i ]
...
!1 = metadata !{i32 589865, metadata !"v12-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v12/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v12-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v12/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
...
!107 = metadata !{i32 453, i32 0, metadata !73, null}
...
!110 = metadata !{i32 466, i32 0, metadata !73, null}
!111 = metadata !{i32 446, i32 0, metadata !73, null}
!112 = metadata !{i32 299, i32 0, metadata !109, metadata !110}
!113 = metadata !{i32 300, i32 0, metadata !109, metadata !110}
!114 = metadata !{i32 304, i32 0, metadata !109, metadata !110}
...
!119 = metadata !{i32 306, i32 0, metadata !109, metadata !110}
...
!134 = metadata !{i32 330, i32 0, metadata !109, metadata !110}
...
!145 = metadata !{i32 353, i32 0, metadata !109, metadata !110}
!146 = metadata !{i32 358, i32 0, metadata !109, metadata !110}
!147 = metadata !{i32 363, i32 0, metadata !109, metadata !110}
