...
ALIM.exit6.i14.i:                                 ; preds = %bb5.i4.i12.i, %bb4.i3.i11.i, %bb2.i2.i10.i, %bb2.i9.i
  ...
  %63 = icmp sle i32 %.0.i5.i13.i, %42, !dbg !128
  %64 = icmp slt i32 %40, %38, !dbg !132
  %or.cond34.i = and i1 %63, %64
  br i1 %or.cond34.i, label %bb20.i, label %bb23.i, !dbg !128

bb6.i16.i:                                        ; preds = %bb16.i
  %65 = icmp slt i32 %40, %38
  br i1 %65, label %bb8.i17.i, label %bb23.i, !dbg !134
...
!1 = metadata !{i32 589865, metadata !"v6-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v6/follow/branch2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v6-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v6/follow/branch2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i3
