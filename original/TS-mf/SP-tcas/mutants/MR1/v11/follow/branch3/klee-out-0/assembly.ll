...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %54, label %bb.i7.i, label %bb8.i16.i, !dbg !129

bb.i7.i:                                          ; preds = %bb16.i
  %58 = icmp slt i32 %36, 300, !dbg !132
  br i1 %58, label %bb19.i, label %bb2.i8.i, !dbg !132

bb2.i8.i:                                         ; preds = %bb.i7.i
  switch i32 %39, label %bb5.i4.i11.i [
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %59 = icmp sgt i32 %.0.i5.i12.i, %41, !dbg !132
  br i1 %59, label %bb19.i, label %bb20.i, !dbg !132

bb8.i16.i:                                        ; preds = %bb16.i
  switch i32 %39, label %bb5.i.i19.i [
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  %60 = icmp sgt i32 %.0.i.i20.i, %40, !dbg !137
  br i1 %60, label %bb19.i, label %bb20.i, !dbg !137

bb19.i:                                           ; preds = %ALIM.exit.i21.i, %ALIM.exit6.i13.i, %bb.i7.i
  br label %bb20.i, !dbg !131
...
bb20.i:                                           ; preds = %bb19.i, %ALIM.exit.i21.i, %ALIM.exit6.i13.i
  ...
  br i1 %61, label %bb24.i, label %alt_sep_test.exit, !dbg !140

bb24.i:                                           ; preds = %bb20.i
  %62 = icmp eq i32 %iftmp.8.0.i, 0, !dbg !141
  %..i = select i1 %62, i32 0, i32 2
...
!1 = metadata !{i32 589865, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v11/follow/branch3/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v11/follow/branch3/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!141 = metadata !{i32 360, i32 0, metadata !107, metadata !108}
...
!146 = metadata !{i32 589835, metadata !44, i32 12, i32 0, metadata !45, i32 0} ; [ DW_TAG_lexical_block ]
