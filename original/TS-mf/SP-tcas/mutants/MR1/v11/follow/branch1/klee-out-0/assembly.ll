...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %or.cond29.i = or i1 %69, %.old.i
  br i1 %or.cond29.i, label %bb15.i, label %bb16.i, !dbg !132
...
bb.i7.i:                                          ; preds = %bb16.i
  ...
  br i1 %or.cond.i6.i, label %bb19.i, label %bb2.i8.i, !dbg !141
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %72 = icmp sgt i32 %.0.i5.i12.i, %42, !dbg !141
  %73 = icmp sgt i32 %39, %38, !dbg !145
  %or.cond31.i = or i1 %72, %73
  br i1 %or.cond31.i, label %bb19.i, label %bb20.i, !dbg !141

bb6.i15.i:                                        ; preds = %bb16.i
  %74 = icmp sgt i32 %39, %38
  br i1 %74, label %bb19.i, label %bb8.i16.i, !dbg !147
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  br i1 %75, label %bb19.i, label %bb20.i, !dbg !147

bb19.i:                                           ; preds = %ALIM.exit.i21.i, %bb6.i15.i, %ALIM.exit6.i13.i, %bb.i7.i
  br label %bb20.i, !dbg !140
...
bb20.i:                                           ; preds = %bb19.i, %ALIM.exit.i21.i, %ALIM.exit6.i13.i
  ...
  br i1 %76, label %bb24.i, label %alt_sep_test.exit, !dbg !151

bb24.i:                                           ; preds = %bb20.i
  %77 = icmp eq i32 %iftmp.8.0.i, 0, !dbg !152
  %..i = select i1 %77, i32 0, i32 2
  br label %alt_sep_test.exit, !dbg !153

alt_sep_test.exit:                                ; preds = %bb13, %bb9.i, %bb20.i, %bb24.i
  %alt_sep.0.i = phi i32 [ 0, %bb13 ], [ 0, %bb9.i ], [ 0, %bb20.i ], [ %..i, %bb24.i ]
...
!1 = metadata !{i32 589865, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v11/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v11/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
