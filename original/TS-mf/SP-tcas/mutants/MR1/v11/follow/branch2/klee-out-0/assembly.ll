...
bb.i.i:                                           ; preds = %bb12.i
  %56 = icmp sgt i32 %38, %40
  br i1 %56, label %bb15.i, label %bb2.i.i, !dbg !114
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %.old.i = icmp sgt i32 %38, %40, !dbg !123
  %or.cond29.i = or i1 %60, %.old.i
  br i1 %or.cond29.i, label %bb15.i, label %bb16.i, !dbg !119
...
bb.i7.i:                                          ; preds = %bb16.i
  %61 = icmp sgt i32 %38, %40, !dbg !128
  %62 = icmp slt i32 %36, 300, !dbg !128
  %or.cond.i6.i = or i1 %62, %61
  br i1 %or.cond.i6.i, label %bb19.i, label %bb2.i8.i, !dbg !128
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %63 = icmp sgt i32 %.0.i5.i12.i, %42, !dbg !128
  %64 = icmp sgt i32 %40, %38, !dbg !132
  %or.cond31.i = or i1 %63, %64
  br i1 %or.cond31.i, label %bb19.i, label %bb20.i, !dbg !128

bb6.i15.i:                                        ; preds = %bb16.i
  %65 = icmp sgt i32 %40, %38
  br i1 %65, label %bb19.i, label %bb8.i16.i, !dbg !134
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  br i1 %66, label %bb19.i, label %bb20.i, !dbg !134

bb19.i:                                           ; preds = %ALIM.exit.i21.i, %bb6.i15.i, %ALIM.exit6.i13.i, %bb.i7.i
  br label %bb20.i, !dbg !127
...
bb20.i:                                           ; preds = %bb19.i, %ALIM.exit.i21.i, %ALIM.exit6.i13.i
  ...
  br i1 %67, label %bb24.i, label %alt_sep_test.exit, !dbg !138

bb24.i:                                           ; preds = %bb20.i
  %68 = icmp eq i32 %iftmp.8.0.i, 0, !dbg !139
  %..i = select i1 %68, i32 0, i32 2
...
!1 = metadata !{i32 589865, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v11/follow/branch2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v11/follow/branch2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!139 = metadata !{i32 360, i32 0, metadata !101, metadata !102}
