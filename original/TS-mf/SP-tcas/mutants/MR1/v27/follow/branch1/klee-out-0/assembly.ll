...
bb13:                                             ; preds = %bb12, %bb
  ...
  br i1 %or.cond.i, label %alt_sep_test.exit, label %bb8.i, !dbg !119

bb8.i:                                            ; preds = %bb13
  %59 = icmp ne i32 %Two_of_Three_Reports_Valid.0, 0, !dbg !120
  %60 = icmp eq i32 %43, 0, !dbg !120
  %.demorgan.i = and i1 %59, %60
  %or.cond2.demorgan.i = and i1 %46, %.demorgan.i
  %.not3.i = xor i1 %46, true
  %brmerge.i = or i1 %or.cond2.demorgan.i, %.not3.i
  br i1 %brmerge.i, label %bb11.i, label %alt_sep_test.exit, !dbg !119

bb11.i:                                           ; preds = %bb8.i
  %61 = icmp eq i32 %45, 0, !dbg !121
  %62 = add nsw i32 %41, 100, !dbg !121
  %iftmp.0.0.i.i.i = select i1 %61, i32 %41, i32 %62
  %63 = icmp sgt i32 %iftmp.0.0.i.i.i, %42, !dbg !123
  br i1 %63, label %bb.i.i, label %bb6.i.i, !dbg !126

bb.i.i:                                           ; preds = %bb11.i
  %64 = icmp slt i32 %38, %39
  br i1 %64, label %bb2.i.i, label %bb14.i, !dbg !127
...
ALIM.exit6.i.i:                                   ; preds = %bb5.i4.i.i, %bb4.i3.i.i, %bb2.i2.i.i, %bb2.i.i
  ...
  %65 = icmp sgt i32 %.0.i5.i.i, %42, !dbg !127
  br i1 %65, label %bb15.i, label %bb14.i, !dbg !127

bb6.i.i:                                          ; preds = %bb11.i
  %66 = icmp sge i32 %39, %38, !dbg !132
  %67 = icmp slt i32 %Cur_Vertical_Sep.0, 300, !dbg !132
  %or.cond.i.i = or i1 %67, %66
  br i1 %or.cond.i.i, label %bb14.i, label %bb8.i.i, !dbg !132
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %71 = icmp sle i32 %.0.i5.i12.i, %42, !dbg !141
  %72 = icmp slt i32 %39, %38, !dbg !145
  %or.cond33.i = and i1 %71, %72
  br i1 %or.cond33.i, label %bb19.i, label %bb22.i, !dbg !141

bb6.i15.i:                                        ; preds = %bb15.i
  %73 = icmp slt i32 %39, %38
  br i1 %73, label %bb8.i16.i, label %bb22.i, !dbg !147
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  %74 = icmp sgt i32 %.0.i.i20.i, %41, !dbg !147
  br i1 %74, label %bb22.i, label %bb19.i, !dbg !147

bb19.i:                                           ; preds = %ALIM.exit.i21.i, %ALIM.exit6.i13.i
  %75 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !151
  br i1 %75, label %bb24.i, label %alt_sep_test.exit, !dbg !151

bb22.i:                                           ; preds = %ALIM.exit.i21.i, %bb6.i15.i, %ALIM.exit6.i13.i, %bb.i7.i
  %76 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !152
  br i1 %76, label %bb24.i, label %alt_sep_test.exit, !dbg !152
...
!llvm.dbg.sp = !{!0, !6, !7, !8, !9, !10, !11, !12, !13, !16, !25, !31, !40}
...
!1 = metadata !{i32 589865, metadata !"v27-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v27/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v27-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v27/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!157 = metadata !{i32 589835, metadata !25, i32 12, i32 0, metadata !26, i32 0} ; [ DW_TAG_lexical_block ]
