...
bb6.i.i:                                          ; preds = %bb12.i
  ...
  br i1 %or.cond.i.i, label %bb15.i, label %bb8.i.i, !dbg !132
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %or.cond22.i = and i1 %69, %.old.i
  br i1 %or.cond22.i, label %bb16.i, label %bb15.i, !dbg !132
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  %iftmp.9.0.i = phi i1 [ true, %bb15.i ], [ false, %ALIM.exit6.i.i ], [ false, %ALIM.exit.i.i ]
  br i1 %64, label %bb.i9.i, label %bb10.i12.i, !dbg !138

bb.i9.i:                                          ; preds = %bb16.i
  %70 = icmp sge i32 %38, %39, !dbg !141
  %71 = icmp slt i32 %Cur_Vertical_Sep.0, 300, !dbg !141
  %or.cond.i8.i = or i1 %71, %70
  br i1 %or.cond.i8.i, label %bb8.i11.i, label %bb2.i10.i, !dbg !141

bb2.i10.i:                                        ; preds = %bb.i9.i
  switch i32 %40, label %bb5.i6.i.i [
    i32 0, label %ALIM.exit8.i.i
    i32 1, label %bb2.i4.i.i
    i32 2, label %bb4.i5.i.i
  ]

bb2.i4.i.i:                                       ; preds = %bb2.i10.i
  br label %ALIM.exit8.i.i, !dbg !142

bb4.i5.i.i:                                       ; preds = %bb2.i10.i
  br label %ALIM.exit8.i.i, !dbg !143

bb5.i6.i.i:                                       ; preds = %bb2.i10.i
  br label %ALIM.exit8.i.i, !dbg !144

ALIM.exit8.i.i:                                   ; preds = %bb5.i6.i.i, %bb4.i5.i.i, %bb2.i4.i.i, %bb2.i10.i
  %.0.i7.i.i = phi i32 [ 500, %bb2.i4.i.i ], [ 640, %bb4.i5.i.i ], [ 740, %bb5.i6.i.i ], [ 400, %bb2.i10.i ]
  %72 = icmp sle i32 %.0.i7.i.i, %42, !dbg !141
  %73 = icmp slt i32 %39, %38, !dbg !145
  %or.cond2.i.i = and i1 %72, %73
  br i1 %or.cond2.i.i, label %Non_Crossing_Biased_Descend.exit.i, label %bb8.i11.i, !dbg !141

bb8.i11.i:                                        ; preds = %ALIM.exit8.i.i, %bb.i9.i
  br label %Non_Crossing_Biased_Descend.exit.i, !dbg !145

bb10.i12.i:                                       ; preds = %bb16.i
  %74 = icmp slt i32 %39, %38
  br i1 %74, label %bb12.i.i, label %bb16.i.i, !dbg !146

bb12.i.i:                                         ; preds = %bb10.i12.i
  switch i32 %40, label %bb5.i.i15.i [
    i32 0, label %ALIM.exit.i17.i
    i32 1, label %bb2.i.i13.i
    i32 2, label %bb4.i.i14.i
  ]

bb2.i.i13.i:                                      ; preds = %bb12.i.i
  br label %ALIM.exit.i17.i, !dbg !147

bb4.i.i14.i:                                      ; preds = %bb12.i.i
  br label %ALIM.exit.i17.i, !dbg !148

bb5.i.i15.i:                                      ; preds = %bb12.i.i
  br label %ALIM.exit.i17.i, !dbg !149

ALIM.exit.i17.i:                                  ; preds = %bb5.i.i15.i, %bb4.i.i14.i, %bb2.i.i13.i, %bb12.i.i
  %.0.i.i16.i = phi i32 [ 500, %bb2.i.i13.i ], [ 640, %bb4.i.i14.i ], [ 740, %bb5.i.i15.i ], [ 400, %bb12.i.i ]
  %75 = icmp sgt i32 %.0.i.i16.i, %41, !dbg !146
  %76 = icmp sgt i32 %39, %38, !dbg !150
  %or.cond3.i.i = or i1 %75, %76
  br i1 %or.cond3.i.i, label %bb18.i.i, label %Non_Crossing_Biased_Descend.exit.i, !dbg !146

bb16.i.i:                                         ; preds = %bb10.i12.i
  %.old.i.i = icmp sgt i32 %39, %38, !dbg !150
  br i1 %.old.i.i, label %bb18.i.i, label %Non_Crossing_Biased_Descend.exit.i, !dbg !150

bb18.i.i:                                         ; preds = %bb16.i.i, %ALIM.exit.i17.i
  br label %Non_Crossing_Biased_Descend.exit.i, !dbg !150

Non_Crossing_Biased_Descend.exit.i:               ; preds = %bb18.i.i, %bb16.i.i, %ALIM.exit.i17.i, %bb8.i11.i, %ALIM.exit8.i.i
  %result.0.i18.i = phi i1 [ true, %bb8.i11.i ], [ true, %bb18.i.i ], [ false, %bb16.i.i ], [ false, %ALIM.exit8.i.i ], [ false, %ALIM.exit.i17.i ]
  %or.cond5.i = or i1 %iftmp.9.0.i, %result.0.i18.i
  %or.cond5.not.i = xor i1 %or.cond5.i, true
  %iftmp.9.0.not.i = xor i1 %iftmp.9.0.i, true
  %brmerge6.i = or i1 %or.cond5.not.i, %iftmp.9.0.not.i
  %77 = zext i1 %or.cond5.not.i to i32
  %.mux.i = xor i32 %77, 1
  br i1 %brmerge6.i, label %alt_sep_test.exit, label %bb21.i, !dbg !151

bb21.i:                                           ; preds = %Non_Crossing_Biased_Descend.exit.i
  %..i = select i1 %result.0.i18.i, i32 0, i32 2
  br label %alt_sep_test.exit, !dbg !152

alt_sep_test.exit:                                ; preds = %bb13, %bb9.i, %Non_Crossing_Biased_Descend.exit.i, %bb21.i
  %alt_sep.0.i = phi i32 [ 0, %bb13 ], [ 0, %bb9.i ], [ %.mux.i, %Non_Crossing_Biased_Descend.exit.i ], [ %..i, %bb21.i ]
  %78 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i32 %alt_sep.0.i) nounwind, !dbg !153
  call void @exit(i32 0) noreturn nounwind, !dbg !154
  unreachable, !dbg !154
}
...
entry:
  %0 = icmp eq i64 %z, 0, !dbg !155
  br i1 %0, label %bb, label %return, !dbg !155
...
!1 = metadata !{i32 589865, metadata !"v32-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v32/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v32-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR1/v32/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!9 = metadata !{i32 589870, i32 0, metadata !1, metadata !"Own_Below_Threat", metadata !"Own_Below_Threat", metadata !"Own_Below_Threat", metadata !1, i32 265, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null} ; [ DW_TAG_subpro
!10 = metadata !{i32 589870, i32 0, metadata !1, metadata !"Own_Above_Threat", metadata !"Own_Above_Threat", metadata !"Own_Above_Threat", metadata !1, i32 281, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null} ; [ DW_TAG_subpr
!11 = metadata !{i32 589870, i32 0, metadata !1, metadata !"alt_sep_test", metadata !"alt_sep_test", metadata !"alt_sep_test", metadata !1, i32 297, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null} ; [ DW_TAG_subprogram ]
!12 = metadata !{i32 589870, i32 0, metadata !1, metadata !"mainQ", metadata !"mainQ", metadata !"mainQ", metadata !1, i32 389, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null} ; [ DW_TAG_subprogram ]
!13 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 404, metadata !14, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!79 = metadata !{i32 418, i32 0, metadata !80, null}
!80 = metadata !{i32 589835, metadata !13, i32 404, i32 0, metadata !1, i32 8} ; [ DW_TAG_lexical_block ]
!81 = metadata !{i32 419, i32 0, metadata !80, null}
!82 = metadata !{i32 420, i32 0, metadata !80, null}
!83 = metadata !{i32 421, i32 0, metadata !80, null}
!84 = metadata !{i32 422, i32 0, metadata !80, null}
!85 = metadata !{i32 423, i32 0, metadata !80, null}
!86 = metadata !{i32 424, i32 0, metadata !80, null}
!87 = metadata !{i32 425, i32 0, metadata !80, null}
!88 = metadata !{i32 426, i32 0, metadata !80, null}
!89 = metadata !{i32 427, i32 0, metadata !80, null}
!90 = metadata !{i32 428, i32 0, metadata !80, null}
!91 = metadata !{i32 429, i32 0, metadata !80, null}
!92 = metadata !{i32 430, i32 0, metadata !80, null}
!93 = metadata !{i32 431, i32 0, metadata !80, null}
!94 = metadata !{i32 432, i32 0, metadata !80, null}
!95 = metadata !{i32 435, i32 0, metadata !80, null}
!96 = metadata !{i32 436, i32 0, metadata !80, null}
!97 = metadata !{i32 437, i32 0, metadata !80, null}
!98 = metadata !{i32 442, i32 0, metadata !80, null}
!99 = metadata !{i32 443, i32 0, metadata !80, null}
!100 = metadata !{i32 444, i32 0, metadata !80, null}
!101 = metadata !{i32 447, i32 0, metadata !80, null}
!102 = metadata !{i32 448, i32 0, metadata !80, null}
!103 = metadata !{i32 449, i32 0, metadata !80, null}
!104 = metadata !{i32 450, i32 0, metadata !80, null}
!105 = metadata !{i32 451, i32 0, metadata !80, null}
!106 = metadata !{i32 452, i32 0, metadata !80, null}
!107 = metadata !{i32 453, i32 0, metadata !80, null}
!108 = metadata !{i32 455, i32 0, metadata !80, null}
!109 = metadata !{i32 445, i32 0, metadata !80, null}
!110 = metadata !{i32 440, i32 0, metadata !80, null}
!111 = metadata !{i32 456, i32 0, metadata !80, null}
!112 = metadata !{i32 459, i32 0, metadata !113, null}
!113 = metadata !{i32 589835, metadata !80, i32 459, i32 0, metadata !1, i32 9} ; [ DW_TAG_lexical_block ]
!114 = metadata !{i32 461, i32 0, metadata !113, null}
!115 = metadata !{i32 463, i32 0, metadata !113, null}
!116 = metadata !{i32 302, i32 0, metadata !117, metadata !118}
!117 = metadata !{i32 589835, metadata !11, i32 297, i32 0, metadata !1, i32 6} ; [ DW_TAG_lexical_block ]
!118 = metadata !{i32 477, i32 0, metadata !80, null}
!119 = metadata !{i32 308, i32 0, metadata !117, metadata !118}
!120 = metadata !{i32 304, i32 0, metadata !117, metadata !118}
...
!125 = metadata !{i32 310, i32 0, metadata !117, metadata !118}
...
!136 = metadata !{i32 266, i32 0, metadata !137, metadata !125}
!137 = metadata !{i32 589835, metadata !9, i32 265, i32 0, metadata !1, i32 4} ; [ DW_TAG_lexical_block ]
...
!140 = metadata !{i32 334, i32 0, metadata !117, metadata !118}
!141 = metadata !{i32 185, i32 0, metadata !139, metadata !140}
...
!145 = metadata !{i32 209, i32 0, metadata !139, metadata !140}
!146 = metadata !{i32 213, i32 0, metadata !139, metadata !140}
!147 = metadata !{i32 34, i32 0, metadata !129, metadata !146}
!148 = metadata !{i32 35, i32 0, metadata !129, metadata !146}
!149 = metadata !{i32 36, i32 0, metadata !129, metadata !146}
!150 = metadata !{i32 248, i32 0, metadata !139, metadata !140}
!151 = metadata !{i32 357, i32 0, metadata !117, metadata !118}
!152 = metadata !{i32 367, i32 0, metadata !117, metadata !118}
!153 = metadata !{i32 478, i32 0, metadata !80, null}
!154 = metadata !{i32 479, i32 0, metadata !80, null}
!155 = metadata !{i32 13, i32 0, metadata !156, null}
!156 = metadata !{i32 589835, metadata !25, i32 12, i32 0, metadata !26, i32 0} ; [ DW_TAG_lexical_block ]
!157 = metadata !{i32 14, i32 0, metadata !156, null}
!158 = metadata !{i32 15, i32 0, metadata !156, null}
