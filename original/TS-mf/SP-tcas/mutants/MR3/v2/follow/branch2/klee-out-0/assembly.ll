...
bb12.i:                                           ; preds = %bb9.i
  %55 = icmp sgt i32 %Up_Separation.0, %Down_Separation.0, !dbg !109
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %55, label %bb.i7.i, label %bb6.i15.i, !dbg !124

bb.i7.i:                                          ; preds = %bb16.i
  %61 = icmp sge i32 %38, %40, !dbg !127
  %62 = icmp slt i32 %36, 300, !dbg !127
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %63 = icmp sle i32 %.0.i5.i12.i, %Down_Separation.0, !dbg !127
  %64 = icmp slt i32 %40, %38, !dbg !131
  %or.cond33.i = and i1 %63, %64
  br i1 %or.cond33.i, label %bb20.i, label %bb23.i, !dbg !127

bb6.i15.i:                                        ; preds = %bb16.i
  %65 = icmp slt i32 %40, %38
  br i1 %65, label %bb8.i16.i, label %bb23.i, !dbg !133
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  %66 = icmp sgt i32 %.0.i.i20.i, %Up_Separation.0, !dbg !133
  br i1 %66, label %bb23.i, label %bb20.i, !dbg !133

bb20.i:                                           ; preds = %ALIM.exit.i21.i, %ALIM.exit6.i13.i
  %67 = icmp eq i32 %iftmp.6.0.i, 0, !dbg !137
  br i1 %67, label %bb25.i, label %alt_sep_test.exit, !dbg !137

bb23.i:                                           ; preds = %ALIM.exit.i21.i, %bb6.i15.i, %ALIM.exit6.i13.i, %bb.i7.i
  %68 = icmp eq i32 %iftmp.6.0.i, 0, !dbg !138
  br i1 %68, label %bb25.i, label %alt_sep_test.exit, !dbg !138
...
!1 = metadata !{i32 589865, metadata !"v2-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v2/follow/branch2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v2-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v2/follow/branch2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i3
...
!100 = metadata !{i32 449, i32 0, metadata !73, null}
...
!103 = metadata !{i32 470, i32 0, metadata !73, null}
!104 = metadata !{i32 300, i32 0, metadata !102, metadata !103}
!105 = metadata !{i32 305, i32 0, metadata !102, metadata !103}
!106 = metadata !{i32 444, i32 0, metadata !73, null}
!107 = metadata !{i32 438, i32 0, metadata !73, null}
...
!140 = metadata !{i32 471, i32 0, metadata !73, null}
!141 = metadata !{i32 472, i32 0, metadata !73, null}
