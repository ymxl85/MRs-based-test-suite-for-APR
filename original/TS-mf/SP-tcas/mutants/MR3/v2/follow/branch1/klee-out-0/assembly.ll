...
bb12.i:                                           ; preds = %bb9.i
  %54 = icmp sgt i32 %Up_Separation.0, %Down_Separation.0, !dbg !109
  br i1 %54, label %bb.i.i, label %bb6.i.i, !dbg !112

bb.i.i:                                           ; preds = %bb12.i
  %55 = icmp slt i32 %38, %40
  br i1 %55, label %bb2.i.i, label %bb15.i, !dbg !113
...
ALIM.exit6.i.i:                                   ; preds = %bb5.i4.i.i, %bb4.i3.i.i, %bb2.i2.i.i, %bb2.i.i
  ...
  %56 = icmp sgt i32 %.0.i5.i.i, %Down_Separation.0, !dbg !113
  br i1 %56, label %bb16.i, label %bb15.i, !dbg !113

bb6.i.i:                                          ; preds = %bb12.i
  %57 = icmp sge i32 %40, %38, !dbg !118
  %58 = icmp slt i32 %36, 300, !dbg !118
  %or.cond.i.i = or i1 %58, %57
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %59 = icmp sle i32 %.0.i.i.i, %Up_Separation.0, !dbg !118
  %.old.i = icmp slt i32 %38, %40, !dbg !122
  %or.cond31.i = and i1 %59, %.old.i
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %54, label %bb.i7.i, label %bb6.i15.i, !dbg !124

bb.i7.i:                                          ; preds = %bb16.i
  %60 = icmp sge i32 %38, %40, !dbg !127
  %61 = icmp slt i32 %36, 300, !dbg !127
  %or.cond.i6.i = or i1 %61, %60
  br i1 %or.cond.i6.i, label %bb23.i, label %bb2.i8.i, !dbg !127
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %62 = icmp sle i32 %.0.i5.i12.i, %Down_Separation.0, !dbg !127
  %63 = icmp slt i32 %40, %38, !dbg !131
  %or.cond33.i = and i1 %62, %63
  br i1 %or.cond33.i, label %bb20.i, label %bb23.i, !dbg !127

bb6.i15.i:                                        ; preds = %bb16.i
  %64 = icmp slt i32 %40, %38
  br i1 %64, label %bb8.i16.i, label %bb23.i, !dbg !133
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  %65 = icmp sgt i32 %.0.i.i20.i, %Up_Separation.0, !dbg !133
  br i1 %65, label %bb23.i, label %bb20.i, !dbg !133

bb20.i:                                           ; preds = %ALIM.exit.i21.i, %ALIM.exit6.i13.i
  %66 = icmp eq i32 %iftmp.6.0.i, 0, !dbg !137
  br i1 %66, label %bb25.i, label %alt_sep_test.exit, !dbg !137

bb23.i:                                           ; preds = %ALIM.exit.i21.i, %bb6.i15.i, %ALIM.exit6.i13.i, %bb.i7.i
  %67 = icmp eq i32 %iftmp.6.0.i, 0, !dbg !138
  br i1 %67, label %bb25.i, label %alt_sep_test.exit, !dbg !138

bb25.i:                                           ; preds = %bb20.i, %bb23.i
  %iftmp.7.029.i2 = phi i32 [ 0, %bb23.i ], [ 2, %bb20.i ]
  br label %alt_sep_test.exit, !dbg !139

alt_sep_test.exit:                                ; preds = %entry, %bb9.i, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %entry ], [ 0, %bb9.i ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.7.029.i2, %bb25.i ]
  %68 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i32 %alt_sep.0.i) nounwind, !dbg !140
...
!1 = metadata !{i32 589865, metadata !"v2-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v2/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v2-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v2/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i3
...
!73 = metadata !{i32 589835, metadata !13, i32 401, i32 0, metadata !1, i32 8} ; [ DW_TAG_lexical_block ]
...
!91 = metadata !{i32 438, i32 0, metadata !73, null}
!92 = metadata !{i32 439, i32 0, metadata !73, null}
!93 = metadata !{i32 441, i32 0, metadata !73, null}
!94 = metadata !{i32 442, i32 0, metadata !73, null}
!95 = metadata !{i32 443, i32 0, metadata !73, null}
!96 = metadata !{i32 444, i32 0, metadata !73, null}
...
!101 = metadata !{i32 299, i32 0, metadata !102, metadata !103}
!102 = metadata !{i32 589835, metadata !11, i32 294, i32 0, metadata !1, i32 6} ; [ DW_TAG_lexical_block ]
!103 = metadata !{i32 471, i32 0, metadata !73, null}
!104 = metadata !{i32 300, i32 0, metadata !102, metadata !103}
!105 = metadata !{i32 305, i32 0, metadata !102, metadata !103}
!106 = metadata !{i32 446, i32 0, metadata !73, null}
!107 = metadata !{i32 440, i32 0, metadata !73, null}
!108 = metadata !{i32 301, i32 0, metadata !102, metadata !103}
!109 = metadata !{i32 77, i32 0, metadata !110, metadata !111}
!110 = metadata !{i32 589835, metadata !7, i32 72, i32 0, metadata !1, i32 2} ; [ DW_TAG_lexical_block ]
!111 = metadata !{i32 307, i32 0, metadata !102, metadata !103}
!112 = metadata !{i32 89, i32 0, metadata !110, metadata !111}
!113 = metadata !{i32 91, i32 0, metadata !110, metadata !111}
...
!118 = metadata !{i32 128, i32 0, metadata !110, metadata !111}
...
!122 = metadata !{i32 263, i32 0, metadata !123, metadata !111}
!123 = metadata !{i32 589835, metadata !9, i32 262, i32 0, metadata !1, i32 4} ; [ DW_TAG_lexical_block ]
!124 = metadata !{i32 184, i32 0, metadata !125, metadata !126}
!125 = metadata !{i32 589835, metadata !8, i32 167, i32 0, metadata !1, i32 3} ; [ DW_TAG_lexical_block ]
!126 = metadata !{i32 331, i32 0, metadata !102, metadata !103}
!127 = metadata !{i32 186, i32 0, metadata !125, metadata !126}
...
!131 = metadata !{i32 279, i32 0, metadata !132, metadata !126}
!132 = metadata !{i32 589835, metadata !10, i32 278, i32 0, metadata !1, i32 5} ; [ DW_TAG_lexical_block ]
!133 = metadata !{i32 212, i32 0, metadata !125, metadata !126}
...
!137 = metadata !{i32 354, i32 0, metadata !102, metadata !103}
!138 = metadata !{i32 359, i32 0, metadata !102, metadata !103}
!139 = metadata !{i32 364, i32 0, metadata !102, metadata !103}
!140 = metadata !{i32 472, i32 0, metadata !73, null}
!141 = metadata !{i32 473, i32 0, metadata !73, null}
