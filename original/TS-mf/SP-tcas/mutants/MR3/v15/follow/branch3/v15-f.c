  ...
  if (upward_preferred)
    ...
    {	
      result = Own_Above_Threat(Cur_Vertical_Sep, 
				...
				Other_RAC,
				Other_Capability,
				Climb_Inhibit) && (Cur_Vertical_Sep >= (300 + 350)) && (Up_Separation >= ALIM(Cur_Vertical_Sep, 
												      High_Confidence,
												      Two_of_Three_Reports_Valid,
												      Own_Tracked_Alt,
												      Own_Tracked_Alt_Rate,
  ...
  if (upward_preferred)
    {
      result = Own_Below_Threat(Cur_Vertical_Sep, 
				...
				Other_RAC,
				Other_Capability,
				Climb_Inhibit) && (Cur_Vertical_Sep >= (300 + 350)) && (Down_Separation >= ALIM(Cur_Vertical_Sep, 
													High_Confidence,
													Two_of_Three_Reports_Valid,
													Own_Tracked_Alt,
													Own_Tracked_Alt_Rate,
		 ...
		 int Climb_Inhibit)
{
  ...
  enabled = High_Confidence && (Own_Tracked_Alt_Rate <= 600);//tvn missing && (Cur_Vertical_Sep > 600);
...
int Cur_Vertical_Sep;
   ...
   int Climb_Inhibit;
		 ...
		 Climb_Inhibit))
    {
          ...
          Other_Tracked_Alt = argv4-1;
          Up_Separation = argv8;
          Down_Separation = argv8+100;         
    }
    else if(argv9<ALIM(Cur_Vertical_Sep, 
		 High_Confidence,
		 Two_of_Three_Reports_Valid,
		 Own_Tracked_Alt,
		 Own_Tracked_Alt_Rate,
    ...
    {
          Other_Tracked_Alt = argv4+1;
          Up_Separation = argv9+1;
          Down_Separation = argv9;       
    }
    else
    {
      Up_Separation=ALIM(Cur_Vertical_Sep, 
		 High_Confidence,
		 Two_of_Three_Reports_Valid,
		 Own_Tracked_Alt,
		 Own_Tracked_Alt_Rate,
		 ...
		 Other_Capability,
		 Climb_Inhibit);
      Down_Separation=(ALIM(Cur_Vertical_Sep, 
		 High_Confidence,
		 Two_of_Three_Reports_Valid,
		 Own_Tracked_Alt,
		 Own_Tracked_Alt_Rate,
