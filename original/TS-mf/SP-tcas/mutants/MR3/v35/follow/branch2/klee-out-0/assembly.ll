...
bb12.i:                                           ; preds = %bb9.i
  ...
  %iftmp.0.0.i.i.i = select i1 %55, i32 %56, i32 %Up_Separation.0
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %57, label %bb.i8.i, label %bb6.i16.i, !dbg !126

bb.i8.i:                                          ; preds = %bb16.i
  %63 = icmp sge i32 %38, %40, !dbg !129
...
ALIM.exit6.i14.i:                                 ; preds = %bb5.i4.i12.i, %bb4.i3.i11.i, %bb2.i2.i10.i, %bb2.i9.i
  ...
  %65 = icmp sle i32 %.0.i5.i13.i, %Down_Separation.0, !dbg !129
  %66 = icmp slt i32 %40, %38, !dbg !133
  %or.cond34.i = and i1 %65, %66
  br i1 %or.cond34.i, label %bb20.i, label %bb23.i, !dbg !129

bb6.i16.i:                                        ; preds = %bb16.i
  %67 = icmp slt i32 %40, %38
  br i1 %67, label %bb8.i17.i, label %bb23.i, !dbg !135
...
ALIM.exit.i22.i:                                  ; preds = %bb5.i.i20.i, %bb4.i.i19.i, %bb2.i.i18.i, %bb8.i17.i
  ...
  %68 = icmp sgt i32 %.0.i.i21.i, %Up_Separation.0, !dbg !135
  br i1 %68, label %bb23.i, label %bb20.i, !dbg !135

bb20.i:                                           ; preds = %ALIM.exit.i22.i, %ALIM.exit6.i14.i
  %69 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !139
  br i1 %69, label %bb25.i, label %alt_sep_test.exit, !dbg !139
...
!1 = metadata !{i32 589865, metadata !"v35-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v35/follow/branch2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v35-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v35/follow/branch2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
