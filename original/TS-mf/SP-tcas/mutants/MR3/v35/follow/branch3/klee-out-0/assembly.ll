...
bb12.i:                                           ; preds = %bb9.i
  ...
  %iftmp.0.0.i.i.i = select i1 %77, i32 %78, i32 %Up_Separation.0
...
ALIM.exit.i22.i:                                  ; preds = %bb5.i.i20.i, %bb4.i.i19.i, %bb2.i.i18.i, %bb8.i17.i
  ...
  %90 = icmp sgt i32 %.0.i.i21.i, %Up_Separation.0, !dbg !160
  br i1 %90, label %bb23.i, label %bb20.i, !dbg !160
...
!1 = metadata !{i32 589865, metadata !"v35-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v35/follow/branch3/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v35-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v35/follow/branch3/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!170 = metadata !{i32 589835, metadata !16, i32 12, i32 0, metadata !17, i32 0} ; [ DW_TAG_lexical_block ]
