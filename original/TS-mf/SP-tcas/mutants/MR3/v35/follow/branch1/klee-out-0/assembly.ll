...
bb12.i:                                           ; preds = %bb9.i
  ...
  %iftmp.0.0.i.i.i = select i1 %54, i32 %55, i32 %Up_Separation.0
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %56, label %bb.i8.i, label %bb6.i16.i, !dbg !126
...
ALIM.exit.i22.i:                                  ; preds = %bb5.i.i20.i, %bb4.i.i19.i, %bb2.i.i18.i, %bb8.i17.i
  ...
  %67 = icmp sgt i32 %.0.i.i21.i, %Up_Separation.0, !dbg !135
...
!1 = metadata !{i32 589865, metadata !"v35-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v35/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v35-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v35/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!140 = metadata !{i32 358, i32 0, metadata !102, metadata !103}
