...
bb.i.i:                                           ; preds = %bb12.i
  %81 = icmp sgt i32 %62, %64
  br i1 %81, label %bb15.i, label %bb2.i.i, !dbg !121
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %.old.i = icmp sgt i32 %62, %64, !dbg !130
  %or.cond29.i = or i1 %85, %.old.i
  br i1 %or.cond29.i, label %bb15.i, label %bb16.i, !dbg !126
...
bb.i7.i:                                          ; preds = %bb16.i
  %86 = icmp sgt i32 %62, %64, !dbg !135
  %87 = icmp slt i32 %60, 300, !dbg !135
  %or.cond.i6.i = or i1 %87, %86
  br i1 %or.cond.i6.i, label %bb19.i, label %bb2.i8.i, !dbg !135
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %88 = icmp sgt i32 %.0.i5.i12.i, %67, !dbg !135
  %89 = icmp sgt i32 %64, %62, !dbg !139
  %or.cond31.i = or i1 %88, %89
  br i1 %or.cond31.i, label %bb19.i, label %bb20.i, !dbg !135

bb6.i15.i:                                        ; preds = %bb16.i
  %90 = icmp sgt i32 %64, %62
  br i1 %90, label %bb19.i, label %bb8.i16.i, !dbg !141
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  br i1 %91, label %bb19.i, label %bb20.i, !dbg !141

bb19.i:                                           ; preds = %ALIM.exit.i21.i, %bb6.i15.i, %ALIM.exit6.i13.i, %bb.i7.i
  br label %bb20.i, !dbg !134
...
bb20.i:                                           ; preds = %bb19.i, %ALIM.exit.i21.i, %ALIM.exit6.i13.i
  ...
  br i1 %92, label %bb24.i, label %alt_sep_test.exit, !dbg !145

bb24.i:                                           ; preds = %bb20.i
  %93 = icmp eq i32 %iftmp.8.0.i, 0, !dbg !146
  %..i = select i1 %93, i32 0, i32 2
...
!1 = metadata !{i32 589865, metadata !"v11-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v11/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v11-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v11/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
...
!146 = metadata !{i32 360, i32 0, metadata !108, metadata !109}
