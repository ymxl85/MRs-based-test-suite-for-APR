...
bb.i.i:                                           ; preds = %bb12.i
  %57 = icmp sgt i32 %38, %40
  br i1 %57, label %bb15.i, label %bb2.i.i, !dbg !115
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %.old.i = icmp sgt i32 %38, %40, !dbg !124
  %or.cond29.i = or i1 %61, %.old.i
  br i1 %or.cond29.i, label %bb15.i, label %bb16.i, !dbg !120
...
bb.i7.i:                                          ; preds = %bb16.i
  %62 = icmp sgt i32 %38, %40, !dbg !129
  %63 = icmp slt i32 %36, 300, !dbg !129
  %or.cond.i6.i = or i1 %63, %62
  br i1 %or.cond.i6.i, label %bb19.i, label %bb2.i8.i, !dbg !129
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %64 = icmp sgt i32 %.0.i5.i12.i, %Down_Separation.0, !dbg !129
  %65 = icmp sgt i32 %40, %38, !dbg !133
  %or.cond31.i = or i1 %64, %65
  br i1 %or.cond31.i, label %bb19.i, label %bb20.i, !dbg !129

bb6.i15.i:                                        ; preds = %bb16.i
  %66 = icmp sgt i32 %40, %38
  br i1 %66, label %bb19.i, label %bb8.i16.i, !dbg !135
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  br i1 %67, label %bb19.i, label %bb20.i, !dbg !135

bb19.i:                                           ; preds = %ALIM.exit.i21.i, %bb6.i15.i, %ALIM.exit6.i13.i, %bb.i7.i
  br label %bb20.i, !dbg !128

bb20.i:                                           ; preds = %bb19.i, %ALIM.exit.i21.i, %ALIM.exit6.i13.i
  %iftmp.8.0.i = phi i32 [ 0, %bb19.i ], [ 1, %ALIM.exit6.i13.i ], [ 1, %ALIM.exit.i21.i ]
  %68 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !139
  br i1 %68, label %bb24.i, label %alt_sep_test.exit, !dbg !139

bb24.i:                                           ; preds = %bb20.i
  %69 = icmp eq i32 %iftmp.8.0.i, 0, !dbg !140
  %..i = select i1 %69, i32 0, i32 2
  br label %alt_sep_test.exit, !dbg !141

alt_sep_test.exit:                                ; preds = %entry, %bb9.i, %bb20.i, %bb24.i
  %alt_sep.0.i = phi i32 [ 0, %entry ], [ 0, %bb9.i ], [ 0, %bb20.i ], [ %..i, %bb24.i ]
...
!1 = metadata !{i32 589865, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v11/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v11/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!99 = metadata !{i32 448, i32 0, metadata !73, null}
...
!106 = metadata !{i32 445, i32 0, metadata !73, null}
!107 = metadata !{i32 439, i32 0, metadata !73, null}
...
!126 = metadata !{i32 183, i32 0, metadata !127, metadata !128}
...
!129 = metadata !{i32 185, i32 0, metadata !127, metadata !128}
...
!133 = metadata !{i32 278, i32 0, metadata !134, metadata !128}
!134 = metadata !{i32 589835, metadata !10, i32 277, i32 0, metadata !1, i32 5} ; [ DW_TAG_lexical_block ]
!135 = metadata !{i32 211, i32 0, metadata !127, metadata !128}
...
!139 = metadata !{i32 353, i32 0, metadata !102, metadata !103}
!140 = metadata !{i32 360, i32 0, metadata !102, metadata !103}
!141 = metadata !{i32 363, i32 0, metadata !102, metadata !103}
!142 = metadata !{i32 471, i32 0, metadata !73, null}
!143 = metadata !{i32 472, i32 0, metadata !73, null}
