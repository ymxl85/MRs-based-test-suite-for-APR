...
bb.i.i:                                           ; preds = %bb12.i
  %58 = icmp sgt i32 %38, %40
  br i1 %58, label %bb15.i, label %bb2.i.i, !dbg !115
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %62 = icmp sgt i32 %.0.i.i.i, %Up_Separation.0, !dbg !120
  %.old.i = icmp sgt i32 %38, %40, !dbg !124
  %or.cond29.i = or i1 %62, %.old.i
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %57, label %bb.i7.i, label %bb6.i15.i, !dbg !126

bb.i7.i:                                          ; preds = %bb16.i
  %63 = icmp sgt i32 %38, %40, !dbg !129
  %64 = icmp slt i32 %36, 300, !dbg !129
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %65 = icmp sgt i32 %.0.i5.i12.i, %Down_Separation.0, !dbg !129
  %66 = icmp sgt i32 %40, %38, !dbg !133
  %or.cond31.i = or i1 %65, %66
  br i1 %or.cond31.i, label %bb19.i, label %bb20.i, !dbg !129

bb6.i15.i:                                        ; preds = %bb16.i
  %67 = icmp sgt i32 %40, %38
  br i1 %67, label %bb19.i, label %bb8.i16.i, !dbg !135
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  %68 = icmp sgt i32 %.0.i.i20.i, %Up_Separation.0, !dbg !135
  br i1 %68, label %bb19.i, label %bb20.i, !dbg !135
...
bb20.i:                                           ; preds = %bb19.i, %ALIM.exit.i21.i, %ALIM.exit6.i13.i
  ...
  %69 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !139
  br i1 %69, label %bb24.i, label %alt_sep_test.exit, !dbg !139

bb24.i:                                           ; preds = %bb20.i
  %70 = icmp eq i32 %iftmp.8.0.i, 0, !dbg !140
  %..i = select i1 %70, i32 0, i32 2
...
alt_sep_test.exit:                                ; preds = %entry, %bb9.i, %bb20.i, %bb24.i
  ...
  %71 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i32 %alt_sep.0.i) nounwind, !dbg !142
...
!1 = metadata !{i32 589865, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v11/follow/branch2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v11/follow/branch2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
