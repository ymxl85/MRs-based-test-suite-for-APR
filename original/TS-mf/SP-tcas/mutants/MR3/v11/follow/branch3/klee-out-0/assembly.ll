...
bb.i.i:                                           ; preds = %bb12.i
  %80 = icmp sgt i32 %45, %Other_Tracked_Alt.0
  br i1 %80, label %bb15.i, label %bb2.i.i, !dbg !141
...
bb6.i.i:                                          ; preds = %bb12.i
  %82 = icmp sgt i32 %Other_Tracked_Alt.0, %45, !dbg !145
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %.old.i = icmp sgt i32 %45, %Other_Tracked_Alt.0, !dbg !149
  %or.cond29.i = or i1 %84, %.old.i
  br i1 %or.cond29.i, label %bb15.i, label %bb16.i, !dbg !145
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %79, label %bb.i7.i, label %bb6.i15.i, !dbg !151

bb.i7.i:                                          ; preds = %bb16.i
  %85 = icmp sgt i32 %45, %Other_Tracked_Alt.0, !dbg !154
  %86 = icmp slt i32 %38, 300, !dbg !154
  %or.cond.i6.i = or i1 %86, %85
  br i1 %or.cond.i6.i, label %bb19.i, label %bb2.i8.i, !dbg !154
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %87 = icmp sgt i32 %.0.i5.i12.i, %Down_Separation.0, !dbg !154
  %88 = icmp sgt i32 %Other_Tracked_Alt.0, %45, !dbg !158
  %or.cond31.i = or i1 %87, %88
  br i1 %or.cond31.i, label %bb19.i, label %bb20.i, !dbg !154

bb6.i15.i:                                        ; preds = %bb16.i
  %89 = icmp sgt i32 %Other_Tracked_Alt.0, %45
  br i1 %89, label %bb19.i, label %bb8.i16.i, !dbg !160
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  %90 = icmp sgt i32 %.0.i.i20.i, %Up_Separation.0, !dbg !160
  br i1 %90, label %bb19.i, label %bb20.i, !dbg !160

bb19.i:                                           ; preds = %ALIM.exit.i21.i, %bb6.i15.i, %ALIM.exit6.i13.i, %bb.i7.i
  br label %bb20.i, !dbg !153
...
bb20.i:                                           ; preds = %bb19.i, %ALIM.exit.i21.i, %ALIM.exit6.i13.i
  ...
  br i1 %91, label %bb24.i, label %alt_sep_test.exit, !dbg !164

bb24.i:                                           ; preds = %bb20.i
  %92 = icmp eq i32 %iftmp.8.0.i, 0, !dbg !165
  %..i = select i1 %92, i32 0, i32 2
  br label %alt_sep_test.exit, !dbg !166

alt_sep_test.exit:                                ; preds = %bb15, %bb9.i, %bb20.i, %bb24.i
  %alt_sep.0.i = phi i32 [ 0, %bb15 ], [ 0, %bb9.i ], [ 0, %bb20.i ], [ %..i, %bb24.i ]
...
!1 = metadata !{i32 589865, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v11/follow/branch3/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v11/follow/branch3/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!165 = metadata !{i32 360, i32 0, metadata !130, metadata !131}
