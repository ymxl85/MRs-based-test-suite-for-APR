  ...
  if (upward_preferred)
    {
      ...
      result = result && (Other_Tracked_Alt < Own_Tracked_Alt); //tvn 1/3 change need removal
    }
  else
    {
      result = !(Own_Above_Threat(Cur_Vertical_Sep, 
      ...
      result = result && (Other_Tracked_Alt <= Own_Tracked_Alt); //tvn 2/3 change need removal
    }
  return result;
}
  ...
  if (enabled && ((tcas_equipped && intent_not_known) || !tcas_equipped))
	...
	Own_Below_Threat(Cur_Vertical_Sep, 
      ...
      need_downward_RA = Non_Crossing_Biased_Descend(Cur_Vertical_Sep, 
						     ...
						     Other_RAC,
						     Other_Capability,
						     Climb_Inhibit); //tvn bug 3/3 && Own_Above_Threat(Cur_Vertical_Sep, 
											/* High_Confidence, */
											/* Two_of_Three_Reports_Valid, */
											/* Own_Tracked_Alt, */
											/* Own_Tracked_Alt_Rate, */
