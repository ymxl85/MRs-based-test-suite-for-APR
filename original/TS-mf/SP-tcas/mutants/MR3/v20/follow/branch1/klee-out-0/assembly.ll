...
bb12.i:                                           ; preds = %bb9.i
  ...
  %56 = icmp slt i32 %iftmp.0.0.i.i.i, %Down_Separation.0, !dbg !111
  br i1 %56, label %bb6.i.i, label %bb.i.i, !dbg !114
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %62, label %bb.i8.i, label %bb6.i16.i, !dbg !129
...
ALIM.exit6.i14.i:                                 ; preds = %bb5.i4.i12.i, %bb4.i3.i11.i, %bb2.i2.i10.i, %bb2.i9.i
  ...
  %65 = icmp sle i32 %.0.i5.i13.i, %Down_Separation.0, !dbg !130
...
bb6.i16.i:                                        ; preds = %bb16.i
  ...
  br i1 %67, label %bb8.i17.i, label %bb23.i, !dbg !136
...
ALIM.exit.i22.i:                                  ; preds = %bb5.i.i20.i, %bb4.i.i19.i, %bb2.i.i18.i, %bb8.i17.i
  ...
  %68 = icmp sgt i32 %.0.i.i21.i, %Up_Separation.0, !dbg !136
...
!1 = metadata !{i32 589865, metadata !"v20-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v20/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v20-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v20/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!144 = metadata !{i32 472, i32 0, metadata !73, null}
