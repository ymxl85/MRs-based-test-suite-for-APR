...
bb12.i:                                           ; preds = %bb9.i
  ...
  %80 = icmp slt i32 %iftmp.0.0.i.i.i, %67, !dbg !117
  br i1 %80, label %bb6.i.i, label %bb.i.i, !dbg !120
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  br i1 %86, label %bb.i8.i, label %bb6.i16.i, !dbg !135

bb.i8.i:                                          ; preds = %bb16.i
  %87 = icmp sge i32 %62, %64, !dbg !136
  %88 = icmp slt i32 %60, 300, !dbg !136
  %or.cond.i7.i = or i1 %88, %87
  br i1 %or.cond.i7.i, label %bb23.i, label %bb2.i9.i, !dbg !136
...
bb5.i4.i12.i:                                     ; preds = %bb2.i9.i
  br label %ALIM.exit6.i14.i, !dbg !139
...
ALIM.exit6.i14.i:                                 ; preds = %bb5.i4.i12.i, %bb4.i3.i11.i, %bb2.i2.i10.i, %bb2.i9.i
  ...
  %89 = icmp sle i32 %.0.i5.i13.i, %67, !dbg !136
  %90 = icmp slt i32 %64, %62, !dbg !140
  %or.cond34.i = and i1 %89, %90
  br i1 %or.cond34.i, label %bb20.i, label %bb23.i, !dbg !136

bb6.i16.i:                                        ; preds = %bb16.i
  %91 = icmp slt i32 %64, %62
  br i1 %91, label %bb8.i17.i, label %bb23.i, !dbg !142
...
bb5.i.i20.i:                                      ; preds = %bb8.i17.i
  br label %ALIM.exit.i22.i, !dbg !145
...
ALIM.exit.i22.i:                                  ; preds = %bb5.i.i20.i, %bb4.i.i19.i, %bb2.i.i18.i, %bb8.i17.i
  ...
  %92 = icmp sgt i32 %.0.i.i21.i, %66, !dbg !142
...
!1 = metadata !{i32 589865, metadata !"v20-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v20/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v20-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v20/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
...
!135 = metadata !{i32 183, i32 0, metadata !133, metadata !134}
!136 = metadata !{i32 185, i32 0, metadata !133, metadata !134}
...
!140 = metadata !{i32 278, i32 0, metadata !141, metadata !134}
!141 = metadata !{i32 589835, metadata !10, i32 277, i32 0, metadata !1, i32 5} ; [ DW_TAG_lexical_block ]
!142 = metadata !{i32 211, i32 0, metadata !133, metadata !134}
...
!146 = metadata !{i32 353, i32 0, metadata !108, metadata !109}
!147 = metadata !{i32 358, i32 0, metadata !108, metadata !109}
!148 = metadata !{i32 363, i32 0, metadata !108, metadata !109}
!149 = metadata !{i32 467, i32 0, metadata !73, null}
!150 = metadata !{i32 468, i32 0, metadata !73, null}
