...
bb2.i.i:                                          ; preds = %bb.i.i
  switch i32 %49, label %bb5.i3.i.i [
...
bb2.i1.i.i:                                       ; preds = %bb2.i.i
  br label %ALIM.exit5.i.i, !dbg !142

bb4.i2.i.i:                                       ; preds = %bb2.i.i
  br label %ALIM.exit5.i.i, !dbg !143

bb5.i3.i.i:                                       ; preds = %bb2.i.i
  br label %ALIM.exit5.i.i, !dbg !144
...
ALIM.exit5.i.i:                                   ; preds = %bb5.i3.i.i, %bb4.i2.i.i, %bb2.i1.i.i, %bb2.i.i
  ...
  %81 = icmp sgt i32 %.0.i4.i.i, %Down_Separation.0, !dbg !141
  br i1 %81, label %bb16.i, label %bb15.i, !dbg !141

bb6.i.i:                                          ; preds = %bb12.i
  %82 = icmp slt i32 %38, 300, !dbg !145
  br i1 %82, label %bb15.i, label %bb7.i.i, !dbg !145
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb7.i.i
  ...
  %83 = icmp sle i32 %.0.i.i.i, %Up_Separation.0, !dbg !145
  %.old.i = icmp slt i32 %45, %Other_Tracked_Alt.0, !dbg !149
  %or.cond24.i = and i1 %83, %.old.i
  br i1 %or.cond24.i, label %bb16.i, label %bb15.i, !dbg !145
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit5.i.i
  ...
  br i1 %79, label %bb.i7.i, label %bb6.i10.i, !dbg !151

bb.i7.i:                                          ; preds = %bb16.i
  %84 = icmp sge i32 %45, %Other_Tracked_Alt.0, !dbg !154
  %85 = icmp slt i32 %38, 300, !dbg !154
  %or.cond.i.i = or i1 %85, %84
  br i1 %or.cond.i.i, label %bb23.i, label %bb2.i8.i, !dbg !154
...
bb2.i2.i.i:                                       ; preds = %bb2.i8.i
  br label %ALIM.exit6.i.i, !dbg !155

bb4.i3.i.i:                                       ; preds = %bb2.i8.i
  br label %ALIM.exit6.i.i, !dbg !156

bb5.i4.i.i:                                       ; preds = %bb2.i8.i
  br label %ALIM.exit6.i.i, !dbg !157
...
ALIM.exit6.i.i:                                   ; preds = %bb5.i4.i.i, %bb4.i3.i.i, %bb2.i2.i.i, %bb2.i8.i
  ...
  %86 = icmp sle i32 %.0.i5.i.i, %Down_Separation.0, !dbg !154
  %87 = icmp slt i32 %Other_Tracked_Alt.0, %45, !dbg !158
  %or.cond26.i = and i1 %86, %87
  br i1 %or.cond26.i, label %bb20.i, label %bb23.i, !dbg !154

bb6.i10.i:                                        ; preds = %bb16.i
  %88 = icmp slt i32 %Other_Tracked_Alt.0, %45
  br i1 %88, label %bb8.i.i, label %bb23.i, !dbg !160

bb8.i.i:                                          ; preds = %bb6.i10.i
  switch i32 %49, label %bb5.i.i13.i [
...
bb2.i.i11.i:                                      ; preds = %bb8.i.i
  br label %ALIM.exit.i15.i, !dbg !161

bb4.i.i12.i:                                      ; preds = %bb8.i.i
  br label %ALIM.exit.i15.i, !dbg !162

bb5.i.i13.i:                                      ; preds = %bb8.i.i
  br label %ALIM.exit.i15.i, !dbg !163
...
ALIM.exit.i15.i:                                  ; preds = %bb5.i.i13.i, %bb4.i.i12.i, %bb2.i.i11.i, %bb8.i.i
  ...
  %89 = icmp sgt i32 %.0.i.i14.i, %Up_Separation.0, !dbg !160
  br i1 %89, label %bb23.i, label %bb20.i, !dbg !160

bb20.i:                                           ; preds = %ALIM.exit.i15.i, %ALIM.exit6.i.i
  %90 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !164
  br i1 %90, label %bb25.i, label %alt_sep_test.exit, !dbg !164

bb23.i:                                           ; preds = %ALIM.exit.i15.i, %bb6.i10.i, %ALIM.exit6.i.i, %bb.i7.i
  %91 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !165
  br i1 %91, label %bb25.i, label %alt_sep_test.exit, !dbg !165

bb25.i:                                           ; preds = %bb20.i, %bb23.i
  %iftmp.8.022.i23 = phi i32 [ 0, %bb23.i ], [ 2, %bb20.i ]
  br label %alt_sep_test.exit, !dbg !166

alt_sep_test.exit:                                ; preds = %bb15, %bb9.i, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %bb15 ], [ 0, %bb9.i ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.8.022.i23, %bb25.i ]
  %92 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i32 %alt_sep.0.i) nounwind, !dbg !167
...
!1 = metadata !{i32 589865, metadata !"v41-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v41/follow/branch3/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v41-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v41/follow/branch3/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!95 = metadata !{i32 422, i32 0, metadata !80, null}
!96 = metadata !{i32 423, i32 0, metadata !80, null}
!97 = metadata !{i32 424, i32 0, metadata !80, null}
!98 = metadata !{i32 427, i32 0, metadata !80, null}
!99 = metadata !{i32 428, i32 0, metadata !80, null}
!100 = metadata !{i32 429, i32 0, metadata !80, null}
!101 = metadata !{i32 430, i32 0, metadata !80, null}
!102 = metadata !{i32 431, i32 0, metadata !80, null}
!103 = metadata !{i32 432, i32 0, metadata !80, null}
!104 = metadata !{i32 433, i32 0, metadata !80, null}
!105 = metadata !{i32 434, i32 0, metadata !80, null}
!106 = metadata !{i32 435, i32 0, metadata !80, null}
!107 = metadata !{i32 436, i32 0, metadata !80, null}
!108 = metadata !{i32 437, i32 0, metadata !80, null}
...
!111 = metadata !{i32 439, i32 0, metadata !80, null}
!112 = metadata !{i32 35, i32 0, metadata !110, metadata !111}
!113 = metadata !{i32 36, i32 0, metadata !110, metadata !111}
!114 = metadata !{i32 453, i32 0, metadata !80, null}
!115 = metadata !{i32 454, i32 0, metadata !80, null}
!116 = metadata !{i32 455, i32 0, metadata !80, null}
!117 = metadata !{i32 34, i32 0, metadata !110, metadata !118}
!118 = metadata !{i32 457, i32 0, metadata !80, null}
!119 = metadata !{i32 35, i32 0, metadata !110, metadata !118}
!120 = metadata !{i32 36, i32 0, metadata !110, metadata !118}
!121 = metadata !{i32 470, i32 0, metadata !80, null}
!122 = metadata !{i32 471, i32 0, metadata !80, null}
!123 = metadata !{i32 472, i32 0, metadata !80, null}
!124 = metadata !{i32 34, i32 0, metadata !110, metadata !125}
!125 = metadata !{i32 488, i32 0, metadata !80, null}
!126 = metadata !{i32 35, i32 0, metadata !110, metadata !125}
!127 = metadata !{i32 36, i32 0, metadata !110, metadata !125}
!128 = metadata !{i32 500, i32 0, metadata !80, null}
...
!131 = metadata !{i32 514, i32 0, metadata !80, null}
...
!139 = metadata !{i32 296, i32 0, metadata !130, metadata !131}
...
!145 = metadata !{i32 128, i32 0, metadata !138, metadata !139}
...
!149 = metadata !{i32 252, i32 0, metadata !150, metadata !139}
!150 = metadata !{i32 589835, metadata !9, i32 251, i32 0, metadata !1, i32 4} ; [ DW_TAG_lexical_block ]
!151 = metadata !{i32 173, i32 0, metadata !152, metadata !153}
!152 = metadata !{i32 589835, metadata !8, i32 156, i32 0, metadata !1, i32 3} ; [ DW_TAG_lexical_block ]
!153 = metadata !{i32 320, i32 0, metadata !130, metadata !131}
!154 = metadata !{i32 175, i32 0, metadata !152, metadata !153}
...
!158 = metadata !{i32 268, i32 0, metadata !159, metadata !153}
!159 = metadata !{i32 589835, metadata !10, i32 267, i32 0, metadata !1, i32 5} ; [ DW_TAG_lexical_block ]
!160 = metadata !{i32 201, i32 0, metadata !152, metadata !153}
...
!165 = metadata !{i32 348, i32 0, metadata !130, metadata !131}
!166 = metadata !{i32 353, i32 0, metadata !130, metadata !131}
!167 = metadata !{i32 515, i32 0, metadata !80, null}
!168 = metadata !{i32 516, i32 0, metadata !80, null}
!169 = metadata !{i32 13, i32 0, metadata !170, null}
!170 = metadata !{i32 589835, metadata !35, i32 12, i32 0, metadata !36, i32 0} ; [ DW_TAG_lexical_block ]
