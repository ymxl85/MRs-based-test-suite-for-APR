...
bb12.i:                                           ; preds = %bb9.i
  ...
  %56 = icmp sgt i32 %55, %Down_Separation.0, !dbg !109
  br i1 %56, label %bb.i.i, label %bb6.i.i, !dbg !112

bb.i.i:                                           ; preds = %bb12.i
  %57 = icmp slt i32 %38, %40
  br i1 %57, label %bb2.i.i, label %bb15.i, !dbg !113
...
ALIM.exit6.i.i:                                   ; preds = %bb5.i4.i.i, %bb4.i3.i.i, %bb2.i2.i.i, %bb2.i.i
  ...
  %58 = icmp sgt i32 %.0.i5.i.i, %Down_Separation.0, !dbg !113
  br i1 %58, label %bb16.i, label %bb15.i, !dbg !113

bb6.i.i:                                          ; preds = %bb12.i
  %59 = icmp sge i32 %40, %38, !dbg !118
  %60 = icmp slt i32 %36, 300, !dbg !118
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %61 = icmp sle i32 %.0.i.i.i, %Up_Separation.0, !dbg !118
  %.old.i = icmp slt i32 %38, %40, !dbg !122
  %or.cond31.i = and i1 %61, %.old.i
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  %62 = icmp eq i32 %43, 0, !dbg !124
  %iftmp.0.0.i.i.i = select i1 %62, i32 %Up_Separation.0, i32 %55
  %63 = icmp sgt i32 %iftmp.0.0.i.i.i, %Down_Separation.0, !dbg !126
  br i1 %63, label %bb.i7.i, label %bb6.i15.i, !dbg !129

bb.i7.i:                                          ; preds = %bb16.i
  %64 = icmp sge i32 %38, %40, !dbg !130
  %65 = icmp slt i32 %36, 300, !dbg !130
  %or.cond.i6.i = or i1 %65, %64
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  %69 = icmp sgt i32 %.0.i.i20.i, %Up_Separation.0, !dbg !136
...
!1 = metadata !{i32 589865, metadata !"v21-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v21/follow/branch2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v21-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v21/follow/branch2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!91 = metadata !{i32 424, i32 0, metadata !73, null}
!92 = metadata !{i32 425, i32 0, metadata !73, null}
!93 = metadata !{i32 427, i32 0, metadata !73, null}
!94 = metadata !{i32 428, i32 0, metadata !73, null}
!95 = metadata !{i32 429, i32 0, metadata !73, null}
!96 = metadata !{i32 430, i32 0, metadata !73, null}
!97 = metadata !{i32 433, i32 0, metadata !73, null}
!98 = metadata !{i32 434, i32 0, metadata !73, null}
!99 = metadata !{i32 435, i32 0, metadata !73, null}
!100 = metadata !{i32 437, i32 0, metadata !73, null}
...
!103 = metadata !{i32 458, i32 0, metadata !73, null}
!104 = metadata !{i32 288, i32 0, metadata !102, metadata !103}
!105 = metadata !{i32 293, i32 0, metadata !102, metadata !103}
!106 = metadata !{i32 432, i32 0, metadata !73, null}
!107 = metadata !{i32 426, i32 0, metadata !73, null}
...
!143 = metadata !{i32 459, i32 0, metadata !73, null}
!144 = metadata !{i32 460, i32 0, metadata !73, null}
