...
bb12.i:                                           ; preds = %bb9.i
  %77 = add nsw i32 %Up_Separation.0, 100, !dbg !135
  %78 = icmp sgt i32 %77, %Down_Separation.0, !dbg !135
  br i1 %78, label %bb.i.i, label %bb6.i.i, !dbg !138

bb.i.i:                                           ; preds = %bb12.i
  %79 = icmp slt i32 %45, %Other_Tracked_Alt.0
  br i1 %79, label %bb2.i.i, label %bb15.i, !dbg !139
...
ALIM.exit6.i.i:                                   ; preds = %bb5.i4.i.i, %bb4.i3.i.i, %bb2.i2.i.i, %bb2.i.i
  ...
  %80 = icmp sgt i32 %.0.i5.i.i, %Down_Separation.0, !dbg !139
  br i1 %80, label %bb16.i, label %bb15.i, !dbg !139

bb6.i.i:                                          ; preds = %bb12.i
  %81 = icmp sge i32 %Other_Tracked_Alt.0, %45, !dbg !143
  %82 = icmp slt i32 %38, 300, !dbg !143
  %or.cond.i.i = or i1 %82, %81
  br i1 %or.cond.i.i, label %bb15.i, label %bb8.i.i, !dbg !143
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %83 = icmp sle i32 %.0.i.i.i, %Up_Separation.0, !dbg !143
  %.old.i = icmp slt i32 %45, %Other_Tracked_Alt.0, !dbg !147
  %or.cond31.i = and i1 %83, %.old.i
  br i1 %or.cond31.i, label %bb16.i, label %bb15.i, !dbg !143

bb15.i:                                           ; preds = %ALIM.exit.i.i, %bb6.i.i, %ALIM.exit6.i.i, %bb.i.i
  br label %bb16.i, !dbg !137

bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  %iftmp.7.0.i = phi i32 [ 0, %bb15.i ], [ 1, %ALIM.exit6.i.i ], [ 1, %ALIM.exit.i.i ]
  %84 = icmp eq i32 %56, 0, !dbg !149
  %iftmp.0.0.i.i.i = select i1 %84, i32 %Up_Separation.0, i32 %77
  %85 = icmp sgt i32 %iftmp.0.0.i.i.i, %Down_Separation.0, !dbg !151
  br i1 %85, label %bb.i7.i, label %bb6.i15.i, !dbg !154

bb.i7.i:                                          ; preds = %bb16.i
  %86 = icmp sge i32 %45, %Other_Tracked_Alt.0, !dbg !155
  %87 = icmp slt i32 %38, 300, !dbg !155
  %or.cond.i6.i = or i1 %87, %86
  br i1 %or.cond.i6.i, label %bb23.i, label %bb2.i8.i, !dbg !155
...
bb4.i3.i10.i:                                     ; preds = %bb2.i8.i
  br label %ALIM.exit6.i13.i, !dbg !157

bb5.i4.i11.i:                                     ; preds = %bb2.i8.i
  br label %ALIM.exit6.i13.i, !dbg !158
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i8.i
  ...
  %88 = icmp sle i32 %.0.i5.i12.i, %Down_Separation.0, !dbg !155
  %89 = icmp slt i32 %Other_Tracked_Alt.0, %45, !dbg !159
  %or.cond33.i = and i1 %88, %89
  br i1 %or.cond33.i, label %bb20.i, label %bb23.i, !dbg !155

bb6.i15.i:                                        ; preds = %bb16.i
  %90 = icmp slt i32 %Other_Tracked_Alt.0, %45
  br i1 %90, label %bb8.i16.i, label %bb23.i, !dbg !161
...
bb4.i.i18.i:                                      ; preds = %bb8.i16.i
  br label %ALIM.exit.i21.i, !dbg !163

bb5.i.i19.i:                                      ; preds = %bb8.i16.i
  br label %ALIM.exit.i21.i, !dbg !164
...
ALIM.exit.i21.i:                                  ; preds = %bb5.i.i19.i, %bb4.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  %91 = icmp sgt i32 %.0.i.i20.i, %Up_Separation.0, !dbg !161
  br i1 %91, label %bb23.i, label %bb20.i, !dbg !161
...
bb23.i:                                           ; preds = %ALIM.exit.i21.i, %bb6.i15.i, %ALIM.exit6.i13.i, %bb.i7.i
  %93 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !166
  br i1 %93, label %bb25.i, label %alt_sep_test.exit, !dbg !166

bb25.i:                                           ; preds = %bb20.i, %bb23.i
  %iftmp.8.029.i23 = phi i32 [ 0, %bb23.i ], [ 2, %bb20.i ]
  br label %alt_sep_test.exit, !dbg !167

alt_sep_test.exit:                                ; preds = %bb15, %bb9.i, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %bb15 ], [ 0, %bb9.i ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.8.029.i23, %bb25.i ]
  %94 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i32 %alt_sep.0.i) nounwind, !dbg !168
  call void @exit(i32 0) noreturn nounwind, !dbg !169
  unreachable, !dbg !169
}
...
entry:
  %0 = icmp eq i64 %z, 0, !dbg !170
  br i1 %0, label %bb, label %return, !dbg !170
...
!llvm.dbg.sp = !{!0, !6, !7, !8, !9, !10, !11, !12, !13, !16, !25, !35, !41}
...
!1 = metadata !{i32 589865, metadata !"v21-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v21/follow/branch3/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v21-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v21/follow/branch3/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!8 = metadata !{i32 589870, i32 0, metadata !1, metadata !"Non_Crossing_Biased_Descend", metadata !"Non_Crossing_Biased_Descend", metadata !"Non_Crossing_Biased_Descend", metadata !1, i32 155, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, 
!9 = metadata !{i32 589870, i32 0, metadata !1, metadata !"Own_Below_Threat", metadata !"Own_Below_Threat", metadata !"Own_Below_Threat", metadata !1, i32 250, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null} ; [ DW_TAG_subpro
!10 = metadata !{i32 589870, i32 0, metadata !1, metadata !"Own_Above_Threat", metadata !"Own_Above_Threat", metadata !"Own_Above_Threat", metadata !1, i32 266, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null} ; [ DW_TAG_subpr
!11 = metadata !{i32 589870, i32 0, metadata !1, metadata !"alt_sep_test", metadata !"alt_sep_test", metadata !"alt_sep_test", metadata !1, i32 282, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null} ; [ DW_TAG_subprogram ]
!12 = metadata !{i32 589870, i32 0, metadata !1, metadata !"mainQ", metadata !"mainQ", metadata !"mainQ", metadata !1, i32 374, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null} ; [ DW_TAG_subprogram ]
!13 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 389, metadata !14, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!60 = metadata !{i32 590081, metadata !25, metadata !"dst", metadata !26, i32 12, metadata !30, i32 0} ; [ DW_TAG_arg_variable ]
!61 = metadata !{i32 590081, metadata !25, metadata !"s", metadata !26, i32 12, metadata !31, i32 0} ; [ DW_TAG_arg_variable ]
!62 = metadata !{i32 590081, metadata !25, metadata !"count", metadata !26, i32 12, metadata !32, i32 0} ; [ DW_TAG_arg_variable ]
!63 = metadata !{i32 590080, metadata !64, metadata !"a", metadata !26, i32 13, metadata !65, i32 0} ; [ DW_TAG_auto_variable ]
...
!66 = metadata !{i32 589877, metadata !26, metadata !"", metadata !26, i32 0, i64 8, i64 8, i64 0, i32 0, metadata !67} ; [ DW_TAG_volatile_type ]
!67 = metadata !{i32 589860, metadata !26, metadata !"char", metadata !26, i32 0, i64 8, i64 8, i64 0, i32 0, i32 6} ; [ DW_TAG_base_type ]
...
!79 = metadata !{i32 403, i32 0, metadata !80, null}
!80 = metadata !{i32 589835, metadata !13, i32 389, i32 0, metadata !1, i32 8} ; [ DW_TAG_lexical_block ]
!81 = metadata !{i32 404, i32 0, metadata !80, null}
!82 = metadata !{i32 405, i32 0, metadata !80, null}
!83 = metadata !{i32 406, i32 0, metadata !80, null}
!84 = metadata !{i32 407, i32 0, metadata !80, null}
!85 = metadata !{i32 408, i32 0, metadata !80, null}
!86 = metadata !{i32 409, i32 0, metadata !80, null}
!87 = metadata !{i32 410, i32 0, metadata !80, null}
!88 = metadata !{i32 411, i32 0, metadata !80, null}
!89 = metadata !{i32 412, i32 0, metadata !80, null}
!90 = metadata !{i32 413, i32 0, metadata !80, null}
!91 = metadata !{i32 414, i32 0, metadata !80, null}
!92 = metadata !{i32 415, i32 0, metadata !80, null}
!93 = metadata !{i32 416, i32 0, metadata !80, null}
!94 = metadata !{i32 417, i32 0, metadata !80, null}
...
!98 = metadata !{i32 426, i32 0, metadata !80, null}
!99 = metadata !{i32 427, i32 0, metadata !80, null}
!100 = metadata !{i32 428, i32 0, metadata !80, null}
!101 = metadata !{i32 429, i32 0, metadata !80, null}
!102 = metadata !{i32 430, i32 0, metadata !80, null}
!103 = metadata !{i32 431, i32 0, metadata !80, null}
!104 = metadata !{i32 432, i32 0, metadata !80, null}
!105 = metadata !{i32 433, i32 0, metadata !80, null}
!106 = metadata !{i32 434, i32 0, metadata !80, null}
!107 = metadata !{i32 435, i32 0, metadata !80, null}
!108 = metadata !{i32 436, i32 0, metadata !80, null}
...
!111 = metadata !{i32 438, i32 0, metadata !80, null}
!112 = metadata !{i32 35, i32 0, metadata !110, metadata !111}
!113 = metadata !{i32 36, i32 0, metadata !110, metadata !111}
!114 = metadata !{i32 452, i32 0, metadata !80, null}
!115 = metadata !{i32 453, i32 0, metadata !80, null}
!116 = metadata !{i32 454, i32 0, metadata !80, null}
!117 = metadata !{i32 34, i32 0, metadata !110, metadata !118}
!118 = metadata !{i32 456, i32 0, metadata !80, null}
!119 = metadata !{i32 35, i32 0, metadata !110, metadata !118}
!120 = metadata !{i32 36, i32 0, metadata !110, metadata !118}
!121 = metadata !{i32 469, i32 0, metadata !80, null}
!122 = metadata !{i32 470, i32 0, metadata !80, null}
!123 = metadata !{i32 471, i32 0, metadata !80, null}
!124 = metadata !{i32 34, i32 0, metadata !110, metadata !125}
!125 = metadata !{i32 487, i32 0, metadata !80, null}
!126 = metadata !{i32 35, i32 0, metadata !110, metadata !125}
!127 = metadata !{i32 36, i32 0, metadata !110, metadata !125}
!128 = metadata !{i32 499, i32 0, metadata !80, null}
!129 = metadata !{i32 287, i32 0, metadata !130, metadata !131}
!130 = metadata !{i32 589835, metadata !11, i32 282, i32 0, metadata !1, i32 6} ; [ DW_TAG_lexical_block ]
!131 = metadata !{i32 513, i32 0, metadata !80, null}
!132 = metadata !{i32 288, i32 0, metadata !130, metadata !131}
!133 = metadata !{i32 293, i32 0, metadata !130, metadata !131}
!134 = metadata !{i32 289, i32 0, metadata !130, metadata !131}
!135 = metadata !{i32 76, i32 0, metadata !136, metadata !137}
!136 = metadata !{i32 589835, metadata !7, i32 71, i32 0, metadata !1, i32 2} ; [ DW_TAG_lexical_block ]
!137 = metadata !{i32 295, i32 0, metadata !130, metadata !131}
!138 = metadata !{i32 77, i32 0, metadata !136, metadata !137}
!139 = metadata !{i32 79, i32 0, metadata !136, metadata !137}
!140 = metadata !{i32 34, i32 0, metadata !110, metadata !139}
!141 = metadata !{i32 35, i32 0, metadata !110, metadata !139}
!142 = metadata !{i32 36, i32 0, metadata !110, metadata !139}
!143 = metadata !{i32 116, i32 0, metadata !136, metadata !137}
!144 = metadata !{i32 34, i32 0, metadata !110, metadata !143}
!145 = metadata !{i32 35, i32 0, metadata !110, metadata !143}
!146 = metadata !{i32 36, i32 0, metadata !110, metadata !143}
!147 = metadata !{i32 251, i32 0, metadata !148, metadata !137}
!148 = metadata !{i32 589835, metadata !9, i32 250, i32 0, metadata !1, i32 4} ; [ DW_TAG_lexical_block ]
!149 = metadata !{i32 54, i32 0, metadata !150, metadata !151}
!150 = metadata !{i32 589835, metadata !6, i32 52, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!151 = metadata !{i32 160, i32 0, metadata !152, metadata !153}
!152 = metadata !{i32 589835, metadata !8, i32 155, i32 0, metadata !1, i32 3} ; [ DW_TAG_lexical_block ]
!153 = metadata !{i32 319, i32 0, metadata !130, metadata !131}
!154 = metadata !{i32 172, i32 0, metadata !152, metadata !153}
!155 = metadata !{i32 174, i32 0, metadata !152, metadata !153}
!156 = metadata !{i32 34, i32 0, metadata !110, metadata !155}
!157 = metadata !{i32 35, i32 0, metadata !110, metadata !155}
!158 = metadata !{i32 36, i32 0, metadata !110, metadata !155}
!159 = metadata !{i32 267, i32 0, metadata !160, metadata !153}
!160 = metadata !{i32 589835, metadata !10, i32 266, i32 0, metadata !1, i32 5} ; [ DW_TAG_lexical_block ]
!161 = metadata !{i32 200, i32 0, metadata !152, metadata !153}
!162 = metadata !{i32 34, i32 0, metadata !110, metadata !161}
!163 = metadata !{i32 35, i32 0, metadata !110, metadata !161}
!164 = metadata !{i32 36, i32 0, metadata !110, metadata !161}
!165 = metadata !{i32 342, i32 0, metadata !130, metadata !131}
!166 = metadata !{i32 347, i32 0, metadata !130, metadata !131}
!167 = metadata !{i32 352, i32 0, metadata !130, metadata !131}
!168 = metadata !{i32 514, i32 0, metadata !80, null}
!169 = metadata !{i32 515, i32 0, metadata !80, null}
!170 = metadata !{i32 13, i32 0, metadata !171, null}
!171 = metadata !{i32 589835, metadata !35, i32 12, i32 0, metadata !36, i32 0} ; [ DW_TAG_lexical_block ]
!172 = metadata !{i32 14, i32 0, metadata !171, null}
!173 = metadata !{i32 15, i32 0, metadata !171, null}
