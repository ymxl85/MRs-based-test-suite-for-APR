...
bb12.i:                                           ; preds = %bb9.i
  ...
  br i1 %57, label %bb.i.i, label %bb5.i.i, !dbg !114

bb.i.i:                                           ; preds = %bb12.i
  %58 = icmp slt i32 %38, %40
  br i1 %58, label %bb3.i.i, label %bb1.i.i, !dbg !115
...
ALIM.exit6.i.i:                                   ; preds = %bb5.i4.i.i, %bb4.i3.i.i, %bb2.i2.i.i, %bb1.i.i
  ...
  br i1 %59, label %Non_Crossing_Biased_Climb.exit.i, label %bb3.i.i, !dbg !115
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb7.i.i
  ...
  br i1 %62, label %bb9.i.i, label %Non_Crossing_Biased_Climb.exit.i, !dbg !120
...
Non_Crossing_Biased_Climb.exit.i:                 ; preds = %bb9.i.i, %ALIM.exit.i.i, %bb3.i.i, %ALIM.exit6.i.i
  ...
  br i1 %57, label %bb.i8.i, label %bb6.i.i, !dbg !124

bb.i8.i:                                          ; preds = %Non_Crossing_Biased_Climb.exit.i
  %63 = icmp sge i32 %38, %40, !dbg !127
  %64 = icmp slt i32 %36, 300, !dbg !127
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i.i
  ...
  %65 = icmp sle i32 %.0.i5.i12.i, %Down_Separation.0, !dbg !127
  %66 = icmp slt i32 %40, %38, !dbg !131
...
bb6.i.i:                                          ; preds = %Non_Crossing_Biased_Climb.exit.i
  ...
  br i1 %67, label %bb8.i.i, label %bb19.i, !dbg !133
...
ALIM.exit.i18.i:                                  ; preds = %bb5.i.i16.i, %bb4.i.i15.i, %bb2.i.i14.i, %bb8.i.i
  ...
  %68 = icmp sgt i32 %.0.i.i17.i, %Up_Separation.0, !dbg !133
  br i1 %68, label %bb19.i, label %bb16.i, !dbg !133

bb16.i:                                           ; preds = %ALIM.exit.i18.i, %ALIM.exit6.i13.i
  %69 = icmp eq i32 %result.0.i.i, 0, !dbg !137
  br i1 %69, label %bb21.i, label %alt_sep_test.exit, !dbg !137

bb19.i:                                           ; preds = %ALIM.exit.i18.i, %bb6.i.i, %ALIM.exit6.i13.i, %bb.i8.i
  %70 = icmp eq i32 %result.0.i.i, 0, !dbg !138
  br i1 %70, label %bb21.i, label %alt_sep_test.exit, !dbg !138
...
alt_sep_test.exit:                                ; preds = %entry, %bb9.i, %bb16.i, %bb19.i, %bb21.i
  ...
  %71 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i32 %alt_sep.0.i) nounwind, !dbg !140
...
!1 = metadata !{i32 589865, metadata !"v40-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v40/follow/branch2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v40-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v40/follow/branch2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!97 = metadata !{i32 424, i32 0, metadata !73, null}
!98 = metadata !{i32 425, i32 0, metadata !73, null}
!99 = metadata !{i32 426, i32 0, metadata !73, null}
!100 = metadata !{i32 428, i32 0, metadata !73, null}
...
!106 = metadata !{i32 423, i32 0, metadata !73, null}
!107 = metadata !{i32 417, i32 0, metadata !73, null}
...
!140 = metadata !{i32 450, i32 0, metadata !73, null}
!141 = metadata !{i32 451, i32 0, metadata !73, null}
