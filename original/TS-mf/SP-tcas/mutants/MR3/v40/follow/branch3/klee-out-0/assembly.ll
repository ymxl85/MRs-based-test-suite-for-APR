...
bb12.i:                                           ; preds = %bb9.i
  ...
  br i1 %79, label %bb.i.i, label %bb5.i.i, !dbg !140

bb.i.i:                                           ; preds = %bb12.i
  %80 = icmp slt i32 %45, %Other_Tracked_Alt.0
  br i1 %80, label %bb3.i.i, label %bb1.i.i, !dbg !141
...
ALIM.exit6.i.i:                                   ; preds = %bb5.i4.i.i, %bb4.i3.i.i, %bb2.i2.i.i, %bb1.i.i
  ...
  br i1 %81, label %Non_Crossing_Biased_Climb.exit.i, label %bb3.i.i, !dbg !141

bb3.i.i:                                          ; preds = %ALIM.exit6.i.i, %bb.i.i
  br label %Non_Crossing_Biased_Climb.exit.i, !dbg !141

bb5.i.i:                                          ; preds = %bb12.i
  %82 = icmp sge i32 %Other_Tracked_Alt.0, %45, !dbg !145
  %83 = icmp slt i32 %38, 300, !dbg !145
  %or.cond.i.i = or i1 %83, %82
  br i1 %or.cond.i.i, label %bb9.i.i, label %bb7.i.i, !dbg !145
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb7.i.i
  ...
  %84 = icmp sgt i32 %.0.i.i.i, %Up_Separation.0, !dbg !145
  br i1 %84, label %bb9.i.i, label %Non_Crossing_Biased_Climb.exit.i, !dbg !145

bb9.i.i:                                          ; preds = %ALIM.exit.i.i, %bb5.i.i
  br label %Non_Crossing_Biased_Climb.exit.i, !dbg !145
...
Non_Crossing_Biased_Climb.exit.i:                 ; preds = %bb9.i.i, %ALIM.exit.i.i, %bb3.i.i, %ALIM.exit6.i.i
  ...
  br i1 %79, label %bb.i8.i, label %bb6.i.i, !dbg !149

bb.i8.i:                                          ; preds = %Non_Crossing_Biased_Climb.exit.i
  %85 = icmp sge i32 %45, %Other_Tracked_Alt.0, !dbg !152
  %86 = icmp slt i32 %38, 300, !dbg !152
  %or.cond.i7.i = or i1 %86, %85
  br i1 %or.cond.i7.i, label %bb19.i, label %bb2.i.i, !dbg !152
...
ALIM.exit6.i13.i:                                 ; preds = %bb5.i4.i11.i, %bb4.i3.i10.i, %bb2.i2.i9.i, %bb2.i.i
  ...
  %87 = icmp sle i32 %.0.i5.i12.i, %Down_Separation.0, !dbg !152
  %88 = icmp slt i32 %Other_Tracked_Alt.0, %45, !dbg !156
  %or.cond24.i = and i1 %87, %88
  br i1 %or.cond24.i, label %bb16.i, label %bb19.i, !dbg !152

bb6.i.i:                                          ; preds = %Non_Crossing_Biased_Climb.exit.i
  %89 = icmp slt i32 %Other_Tracked_Alt.0, %45
  br i1 %89, label %bb8.i.i, label %bb19.i, !dbg !158

bb8.i.i:                                          ; preds = %bb6.i.i
  switch i32 %49, label %bb5.i.i16.i [
...
bb2.i.i14.i:                                      ; preds = %bb8.i.i
  br label %ALIM.exit.i18.i, !dbg !159

bb4.i.i15.i:                                      ; preds = %bb8.i.i
  br label %ALIM.exit.i18.i, !dbg !160

bb5.i.i16.i:                                      ; preds = %bb8.i.i
  br label %ALIM.exit.i18.i, !dbg !161
...
ALIM.exit.i18.i:                                  ; preds = %bb5.i.i16.i, %bb4.i.i15.i, %bb2.i.i14.i, %bb8.i.i
  ...
  %90 = icmp sgt i32 %.0.i.i17.i, %Up_Separation.0, !dbg !158
  br i1 %90, label %bb19.i, label %bb16.i, !dbg !158

bb16.i:                                           ; preds = %ALIM.exit.i18.i, %ALIM.exit6.i13.i
  %91 = icmp eq i32 %result.0.i.i, 0, !dbg !162
  br i1 %91, label %bb21.i, label %alt_sep_test.exit, !dbg !162

bb19.i:                                           ; preds = %ALIM.exit.i18.i, %bb6.i.i, %ALIM.exit6.i13.i, %bb.i8.i
  %92 = icmp eq i32 %result.0.i.i, 0, !dbg !163
  br i1 %92, label %bb21.i, label %alt_sep_test.exit, !dbg !163

bb21.i:                                           ; preds = %bb16.i, %bb19.i
  %iftmp.7.023.i23 = phi i32 [ 0, %bb19.i ], [ 2, %bb16.i ]
  br label %alt_sep_test.exit, !dbg !164

alt_sep_test.exit:                                ; preds = %bb15, %bb9.i, %bb16.i, %bb19.i, %bb21.i
  %alt_sep.0.i = phi i32 [ 0, %bb15 ], [ 0, %bb9.i ], [ 0, %bb16.i ], [ 1, %bb19.i ], [ %iftmp.7.023.i23, %bb21.i ]
  %93 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i32 %alt_sep.0.i) nounwind, !dbg !165
  call void @exit(i32 0) noreturn nounwind, !dbg !166
  unreachable, !dbg !166
}
...
entry:
  %0 = icmp eq i64 %z, 0, !dbg !167
  br i1 %0, label %bb, label %return, !dbg !167
...
!1 = metadata !{i32 589865, metadata !"v40-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v40/follow/branch3/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v40-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v40/follow/branch3/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!95 = metadata !{i32 412, i32 0, metadata !80, null}
!96 = metadata !{i32 413, i32 0, metadata !80, null}
!97 = metadata !{i32 414, i32 0, metadata !80, null}
!98 = metadata !{i32 417, i32 0, metadata !80, null}
!99 = metadata !{i32 418, i32 0, metadata !80, null}
!100 = metadata !{i32 419, i32 0, metadata !80, null}
!101 = metadata !{i32 420, i32 0, metadata !80, null}
!102 = metadata !{i32 421, i32 0, metadata !80, null}
!103 = metadata !{i32 422, i32 0, metadata !80, null}
!104 = metadata !{i32 423, i32 0, metadata !80, null}
!105 = metadata !{i32 424, i32 0, metadata !80, null}
!106 = metadata !{i32 425, i32 0, metadata !80, null}
!107 = metadata !{i32 426, i32 0, metadata !80, null}
!108 = metadata !{i32 427, i32 0, metadata !80, null}
...
!111 = metadata !{i32 429, i32 0, metadata !80, null}
!112 = metadata !{i32 35, i32 0, metadata !110, metadata !111}
!113 = metadata !{i32 36, i32 0, metadata !110, metadata !111}
!114 = metadata !{i32 443, i32 0, metadata !80, null}
!115 = metadata !{i32 444, i32 0, metadata !80, null}
!116 = metadata !{i32 445, i32 0, metadata !80, null}
!117 = metadata !{i32 34, i32 0, metadata !110, metadata !118}
!118 = metadata !{i32 447, i32 0, metadata !80, null}
!119 = metadata !{i32 35, i32 0, metadata !110, metadata !118}
!120 = metadata !{i32 36, i32 0, metadata !110, metadata !118}
!121 = metadata !{i32 460, i32 0, metadata !80, null}
!122 = metadata !{i32 461, i32 0, metadata !80, null}
!123 = metadata !{i32 462, i32 0, metadata !80, null}
!124 = metadata !{i32 34, i32 0, metadata !110, metadata !125}
!125 = metadata !{i32 478, i32 0, metadata !80, null}
!126 = metadata !{i32 35, i32 0, metadata !110, metadata !125}
!127 = metadata !{i32 36, i32 0, metadata !110, metadata !125}
!128 = metadata !{i32 490, i32 0, metadata !80, null}
!129 = metadata !{i32 288, i32 0, metadata !130, metadata !131}
!130 = metadata !{i32 589835, metadata !11, i32 283, i32 0, metadata !1, i32 6} ; [ DW_TAG_lexical_block ]
!131 = metadata !{i32 504, i32 0, metadata !80, null}
!132 = metadata !{i32 289, i32 0, metadata !130, metadata !131}
!133 = metadata !{i32 294, i32 0, metadata !130, metadata !131}
!134 = metadata !{i32 290, i32 0, metadata !130, metadata !131}
...
!139 = metadata !{i32 297, i32 0, metadata !130, metadata !131}
!140 = metadata !{i32 88, i32 0, metadata !138, metadata !139}
!141 = metadata !{i32 91, i32 0, metadata !138, metadata !139}
...
!145 = metadata !{i32 117, i32 0, metadata !138, metadata !139}
...
!149 = metadata !{i32 173, i32 0, metadata !150, metadata !151}
!150 = metadata !{i32 589835, metadata !8, i32 156, i32 0, metadata !1, i32 3} ; [ DW_TAG_lexical_block ]
!151 = metadata !{i32 310, i32 0, metadata !130, metadata !131}
!152 = metadata !{i32 175, i32 0, metadata !150, metadata !151}
!153 = metadata !{i32 34, i32 0, metadata !110, metadata !152}
!154 = metadata !{i32 35, i32 0, metadata !110, metadata !152}
!155 = metadata !{i32 36, i32 0, metadata !110, metadata !152}
!156 = metadata !{i32 268, i32 0, metadata !157, metadata !151}
!157 = metadata !{i32 589835, metadata !10, i32 267, i32 0, metadata !1, i32 5} ; [ DW_TAG_lexical_block ]
!158 = metadata !{i32 201, i32 0, metadata !150, metadata !151}
!159 = metadata !{i32 34, i32 0, metadata !110, metadata !158}
!160 = metadata !{i32 35, i32 0, metadata !110, metadata !158}
!161 = metadata !{i32 36, i32 0, metadata !110, metadata !158}
!162 = metadata !{i32 333, i32 0, metadata !130, metadata !131}
!163 = metadata !{i32 338, i32 0, metadata !130, metadata !131}
!164 = metadata !{i32 343, i32 0, metadata !130, metadata !131}
!165 = metadata !{i32 505, i32 0, metadata !80, null}
!166 = metadata !{i32 506, i32 0, metadata !80, null}
!167 = metadata !{i32 13, i32 0, metadata !168, null}
!168 = metadata !{i32 589835, metadata !26, i32 12, i32 0, metadata !27, i32 0} ; [ DW_TAG_lexical_block ]
!169 = metadata !{i32 14, i32 0, metadata !168, null}
!170 = metadata !{i32 15, i32 0, metadata !168, null}
