...
bb12.i:                                           ; preds = %bb9.i
  ...
  br i1 %56, label %bb.i.i, label %bb6.i.i, !dbg !114

bb.i.i:                                           ; preds = %bb12.i
  %57 = icmp slt i32 %38, %40
  br i1 %57, label %bb2.i.i, label %bb15.i, !dbg !115
...
ALIM.exit6.i.i:                                   ; preds = %bb5.i4.i.i, %bb4.i3.i.i, %bb2.i2.i.i, %bb2.i.i
  ...
  br i1 %58, label %bb16.i, label %bb15.i, !dbg !115
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %61 = icmp sle i32 %.0.i.i.i, %Up_Separation.0, !dbg !120
  %.old.i = icmp slt i32 %38, %40, !dbg !124
  %or.cond31.i = and i1 %61, %.old.i
  br i1 %or.cond31.i, label %bb16.i, label %bb15.i, !dbg !120
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  %62 = icmp sgt i32 %Up_Separation.0, %Down_Separation.0, !dbg !126
...
!1 = metadata !{i32 589865, metadata !"v24-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v24/follow/branch1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v24-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v24/follow/branch1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
...
!113 = metadata !{i32 295, i32 0, metadata !102, metadata !103}
...
!124 = metadata !{i32 251, i32 0, metadata !125, metadata !113}
!125 = metadata !{i32 589835, metadata !9, i32 250, i32 0, metadata !1, i32 4} ; [ DW_TAG_lexical_block ]
