...
bb12.i:                                           ; preds = %bb9.i
  ...
  %57 = icmp sgt i32 %iftmp.0.0.i.i.i, %Down_Separation.0, !dbg !111
  br i1 %57, label %bb.i.i, label %bb6.i.i, !dbg !114
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  %63 = icmp sgt i32 %Up_Separation.0, %Down_Separation.0, !dbg !126
...
!1 = metadata !{i32 589865, metadata !"v24-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v24/follow/branch2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v24-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR3/v24/follow/branch2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", 
