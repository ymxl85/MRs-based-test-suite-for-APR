...
bb2.i.i:                                          ; preds = %bb.i.i
  switch i32 %65, label %bb3.i3.i.i [
...
bb6.i.i:                                          ; preds = %bb12.i
  %83 = icmp sge i32 %64, %62, !dbg !125
  %84 = icmp slt i32 %60, 300, !dbg !125
  %or.cond.i.i = or i1 %84, %83
  br i1 %or.cond.i.i, label %bb15.i, label %bb8.i.i, !dbg !125

bb8.i.i:                                          ; preds = %bb6.i.i
  switch i32 %65, label %bb3.i.i.i [
...
ALIM.exit.i.i:                                    ; preds = %bb3.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %85 = icmp sle i32 %.0.i.i.i, %66, !dbg !125
  %.old.i = icmp slt i32 %62, %64, !dbg !128
  %or.cond30.i = and i1 %85, %.old.i
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit5.i.i
  ...
  br i1 %80, label %bb.i8.i, label %bb6.i15.i, !dbg !130

bb.i8.i:                                          ; preds = %bb16.i
  %86 = icmp sge i32 %62, %64, !dbg !133
  %87 = icmp slt i32 %60, 300, !dbg !133
  %or.cond.i7.i = or i1 %87, %86
  br i1 %or.cond.i7.i, label %bb23.i, label %bb2.i9.i, !dbg !133

bb2.i9.i:                                         ; preds = %bb.i8.i
  switch i32 %65, label %bb3.i3.i11.i [
...
ALIM.exit5.i13.i:                                 ; preds = %bb3.i3.i11.i, %bb2.i2.i10.i, %bb2.i9.i
  ...
  %88 = icmp sle i32 %.0.i4.i12.i, %67, !dbg !133
  %89 = icmp slt i32 %64, %62, !dbg !136
  %or.cond32.i = and i1 %88, %89
  br i1 %or.cond32.i, label %bb20.i, label %bb23.i, !dbg !133

bb6.i15.i:                                        ; preds = %bb16.i
  %90 = icmp slt i32 %64, %62
  br i1 %90, label %bb8.i16.i, label %bb23.i, !dbg !138

bb8.i16.i:                                        ; preds = %bb6.i15.i
  switch i32 %65, label %bb3.i.i18.i [
...
ALIM.exit.i20.i:                                  ; preds = %bb3.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  ...
  %91 = icmp sgt i32 %.0.i.i19.i, %66, !dbg !138
  br i1 %91, label %bb23.i, label %bb20.i, !dbg !138

bb20.i:                                           ; preds = %ALIM.exit.i20.i, %ALIM.exit5.i13.i
  %92 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !141
  br i1 %92, label %bb25.i, label %alt_sep_test.exit, !dbg !141

bb23.i:                                           ; preds = %ALIM.exit.i20.i, %bb6.i15.i, %ALIM.exit5.i13.i, %bb.i8.i
  %93 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !142
  br i1 %93, label %bb25.i, label %alt_sep_test.exit, !dbg !142

bb25.i:                                           ; preds = %bb20.i, %bb23.i
  %iftmp.8.028.i9 = phi i32 [ 0, %bb23.i ], [ 2, %bb20.i ]
  br label %alt_sep_test.exit, !dbg !143

alt_sep_test.exit:                                ; preds = %entry, %bb9.i, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %entry ], [ 0, %bb9.i ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.8.028.i9, %bb25.i ]
  %94 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i32 %alt_sep.0.i) nounwind, !dbg !144
...
!1 = metadata !{i32 589865, metadata !"v38-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR2/v38/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v38-s.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR2/v38/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
...
!106 = metadata !{i32 452, i32 0, metadata !73, null}
!107 = metadata !{i32 297, i32 0, metadata !108, metadata !109}
!108 = metadata !{i32 589835, metadata !11, i32 292, i32 0, metadata !1, i32 6} ; [ DW_TAG_lexical_block ]
!109 = metadata !{i32 465, i32 0, metadata !73, null}
!110 = metadata !{i32 298, i32 0, metadata !108, metadata !109}
!111 = metadata !{i32 303, i32 0, metadata !108, metadata !109}
!112 = metadata !{i32 450, i32 0, metadata !73, null}
!113 = metadata !{i32 443, i32 0, metadata !73, null}
!114 = metadata !{i32 299, i32 0, metadata !108, metadata !109}
...
!119 = metadata !{i32 305, i32 0, metadata !108, metadata !109}
...
!132 = metadata !{i32 329, i32 0, metadata !108, metadata !109}
...
!141 = metadata !{i32 352, i32 0, metadata !108, metadata !109}
!142 = metadata !{i32 357, i32 0, metadata !108, metadata !109}
!143 = metadata !{i32 362, i32 0, metadata !108, metadata !109}
!144 = metadata !{i32 466, i32 0, metadata !73, null}
!145 = metadata !{i32 467, i32 0, metadata !73, null}
