...
bb2.i.i:                                          ; preds = %bb.i.i
  switch i32 %Alt_Layer_Value.0, label %bb3.i3.i.i [
...
bb3.i3.i.i:                                       ; preds = %bb2.i.i
  br label %ALIM.exit5.i.i, !dbg !124

ALIM.exit5.i.i:                                   ; preds = %bb3.i3.i.i, %bb2.i2.i.i, %bb2.i.i
  %.0.i4.i.i = phi i32 [ 500, %bb2.i2.i.i ], [ 640, %bb3.i3.i.i ], [ 400, %bb2.i.i ]
  %64 = icmp sgt i32 %.0.i4.i.i, %Down_Separation.0, !dbg !121
  br i1 %64, label %bb16.i, label %bb15.i, !dbg !121

bb6.i.i:                                          ; preds = %bb12.i
  %65 = icmp sge i32 %41, %39, !dbg !125
  %66 = icmp slt i32 %36, 300, !dbg !125
  %or.cond.i.i = or i1 %66, %65
  br i1 %or.cond.i.i, label %bb15.i, label %bb8.i.i, !dbg !125

bb8.i.i:                                          ; preds = %bb6.i.i
  switch i32 %Alt_Layer_Value.0, label %bb3.i.i.i [
...
bb3.i.i.i:                                        ; preds = %bb8.i.i
  br label %ALIM.exit.i.i, !dbg !127

ALIM.exit.i.i:                                    ; preds = %bb3.i.i.i, %bb2.i.i.i, %bb8.i.i
  %.0.i.i.i = phi i32 [ 500, %bb2.i.i.i ], [ 640, %bb3.i.i.i ], [ 400, %bb8.i.i ]
  %67 = icmp sle i32 %.0.i.i.i, %Up_Separation.0, !dbg !125
  %.old.i = icmp slt i32 %39, %41, !dbg !128
  %or.cond30.i = and i1 %67, %.old.i
  br i1 %or.cond30.i, label %bb16.i, label %bb15.i, !dbg !125
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit5.i.i
  ...
  br i1 %62, label %bb.i8.i, label %bb6.i15.i, !dbg !130

bb.i8.i:                                          ; preds = %bb16.i
  %68 = icmp sge i32 %39, %41, !dbg !133
  %69 = icmp slt i32 %36, 300, !dbg !133
  %or.cond.i7.i = or i1 %69, %68
  br i1 %or.cond.i7.i, label %bb23.i, label %bb2.i9.i, !dbg !133

bb2.i9.i:                                         ; preds = %bb.i8.i
  switch i32 %Alt_Layer_Value.0, label %bb3.i3.i11.i [
    i32 0, label %ALIM.exit5.i13.i
    i32 1, label %bb2.i2.i10.i
  ]

bb2.i2.i10.i:                                     ; preds = %bb2.i9.i
  br label %ALIM.exit5.i13.i, !dbg !134

bb3.i3.i11.i:                                     ; preds = %bb2.i9.i
  br label %ALIM.exit5.i13.i, !dbg !135

ALIM.exit5.i13.i:                                 ; preds = %bb3.i3.i11.i, %bb2.i2.i10.i, %bb2.i9.i
  %.0.i4.i12.i = phi i32 [ 500, %bb2.i2.i10.i ], [ 640, %bb3.i3.i11.i ], [ 400, %bb2.i9.i ]
  %70 = icmp sle i32 %.0.i4.i12.i, %Down_Separation.0, !dbg !133
  %71 = icmp slt i32 %41, %39, !dbg !136
  %or.cond32.i = and i1 %70, %71
  br i1 %or.cond32.i, label %bb20.i, label %bb23.i, !dbg !133

bb6.i15.i:                                        ; preds = %bb16.i
  %72 = icmp slt i32 %41, %39
  br i1 %72, label %bb8.i16.i, label %bb23.i, !dbg !138

bb8.i16.i:                                        ; preds = %bb6.i15.i
  switch i32 %Alt_Layer_Value.0, label %bb3.i.i18.i [
    i32 0, label %ALIM.exit.i20.i
    i32 1, label %bb2.i.i17.i
  ]

bb2.i.i17.i:                                      ; preds = %bb8.i16.i
  br label %ALIM.exit.i20.i, !dbg !139

bb3.i.i18.i:                                      ; preds = %bb8.i16.i
  br label %ALIM.exit.i20.i, !dbg !140

ALIM.exit.i20.i:                                  ; preds = %bb3.i.i18.i, %bb2.i.i17.i, %bb8.i16.i
  %.0.i.i19.i = phi i32 [ 500, %bb2.i.i17.i ], [ 640, %bb3.i.i18.i ], [ 400, %bb8.i16.i ]
  %73 = icmp sgt i32 %.0.i.i19.i, %Up_Separation.0, !dbg !138
  br i1 %73, label %bb23.i, label %bb20.i, !dbg !138

bb20.i:                                           ; preds = %ALIM.exit.i20.i, %ALIM.exit5.i13.i
  %74 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !141
  br i1 %74, label %bb25.i, label %alt_sep_test.exit, !dbg !141

bb23.i:                                           ; preds = %ALIM.exit.i20.i, %bb6.i15.i, %ALIM.exit5.i13.i, %bb.i8.i
  %75 = icmp eq i32 %iftmp.7.0.i, 0, !dbg !142
  br i1 %75, label %bb25.i, label %alt_sep_test.exit, !dbg !142

bb25.i:                                           ; preds = %bb20.i, %bb23.i
  %iftmp.8.028.i3 = phi i32 [ 0, %bb23.i ], [ 2, %bb20.i ]
  br label %alt_sep_test.exit, !dbg !143

alt_sep_test.exit:                                ; preds = %bb15, %bb9.i, %bb20.i, %bb23.i, %bb25.i
  %alt_sep.0.i = phi i32 [ 0, %bb15 ], [ 0, %bb9.i ], [ 0, %bb20.i ], [ 1, %bb23.i ], [ %iftmp.8.028.i3, %bb25.i ]
  %76 = call i32 (...)* @klee_print_expr(i8* getelementptr inbounds ([8 x i8]* @.str12, i32 0, i32 0), i32 %alt_sep.0.i) nounwind, !dbg !144
  call void @exit(i32 0) noreturn nounwind, !dbg !145
  unreachable, !dbg !145
}
...
!1 = metadata !{i32 589865, metadata !"v38-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR2/v38/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v38-f.c", metadata !"/home/mingyue/experiments/ceti/TCAS/SP-tcas/mutants/MR2/v38/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ;
...
!6 = metadata !{i32 589870, i32 0, metadata !1, metadata !"Inhibit_Biased_Climb", metadata !"Inhibit_Biased_Climb", metadata !"Inhibit_Biased_Climb", metadata !1, i32 51, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null} ; [ DW
...
!103 = metadata !{i32 451, i32 0, metadata !73, null}
!104 = metadata !{i32 452, i32 0, metadata !73, null}
!105 = metadata !{i32 453, i32 0, metadata !73, null}
!106 = metadata !{i32 457, i32 0, metadata !73, null}
!107 = metadata !{i32 458, i32 0, metadata !73, null}
!108 = metadata !{i32 459, i32 0, metadata !73, null}
!109 = metadata !{i32 297, i32 0, metadata !110, metadata !111}
!110 = metadata !{i32 589835, metadata !11, i32 292, i32 0, metadata !1, i32 6} ; [ DW_TAG_lexical_block ]
!111 = metadata !{i32 473, i32 0, metadata !73, null}
!112 = metadata !{i32 298, i32 0, metadata !110, metadata !111}
!113 = metadata !{i32 303, i32 0, metadata !110, metadata !111}
!114 = metadata !{i32 299, i32 0, metadata !110, metadata !111}
!115 = metadata !{i32 53, i32 0, metadata !116, metadata !117}
!116 = metadata !{i32 589835, metadata !6, i32 51, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!117 = metadata !{i32 75, i32 0, metadata !118, metadata !119}
!118 = metadata !{i32 589835, metadata !7, i32 70, i32 0, metadata !1, i32 2} ; [ DW_TAG_lexical_block ]
!119 = metadata !{i32 305, i32 0, metadata !110, metadata !111}
!120 = metadata !{i32 87, i32 0, metadata !118, metadata !119}
!121 = metadata !{i32 89, i32 0, metadata !118, metadata !119}
...
!125 = metadata !{i32 126, i32 0, metadata !118, metadata !119}
!126 = metadata !{i32 34, i32 0, metadata !123, metadata !125}
!127 = metadata !{i32 35, i32 0, metadata !123, metadata !125}
!128 = metadata !{i32 261, i32 0, metadata !129, metadata !119}
!129 = metadata !{i32 589835, metadata !9, i32 260, i32 0, metadata !1, i32 4} ; [ DW_TAG_lexical_block ]
!130 = metadata !{i32 182, i32 0, metadata !131, metadata !132}
!131 = metadata !{i32 589835, metadata !8, i32 165, i32 0, metadata !1, i32 3} ; [ DW_TAG_lexical_block ]
!132 = metadata !{i32 329, i32 0, metadata !110, metadata !111}
!133 = metadata !{i32 184, i32 0, metadata !131, metadata !132}
!134 = metadata !{i32 34, i32 0, metadata !123, metadata !133}
!135 = metadata !{i32 35, i32 0, metadata !123, metadata !133}
!136 = metadata !{i32 277, i32 0, metadata !137, metadata !132}
!137 = metadata !{i32 589835, metadata !10, i32 276, i32 0, metadata !1, i32 5} ; [ DW_TAG_lexical_block ]
!138 = metadata !{i32 210, i32 0, metadata !131, metadata !132}
!139 = metadata !{i32 34, i32 0, metadata !123, metadata !138}
!140 = metadata !{i32 35, i32 0, metadata !123, metadata !138}
!141 = metadata !{i32 352, i32 0, metadata !110, metadata !111}
!142 = metadata !{i32 357, i32 0, metadata !110, metadata !111}
!143 = metadata !{i32 362, i32 0, metadata !110, metadata !111}
!144 = metadata !{i32 474, i32 0, metadata !73, null}
!145 = metadata !{i32 475, i32 0, metadata !73, null}
