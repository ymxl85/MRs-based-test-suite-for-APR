...
main(){
   ...
   int Climb_Inhibit;
    ...
    if(Alt_Layer_Value==0 || Alt_Layer_Value==2)
    {
      Alt_Layer_Value=Alt_Layer_Value+1;
      Up_Separation=Up_Separation+100;
      Down_Separation=Down_Separation+100;
    }
    else if (Alt_Layer_Value==1)
    {
       Alt_Layer_Value=Alt_Layer_Value+1;
      Up_Separation=Up_Separation+140;
      Down_Separation=Down_Separation+140;
    }
