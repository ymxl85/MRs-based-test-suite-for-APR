...
bb5.i:                                            ; preds = %bb3.i
  ...
  br i1 %96, label %bb2.i16.i, label %bb18.i
...
addstr.exit11.i:                                  ; preds = %bb2.i8.i, %bb17.i
  ...
  %203 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 %i.i.7
...
bb1.i.i:                                          ; preds = %addstr.exit11.i
  ...
  %208 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 %207
...
bb18.i:                                           ; preds = %bb2.i4.i, %esc.exit.i, %stclose.exit.i, %getccl.exit.i, %bb2.i20.i, %bb8.i, %bb2.i16.i, %bb5.i, %bb2.i.i, %bb2.i
  %j.i.9 = phi i32 [ %94, %bb2.i.i ], [ %j.i.10, %bb2.i ], [ %105, %bb2.i20.i ], [ %j.i.10, %bb8.i ], [ %j.i.7, %getccl.exit.i ], [ %218, %bb2.i4.i ], [ %j.i.8, %esc.exit.i ], [ %199, %stclose.exit.i ], [ %98, %bb2.i16.i ], [ %j.i.10, %bb5.i ]
...
bb20.outer.i:                                     ; preds = %bb19.i, %bb18.i, %bb12
  ...
  %221 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 %i.i.7
  %222 = add nsw i32 %i.i.7, 1
  %223 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 %222
...
bb.i1:                                            ; preds = %bb6.i14
  ...
  br i1 %233, label %bb2.i2, label %bb3.i4

bb2.i2:                                           ; preds = %bb.i1
  %234 = icmp slt i32 %j.1.i, 100
  br i1 %234, label %bb2.i.i3, label %bb4.i
...
bb3.i4:                                           ; preds = %bb.i1
  ...
  br i1 %238, label %bb1.i.i6, label %bb.i.i5
...
esc.exit.i11:                                     ; preds = %bb7.i.i9, %bb5.i.i8, %bb3.i.i7, %bb1.i.i6, %bb.i.i5
  %i.0.i = phi i32 [ %storemerge.i, %bb1.i.i6 ], [ %240, %bb3.i.i7 ], [ %240, %bb5.i.i8 ], [ %240, %bb7.i.i9 ], [ %storemerge.i, %bb.i.i5 ]
  %result.0.i7.i10 = phi i8 [ 64, %bb1.i.i6 ], [ 10, %bb3.i.i7 ], [ 9, %bb5.i.i8 ], [ %248, %bb7.i.i9 ], [ %239, %bb.i.i5 ]
  %249 = icmp slt i32 %j.1.i, 100
  br i1 %249, label %bb2.i4.i12, label %bb4.i

bb2.i4.i12:                                       ; preds = %esc.exit.i11
  %250 = getelementptr inbounds [100 x i8]* %sub.i, i32 0, i32 %j.1.i
  store i8 %result.0.i7.i10, i8* %250, align 1
  %251 = add nsw i32 %j.1.i, 1
  br label %bb4.i

bb4.i:                                            ; preds = %bb2.i4.i12, %esc.exit.i11, %bb2.i.i3, %bb2.i2
  %j.0.i = phi i32 [ %236, %bb2.i.i3 ], [ %j.1.i, %bb2.i2 ], [ %251, %bb2.i4.i12 ], [ %j.1.i, %esc.exit.i11 ]
...
makesub.exit:                                     ; preds = %bb7.i16, %bb11.i17
  %262 = load i8* %argv33, align 1
  %263 = icmp eq i8 %262, 0
  br i1 %263, label %subline.exit, label %bb.i19
...
bb.i19:                                           ; preds = %makesub.exit, %bb7.backedge.i
  ...
  %264 = call fastcc i32 @amatch(i8* %argv33, i32 %i.02.i, i8* %pat1.i, i32 0) nounwind
  %265 = icmp slt i32 %264, 0
  %266 = icmp eq i32 %lastm.13.i, %264
  %or.cond.i18 = or i1 %265, %266
  br i1 %or.cond.i18, label %bb3.i29, label %bb2.i20

bb2.i20:                                          ; preds = %bb.i19
  %267 = load i8* %sub2.i, align 1
  %268 = icmp eq i8 %267, 0
  br i1 %268, label %bb3.i29, label %bb.lr.ph.i.i21

bb.lr.ph.i.i21:                                   ; preds = %bb2.i20
  %269 = icmp slt i32 %i.02.i, %264
  br i1 %269, label %bb.lr.ph.split.us.i.i, label %bb.i.i27
...
bb.us.i.i:                                        ; preds = %bb6.us.i.i, %bb.lr.ph.split.us.i.i
  ...
  br i1 %271, label %bb2.us.i.i, label %bb5.us.i.i

bb6.us.i.i:                                       ; preds = %bb2.us.i.i, %bb5.us.i.i
  %OL.2 = phi i32 [ %276, %bb5.us.i.i ], [ %279, %bb2.us.i.i ]
  %272 = load i8* %scevgep6.i.i, align 1
  %273 = icmp eq i8 %272, 0
  br i1 %273, label %bb3.i29, label %bb.us.i.i

bb5.us.i.i:                                       ; preds = %bb.us.i.i
  %274 = load i8* %scevgep4.i.i, align 1
  %275 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 %OL.1
  store i8 %274, i8* %275, align 1
  %276 = add nsw i32 %OL.1, 1
  br label %bb6.us.i.i

bb2.us.i.i:                                       ; preds = %bb.us.i.i, %bb2.us.i.i
  %OL.3 = phi i32 [ %279, %bb2.us.i.i ], [ %OL.1, %bb.us.i.i ]
  ...
  %277 = load i8* %scevgep.i.i24, align 1
  %278 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 %OL.3
  store i8 %277, i8* %278, align 1
  %279 = add nsw i32 %OL.3, 1
...
bb.i.i27:                                         ; preds = %bb.lr.ph.i.i21, %bb6.i.i
  ...
  %280 = load i8* %scevgep9.i.i26, align 1
  %281 = icmp eq i8 %280, -1
  br i1 %281, label %bb6.i.i, label %bb5.i.i28

bb5.i.i28:                                        ; preds = %bb.i.i27
  %282 = load i8* %scevgep9.i.i26, align 1
  %283 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 %OL.4
  store i8 %282, i8* %283, align 1
  %284 = add nsw i32 %OL.4, 1
  br label %bb6.i.i

bb6.i.i:                                          ; preds = %bb5.i.i28, %bb.i.i27
  %OL.5 = phi i32 [ %OL.4, %bb.i.i27 ], [ %284, %bb5.i.i28 ]
  %285 = load i8* %scevgep11.i.i, align 1
  %286 = icmp eq i8 %285, 0
  br i1 %286, label %bb3.i29, label %bb.i.i27

bb3.i29:                                          ; preds = %bb6.i.i, %bb6.us.i.i, %bb2.i20, %bb.i19
  %OL.6 = phi i32 [ %OL.0, %bb.i19 ], [ %OL.0, %bb2.i20 ], [ %OL.2, %bb6.us.i.i ], [ %OL.5, %bb6.i.i ]
  %lastm.0.i = phi i32 [ %lastm.13.i, %bb.i19 ], [ %264, %bb2.i20 ], [ %264, %bb6.us.i.i ], [ %264, %bb6.i.i ]
  %287 = icmp eq i32 %264, -1
  %288 = icmp eq i32 %264, %i.02.i
  %or.cond1.i = or i1 %287, %288
  br i1 %or.cond1.i, label %bb5.i30, label %bb7.backedge.i

bb5.i30:                                          ; preds = %bb3.i29
  %289 = getelementptr inbounds [3 x i8]* %argv3, i32 0, i32 %i.02.i
  %290 = load i8* %289, align 1
  %291 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 %OL.6
  store i8 %290, i8* %291, align 1
  %292 = add nsw i32 %OL.6, 1
  %293 = add nsw i32 %i.02.i, 1
  br label %bb7.backedge.i

bb7.backedge.i:                                   ; preds = %bb5.i30, %bb3.i29
  %OL.7 = phi i32 [ %292, %bb5.i30 ], [ %OL.6, %bb3.i29 ]
  %i.0.be.i = phi i32 [ %293, %bb5.i30 ], [ %264, %bb3.i29 ]
  %294 = getelementptr inbounds [3 x i8]* %argv3, i32 0, i32 %i.0.be.i
  %295 = load i8* %294, align 1
  %296 = icmp eq i8 %295, 0
  br i1 %296, label %subline.exit, label %bb.i19

subline.exit:                                     ; preds = %bb7.backedge.i, %makesub.exit
  %OL.8 = phi i32 [ 0, %makesub.exit ], [ %OL.7, %bb7.backedge.i ]
  %297 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 %OL.8
...
!1 = metadata !{i32 589865, metadata !"v7-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v7/follow4/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v7-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v7/follow4/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32
