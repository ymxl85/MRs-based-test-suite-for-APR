...
addstr.exit11.i:                                  ; preds = %bb2.i8.i, %bb17.i
  ...
  %189 = getelementptr inbounds [3 x i8]* %argv1, i32 0, i32 %i.i.7
...
esc.exit.i:                                       ; preds = %bb7.i.i, %bb5.i.i, %bb3.i.i, %bb1.i.i, %bb.i.i
  %i.i.5 = phi i32 [ %i.i.7, %bb1.i.i ], [ %193, %bb3.i.i ], [ %193, %bb5.i.i ], [ %193, %bb7.i.i ], [ %i.i.7, %bb.i.i ]
...
!1 = metadata !{i32 589865, metadata !"v8-s.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v8/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v8-s.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v8/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 
