...
bb.i:                                             ; preds = %bb4.i
  ...
  %34 = load i8* %scevgep.i, align 1
  %35 = icmp eq i8 %34, %31
  br i1 %35, label %bb25, label %bb3.i
...
bb4.i:                                            ; preds = %bb3.i, %bb16
  ...
  %36 = icmp slt i32 %i.0.i, %28
  br i1 %36, label %bb27, label %bb.i

bb19:                                             ; preds = %bb3
  %37 = load i32* %i, align 4, !dbg !108
  %38 = getelementptr inbounds i8* %lin, i32 %37, !dbg !108
  %39 = load i8* %38, align 1, !dbg !108
  %40 = icmp eq i8 %39, 10, !dbg !108
  br i1 %40, label %bb27, label %bb20, !dbg !108

bb20:                                             ; preds = %bb19
  %41 = add nsw i32 %j, 1, !dbg !108
  %42 = load i32* %i, align 4, !dbg !108
  %43 = getelementptr inbounds i8* %lin, i32 %42, !dbg !108
  %44 = load i8* %43, align 1, !dbg !108
  %45 = getelementptr inbounds i8* %pat, i32 %41
  %46 = load i8* %45, align 1
  %tmp27 = sext i8 %46 to i32
...
bb.i6:                                            ; preds = %bb4.i11
  ...
  %47 = load i8* %scevgep.i5, align 1
  %48 = icmp eq i8 %47, %44
  br i1 %48, label %bb27, label %bb3.i8
...
bb4.i11:                                          ; preds = %bb3.i8, %bb20
  ...
  %49 = icmp slt i32 %i.0.i10, %41
  br i1 %49, label %bb25, label %bb.i6

bb23:                                             ; preds = %bb3
  %50 = load i8* %4, align 1, !dbg !109
  %51 = sext i8 %50 to i32, !dbg !109
  tail call fastcc void @Caseerror(i32 %51) nounwind
  unreachable

bb25:                                             ; preds = %bb4.i11, %bb.i, %bb13, %bb10, %bb7, %bb4
  %advance.0.ph = phi i32 [ 1, %bb4 ], [ 0, %bb7 ], [ 1, %bb10 ], [ 0, %bb13 ], [ 1, %bb.i ], [ 1, %bb4.i11 ]
  %52 = load i32* %i, align 4, !dbg !110
  %53 = add nsw i32 %52, %advance.0.ph, !dbg !110
  store i32 %53, i32* %i, align 4, !dbg !110
...
!1 = metadata !{i32 589865, metadata !"v6-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v6/follow4/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v6-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v6/follow4/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32
