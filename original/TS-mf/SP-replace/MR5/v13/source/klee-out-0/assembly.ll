...
bb5.i30:                                          ; preds = %bb3.i29
  ...
  br i1 %274, label %bb6.i31, label %bb7.i32
...
bb7.i32:                                          ; preds = %bb5.i30
  %281 = add nsw i32 %i.02.i, 2
  br label %bb10.backedge.i

bb10.backedge.i:                                  ; preds = %bb7.i32, %bb6.i31, %bb3.i29
  %OL.7 = phi i32 [ %279, %bb6.i31 ], [ %279, %bb7.i32 ], [ %OL.6, %bb3.i29 ]
  %i.0.be.i = phi i32 [ %280, %bb6.i31 ], [ %281, %bb7.i32 ], [ %251, %bb3.i29 ]
...
!1 = metadata !{i32 589865, metadata !"v13-s.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v13/source/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v13-s.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v13/source/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i3
...
!142 = metadata !{i32 525, i32 0, metadata !143, metadata !141}
!143 = metadata !{i32 589835, metadata !33, i32 522, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!144 = metadata !{i32 526, i32 0, metadata !143, metadata !141}
!145 = metadata !{i32 553, i32 0, metadata !131, null}
