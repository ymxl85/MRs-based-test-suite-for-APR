...
bb20:                                             ; preds = %bb19
  %46 = load i32* %i, align 4, !dbg !108
  %47 = getelementptr inbounds i8* %lin, i32 %46, !dbg !108
  %48 = load i8* %47, align 1, !dbg !108
  %49 = load i8* %4, align 1
  %50 = sext i8 %49 to i32
  %51 = add nsw i32 %50, %j
  br label %bb4.outer.i5

bb4.outer.i5:                                     ; preds = %bb.i7, %bb20
  %i.0.ph.i3 = phi i32 [ %51, %bb20 ], [ %offset..i6, %bb.i7 ]
  %flag.0.ph.i4 = phi i8 [ 0, %bb20 ], [ 1, %bb.i7 ]
  br label %bb4.i9

bb.i7:                                            ; preds = %bb4.i9
  %52 = getelementptr inbounds i8* %pat, i32 %i.0.i8
  %53 = load i8* %52, align 1
  %54 = add nsw i32 %i.0.i8, -1
  %55 = icmp eq i8 %53, %48
  %offset..i6 = select i1 %55, i32 %j, i32 %54
  br i1 %55, label %bb4.outer.i5, label %bb4.i9

bb4.i9:                                           ; preds = %bb.i7, %bb4.outer.i5
  %i.0.i8 = phi i32 [ %i.0.ph.i3, %bb4.outer.i5 ], [ %offset..i6, %bb.i7 ]
  %56 = icmp sgt i32 %i.0.i8, %j
  br i1 %56, label %bb.i7, label %locate.exit10

locate.exit10:                                    ; preds = %bb4.i9
  %57 = icmp eq i8 %flag.0.ph.i4, 0, !dbg !108
  br i1 %57, label %bb25, label %bb27, !dbg !108

bb23:                                             ; preds = %bb3
  %58 = load i8* %4, align 1, !dbg !109
  %59 = sext i8 %58 to i32, !dbg !109
  tail call fastcc void @Caseerror(i32 %59) nounwind
  unreachable
...
bb25:                                             ; preds = %locate.exit10, %locate.exit, %bb13, %bb10, %bb7, %bb4
  ...
  %60 = load i32* %i, align 4, !dbg !110
  %61 = add nsw i32 %60, %advance.0.ph, !dbg !110
  store i32 %61, i32* %i, align 4, !dbg !110
...
!1 = metadata !{i32 589865, metadata !"v26-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v26/follow1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v26-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v26/follow1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i
