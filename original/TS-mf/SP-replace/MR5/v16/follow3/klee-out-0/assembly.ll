...
addstr.exit11.i:                                  ; preds = %bb2.i8.i, %bb17.i
  ...
  %206 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 %i.i.7
...
bb1.i.i:                                          ; preds = %addstr.exit11.i
  ...
  %211 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 %210
...
bb18.i:                                           ; preds = %bb2.i4.i, %esc.exit.i, %stclose.exit.i, %getccl.exit.i, %bb2.i19.i, %bb8.i, %bb2.i15.i, %bb5.i, %bb2.i.i, %bb2.i
  %j.i.9 = phi i32 [ %94, %bb2.i.i ], [ %j.i.10, %bb2.i ], [ %105, %bb2.i19.i ], [ %j.i.10, %bb8.i ], [ %j.i.7, %getccl.exit.i ], [ %221, %bb2.i4.i ], [ %j.i.8, %esc.exit.i ], [ %202, %stclose.exit.i ], [ %98, %bb2.i15.i ], [ %j.i.10, %bb5.i ]
...
bb20.outer.i:                                     ; preds = %bb19.i, %bb18.i, %bb12
  ...
  %224 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 %i.i.7
  %225 = add nsw i32 %i.i.7, 1
  %226 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 %225
...
bb.i1:                                            ; preds = %bb6.i14
  ...
  br i1 %236, label %bb2.i2, label %bb3.i4

bb2.i2:                                           ; preds = %bb.i1
  %237 = icmp slt i32 %j.1.i, 100
  br i1 %237, label %bb2.i.i3, label %bb4.i
...
bb3.i4:                                           ; preds = %bb.i1
  ...
  br i1 %241, label %bb1.i.i6, label %bb.i.i5
...
esc.exit.i11:                                     ; preds = %bb7.i.i9, %bb5.i.i8, %bb3.i.i7, %bb1.i.i6, %bb.i.i5
  %i.0.i = phi i32 [ %storemerge.i, %bb1.i.i6 ], [ %243, %bb3.i.i7 ], [ %243, %bb5.i.i8 ], [ %243, %bb7.i.i9 ], [ %storemerge.i, %bb.i.i5 ]
  %result.0.i7.i10 = phi i8 [ 64, %bb1.i.i6 ], [ 10, %bb3.i.i7 ], [ 9, %bb5.i.i8 ], [ %251, %bb7.i.i9 ], [ %242, %bb.i.i5 ]
  %252 = icmp slt i32 %j.1.i, 100
  br i1 %252, label %bb2.i4.i12, label %bb4.i

bb2.i4.i12:                                       ; preds = %esc.exit.i11
  %253 = getelementptr inbounds [100 x i8]* %sub.i, i32 0, i32 %j.1.i
  store i8 %result.0.i7.i10, i8* %253, align 1
  %254 = add nsw i32 %j.1.i, 1
  br label %bb4.i

bb4.i:                                            ; preds = %bb2.i4.i12, %esc.exit.i11, %bb2.i.i3, %bb2.i2
  %j.0.i = phi i32 [ %239, %bb2.i.i3 ], [ %j.1.i, %bb2.i2 ], [ %254, %bb2.i4.i12 ], [ %j.1.i, %esc.exit.i11 ]
...
makesub.exit:                                     ; preds = %bb7.i16, %bb11.i17
  %265 = load i8* %argv33, align 1
  %266 = icmp eq i8 %265, 0
  br i1 %266, label %subline.exit, label %bb.i19
...
bb.i19:                                           ; preds = %makesub.exit, %bb7.backedge.i
  ...
  %267 = call fastcc i32 @amatch(i8* %argv33, i32 %i.02.i, i8* %pat1.i, i32 0) nounwind
  %268 = icmp slt i32 %267, 0
  %269 = icmp eq i32 %lastm.13.i, %267
  %or.cond.i18 = or i1 %268, %269
  br i1 %or.cond.i18, label %bb3.i29, label %bb2.i20

bb2.i20:                                          ; preds = %bb.i19
  %270 = load i8* %sub2.i, align 1
  %271 = icmp eq i8 %270, 0
  br i1 %271, label %bb3.i29, label %bb.lr.ph.i.i21

bb.lr.ph.i.i21:                                   ; preds = %bb2.i20
  %272 = icmp slt i32 %i.02.i, %267
  br i1 %272, label %bb.lr.ph.split.us.i.i, label %bb.i.i27
...
bb.us.i.i:                                        ; preds = %bb6.us.i.i, %bb.lr.ph.split.us.i.i
  ...
  br i1 %274, label %bb2.us.i.i, label %bb5.us.i.i

bb6.us.i.i:                                       ; preds = %bb2.us.i.i, %bb5.us.i.i
  %OL.2 = phi i32 [ %279, %bb5.us.i.i ], [ %282, %bb2.us.i.i ]
  %275 = load i8* %scevgep6.i.i, align 1
  %276 = icmp eq i8 %275, 0
  br i1 %276, label %bb3.i29, label %bb.us.i.i

bb5.us.i.i:                                       ; preds = %bb.us.i.i
  %277 = load i8* %scevgep4.i.i, align 1
  %278 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 %OL.1
  store i8 %277, i8* %278, align 1
  %279 = add nsw i32 %OL.1, 1
  br label %bb6.us.i.i

bb2.us.i.i:                                       ; preds = %bb.us.i.i, %bb2.us.i.i
  %OL.3 = phi i32 [ %282, %bb2.us.i.i ], [ %OL.1, %bb.us.i.i ]
  ...
  %280 = load i8* %scevgep.i.i24, align 1
  %281 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 %OL.3
  store i8 %280, i8* %281, align 1
  %282 = add nsw i32 %OL.3, 1
...
bb.i.i27:                                         ; preds = %bb.lr.ph.i.i21, %bb6.i.i
  ...
  %283 = load i8* %scevgep9.i.i26, align 1
  %284 = icmp eq i8 %283, -1
  br i1 %284, label %bb6.i.i, label %bb5.i.i28

bb5.i.i28:                                        ; preds = %bb.i.i27
  %285 = load i8* %scevgep9.i.i26, align 1
  %286 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 %OL.4
  store i8 %285, i8* %286, align 1
  %287 = add nsw i32 %OL.4, 1
  br label %bb6.i.i

bb6.i.i:                                          ; preds = %bb5.i.i28, %bb.i.i27
  %OL.5 = phi i32 [ %OL.4, %bb.i.i27 ], [ %287, %bb5.i.i28 ]
  %288 = load i8* %scevgep11.i.i, align 1
  %289 = icmp eq i8 %288, 0
  br i1 %289, label %bb3.i29, label %bb.i.i27

bb3.i29:                                          ; preds = %bb6.i.i, %bb6.us.i.i, %bb2.i20, %bb.i19
  %OL.6 = phi i32 [ %OL.0, %bb.i19 ], [ %OL.0, %bb2.i20 ], [ %OL.2, %bb6.us.i.i ], [ %OL.5, %bb6.i.i ]
  %lastm.0.i = phi i32 [ %lastm.13.i, %bb.i19 ], [ %267, %bb2.i20 ], [ %267, %bb6.us.i.i ], [ %267, %bb6.i.i ]
  %290 = icmp eq i32 %267, -1
  %291 = icmp eq i32 %267, %i.02.i
  %or.cond1.i = or i1 %290, %291
  br i1 %or.cond1.i, label %bb5.i30, label %bb7.backedge.i

bb5.i30:                                          ; preds = %bb3.i29
  %292 = getelementptr inbounds [3 x i8]* %argv3, i32 0, i32 %i.02.i
  %293 = load i8* %292, align 1
  %294 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 %OL.6
  store i8 %293, i8* %294, align 1
  %295 = add nsw i32 %OL.6, 1
  %296 = add nsw i32 %i.02.i, 1
  br label %bb7.backedge.i

bb7.backedge.i:                                   ; preds = %bb5.i30, %bb3.i29
  %OL.7 = phi i32 [ %295, %bb5.i30 ], [ %OL.6, %bb3.i29 ]
  %i.0.be.i = phi i32 [ %296, %bb5.i30 ], [ %267, %bb3.i29 ]
  %297 = getelementptr inbounds [3 x i8]* %argv3, i32 0, i32 %i.0.be.i
  %298 = load i8* %297, align 1
  %299 = icmp eq i8 %298, 0
  br i1 %299, label %subline.exit, label %bb.i19

subline.exit:                                     ; preds = %bb7.backedge.i, %makesub.exit
  %OL.8 = phi i32 [ 0, %makesub.exit ], [ %OL.7, %bb7.backedge.i ]
  %300 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 %OL.8
...
!1 = metadata !{i32 589865, metadata !"v16-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v16/follow3/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v16-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v16/follow3/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i
