...
bb.i.i.i:                                         ; preds = %bb16.i.i.i
  ...
  br i1 %140, label %bb3.i.i.i, label %bb2.i7.i.i

bb2.i7.i.i:                                       ; preds = %bb.i.i.i
  %141 = icmp slt i32 %j.i.7, 100
  br i1 %141, label %bb2.i.i.i.i, label %bb14.i.i.i
...
bb3.i.i.i:                                        ; preds = %bb.i.i.i
  %145 = icmp slt i32 %j.i.7, 2
  br i1 %145, label %bb2.i8.i.i.i, label %bb4.i.i.i

bb4.i.i.i:                                        ; preds = %bb3.i.i.i
  %146 = add nsw i32 %i.i.3, 1
  %147 = getelementptr inbounds [5 x i8]* %f1, i32 0, i32 %146
  %148 = load i8* %147, align 1
  %149 = icmp eq i8 %148, 0
  br i1 %149, label %bb5.i.i.i, label %bb6.i.i.i

bb5.i.i.i:                                        ; preds = %bb4.i.i.i
  %150 = icmp slt i32 %j.i.7, 100
  br i1 %150, label %bb2.i8.i.i.i, label %bb14.i.i.i

bb2.i8.i.i.i:                                     ; preds = %bb3.i.i.i, %bb5.i.i.i
  %151 = getelementptr inbounds [100 x i8]* %pat.i, i32 0, i32 %j.i.7
  store i8 45, i8* %151, align 1
  %152 = add nsw i32 %j.i.7, 1
  br label %bb14.i.i.i

bb6.i.i.i:                                        ; preds = %bb4.i.i.i
  %153 = add nsw i32 %i.i.3, -1
  %154 = getelementptr inbounds [5 x i8]* %f1, i32 0, i32 %153
  %155 = load i8* %154, align 1
  %156 = sext i8 %155 to i32
  %157 = call i32 (...)* bitcast (i32 (i32)* @isalnum to i32 (...)*)(i32 %156) nounwind readonly
  %158 = icmp eq i32 %157, 0
  br i1 %158, label %bb13.i.i.i, label %bb7.i.i.i

bb7.i.i.i:                                        ; preds = %bb6.i.i.i
  %159 = load i8* %147, align 1
  %160 = sext i8 %159 to i32
  %161 = call i32 (...)* bitcast (i32 (i32)* @isalnum to i32 (...)*)(i32 %160) nounwind readonly
  %162 = icmp eq i32 %161, 0
  br i1 %162, label %bb13.i.i.i, label %bb8.i.i.i

bb8.i.i.i:                                        ; preds = %bb7.i.i.i
  %163 = load i8* %154, align 1
  %164 = load i8* %147, align 1
  %165 = icmp sgt i8 %163, %164
  br i1 %165, label %bb13.i.i.i, label %bb9.i.i.i

bb9.i.i.i:                                        ; preds = %bb8.i.i.i
  %166 = load i8* %154, align 1
  %167 = sext i8 %166 to i32
  %k.011.i.i.i = add nsw i32 %167, 1
  %168 = load i8* %147, align 1
  %169 = sext i8 %168 to i32
  %170 = icmp slt i32 %169, %k.011.i.i.i
  br i1 %170, label %bb14.i.i.i, label %bb10.lr.ph.i.i.i

bb10.lr.ph.i.i.i:                                 ; preds = %bb9.i.i.i
  %tmp13.i.i.i = add i32 %167, 2
  %tmp15.i.i.i = add i8 %166, 1
...
bb10.i.i.i:                                       ; preds = %bb11.backedge.bb10_crit_edge.i.i.i, %bb10.lr.ph.i.i.i
  ...
  %171 = icmp slt i32 %j.i.3, 100
  br i1 %171, label %bb2.i5.i.i.i, label %bb11.backedge.i.i.i

bb11.backedge.i.i.i:                              ; preds = %bb2.i5.i.i.i, %bb10.i.i.i
  %j.i.4 = phi i32 [ %176, %bb2.i5.i.i.i ], [ %j.i.3, %bb10.i.i.i ]
  %172 = load i8* %147, align 1
  %173 = sext i8 %172 to i32
  %174 = icmp slt i32 %173, %k.0.i.i.i
  br i1 %174, label %bb14.i.i.i, label %bb11.backedge.bb10_crit_edge.i.i.i
...
bb2.i5.i.i.i:                                     ; preds = %bb10.i.i.i
  ...
  %175 = getelementptr inbounds [100 x i8]* %pat.i, i32 0, i32 %j.i.3
  store i8 %c.i4.i.i.i, i8* %175, align 1
  %176 = add nsw i32 %j.i.3, 1
  br label %bb11.backedge.i.i.i

bb13.i.i.i:                                       ; preds = %bb8.i.i.i, %bb7.i.i.i, %bb6.i.i.i
  %177 = icmp slt i32 %j.i.7, 100
  br i1 %177, label %bb2.i1.i.i.i, label %bb14.i.i.i
...
bb14.i.i.i:                                       ; preds = %bb9.i.i.i, %bb11.backedge.i.i.i, %bb2.i1.i.i.i, %bb13.i.i.i, %bb2.i8.i.i.i, %bb5.i.i.i, %bb2.i.i.i.i, %bb2.i7.i.i
  %j.i.6 = phi i32 [ %152, %bb2.i8.i.i.i ], [ %j.i.7, %bb5.i.i.i ], [ %179, %bb2.i1.i.i.i ], [ %j.i.7, %bb13.i.i.i ], [ %144, %bb2.i.i.i.i ], [ %j.i.7, %bb2.i7.i.i ], [ %j.i.7, %bb9.i.i.i ], [ %j.i.4, %bb11.backedge.i.i.i ]
  %i.i.2 = phi i32 [ %i.i.3, %bb2.i8.i.i.i ], [ %i.i.3, %bb5.i.i.i ], [ %i.i.3, %bb2.i1.i.i.i ], [ %i.i.3, %bb13.i.i.i ], [ %i.i.3, %bb2.i.i.i.i ], [ %i.i.3, %bb2.i7.i.i ], [ %146, %bb9.i.i.i ], [ %146, %bb11.backedge.i.i.i ]
  %180 = add nsw i32 %i.i.2, 1
  br label %bb15.i.i.i

bb15.i.i.i:                                       ; preds = %bb14.i.i.i, %addstr.exit6.i.i
  %j.i.7 = phi i32 [ %j.i.2, %addstr.exit6.i.i ], [ %j.i.6, %bb14.i.i.i ]
  %i.i.3 = phi i32 [ %i.i.1, %addstr.exit6.i.i ], [ %180, %bb14.i.i.i ]
  %181 = getelementptr inbounds [5 x i8]* %f1, i32 0, i32 %i.i.3
  %182 = load i8* %181, align 1
  %183 = icmp eq i8 %182, 93
  %.pre = getelementptr inbounds [5 x i8]* %f1, i32 0, i32 %i.i.3
  br i1 %183, label %getccl.exit.i, label %bb16.i.i.i

bb16.i.i.i:                                       ; preds = %bb15.i.i.i
  %184 = load i8* %.pre, align 1
  %185 = icmp eq i8 %184, 0
  br i1 %185, label %getccl.exit.i, label %bb.i.i.i

getccl.exit.i:                                    ; preds = %bb15.i.i.i, %bb16.i.i.i
  %186 = trunc i32 %j.i.7 to i8
  %187 = trunc i32 %138 to i8
  %188 = xor i8 %187, -1
  %189 = add i8 %186, %188
  %190 = getelementptr inbounds [100 x i8]* %pat.i, i32 0, i32 %138
  store i8 %189, i8* %190, align 1
  %191 = load i8* %.pre, align 1
  %192 = icmp ne i8 %191, 93
  %193 = zext i1 %192 to i8
  br label %bb18.i

bb11.i:                                           ; preds = %bb9.i
  %194 = load i8* %224, align 1
  %.not48.i = icmp ne i8 %194, 42
  %brmerge50.i = or i1 %.not48.i, %.not49.i
  br i1 %brmerge50.i, label %bb17.i, label %bb13.i

bb13.i:                                           ; preds = %bb11.i
  %195 = load i8* %227, align 1
  %c.off.i.i = add i8 %195, -36
  %196 = icmp ult i8 %c.off.i.i, 2
  %197 = icmp eq i8 %195, 42
  %.demorgan.i = or i1 %196, %197
...
addstr.exit11.i:                                  ; preds = %bb2.i8.i, %bb17.i
  ...
  %206 = getelementptr inbounds [5 x i8]* %f1, i32 0, i32 %i.i.6
...
bb1.i.i:                                          ; preds = %addstr.exit11.i
  %210 = add nsw i32 %i.i.6, 1
  %211 = getelementptr inbounds [5 x i8]* %f1, i32 0, i32 %210
...
esc.exit.i:                                       ; preds = %bb7.i.i, %bb5.i.i, %bb3.i.i, %bb1.i.i, %bb.i.i
  %i.i.4 = phi i32 [ %i.i.6, %bb1.i.i ], [ %210, %bb3.i.i ], [ %210, %bb5.i.i ], [ %210, %bb7.i.i ], [ %i.i.6, %bb.i.i ]
...
bb18.i:                                           ; preds = %bb2.i4.i, %esc.exit.i, %stclose.exit.i, %getccl.exit.i, %bb2.i19.i, %bb8.i, %bb2.i15.i, %bb5.i, %bb2.i.i, %bb2.i
  %j.i.9 = phi i32 [ %111, %bb2.i.i ], [ %j.i.10, %bb2.i ], [ %122, %bb2.i19.i ], [ %j.i.10, %bb8.i ], [ %j.i.7, %getccl.exit.i ], [ %221, %bb2.i4.i ], [ %j.i.8, %esc.exit.i ], [ %202, %stclose.exit.i ], [ %115, %bb2.i15.i ], [ %j.i.10, %bb5.i ]
  ...
  %done.0.i = phi i8 [ %done.1.i, %bb2.i.i ], [ %done.1.i, %bb2.i ], [ %done.1.i, %bb2.i19.i ], [ %done.1.i, %bb8.i ], [ %193, %getccl.exit.i ], [ %done.1.i, %bb2.i4.i ], [ %done.1.i, %esc.exit.i ], [ %done.1.i, %stclose.exit.i ], [ %done.1.i, %bb2.i15.i
...
bb.i19:                                           ; preds = %makesub.exit, %bb7.backedge.i
  ...
  %267 = call fastcc i32 @amatch(i8* %f318, i32 %i.02.i, i8* %pat1.i, i32 0) nounwind
...
bb5.i30:                                          ; preds = %bb3.i29
  %292 = getelementptr inbounds [7 x i8]* %f3, i32 0, i32 %i.02.i
...
bb7.backedge.i:                                   ; preds = %bb5.i30, %bb3.i29
  ...
  %297 = getelementptr inbounds [7 x i8]* %f3, i32 0, i32 %i.0.be.i
...
!1 = metadata !{i32 589865, metadata !"v2-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v2/follow1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v2-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v2/follow1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32
