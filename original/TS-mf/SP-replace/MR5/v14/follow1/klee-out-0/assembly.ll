...
bb19:                                             ; preds = %bb3
  ...
  br i1 %45, label %bb26, label %bb24, !dbg !108

bb22:                                             ; preds = %bb3
  %46 = load i8* %4, align 1, !dbg !109
  %47 = sext i8 %46 to i32, !dbg !109
  tail call fastcc void @Caseerror(i32 %47) nounwind
  unreachable

bb24:                                             ; preds = %bb19, %locate.exit, %bb13, %bb10, %bb7, %bb4
  %advance.0.ph = phi i32 [ 1, %bb4 ], [ 0, %bb7 ], [ 1, %bb10 ], [ 0, %bb13 ], [ 1, %locate.exit ], [ 1, %bb19 ]
  %48 = load i32* %i, align 4, !dbg !110
  %49 = add nsw i32 %48, %advance.0.ph, !dbg !110
  store i32 %49, i32* %i, align 4, !dbg !110
...
!1 = metadata !{i32 589865, metadata !"v14-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v14/follow1/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v14-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR5/v14/follow1/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i
