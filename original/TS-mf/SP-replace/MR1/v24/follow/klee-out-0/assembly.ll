...
entry:
  ...
  %17 = icmp ne i8 %16, 110, !dbg !134
  %toBool5 = icmp sgt i8 %16, -1, !dbg !134
  %18 = and i1 %toBool5, %17, !dbg !134
  %19 = icmp ne i8 %16, 116, !dbg !134
  %20 = and i1 %18, %19
  %21 = icmp ne i8 %16, 93, !dbg !134
  %22 = and i1 %20, %21
  %23 = icmp ne i8 %16, 91, !dbg !134
  %24 = and i1 %22, %23
  %25 = icmp ne i8 %16, 94, !dbg !134
  %26 = and i1 %24, %25
  %27 = icmp ne i8* %15, inttoptr (i64 45 to i8*), !dbg !134
  %28 = and i1 %26, %27
  %29 = zext i1 %28 to i32, !dbg !134
  call void @klee_assume(i32 %29) nounwind, !dbg !134
  %30 = getelementptr inbounds [3 x i8]* %argv1, i32 0, i32 2, !dbg !135
  %31 = load i8* %30, align 1, !dbg !135
  %32 = icmp eq i8 %31, 0, !dbg !135
  %33 = zext i1 %32 to i32, !dbg !135
  call void @klee_assume(i32 %33) nounwind, !dbg !135
  %34 = load i8* %argv22, align 1, !dbg !136
  %.off = add i8 %34, -97
  %35 = icmp ult i8 %.off, 26
  %36 = zext i1 %35 to i32, !dbg !136
  call void @klee_assume(i32 %36) nounwind, !dbg !136
  %37 = getelementptr inbounds [2 x i8]* %argv2, i32 0, i32 1, !dbg !137
  %38 = load i8* %37, align 1, !dbg !137
  %39 = icmp eq i8 %38, 0, !dbg !137
  %40 = zext i1 %39 to i32, !dbg !137
  call void @klee_assume(i32 %40) nounwind, !dbg !137
  %41 = load i8* %argv33, align 1, !dbg !138
  %42 = icmp sgt i8 %41, 0, !dbg !138
  %43 = zext i1 %42 to i32, !dbg !138
  call void @klee_assume(i32 %43) nounwind, !dbg !138
  %44 = getelementptr inbounds [3 x i8]* %argv3, i32 0, i32 1, !dbg !139
  %45 = load i8* %44, align 1, !dbg !139
  %46 = icmp sgt i8 %45, 0, !dbg !139
  %47 = zext i1 %46 to i32, !dbg !139
  call void @klee_assume(i32 %47) nounwind, !dbg !139
  %48 = getelementptr inbounds [3 x i8]* %argv3, i32 0, i32 2, !dbg !140
  %49 = load i8* %48, align 1, !dbg !140
  %50 = icmp eq i8 %49, 0, !dbg !140
  %51 = zext i1 %50 to i32, !dbg !140
  call void @klee_assume(i32 %51) nounwind, !dbg !140
  %52 = load i8* %15, align 1, !dbg !141
  %53 = icmp eq i8 %52, 0, !dbg !141
  %54 = load i8* %argv11, align 1, !dbg !142
  br i1 %53, label %bb, label %bb12, !dbg !141

bb:                                               ; preds = %entry
  %55 = icmp eq i8 %54, 63, !dbg !142
  %56 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 0, !dbg !143
  store i8 91, i8* %56, align 1, !dbg !143
  br i1 %55, label %bb9, label %bb10, !dbg !142

bb9:                                              ; preds = %bb
  %57 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 1, !dbg !144
  store i8 94, i8* %57, align 1, !dbg !144
  %58 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 2, !dbg !145
  store i8 93, i8* %58, align 1, !dbg !145
  %59 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 3, !dbg !146
  store i8 0, i8* %59, align 1, !dbg !146
  br label %bb17, !dbg !146

bb10:                                             ; preds = %bb
  %60 = load i8* %argv11, align 1, !dbg !147
  %61 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 1, !dbg !147
  store i8 %60, i8* %61, align 1, !dbg !147
  %62 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 2, !dbg !148
  store i8 93, i8* %62, align 1, !dbg !148
  %63 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 3, !dbg !149
  store i8 0, i8* %63, align 1, !dbg !149
  br label %bb17, !dbg !149

bb12:                                             ; preds = %entry
  %64 = icmp eq i8 %54, 64, !dbg !150
  br i1 %64, label %bb13, label %bb14, !dbg !150

bb13:                                             ; preds = %bb12
  %65 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 0, !dbg !151
  store i8 91, i8* %65, align 1, !dbg !151
  %66 = load i8* %15, align 1, !dbg !152
  %67 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 1, !dbg !152
  store i8 %66, i8* %67, align 1, !dbg !152
  %68 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 2, !dbg !153
  store i8 93, i8* %68, align 1, !dbg !153
  %69 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 3, !dbg !154
  store i8 0, i8* %69, align 1, !dbg !154
  br label %bb17, !dbg !154

bb14:                                             ; preds = %bb12
  %70 = load i8* %argv11, align 1, !dbg !155
  %71 = icmp eq i8 %70, 63, !dbg !155
  %72 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 0, !dbg !156
  store i8 91, i8* %72, align 1, !dbg !156
  br i1 %71, label %bb15, label %bb16, !dbg !155

bb15:                                             ; preds = %bb14
  %73 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 1, !dbg !157
  store i8 94, i8* %73, align 1, !dbg !157
  %74 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 2, !dbg !158
  store i8 93, i8* %74, align 1, !dbg !158
  %75 = load i8* %15, align 1, !dbg !159
  %76 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 3, !dbg !159
  store i8 %75, i8* %76, align 1, !dbg !159
  %77 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 4, !dbg !160
  store i8 0, i8* %77, align 1, !dbg !160
  br label %bb17, !dbg !160

bb16:                                             ; preds = %bb14
  %78 = load i8* %argv11, align 1, !dbg !161
  %79 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 1, !dbg !161
  store i8 %78, i8* %79, align 1, !dbg !161
  %80 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 2, !dbg !162
  store i8 93, i8* %80, align 1, !dbg !162
  %81 = load i8* %15, align 1, !dbg !163
  %82 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 3, !dbg !163
  store i8 %81, i8* %82, align 1, !dbg !163
  %83 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 4, !dbg !164
  store i8 0, i8* %83, align 1, !dbg !164
  br label %bb17, !dbg !164

bb17:                                             ; preds = %bb9, %bb10, %bb16, %bb15, %bb13
  %rr21 = getelementptr inbounds [1000 x i8]* %rr, i32 0, i32 0, !dbg !165
  %pat1.i = getelementptr inbounds [100 x i8]* %pat.i, i32 0, i32 0, !dbg !166
...
addstr.exit3.i:                                   ; preds = %bb2.i1.i, %bb23.i
  %sub2.i = getelementptr inbounds [100 x i8]* %sub.i, i32 0, i32 0, !dbg !168
  br label %bb5.i13
...
subline.exit:                                     ; preds = %bb7.backedge.i, %makesub.exit
  ...
  call void (i8*, ...)* @klee_print_expr(i8* getelementptr inbounds ([4 x i8]* @.str6, i32 0, i32 0), i8* %rr21) nounwind, !dbg !169
  ret i32 0, !dbg !170
}
...
!1 = metadata !{i32 589865, metadata !"v24-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR1/v24/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v24-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR1/v24/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i3
...
!149 = metadata !{i32 565, i32 0, metadata !130, null}
!150 = metadata !{i32 570, i32 0, metadata !130, null}
!151 = metadata !{i32 572, i32 0, metadata !130, null}
!152 = metadata !{i32 573, i32 0, metadata !130, null}
!153 = metadata !{i32 574, i32 0, metadata !130, null}
!154 = metadata !{i32 575, i32 0, metadata !130, null}
!155 = metadata !{i32 577, i32 0, metadata !130, null}
!156 = metadata !{i32 579, i32 0, metadata !130, null}
!157 = metadata !{i32 580, i32 0, metadata !130, null}
!158 = metadata !{i32 581, i32 0, metadata !130, null}
!159 = metadata !{i32 582, i32 0, metadata !130, null}
!160 = metadata !{i32 583, i32 0, metadata !130, null}
!161 = metadata !{i32 588, i32 0, metadata !130, null}
...
!165 = metadata !{i32 595, i32 0, metadata !130, null}
!166 = metadata !{i32 522, i32 0, metadata !167, metadata !165}
!167 = metadata !{i32 589835, metadata !33, i32 519, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!168 = metadata !{i32 523, i32 0, metadata !167, metadata !165}
!169 = metadata !{i32 596, i32 0, metadata !130, null}
