...
bb.i12.i:                                         ; preds = %bb1.backedge.i.i, %bb.lr.ph.i.i
  ...
  %191 = icmp slt i32 %jp.0.in2.i.i, 100
...
addstr.exit11.i:                                  ; preds = %bb2.i8.i, %bb17.i
  ...
  %198 = getelementptr inbounds [5 x i8]* %f, i32 0, i32 %i.i.7
...
esc.exit.i:                                       ; preds = %bb7.i.i, %bb5.i.i, %bb3.i.i, %bb1.i.i, %bb.i.i
  %i.i.5 = phi i32 [ %i.i.7, %bb1.i.i ], [ %202, %bb3.i.i ], [ %202, %bb5.i.i ], [ %202, %bb7.i.i ], [ %i.i.7, %bb.i.i ]
  %result.0.i7.i = phi i8 [ 64, %bb1.i.i ], [ 10, %bb3.i.i ], [ 9, %bb5.i.i ], [ %210, %bb7.i.i ], [ %201, %bb.i.i ]
  %211 = icmp slt i32 %j.i.8, 100
...
!1 = metadata !{i32 589865, metadata !"v8-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR1/v8/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v8-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR1/v8/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 
