...
bb17.i.i.i:                                       ; preds = %bb16.i.i.i, %addstr.exit6.i.i
  ...
  %.pre39 = getelementptr inbounds [10 x i8]* %f, i32 0, i32 %i.i.4
  br i1 %182, label %getccl.exit.i, label %bb18.i.i.i

bb18.i.i.i:                                       ; preds = %bb17.i.i.i
  %183 = load i8* %.pre39, align 1
...
bb.i19:                                           ; preds = %bb6.i32
  %234 = load i8* %255, align 1
  %235 = icmp eq i8 %234, 38
  br i1 %235, label %bb2.i20, label %bb3.i22

bb2.i20:                                          ; preds = %bb.i19
  %236 = icmp slt i32 %j.1.i, 100
  br i1 %236, label %bb2.i.i21, label %bb4.i

bb2.i.i21:                                        ; preds = %bb2.i20
  %237 = getelementptr inbounds [100 x i8]* %sub.i, i32 0, i32 %j.1.i
  store i8 -1, i8* %237, align 1
  %238 = add nsw i32 %j.1.i, 1
  br label %bb4.i

bb3.i22:                                          ; preds = %bb.i19
  %239 = load i8* %255, align 1
  %240 = icmp eq i8 %239, 64
  br i1 %240, label %bb1.i.i24, label %bb.i.i23

bb.i.i23:                                         ; preds = %bb3.i22
  %241 = load i8* %255, align 1
  br label %esc.exit.i29

bb1.i.i24:                                        ; preds = %bb3.i22
  %242 = add nsw i32 %storemerge.i, 1
  %243 = getelementptr inbounds [2 x i8]* %argv2, i32 0, i32 %242
  %244 = load i8* %243, align 1
  %245 = icmp eq i8 %244, 0
  br i1 %245, label %esc.exit.i29, label %bb3.i.i25

bb3.i.i25:                                        ; preds = %bb1.i.i24
  %246 = load i8* %243, align 1
  %247 = icmp eq i8 %246, 110
  br i1 %247, label %esc.exit.i29, label %bb5.i.i26

bb5.i.i26:                                        ; preds = %bb3.i.i25
  %248 = load i8* %243, align 1
  %249 = icmp eq i8 %248, 116
  br i1 %249, label %esc.exit.i29, label %bb7.i.i27

bb7.i.i27:                                        ; preds = %bb5.i.i26
  %250 = load i8* %243, align 1
  br label %esc.exit.i29

esc.exit.i29:                                     ; preds = %bb7.i.i27, %bb5.i.i26, %bb3.i.i25, %bb1.i.i24, %bb.i.i23
  %i.0.i = phi i32 [ %storemerge.i, %bb1.i.i24 ], [ %242, %bb3.i.i25 ], [ %242, %bb5.i.i26 ], [ %242, %bb7.i.i27 ], [ %storemerge.i, %bb.i.i23 ]
  %result.0.i7.i28 = phi i8 [ 64, %bb1.i.i24 ], [ 10, %bb3.i.i25 ], [ 9, %bb5.i.i26 ], [ %250, %bb7.i.i27 ], [ %241, %bb.i.i23 ]
  %251 = icmp slt i32 %j.1.i, 100
  br i1 %251, label %bb2.i4.i30, label %bb4.i

bb2.i4.i30:                                       ; preds = %esc.exit.i29
  %252 = getelementptr inbounds [100 x i8]* %sub.i, i32 0, i32 %j.1.i
  store i8 %result.0.i7.i28, i8* %252, align 1
  %253 = add nsw i32 %j.1.i, 1
  br label %bb4.i

bb4.i:                                            ; preds = %bb2.i4.i30, %esc.exit.i29, %bb2.i.i21, %bb2.i20
  %j.0.i = phi i32 [ %238, %bb2.i.i21 ], [ %j.1.i, %bb2.i20 ], [ %253, %bb2.i4.i30 ], [ %j.1.i, %esc.exit.i29 ]
  %i.1.i = phi i32 [ %storemerge.i, %bb2.i.i21 ], [ %storemerge.i, %bb2.i20 ], [ %i.0.i, %bb2.i4.i30 ], [ %i.0.i, %esc.exit.i29 ]
  %254 = add nsw i32 %i.1.i, 1
  br label %bb5.i31

bb5.i31:                                          ; preds = %bb4.i, %addstr.exit3.i
  ...
  br i1 %257, label %bb7.i34, label %bb6.i32

bb6.i32:                                          ; preds = %bb5.i31
  %258 = load i8* %255, align 1
  %259 = icmp eq i8 %258, 0
  br i1 %259, label %bb7.i34, label %bb.i19

bb7.i34:                                          ; preds = %bb6.i32, %bb5.i31
  %260 = load i8* %255, align 1
  %261 = icmp eq i8 %260, 0
  %262 = icmp slt i32 %j.1.i, 100
  %or.cond.i33 = and i1 %261, %262
  br i1 %or.cond.i33, label %bb11.i35, label %makesub.exit

bb11.i35:                                         ; preds = %bb7.i34
  %263 = getelementptr inbounds [100 x i8]* %sub.i, i32 0, i32 %j.1.i
  store i8 0, i8* %263, align 1
  br label %makesub.exit

makesub.exit:                                     ; preds = %bb7.i34, %bb11.i35
  %264 = load i8* %argv34, align 1
  %265 = icmp eq i8 %264, 0
  br i1 %265, label %subline.exit, label %bb.i4

bb.i4:                                            ; preds = %makesub.exit, %bb10.backedge.i
  %lastm.13.i = phi i32 [ %lastm.0.i, %bb10.backedge.i ], [ -1, %makesub.exit ]
  %i.02.i = phi i32 [ %i.0.be.i, %bb10.backedge.i ], [ 0, %makesub.exit ]
...
bb.us.i.i:                                        ; preds = %bb6.us.i.i, %bb.lr.ph.split.us.i.i
  %.pre.i.i7 = phi i32 [ %.pre.i.i7.pre, %bb.lr.ph.split.us.i.i ], [ %.pre.i.i738, %bb6.us.i.i ]
...
bb6.us.i.i:                                       ; preds = %bb2.us.i.i, %bb5.us.i.i
  %.pre.i.i738 = phi i32 [ %279, %bb5.us.i.i ], [ %284, %bb2.us.i.i ]
...
bb3.i14:                                          ; preds = %bb6.i.i, %bb6.us.i.i, %bb2.i5, %bb.i4
  ...
  br i1 %or.cond1.i, label %bb5.i15, label %bb10.backedge.i
...
bb5.i15:                                          ; preds = %bb3.i14
  ...
  br i1 %294, label %bb6.i16, label %bb7.i17

bb6.i16:                                          ; preds = %bb5.i15
  %302 = add nsw i32 %i.02.i, 1
  br label %bb10.backedge.i

bb7.i17:                                          ; preds = %bb5.i15
  %303 = add nsw i32 %i.02.i, 2
  br label %bb10.backedge.i

bb10.backedge.i:                                  ; preds = %bb7.i17, %bb6.i16, %bb3.i14
  %i.0.be.i = phi i32 [ %302, %bb6.i16 ], [ %303, %bb7.i17 ], [ %266, %bb3.i14 ]
...
subline.exit:                                     ; preds = %bb10.backedge.i, %makesub.exit
...
!1 = metadata !{i32 589865, metadata !"v13-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR2/v13/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v13-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR2/v13/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i3
...
!816 = metadata !{i32 589870, i32 0, metadata !1, metadata !"change", metadata !"change", metadata !"change", metadata !1, i32 518, metadata !790, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null} ; [ DW_TAG_subprogram ]
!817 = metadata !{i32 589870, i32 0, metadata !1, metadata !"mainQ", metadata !"mainQ", metadata !"mainQ", metadata !1, i32 522, metadata !818, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null} ; [ DW_TAG_subprogram ]
...
!821 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 530, metadata !792, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @__user_main} ; [ DW_TAG_subprogram ]
...
!2222 = metadata !{i32 534, i32 0, metadata !2223, null}
!2223 = metadata !{i32 589835, metadata !821, i32 530, i32 0, metadata !1, i32 20} ; [ DW_TAG_lexical_block ]
!2224 = metadata !{i32 535, i32 0, metadata !2223, null}
!2225 = metadata !{i32 536, i32 0, metadata !2223, null}
!2226 = metadata !{i32 537, i32 0, metadata !2223, null}
!2227 = metadata !{i32 540, i32 0, metadata !2223, null}
!2228 = metadata !{i32 541, i32 0, metadata !2223, null}
!2229 = metadata !{i32 542, i32 0, metadata !2223, null}
!2230 = metadata !{i32 543, i32 0, metadata !2223, null}
!2231 = metadata !{i32 544, i32 0, metadata !2223, null}
!2232 = metadata !{i32 546, i32 0, metadata !2223, null}
!2233 = metadata !{i32 548, i32 0, metadata !2223, null}
!2234 = metadata !{i32 549, i32 0, metadata !2223, null}
!2235 = metadata !{i32 551, i32 0, metadata !2223, null}
!2236 = metadata !{i32 553, i32 0, metadata !2223, null}
!2237 = metadata !{i32 556, i32 0, metadata !2223, null}
!2238 = metadata !{i32 586, i32 0, metadata !2223, null}
!2239 = metadata !{i32 559, i32 0, metadata !2223, null}
!2240 = metadata !{i32 560, i32 0, metadata !2223, null}
!2241 = metadata !{i32 561, i32 0, metadata !2223, null}
!2242 = metadata !{i32 562, i32 0, metadata !2223, null}
!2243 = metadata !{i32 563, i32 0, metadata !2223, null}
!2244 = metadata !{i32 564, i32 0, metadata !2223, null}
!2245 = metadata !{i32 565, i32 0, metadata !2223, null}
!2246 = metadata !{i32 566, i32 0, metadata !2223, null}
!2247 = metadata !{i32 587, i32 0, metadata !2223, null}
!2248 = metadata !{i32 588, i32 0, metadata !2223, null}
!2249 = metadata !{i32 589, i32 0, metadata !2223, null}
!2250 = metadata !{i32 590, i32 0, metadata !2223, null}
!2251 = metadata !{i32 591, i32 0, metadata !2223, null}
!2252 = metadata !{i32 525, i32 0, metadata !2253, metadata !2254}
!2253 = metadata !{i32 589835, metadata !817, i32 522, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!2254 = metadata !{i32 594, i32 0, metadata !2223, null}
!2255 = metadata !{i32 526, i32 0, metadata !2253, metadata !2254}
!2256 = metadata !{i32 595, i32 0, metadata !2223, null}
!2257 = metadata !{i32 597, i32 0, metadata !2223, null}
