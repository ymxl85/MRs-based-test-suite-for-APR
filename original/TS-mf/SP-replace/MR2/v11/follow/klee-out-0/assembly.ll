...
bb10.i.i.i:                                       ; preds = %bb9.i.i.i
  ...
  %163 = load i8* %.pre37, align 1
  %164 = icmp sgt i8 %162, %163
  br i1 %164, label %bb11.i.i.i, label %bb15.i.i.i
...
!1 = metadata !{i32 589865, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR2/v11/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v11-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR2/v11/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i3
