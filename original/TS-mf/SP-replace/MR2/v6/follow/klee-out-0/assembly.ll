...
bb16:                                             ; preds = %bb3
  ...
  %tmp22 = sext i8 %30 to i32
  %tmp23 = add i32 %tmp22, %j
  %tmp24 = add i32 %tmp23, 1
  br label %bb4.i

bb.i:                                             ; preds = %bb4.i
  %scevgep.i = getelementptr i8* %pat, i32 %i.0.i
  %31 = load i8* %scevgep.i, align 1
  %32 = icmp eq i8 %31, %28
  br i1 %32, label %bb25, label %bb3.i

bb3.i:                                            ; preds = %bb.i
  %indvar.next.i = add i32 %indvar.i, 1
  br label %bb4.i

bb4.i:                                            ; preds = %bb3.i, %bb16
  %indvar.i = phi i32 [ %indvar.next.i, %bb3.i ], [ 0, %bb16 ]
  %i.0.i = sub i32 %tmp24, %indvar.i
  %33 = icmp slt i32 %i.0.i, %25
  br i1 %33, label %bb27, label %bb.i

bb19:                                             ; preds = %bb3
  %34 = load i32* %i, align 4, !dbg !2200
  %35 = getelementptr inbounds i8* %lin, i32 %34, !dbg !2200
  %36 = load i8* %35, align 1, !dbg !2200
  %37 = icmp eq i8 %36, 10, !dbg !2200
  br i1 %37, label %bb27, label %bb20, !dbg !2200

bb20:                                             ; preds = %bb19
  %38 = add nsw i32 %j, 1, !dbg !2200
  %39 = load i32* %i, align 4, !dbg !2200
  %40 = getelementptr inbounds i8* %lin, i32 %39, !dbg !2200
  %41 = load i8* %40, align 1, !dbg !2200
  %42 = getelementptr inbounds i8* %pat, i32 %38
  %43 = load i8* %42, align 1
  %tmp27 = sext i8 %43 to i32
  %tmp28 = add i32 %tmp27, %j
  %tmp29 = add i32 %tmp28, 1
  br label %bb4.i11

bb.i6:                                            ; preds = %bb4.i11
  %scevgep.i5 = getelementptr i8* %pat, i32 %i.0.i10
  %44 = load i8* %scevgep.i5, align 1
  %45 = icmp eq i8 %44, %41
  br i1 %45, label %bb27, label %bb3.i8

bb3.i8:                                           ; preds = %bb.i6
  %indvar.next.i7 = add i32 %indvar.i9, 1
  br label %bb4.i11

bb4.i11:                                          ; preds = %bb3.i8, %bb20
  %indvar.i9 = phi i32 [ %indvar.next.i7, %bb3.i8 ], [ 0, %bb20 ]
  %i.0.i10 = sub i32 %tmp29, %indvar.i9
  %46 = icmp slt i32 %i.0.i10, %38
  br i1 %46, label %bb25, label %bb.i6

bb23:                                             ; preds = %bb3
  %47 = load i8* %4, align 1, !dbg !2201
  %48 = sext i8 %47 to i32, !dbg !2201
  tail call fastcc void @Caseerror(i32 %48) nounwind
  unreachable

bb25:                                             ; preds = %bb4.i11, %bb.i, %bb13, %bb10, %bb7, %bb4
  %advance.0.ph = phi i32 [ 1, %bb4 ], [ 0, %bb7 ], [ 1, %bb10 ], [ 0, %bb13 ], [ 1, %bb.i ], [ 1, %bb4.i11 ]
  %49 = load i32* %i, align 4, !dbg !2202
  %50 = add nsw i32 %49, %advance.0.ph, !dbg !2202
  store i32 %50, i32* %i, align 4, !dbg !2202
  br label %bb27, !dbg !2203

bb27:                                             ; preds = %bb.i6, %bb4.i, %entry, %bb19, %bb13, %bb7, %bb10, %bb4, %bb25
  %result.0 = phi i8 [ 1, %bb25 ], [ 0, %bb4 ], [ 0, %bb10 ], [ 0, %bb7 ], [ 0, %bb13 ], [ 0, %bb19 ], [ 0, %entry ], [ 0, %bb4.i ], [ 0, %bb.i6 ]
...
!1 = metadata !{i32 589865, metadata !"v6-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR2/v6/follow/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v6-f.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/SP-replace/mutants/MR2/v6/follow/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 
