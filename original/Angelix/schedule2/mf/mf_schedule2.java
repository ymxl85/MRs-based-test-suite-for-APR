...
public class mf_schedule2 {

	public String path;
	  public String inputdir;
	  public String idirname;
	  public mf_schedule2(String a,String b,String c)
	  {
		  this.path=a;
		  this.inputdir=b;
		  this.idirname=c;
	  ...
	  public String getOperand (String a)
  {
	  ...
	  public void processT0() throws IOException
	  {
		  ...
		  ow.write("    diff <(${ANGELIX_RUN:-eval} ./schedule2 $1 < $2) <(angelix-eval $SCRIPT_DIR/../golden/schedule2 $1 < $2)");ow.newLine();
		  ow.write("}");ow.newLine();
		  ow.write("");ow.newLine();
	  ...
	  {
		  mf_schedule2 tt=new mf_schedule2(args[0],args[1],args[2]);
		  tt.processT0();
	  }
}
