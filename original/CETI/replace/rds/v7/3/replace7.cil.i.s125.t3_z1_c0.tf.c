...
{ 
  ...
  {
  __cil_tmp2 = (bool )(((int )c == 37 || (int )c == 63) || (int )c == 42);
  return (__cil_tmp2);
}
}
...
{ 
  ...
  __cil_tmp6 = mainQ("", "Sk13", "uz,cV1&I4OIe&%j]Hp", uk_0);
  __cil_tmp7 = strcmp(__cil_tmp6, "Sk13uSk13zSk13,Sk13cSk13VSk131Sk13&Sk13ISk134Sk13OSk13ISk13eSk13&Sk13%Sk13jSk13]Sk13HSk13p");
  __cil_tmp8 = mainQ("QCk`", "", "P~QYyypjQ~n", uk_0);
  __cil_tmp9 = strcmp(__cil_tmp8, "P~QYyypjQ~n");
  __cil_tmp10 = mainQ("/v]", "Z^\"", "=ESamnZ=6y_4jcEDb", uk_0);
  __cil_tmp11 = strcmp(__cil_tmp10, "=ESamnZ=6y_4jcEDb");
  __cil_tmp12 = mainQ("5", "0", "v.iBYwB0Y7uB{eu", uk_0);
  __cil_tmp13 = strcmp(__cil_tmp12, "v.iBYwB0Y7uB{eu");
  __cil_tmp14 = mainQ("?*k", "Z", "|Uo!}+3<R", uk_0);
  __cil_tmp15 = strcmp(__cil_tmp14, "|Uo!}+3<R");
  __cil_tmp16 = mainQ(">Y#q", "T]G", "Okb1tFwB(G", uk_0);
  __cil_tmp17 = strcmp(__cil_tmp16, "Okb1tFwB(G");
  __cil_tmp18 = mainQ("xa2", "0", "x{PdCRgwR^CP", uk_0);
  __cil_tmp19 = strcmp(__cil_tmp18, "x{PdCRgwR^CP");
  __cil_tmp20 = mainQ("jB", "z", "Ff", uk_0);
  __cil_tmp21 = strcmp(__cil_tmp20, "Ff");
  __cil_tmp22 = mainQ("b&hU", "j*", "akI&t*jOjv", uk_0);
  __cil_tmp23 = strcmp(__cil_tmp22, "akI&t*jOjv");
  __cil_tmp24 = mainQ("{w4M", "d! ", "} 0HSs", uk_0);
  __cil_tmp25 = strcmp(__cil_tmp24, "} 0HSs");
  __cil_tmp26 = mainQ("Vz", "", "y}=Eaa3V6`FH!w1GM`(C", uk_0);
  __cil_tmp27 = strcmp(__cil_tmp26, "y}=Eaa3V6`FH!w1GM`(C");
  __cil_tmp28 = mainQ(",C", "", "+69l,z)(y!]cL.^eHD=", uk_0);
  __cil_tmp29 = strcmp(__cil_tmp28, "+69l,z)(y!]cL.^eHD=");
  __cil_tmp30 = mainQ(" gy", "", "hnoRlf5)@", uk_0);
  __cil_tmp31 = strcmp(__cil_tmp30, "hnoRlf5)@");
  __cil_tmp32 = mainQ("a", "*", "ss7G&\\H-_?(Yrm", uk_0);
  __cil_tmp33 = strcmp(__cil_tmp32, "ss7G&\\H-_?(Yrm");
  __cil_tmp34 = mainQ("", "h\\Jl", "Tcc]gLS", uk_0);
  __cil_tmp35 = strcmp(__cil_tmp34, "h\\JlTh\\Jlch\\Jlch\\Jl]h\\Jlgh\\JlLh\\JlS");
  __cil_tmp36 = mainQ("", "(7~", "iK3kIw$Mcb2eqpY6", uk_0);
  __cil_tmp37 = strcmp(__cil_tmp36, "(7~i(7~K(7~3(7~k(7~I(7~w(7~$(7~M(7~c(7~b(7~2(7~e(7~q(7~p(7~Y(7~6");
  __cil_tmp38 = mainQ("s+qP", "?", "J2GBE#19d*)~U,", uk_0);
  __cil_tmp39 = strcmp(__cil_tmp38, "J2GBE#19d*)~U,");
  __cil_tmp40 = mainQ("0S", "gXy", "*kB~Os<cNa", uk_0);
  __cil_tmp41 = strcmp(__cil_tmp40, "*kB~Os<cNa");
  __cil_tmp42 = mainQ("{o", "t~", "2BV|o*UM0ne+D|S.", uk_0);
  __cil_tmp43 = strcmp(__cil_tmp42, "2BV|o*UM0ne+D|S.");
  __cil_tmp44 = mainQ("o", "pm-", "sG/S\"6q5GUJ", uk_0);
  __cil_tmp45 = strcmp(__cil_tmp44, "sG/S\"6q5GUJ");
  __cil_tmp46 = mainQ("^", "p", "|$yK(6QGCK;/@_n|g\\.\\", uk_0);
  __cil_tmp47 = strcmp(__cil_tmp46, "|$yK(6QGCK;/@_n|g\\.\\");
  __cil_tmp48 = mainQ(".NI", "K", "F};,FozEa&", uk_0);
  __cil_tmp49 = strcmp(__cil_tmp48, "F};,FozEa&");
  __cil_tmp50 = mainQ("", "", "M[]u{lf1BUjy9", uk_0);
  __cil_tmp51 = strcmp(__cil_tmp50, "M[]u{lf1BUjy9");
  __cil_tmp52 = mainQ("K", "", "p:}/W!jmv$Rzrfw", uk_0);
  __cil_tmp53 = strcmp(__cil_tmp52, "p:}/W!jmv$Rzrfw");
  __cil_tmp54 = mainQ("", "!cl", "UG7lW]jw5qjp-T", uk_0);
  __cil_tmp55 = strcmp(__cil_tmp54, "!clU!clG!cl7!cll!clW!cl]!clj!clw!cl5!clq!clj!clp!cl-!clT");
  __cil_tmp56 = mainQ("8L", "WLI", "hm%.", uk_0);
  __cil_tmp57 = strcmp(__cil_tmp56, "hm%.");
  __cil_tmp58 = mainQ("", "%|T ", "QU&Rt$", uk_0);
  __cil_tmp59 = strcmp(__cil_tmp58, "%|T Q%|T U%|T &%|T R%|T t%|T $");
  __cil_tmp60 = mainQ("\\Z", "*A{M", "3P1ghJ7q\\", uk_0);
  __cil_tmp61 = strcmp(__cil_tmp60, "3P1ghJ7q\\");
  __cil_tmp62 = mainQ("\\", "", ",z", uk_0);
  __cil_tmp63 = strcmp(__cil_tmp62, ",z");
  __cil_tmp64 = mainQ(";TS", "X8d", "=mCSkIE~rphB", uk_0);
  __cil_tmp65 = strcmp(__cil_tmp64, "=mCSkIE~rphB");
