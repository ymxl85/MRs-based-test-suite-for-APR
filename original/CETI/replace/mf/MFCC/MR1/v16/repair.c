...
char c;
{
  return (c == 99 || c == 99 || c == 99 || c == 99); /* added code fault*/////__cil_tmp2 = (bool )((((int )c == 37 || (int )c == 36) || (int )c == 42) || (int )c == 63); ===> __cil_tmp2 = (bool )((((int )c == uk_3 || (int )c == uk_2) || (int )c == uk_1) || (int )c == uk_0); ===> uk_0 99, uk_1 99, uk_2 99, uk_3 99
}      
