...
entry:
  ...
  %argv11 = getelementptr inbounds [10 x i8]* %argv1, i32 0, i32 0, !dbg !129
  call void @klee_make_symbolic(i8* %argv11, i32 10, i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !129
  %argv22 = getelementptr inbounds [3 x i8]* %argv2, i32 0, i32 0, !dbg !131
  call void @klee_make_symbolic(i8* %argv22, i32 3, i8* getelementptr inbounds ([6 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !131
  %argv33 = getelementptr inbounds [10 x i8]* %argv3, i32 0, i32 0, !dbg !132
  call void @klee_make_symbolic(i8* %argv33, i32 10, i8* getelementptr inbounds ([6 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !132
  %0 = load i8* %argv11, align 1, !dbg !133
  %1 = icmp ne i8 %0, 0, !dbg !133
  %2 = zext i1 %1 to i32, !dbg !133
  call void @klee_assume(i32 %2) nounwind, !dbg !133
  %3 = load i8* %argv22, align 1, !dbg !134
  %4 = icmp ne i8 %3, 0, !dbg !134
  %5 = zext i1 %4 to i32, !dbg !134
  call void @klee_assume(i32 %5) nounwind, !dbg !134
  %6 = load i8* %argv33, align 1, !dbg !135
  %7 = icmp ne i8 %6, 0, !dbg !135
  %8 = zext i1 %7 to i32, !dbg !135
  call void @klee_assume(i32 %8) nounwind, !dbg !135
  %9 = getelementptr inbounds [10 x i8]* %argv1, i32 0, i32 9, !dbg !136
  %10 = load i8* %9, align 1, !dbg !136
  %11 = icmp eq i8 %10, 0, !dbg !136
  %12 = zext i1 %11 to i32, !dbg !136
  call void @klee_assume(i32 %12) nounwind, !dbg !136
  %13 = getelementptr inbounds [3 x i8]* %argv2, i32 0, i32 2, !dbg !137
  %14 = load i8* %13, align 1, !dbg !137
  %15 = icmp eq i8 %14, 0, !dbg !137
  %16 = zext i1 %15 to i32, !dbg !137
  call void @klee_assume(i32 %16) nounwind, !dbg !137
  %17 = getelementptr inbounds [10 x i8]* %argv3, i32 0, i32 9, !dbg !138
  %18 = load i8* %17, align 1, !dbg !138
  %19 = icmp eq i8 %18, 0, !dbg !138
  %20 = zext i1 %19 to i32, !dbg !138
  call void @klee_assume(i32 %20) nounwind, !dbg !138
  %pat1.i = getelementptr inbounds [100 x i8]* %pat.i, i32 0, i32 0, !dbg !139
...
bb11.i.i.i:                                       ; preds = %bb10.i.i.i
  ...
  %100 = icmp slt i32 %99, %k.021.i.i.i
  br i1 %100, label %bb16.i.i.i, label %bb12.lr.ph.i.i.i
...
bb13.backedge.i.i.i:                              ; preds = %bb2.i3.i.i.i, %bb12.i.i.i
  ...
  %104 = icmp slt i32 %103, %k.0.i.i.i
  br i1 %104, label %bb16.i.i.i, label %bb13.backedge.bb12_crit_edge.i.i.i
...
addstr.exit3.i:                                   ; preds = %bb2.i1.i, %bb23.i
  %sub2.i = getelementptr inbounds [100 x i8]* %sub.i, i32 0, i32 0, !dbg !142
  br label %bb5.i14
...
!1 = metadata !{i32 589865, metadata !"v24.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/coverageTC/v24/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v24.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/coverageTC/v24/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compi
...
!136 = metadata !{i32 540, i32 0, metadata !130, null}
!137 = metadata !{i32 542, i32 0, metadata !130, null}
!138 = metadata !{i32 544, i32 0, metadata !130, null}
!139 = metadata !{i32 522, i32 0, metadata !140, metadata !141}
!140 = metadata !{i32 589835, metadata !33, i32 519, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!141 = metadata !{i32 547, i32 0, metadata !130, null}
!142 = metadata !{i32 523, i32 0, metadata !140, metadata !141}
!143 = metadata !{i32 549, i32 0, metadata !130, null}
