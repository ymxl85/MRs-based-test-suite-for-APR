...
# 5 "coverageTC/v12/replace12.c" 2

void Caseerror();

typedef char bool;
# 35 "coverageTC/v12/replace12.c"
...
int *j;
{
    ...
    *i = *i + 1;
    if (arg[*i] == '^') {
 junk = addstr('!', pat, j, MAXPAT);
 *i = *i + 1;
    } else
 junk = addstr('[', pat, j, MAXPAT);
    jstart = *j;
    junk = addstr(0, pat, j, MAXPAT);
    dodash(']', arg, i, pat, j, MAXPAT);
