...
{ 
  ...
  {
  __cil_tmp2 = (bool )((((((int )c == 99 || (int )c == 37) || (int )c == 63) || (int )c == 91) || (int )c == 33) || (int )c == 42);
  return (__cil_tmp2);
}
}
...
{ 
  ...
  while (1) {
    __cil_tmp26 = (! done && (int )*(arg + i) != (int )delim) && (int )*(arg + i) != uk_0;
    if (! __cil_tmp26) {
      break;
    }
    lj = j;
...
{ 
  ...
  __cil_tmp10 = mainQ("$", "&", "\\xff", uk_0);
  __cil_tmp11 = strcmp(__cil_tmp10, "\\xff");
  __cil_tmp12 = mainQ("?", "@", "\\n", uk_0);
  __cil_tmp13 = strcmp(__cil_tmp12, "@@");
  __cil_tmp14 = mainQ("?", "\\xff", "\\n", uk_0);
  __cil_tmp15 = strcmp(__cil_tmp14, "\\xff\\xff");
  __cil_tmp16 = mainQ("%", "&", "\\xff", uk_0);
  ...
  __cil_tmp34 = mainQ("??", "&", "\\xf5", uk_0);
  __cil_tmp35 = strcmp(__cil_tmp34, "\\xf5");
  __cil_tmp36 = mainQ("?", "@\\x9b", "\\n", uk_0);
  __cil_tmp37 = strcmp(__cil_tmp36, "\\x9b\\x9b");
  __cil_tmp38 = mainQ("$?", "&", "\\xdb", uk_0);
  __cil_tmp39 = strcmp(__cil_tmp38, "\\xdb");
  __cil_tmp40 = mainQ("??", "&", "\\xf5\\xf5", uk_0);
  __cil_tmp41 = strcmp(__cil_tmp40, "\\xf5\\xf5");
  __cil_tmp42 = mainQ("$?", "&", "$", uk_0);
  __cil_tmp43 = strcmp(__cil_tmp42, "$");
  __cil_tmp44 = mainQ("[", "&", "\\xff", uk_0);
  __cil_tmp45 = strcmp(__cil_tmp44, "\\xff");
  __cil_tmp46 = mainQ("[^", "&", "\\n", uk_0);
  __cil_tmp47 = strcmp(__cil_tmp46, "\\n");
  __cil_tmp48 = mainQ("\\xda", "&", "\\xda", uk_0);
  __cil_tmp49 = strcmp(__cil_tmp48, "\\xda");
  __cil_tmp50 = mainQ("@", "&", "@", uk_0);
  ...
  __cil_tmp58 = mainQ("[^]", "&", "\\xf5", uk_0);
  __cil_tmp59 = strcmp(__cil_tmp58, "\\xf5");
  __cil_tmp60 = mainQ("?*", "&", "\\n", uk_0);
  ...
  __cil_tmp66 = mainQ("?*", "&", "\\xf5", uk_0);
  __cil_tmp67 = strcmp(__cil_tmp66, "\\xf5");
  __cil_tmp68 = mainQ("[-", "&", "\\xd2", uk_0);
  __cil_tmp69 = strcmp(__cil_tmp68, "\\xd2");
  __cil_tmp70 = mainQ("@\\x9b", "&", "\\x9b", uk_0);
  __cil_tmp71 = strcmp(__cil_tmp70, "\\x9b");
  __cil_tmp72 = mainQ("@t", "&", "\\t", uk_0);
  __cil_tmp73 = strcmp(__cil_tmp72, "\\t");
  __cil_tmp74 = mainQ("[^-", "&", "-", uk_0);
  __cil_tmp75 = strcmp(__cil_tmp74, "-");
  __cil_tmp76 = mainQ("[^\\xf2]", "&", "\\n", uk_0);
  ...
  __cil_tmp94 = mainQ("[@@\\x9b]", "&", "\\xff", uk_0);
  __cil_tmp95 = strcmp(__cil_tmp94, "\\xff");
  __cil_tmp96 = mainQ("[@@", "&", "@", uk_0);
  __cil_tmp97 = strcmp(__cil_tmp96, "@");
  __cil_tmp98 = mainQ("[@\\xbf]", "&", "\\xbf", uk_0);
  __cil_tmp99 = strcmp(__cil_tmp98, "\\xbf");
  ...
  __cil_tmp104 = mainQ("[@@n-]", "\\xff", "\\xff", uk_0);
