...
{ 
  ...
  __cil_tmp30 = mainQ("?", "&&", "\\xf5", uk_0);
  __cil_tmp31 = strcmp(__cil_tmp30, "\\\\xxff55");
  __cil_tmp32 = mainQ("%", "\\x99", "\\xff", uk_0);
  __cil_tmp33 = strcmp(__cil_tmp32, "\\x99\\xff");
  __cil_tmp34 = mainQ("$", "&", "\\n", uk_0);
  ...
  __cil_tmp42 = mainQ("@", "&", "\\xff", uk_0);
  __cil_tmp43 = strcmp(__cil_tmp42, "\\xff");
  __cil_tmp44 = mainQ("\\xda", "&", "\\xff", uk_0);
  __cil_tmp45 = strcmp(__cil_tmp44, "\\xff");
  __cil_tmp46 = mainQ("??", "&", "\\xf5\\xf5", uk_0);
  __cil_tmp47 = strcmp(__cil_tmp46, "\\xf5\\xf5");
  __cil_tmp48 = mainQ("[]", "&", "\\xff", uk_0);
  __cil_tmp49 = strcmp(__cil_tmp48, "\\xff");
  __cil_tmp50 = mainQ("\\xda", "&", "\\xda", uk_0);
  ...
  __cil_tmp58 = mainQ("%*", "&", "\\xff", uk_0);
  __cil_tmp59 = strcmp(__cil_tmp58, "\\xff");
  __cil_tmp60 = mainQ("$?", "&", "$", uk_0);
  ...
  __cil_tmp70 = mainQ("?*", "&", "\\xf5", uk_0);
  __cil_tmp71 = strcmp(__cil_tmp70, "\\xf5");
  ...
  __cil_tmp94 = mainQ("[^@@t]", "&", "\\xff", uk_0);
  __cil_tmp95 = strcmp(__cil_tmp94, "\\xff");
  __cil_tmp96 = mainQ("[^@@n]", "&", "\\xff", uk_0);
  __cil_tmp97 = strcmp(__cil_tmp96, "\\xff");
  __cil_tmp98 = mainQ("[^@\\xbf]", "&", "\\n", uk_0);
  __cil_tmp99 = strcmp(__cil_tmp98, "\\n");
  __cil_tmp100 = mainQ("[^]*", "&", "\\n", uk_0);
  __cil_tmp101 = strcmp(__cil_tmp100, "\\n");
  __cil_tmp102 = mainQ("[^@@\\x9b]", "&", "\\xff", uk_0);
