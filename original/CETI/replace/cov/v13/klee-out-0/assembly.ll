...
bb.i20:                                           ; preds = %makesub.exit, %bb10.backedge.i
...
bb3.i30:                                          ; preds = %bb6.i.i, %bb6.us.i.i, %bb2.i21, %bb.i20
  ...
  br i1 %or.cond1.i, label %bb5.i31, label %bb10.backedge.i
...
bb5.i31:                                          ; preds = %bb3.i30
  ...
  br i1 %220, label %bb6.i32, label %bb7.i33

bb6.i32:                                          ; preds = %bb5.i31
  %226 = add nsw i32 %i.02.i, 1
  br label %bb10.backedge.i

bb7.i33:                                          ; preds = %bb5.i31
  %227 = add nsw i32 %i.02.i, 2
  br label %bb10.backedge.i

bb10.backedge.i:                                  ; preds = %bb7.i33, %bb6.i32, %bb3.i30
  %OL.7 = phi i32 [ %225, %bb6.i32 ], [ %225, %bb7.i33 ], [ %OL.6, %bb3.i30 ]
  %i.0.be.i = phi i32 [ %226, %bb6.i32 ], [ %227, %bb7.i33 ], [ %197, %bb3.i30 ]
...
!1 = metadata !{i32 589865, metadata !"v13.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/coverageTC/v13/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v13.c", metadata !"/home/mingyue/experiments/ceti/REPLACE/coverageTC/v13/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compi
...
!140 = metadata !{i32 525, i32 0, metadata !141, metadata !142}
!141 = metadata !{i32 589835, metadata !33, i32 522, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!142 = metadata !{i32 550, i32 0, metadata !131, null}
!143 = metadata !{i32 526, i32 0, metadata !141, metadata !142}
!144 = metadata !{i32 552, i32 0, metadata !131, null}
