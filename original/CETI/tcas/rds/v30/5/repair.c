...
//intent_not_known = Two_of_Three_Reports_Valid && Other_RAC == 0; ===> intent_not_known = Two_of_Three_Reports_Valid && Other_RAC == uk_0; ===> uk_0 100000
  tcas_equipped = Other_Capability == 1;
  intent_not_known = Two_of_Three_Reports_Valid && Other_RAC == 100000;
