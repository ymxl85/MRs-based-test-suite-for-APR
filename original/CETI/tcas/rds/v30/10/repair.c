			  ...
			  int Climb_Inhibit)
{
  ...
  return (Up_Separation + 48); //tvn: missing code (Climb_Inhibit ? 100 + Up_Separation: Up_Separation);
	//__cil_tmp13 = Up_Separation + 100; ===> __cil_tmp13 = Up_Separation + uk_0; ===> uk_0 48  
}
