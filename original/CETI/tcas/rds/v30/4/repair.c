		 ...
		 int Climb_Inhibit)
{
  ...
  enabled = High_Confidence && (Own_Tracked_Alt_Rate <= 160) && (Cur_Vertical_Sep > 703);
//enabled = (High_Confidence && Own_Tracked_Alt_Rate <= 600) && Cur_Vertical_Sep > 600; ===> enabled = (High_Confidence && Own_Tracked_Alt_Rate <= uk_1) && Cur_Vertical_Sep > uk_0; ===> uk_0 703, uk_1 160
