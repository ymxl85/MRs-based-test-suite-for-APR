		 ...
		 int Climb_Inhibit)
{
  ...
  enabled = High_Confidence && (Own_Tracked_Alt_Rate <= 640) && (Cur_Vertical_Sep > 607); //tvn const change > 600
//enabled = (High_Confidence && Own_Tracked_Alt_Rate <= 600) && Cur_Vertical_Sep > 650; ===> enabled = (High_Confidence && Own_Tracked_Alt_Rate <= uk_1) && Cur_Vertical_Sep > uk_0; ===> uk_0 607, uk_1 640
