			      ...
			      int Climb_Inhibit)
{
  ...
  upward_preferred = (Up_Separation + -212)  > Down_Separation; //tvn: misc change Inhibit_Biased_Climb() > Down_Separation
//upward_preferred = Up_Separation + 100 > Down_Separation; ===> upward_preferred = Up_Separation + uk_0 > Down_Separation; ===> uk_0 -212
  if (upward_preferred)
    {
