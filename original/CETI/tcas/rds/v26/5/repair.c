		 ...
		 int Climb_Inhibit)
{
  ...
  enabled = High_Confidence && (Cur_Vertical_Sep > 100000); //tvn misc: missing  (Own_Tracked_Alt_Rate <= 600) &&
//enabled = High_Confidence && Cur_Vertical_Sep > 600; ===> enabled = High_Confidence && Cur_Vertical_Sep > uk_0; ===> uk_0 100000
