		 ...
		 int Climb_Inhibit)
{
  ...
  enabled = High_Confidence && (Own_Tracked_Alt_Rate <= 256) && (Cur_Vertical_Sep > 610);//enabled = (High_Confidence && Own_Tracked_Alt_Rate <= 600) && Cur_Vertical_Sep > 600; ===> enabled = (High_Confidence && Own_Tracked_Alt_Rate <= uk_1) && Cur_Vertical_Sep > uk_0; ===> uk_0 610, uk_1 256
