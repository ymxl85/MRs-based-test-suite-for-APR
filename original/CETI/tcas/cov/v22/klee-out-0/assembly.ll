...
bb12.i:                                           ; preds = %bb9.i
  %78 = icmp sgt i32 %66, %67, !dbg !115
  br i1 %78, label %bb.i.i, label %bb6.i.i, !dbg !118

bb.i.i:                                           ; preds = %bb12.i
  %79 = icmp slt i32 %62, %64
  br i1 %79, label %bb2.i.i, label %bb15.i, !dbg !119
...
ALIM.exit6.i.i:                                   ; preds = %bb5.i4.i.i, %bb4.i3.i.i, %bb2.i2.i.i, %bb2.i.i
  ...
  %80 = icmp sgt i32 %.0.i5.i.i, %67, !dbg !119
  br i1 %80, label %bb16.i, label %bb15.i, !dbg !119

bb6.i.i:                                          ; preds = %bb12.i
  %81 = icmp sge i32 %64, %62, !dbg !124
  %82 = icmp slt i32 %60, 300, !dbg !124
...
ALIM.exit.i.i:                                    ; preds = %bb5.i.i.i, %bb4.i.i.i, %bb2.i.i.i, %bb8.i.i
  ...
  %83 = icmp sle i32 %.0.i.i.i, %66, !dbg !124
...
bb16.i:                                           ; preds = %bb15.i, %ALIM.exit.i.i, %ALIM.exit6.i.i
  ...
  %84 = icmp eq i32 %69, 0, !dbg !130
  %85 = add nsw i32 %66, 100, !dbg !130
  %iftmp.0.0.i.i.i = select i1 %84, i32 %66, i32 %85
...
!1 = metadata !{i32 589865, metadata !"v22.c", metadata !"/home/mingyue/experiments/ceti/TCAS/coverageTC/v22/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v22.c", metadata !"/home/mingyue/experiments/ceti/TCAS/coverageTC/v22/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_
