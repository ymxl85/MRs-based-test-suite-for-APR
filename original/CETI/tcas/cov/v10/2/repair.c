  ...
  if (upward_preferred)
    {
      result = Own_Below_Threat(Cur_Vertical_Sep, 
				...
				Other_RAC,
				Other_Capability,
				Climb_Inhibit) && (Cur_Vertical_Sep >= 100000) && (Down_Separation >= ALIM(Cur_Vertical_Sep, 
													High_Confidence,
													Two_of_Three_Reports_Valid,
													Own_Tracked_Alt,
													Own_Tracked_Alt_Rate,
													...
													Other_Capability,
													Climb_Inhibit));
///_cil_tmp24 = tmp___0 && Cur_Vertical_Sep >= 300; ===> __cil_tmp24 = tmp___0 && Cur_Vertical_Sep >= uk_0; ===> uk_0 100000
    }
  else
    {
      result = !(Own_Above_Threat(Cur_Vertical_Sep, 
