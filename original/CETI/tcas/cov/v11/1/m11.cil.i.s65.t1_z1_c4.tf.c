...
{ 
  ...
  if (__cil_tmp32) {
    ...
    __cil_tmp31 = uk_0 + uk_1 * Own_Tracked_Alt_Rate;
    if (__cil_tmp31) {
      alt_sep = 0;
    } else {
...
{ 
  ...
  __cil_tmp21 = mainQ(2288, 1, 1, 6368, -8976, 6320, 0, 6264, -6416, 0, 2, 1, uk_0,
                      uk_1);
  __cil_tmp22 = mainQ(2960, 1, 1, -5920, 112, -1840, 0, -8192, 5872, 0, 2, 0, uk_0,
                      uk_1);
  __cil_tmp23 = mainQ(1048, 1, 1, -8976, -1456, -10000, 1, 0, 6256, 0, 2, 0, uk_0,
                      uk_1);
  __cil_tmp24 = mainQ(6840, 1, 1, -9928, 80, -9928, 1, 2288, 2288, 0, 2, 0, uk_0,
                      uk_1);
  __cil_tmp25 = mainQ(976, 1, 1, 2288, 16, 2288, 0, 2292, 2064, 0, 2, 1, uk_0, uk_1);
  __cil_tmp26 = mainQ(1832, 1, 1, -1935, 112, -10000, 1, 2300, 2404, 0, 2, 1, uk_0,
                      uk_1);
  __cil_tmp27 = mainQ(6200, 1, 1, 4306, 80, 4306, 2, 2288, 2292, 0, 2, 0, uk_0, uk_1);
  __cil_tmp28 = mainQ(2288, 1, 1, -5904, 112, 6256, 0, -4, -7951, 0, 2, 0, uk_0, uk_1);
  __cil_tmp29 = mainQ(2288, 1, 1, 4208, 80, 6257, 0, 6296, 401, 0, 2, 1, uk_0, uk_1);
  __cil_tmp30 = mainQ(1048, 1, 1, -8976, -1808, -10000, 2, 0, 6256, 0, 2, 0, uk_0,
                      uk_1);
  __cil_tmp31 = mainQ(2288, 1, 1, -5904, 112, 6256, 2, -4, -7951, 0, 2, 0, uk_0, uk_1);
  __cil_tmp32 = mainQ(3312, 1, 1, 8976, 16, 10000, 1, 3981, 2288, 0, 2, 1, uk_0, uk_1);
  __cil_tmp33 = mainQ(6184, 1, 1, 2264, 80, 2264, 3, 2288, 2288, 0, 2, 0, uk_0, uk_1);
  __cil_tmp34 = mainQ(1048, 1, 1, -8976, -1808, -10000, 3, 0, 6256, 0, 2, 0, uk_0,
                      uk_1);
  __cil_tmp35 = mainQ(2288, 1, 1, -5904, 112, 6256, 3, -4, -7951, 0, 2, 0, uk_0, uk_1);
  __cil_tmp36 = mainQ(2288, 1, 1, -5904, 112, 6256, 1, -4, -7951, 0, 2, 0, uk_0, uk_1);
  if (((((((((((((((((__cil_tmp19 == 0 && __cil_tmp20 == 0) && __cil_tmp21 == 0) && __cil_tmp22 == 0) && __cil_tmp23 == 0) && __cil_tmp24 == 0) && __cil_tmp25 == 0) && __cil_tmp26 == 2) && __cil_tmp27 == 0) && __cil_tmp28 == 1) && __cil_tmp29 == 0) && __cil_tmp30 == 0) && __cil_tmp31 == 1) && __cil_tmp32 == 0) && __cil_tmp33 == 0) && __cil_tmp34 == 0) && __cil_tmp35 == 1) && __cil_tmp36 == 1) {
