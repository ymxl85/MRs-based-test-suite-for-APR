...
{ 
  ...
  __cil_tmp19 = mainQ(-10000, 1, 1, 2288, 2288, -9872, 0, -15, -2320, 0, 2, 0, uk_0);
  __cil_tmp20 = mainQ(-9136, 1, 1, -3856, -6416, -1808, 0, 0, 0, 0, 2, 0, uk_0);
  __cil_tmp21 = mainQ(48, 1, 1, 6352, 7248, 6320, 2, -4160, 5872, 0, 2, 0, uk_0);
  __cil_tmp22 = mainQ(-10000, 1, 1, -9991, 2288, -9989, 1, -9064, -9999, 0, 2, 1,
                      uk_0);
  __cil_tmp23 = mainQ(-10000, 1, 1, -9991, 2288, -9989, 2, -9064, -9999, 0, 2, 1,
                      uk_0);
  __cil_tmp24 = mainQ(-10000, 1, 1, 6352, 6368, 6288, 2, 3192, 4336, 0, 2, 1, uk_0);
  __cil_tmp25 = mainQ(760, 1, 1, -10000, 16, -9999, 1, 6332, 752, 0, 2, 1, uk_0);
  __cil_tmp26 = mainQ(144, 1, 1, 4336, 1552, 2288, 3, -8292, -8192, 0, 2, 1, uk_0);
  __cil_tmp27 = mainQ(1256, 1, 1, 1040, 240, 3256, 2, -3, -6416, 0, 2, 0, uk_0);
  __cil_tmp28 = mainQ(-2896, 1, 1, -9616, 3152, -9104, 2, 6316, 2288, 0, 2, 1, uk_0);
  __cil_tmp29 = mainQ(144, 1, 1, 4336, 1552, 2288, 1, -8292, -8192, 0, 2, 1, uk_0);
  __cil_tmp30 = mainQ(3304, 1, 1, -9231, 6064, -10000, 3, -8128, 5872, 0, 2, 0, uk_0);
  __cil_tmp31 = mainQ(240, 1, 1, 8428, 848, 8301, 0, 0, 0, 0, 2, 0, uk_0);
  __cil_tmp32 = mainQ(3304, 1, 1, -9231, 6064, -10000, 0, -8128, 5872, 0, 2, 0, uk_0);
  __cil_tmp33 = mainQ(-10000, 1, 1, -9991, 2288, -9989, 3, -9064, -9999, 0, 2, 1,
                      uk_0);
  __cil_tmp34 = mainQ(3304, 1, 1, -9231, 6064, -10000, 1, -8128, 5872, 0, 2, 0, uk_0);
  __cil_tmp35 = mainQ(1256, 1, 1, 1040, 240, 3256, 3, -3, -6416, 0, 2, 0, uk_0);
  __cil_tmp36 = mainQ(-10000, 1, 1, -9991, 2288, -9989, 0, -9064, -9999, 0, 2, 1,
                      uk_0);
  __cil_tmp37 = mainQ(3304, 1, 1, -9231, 6064, -10000, 2, -8128, 5872, 0, 2, 0, uk_0);
  if (((((((((((((((((((__cil_tmp18 == 0 && __cil_tmp19 == 0) && __cil_tmp20 == 0) && __cil_tmp21 == 0) && __cil_tmp22 == 0) && __cil_tmp23 == 0) && __cil_tmp24 == 0) && __cil_tmp25 == 0) && __cil_tmp26 == 0) && __cil_tmp27 == 1) && __cil_tmp28 == 0) && __cil_tmp29 == 0) && __cil_tmp30 == 0) && __cil_tmp31 == 0) && __cil_tmp32 == 0) && __cil_tmp33 == 0) && __cil_tmp34 == 0) && __cil_tmp35 == 1) && __cil_tmp36 == 0) && __cil_tmp37 == 0) {
    printf("GOAL: uk_0 %d\n", uk_0);
    klee_assert(0);
  }
}
