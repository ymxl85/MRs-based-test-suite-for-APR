# 1 "randomTC/v2/2/v2.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "randomTC/v2/2/v2.c"
# 16 "randomTC/v2/2/v2.c"
...
# 17 "randomTC/v2/2/v2.c" 2
# 1 "randomTC/v2/2/schedule2.h" 1
# 41 "randomTC/v2/2/schedule2.h"
...
# 18 "randomTC/v2/2/v2.c" 2
# 1 "randomTC/v2/2/processor.h" 1
float getOperand(char * str);

void getAdata(char * str,int *pos, char * s);
# 19 "randomTC/v2/2/v2.c" 2
