...
{ 
  ...
  __cil_tmp5 = mainQ("%+U:\"}OW\\K~`w]i6BG", uk_0);
  __cil_tmp6 = strcmp(__cil_tmp5, "error,\"%+U:\"}OW\\K~\".\nbquote.\nidentifier,\"w\".\nrsquare.\nidentifier,\"i6BG\".\neof.\n");
  __cil_tmp7 = mainQ("SyZd_Q#@s6;5!7vn", uk_0);
  __cil_tmp8 = strcmp(__cil_tmp7, "error,\"SyZd_Q#@s6\".\neof.\n");
  __cil_tmp9 = mainQ("F&sP2|d.RbYtfiI5<=", uk_0);
  __cil_tmp10 = strcmp(__cil_tmp9, "error,\"F&sP2|d.RbYtfiI5<=\".\neof.\n");
  __cil_tmp11 = mainQ("jAAFM?Muj|(927", uk_0);
  __cil_tmp12 = strcmp(__cil_tmp11, "error,\"jAAFM?Muj|\".\nlparen.\nnumeric,927.\neof.\n");
  __cil_tmp13 = mainQ("2", uk_0);
  __cil_tmp14 = strcmp(__cil_tmp13, "numeric,2.\neof.\n");
  __cil_tmp15 = mainQ("W7B}n].4*65n_DDn", uk_0);
  __cil_tmp16 = strcmp(__cil_tmp15, "error,\"W7B}n\".\nrsquare.\nerror,\".4*65n_DDn\".\neof.\n");
  __cil_tmp17 = mainQ("(Z0vEk7|{#", uk_0);
  __cil_tmp18 = strcmp(__cil_tmp17, "lparen.\nerror,\"Z0vEk7|{#\".\neof.\n");
  __cil_tmp19 = mainQ("BJ[z\"vhrDFB\\D", uk_0);
  __cil_tmp20 = strcmp(__cil_tmp19, "identifier,\"BJ\".\nlsquare.\nerror,\"z\"vhrDFB\\D\".\neof.\n");
  __cil_tmp21 = mainQ("bEMBb9.{1d", uk_0);
  __cil_tmp22 = strcmp(__cil_tmp21, "error,\"bEMBb9.{1d\".\neof.\n");
  __cil_tmp23 = mainQ("M@263n;2", uk_0);
  __cil_tmp24 = strcmp(__cil_tmp23, "error,\"M@263n\".\neof.\n");
  __cil_tmp25 = mainQ("2.1I WV*9", uk_0);
  __cil_tmp26 = strcmp(__cil_tmp25, "error,\"2.1I\".\nerror,\"WV*9\".\neof.\n");
  __cil_tmp27 = mainQ("GO", uk_0);
  __cil_tmp28 = strcmp(__cil_tmp27, "identifier,\"GO\".\neof.\n");
