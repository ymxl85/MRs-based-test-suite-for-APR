...
{ 
  ...
  __cil_tmp5 = mainQ("p4*U>m7nhXd<?L\\>OU$", uk_0);
  __cil_tmp6 = strcmp(__cil_tmp5, "error,\"p4*U>m7nhXd<?L\\>OU$\".\neof.\n");
  __cil_tmp7 = mainQ(":$T2", uk_0);
  __cil_tmp8 = strcmp(__cil_tmp7, "error,\":$T2\".\neof.\n");
  __cil_tmp9 = mainQ("qGuzf62Bd%n_", uk_0);
  __cil_tmp10 = strcmp(__cil_tmp9, "error,\"qGuzf62Bd%n_\".\neof.\n");
  __cil_tmp11 = mainQ("\\gW?]`e@_*ZY{]", uk_0);
  __cil_tmp12 = strcmp(__cil_tmp11, "error,\"\\gW?\".\nrsquare.\nbquote.\nerror,\"e@_*ZY{\".\nrsquare.\neof.\n");
  __cil_tmp13 = mainQ("\\", uk_0);
  __cil_tmp14 = strcmp(__cil_tmp13, "error,\"\\\".\neof.\n");
  __cil_tmp15 = mainQ("Y0Uv`TnX!mSaWG*6<", uk_0);
  __cil_tmp16 = strcmp(__cil_tmp15, "identifier,\"Y0Uv\".\nbquote.\nerror,\"TnX!mSaWG*6<\".\neof.\n");
  __cil_tmp17 = mainQ("HSR48]/,#(a S3o}l", uk_0);
  __cil_tmp18 = strcmp(__cil_tmp17, "identifier,\"HSR48\".\nrsquare.\nerror,\"/\".\ncomma.\nerror,\"#\".\nlparen.\nidentifier,\"a\".\nerror,\"S3o}l\".\neof.\n");
  __cil_tmp19 = mainQ("tm@Uv]a>CfW]vG/)T 72", uk_0);
  __cil_tmp20 = strcmp(__cil_tmp19, "error,\"tm@Uv\".\nrsquare.\nerror,\"a>CfW\".\nrsquare.\nerror,\"vG/\".\nrparen.\nidentifier,\"T\".\nnumeric,72.\neof.\n");
  __cil_tmp21 = mainQ("s0(2", uk_0);
  __cil_tmp22 = strcmp(__cil_tmp21, "identifier,\"s0\".\nlparen.\nnumeric,2.\neof.\n");
  __cil_tmp23 = mainQ("VWx", uk_0);
  __cil_tmp24 = strcmp(__cil_tmp23, "identifier,\"VWx\".\neof.\n");
  __cil_tmp25 = mainQ("?}Y", uk_0);
  __cil_tmp26 = strcmp(__cil_tmp25, "error,\"?}Y\".\neof.\n");
  __cil_tmp27 = mainQ("|o", uk_0);
  __cil_tmp28 = strcmp(__cil_tmp27, "error,\"|o\".\neof.\n");
