...
{ 
  ...
  __cil_tmp5 = mainQ("7u9{", uk_0);
  __cil_tmp6 = strcmp(__cil_tmp5, "error,\"7u9{\".\neof.\n");
  __cil_tmp7 = mainQ("h,Cqsz\"3|WT", uk_0);
  __cil_tmp8 = strcmp(__cil_tmp7, "identifier,\"h\".\ncomma.\nerror,\"Cqsz\"3|WT\".\neof.\n");
  __cil_tmp9 = mainQ("[#)y,Xe;?[vCfePGG ", uk_0);
  __cil_tmp10 = strcmp(__cil_tmp9, "lsquare.\nerror,\"#\".\nrparen.\nidentifier,\"y\".\ncomma.\nidentifier,\"Xe\".\neof.\n");
  __cil_tmp11 = mainQ("40(L^rHsdGmz)y6Rvf", uk_0);
  __cil_tmp12 = strcmp(__cil_tmp11, "numeric,40.\nlparen.\nerror,\"L^rHsdGmz\".\nrparen.\nidentifier,\"y6Rvf\".\neof.\n");
  __cil_tmp13 = mainQ("PR=YXx>;n[b#&k(", uk_0);
  __cil_tmp14 = strcmp(__cil_tmp13, "error,\"PR=YXx>\".\neof.\n");
  __cil_tmp15 = mainQ("sSbU2CV.Tx76WIFd-@", uk_0);
  __cil_tmp16 = strcmp(__cil_tmp15, "error,\"sSbU2CV.Tx76WIFd-@\".\neof.\n");
  __cil_tmp17 = mainQ("6  e>GGNl^Kec%;+or%!", uk_0);
  __cil_tmp18 = strcmp(__cil_tmp17, "numeric,6.\nerror,\"e>GGNl^Kec%\".\neof.\n");
  __cil_tmp19 = mainQ("e8nnZsWu2M:E", uk_0);
  __cil_tmp20 = strcmp(__cil_tmp19, "error,\"e8nnZsWu2M:E\".\neof.\n");
  __cil_tmp21 = mainQ("6VI!:@hw", uk_0);
  __cil_tmp22 = strcmp(__cil_tmp21, "error,\"6VI!:@hw\".\neof.\n");
  __cil_tmp23 = mainQ("\"QyP<", uk_0);
  __cil_tmp24 = strcmp(__cil_tmp23, "error,\"\"QyP<\".\neof.\n");
  __cil_tmp25 = mainQ("XiCCwhj3N[J4BW.", uk_0);
  __cil_tmp26 = strcmp(__cil_tmp25, "identifier,\"XiCCwhj3N\".\nlsquare.\nerror,\"J4BW.\".\neof.\n");
  __cil_tmp27 = mainQ("$r=.", uk_0);
  __cil_tmp28 = strcmp(__cil_tmp27, "error,\"$r=.\".\neof.\n");
