...
{ 
  ...
  if (__cil_tmp10) {
    while (1) {
      __cil_tmp6 = (int )*(str + i) != uk_0;
      if (! __cil_tmp6) {
        break;
      }
      tmp = __ctype_b_loc();
      __cil_tmp7 = (int const   )*(*tmp + (int )*((str + i) + 1)) & 2048;
      if (__cil_tmp7) {
        i ++;
      } else {
        __cil_tmp5 = 0;
...
{ 
  ...
  __cil_tmp5 = mainQ("^NSC%NN#9SrqpH;K4B", uk_0);
  __cil_tmp6 = strcmp(__cil_tmp5, "error,\"^NSC%NN#9SrqpH\".\neof.\n");
  __cil_tmp7 = mainQ("):E,jI$hD", uk_0);
  __cil_tmp8 = strcmp(__cil_tmp7, "rparen.\nerror,\":E\".\ncomma.\nerror,\"jI$hD\".\neof.\n");
  __cil_tmp9 = mainQ("^yE7", uk_0);
  __cil_tmp10 = strcmp(__cil_tmp9, "error,\"^yE7\".\neof.\n");
  __cil_tmp11 = mainQ("D:5S/>cP~d67ta=`a", uk_0);
  __cil_tmp12 = strcmp(__cil_tmp11, "error,\"D:5S/>cP~d67ta=\".\nbquote.\nidentifier,\"a\".\neof.\n");
  __cil_tmp13 = mainQ("Gm|bx&=eo/iOev7J", uk_0);
  __cil_tmp14 = strcmp(__cil_tmp13, "error,\"Gm|bx&=eo/iOev7J\".\neof.\n");
  __cil_tmp15 = mainQ("b;jO7$U=)up", uk_0);
  __cil_tmp16 = strcmp(__cil_tmp15, "identifier,\"b\".\neof.\n");
  __cil_tmp17 = mainQ(":Yf\"r)58", uk_0);
  __cil_tmp18 = strcmp(__cil_tmp17, "error,\":Yf\"r\".\nrparen.\nnumeric,58.\neof.\n");
  __cil_tmp19 = mainQ("~tu&`M", uk_0);
  __cil_tmp20 = strcmp(__cil_tmp19, "error,\"~tu&\".\nbquote.\nidentifier,\"M\".\neof.\n");
  __cil_tmp21 = mainQ("u&<,", uk_0);
  __cil_tmp22 = strcmp(__cil_tmp21, "error,\"u&<\".\ncomma.\neof.\n");
  __cil_tmp23 = mainQ("EZ;LJ(", uk_0);
  __cil_tmp24 = strcmp(__cil_tmp23, "identifier,\"EZ\".\neof.\n");
  __cil_tmp25 = mainQ("\\,m\"L@_@}O<!5hxDkSO", uk_0);
  __cil_tmp26 = strcmp(__cil_tmp25, "error,\"\\\".\ncomma.\nerror,\"m\"L@_@}O<!5hxDkSO\".\neof.\n");
  __cil_tmp27 = mainQ("wuB/*Q}t,i{XbYZ", uk_0);
  __cil_tmp28 = strcmp(__cil_tmp27, "error,\"wuB/*Q}t\".\ncomma.\nerror,\"i{XbYZ\".\neof.\n");
