...
{ 
  ...
  __cil_tmp7 = mainQ("ncscI&;TBa+wK", uk_0);
  __cil_tmp8 = strcmp(__cil_tmp7, "error,\"ncscI&\".\neof.\n");
  __cil_tmp9 = mainQ("x2OSxl~V/O)/", uk_0);
  __cil_tmp10 = strcmp(__cil_tmp9, "error,\"x2OSxl~V/O\".\nrparen.\nerror,\"/\".\neof.\n");
  __cil_tmp11 = mainQ("p%;f#`v", uk_0);
  __cil_tmp12 = strcmp(__cil_tmp11, "error,\"p%\".\neof.\n");
  __cil_tmp13 = mainQ("Pqlash`79", uk_0);
  __cil_tmp14 = strcmp(__cil_tmp13, "identifier,\"Pqlash\".\nbquote.\nnumeric,79.\neof.\n");
  __cil_tmp15 = mainQ("LpZ8Z", uk_0);
  __cil_tmp16 = strcmp(__cil_tmp15, "identifier,\"LpZ8Z\".\neof.\n");
  __cil_tmp17 = mainQ("**F", uk_0);
  __cil_tmp18 = strcmp(__cil_tmp17, "error,\"**F\".\neof.\n");
  __cil_tmp19 = mainQ("Xv;{!*^k", uk_0);
  __cil_tmp20 = strcmp(__cil_tmp19, "identifier,\"Xv\".\neof.\n");
  __cil_tmp21 = mainQ("is.p9q9", uk_0);
  __cil_tmp22 = strcmp(__cil_tmp21, "error,\"is.p9q9\".\neof.\n");
  __cil_tmp23 = mainQ("K)0wj(ZA", uk_0);
  __cil_tmp24 = strcmp(__cil_tmp23, "identifier,\"K\".\nrparen.\nerror,\"0wj\".\nlparen.\nidentifier,\"ZA\".\neof.\n");
  __cil_tmp25 = mainQ("9=$QO+^Y", uk_0);
  __cil_tmp26 = strcmp(__cil_tmp25, "error,\"9=$QO+^Y\".\neof.\n");
  __cil_tmp27 = mainQ("Dg4vo&bi6%", uk_0);
  __cil_tmp28 = strcmp(__cil_tmp27, "error,\"Dg4vo&bi6%\".\neof.\n");
