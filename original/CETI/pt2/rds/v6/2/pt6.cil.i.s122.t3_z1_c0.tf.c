...
{ 
  ...
  if (__cil_tmp10) {
    while (1) {
      ...
      tmp = __ctype_b_loc();
      __cil_tmp7 = (int const   )*(*tmp + (int )*((str + i) + 1)) & uk_0;
      if (__cil_tmp7) {
        i ++;
      } else {
        __cil_tmp5 = 0;
...
{ 
  ...
  __cil_tmp5 = mainQ("^,MP;)J,Kpe{9,Nc", uk_0);
  __cil_tmp6 = strcmp(__cil_tmp5, "error,\"^\".\ncomma.\nidentifier,\"MP\".\neof.\n");
  __cil_tmp7 = mainQ("yX*ol0q", uk_0);
  __cil_tmp8 = strcmp(__cil_tmp7, "error,\"yX*ol0q\".\neof.\n");
  __cil_tmp9 = mainQ("l,/*s", uk_0);
  __cil_tmp10 = strcmp(__cil_tmp9, "identifier,\"l\".\ncomma.\nerror,\"/*s\".\neof.\n");
  __cil_tmp11 = mainQ("hL`Q9aOve.Q<$7m*A", uk_0);
  __cil_tmp12 = strcmp(__cil_tmp11, "identifier,\"hL\".\nbquote.\nerror,\"Q9aOve.Q<$7m*A\".\neof.\n");
  __cil_tmp13 = mainQ(":Cj-:52&$L/m&S3H\\[p", uk_0);
  __cil_tmp14 = strcmp(__cil_tmp13, "error,\":Cj-:52&$L/m&S3H\\\".\nlsquare.\nidentifier,\"p\".\neof.\n");
  __cil_tmp15 = mainQ("=R|$Qt1X,}Tn$;", uk_0);
  __cil_tmp16 = strcmp(__cil_tmp15, "error,\"=R|$Qt1X\".\ncomma.\nerror,\"}Tn$\".\neof.\n");
  __cil_tmp17 = mainQ("@i%JVKgGF,bw19Z", uk_0);
  __cil_tmp18 = strcmp(__cil_tmp17, "error,\"@i%JVKgGF\".\ncomma.\nidentifier,\"bw19Z\".\neof.\n");
  __cil_tmp19 = mainQ("6VPrlcie|~m@[c%L+giP", uk_0);
  __cil_tmp20 = strcmp(__cil_tmp19, "error,\"6VPrlcie|~m@\".\nlsquare.\nerror,\"c%L+giP\".\neof.\n");
  __cil_tmp21 = mainQ("z!/!+#Ef[</s,1130", uk_0);
  __cil_tmp22 = strcmp(__cil_tmp21, "error,\"z!/!+#Ef\".\nlsquare.\nerror,\"</s\".\ncomma.\nnumeric,1130.\neof.\n");
  __cil_tmp23 = mainQ("+WpS7", uk_0);
  __cil_tmp24 = strcmp(__cil_tmp23, "error,\"+WpS7\".\neof.\n");
  __cil_tmp25 = mainQ(")#(q~mWzzD", uk_0);
  __cil_tmp26 = strcmp(__cil_tmp25, "rparen.\nerror,\"#\".\nlparen.\nerror,\"q~mWzzD\".\neof.\n");
  __cil_tmp27 = mainQ("liw(%k~1\"4m<q9sM)@ey", uk_0);
  __cil_tmp28 = strcmp(__cil_tmp27, "identifier,\"liw\".\nlparen.\nerror,\"%k~1\"4m<q9sM\".\nrparen.\nerror,\"@ey\".\neof.\n");
  if (((((((((((0 == __cil_tmp6 && 0 == __cil_tmp8) && 0 == __cil_tmp10) && 0 == __cil_tmp12) && 0 == __cil_tmp14) && 0 == __cil_tmp16) && 0 == __cil_tmp18) && 0 == __cil_tmp20) && 0 == __cil_tmp22) && 0 == __cil_tmp24) && 0 == __cil_tmp26) && 0 == __cil_tmp28) {
    printf("GOAL: uk_0 %d\n", uk_0);
    klee_assert(0);
  }
}
