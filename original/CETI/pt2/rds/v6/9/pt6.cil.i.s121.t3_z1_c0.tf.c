...
{ 
  ...
  __cil_tmp5 = mainQ("$uk O-cub~!A3gji", uk_0);
  __cil_tmp6 = strcmp(__cil_tmp5, "error,\"$uk\".\nerror,\"O-cub~!A3gji\".\neof.\n");
  __cil_tmp7 = mainQ("%zgwTd2kK&", uk_0);
  __cil_tmp8 = strcmp(__cil_tmp7, "error,\"%zgwTd2kK&\".\neof.\n");
  __cil_tmp9 = mainQ("i4<-", uk_0);
  __cil_tmp10 = strcmp(__cil_tmp9, "error,\"i4<-\".\neof.\n");
  __cil_tmp11 = mainQ(")#W:x::A/", uk_0);
  __cil_tmp12 = strcmp(__cil_tmp11, "rparen.\ncharacter,\"W:x::A/\".\neof.\n");
  __cil_tmp13 = mainQ("zQ", uk_0);
  __cil_tmp14 = strcmp(__cil_tmp13, "identifier,\"zQ\".\neof.\n");
  __cil_tmp15 = mainQ("Q_xsri&", uk_0);
  __cil_tmp16 = strcmp(__cil_tmp15, "error,\"Q_xsri&\".\neof.\n");
  __cil_tmp17 = mainQ("|co\\jYr", uk_0);
  __cil_tmp18 = strcmp(__cil_tmp17, "error,\"|co\\jYr\".\neof.\n");
  __cil_tmp19 = mainQ("(v8?p]", uk_0);
  __cil_tmp20 = strcmp(__cil_tmp19, "lparen.\nerror,\"v8?p\".\nrsquare.\neof.\n");
  __cil_tmp21 = mainQ("Z}{fkA", uk_0);
  __cil_tmp22 = strcmp(__cil_tmp21, "error,\"Z}{fkA\".\neof.\n");
  __cil_tmp23 = mainQ("35", uk_0);
  __cil_tmp24 = strcmp(__cil_tmp23, "numeric,35.\neof.\n");
  __cil_tmp25 = mainQ("8:_Y#CENlj)~p|Cy", uk_0);
  __cil_tmp26 = strcmp(__cil_tmp25, "error,\"8:_Y#CENlj\".\nrparen.\nerror,\"~p|Cy\".\neof.\n");
  __cil_tmp27 = mainQ("!+lbs", uk_0);
  __cil_tmp28 = strcmp(__cil_tmp27, "error,\"!+lbs\".\neof.\n");
