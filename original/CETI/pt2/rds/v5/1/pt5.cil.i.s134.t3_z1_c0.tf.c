...
{ 
  ...
  __cil_tmp5 = mainQ(" $}T+", uk_0);
  __cil_tmp6 = strcmp(__cil_tmp5, "error,\"$}T+\".\neof.\n");
  __cil_tmp7 = mainQ("i8IERR\"", uk_0);
  __cil_tmp8 = strcmp(__cil_tmp7, "error,\"i8IERR\"\".\neof.\n");
  __cil_tmp9 = mainQ("bmT|NaQ\"^T>^", uk_0);
  __cil_tmp10 = strcmp(__cil_tmp9, "error,\"bmT|NaQ\"^T>^\".\neof.\n");
  __cil_tmp11 = mainQ("YJM0\"P\"SqE\\ZA~w", uk_0);
  __cil_tmp12 = strcmp(__cil_tmp11, "error,\"YJM0\"P\"SqE\\ZA~w\".\neof.\n");
  __cil_tmp13 = mainQ("rR!aj}IL@T-Pin&~>S", uk_0);
  __cil_tmp14 = strcmp(__cil_tmp13, "error,\"rR!aj}IL@T-Pin&~>S\".\neof.\n");
  __cil_tmp15 = mainQ("Xjn3?w0", uk_0);
  __cil_tmp16 = strcmp(__cil_tmp15, "error,\"Xjn3?w0\".\neof.\n");
  __cil_tmp17 = mainQ("ag/w5z\\AFqh(Q;*w1", uk_0);
  __cil_tmp18 = strcmp(__cil_tmp17, "error,\"ag/w5z\\AFqh\".\nlparen.\nidentifier,\"Q\".\neof.\n");
  __cil_tmp19 = mainQ("o&-T`Dh", uk_0);
  __cil_tmp20 = strcmp(__cil_tmp19, "error,\"o&-T\".\nbquote.\nidentifier,\"Dh\".\neof.\n");
  __cil_tmp21 = mainQ("CNvI", uk_0);
  __cil_tmp22 = strcmp(__cil_tmp21, "identifier,\"CNvI\".\neof.\n");
  __cil_tmp23 = mainQ("bP)i", uk_0);
  __cil_tmp24 = strcmp(__cil_tmp23, "identifier,\"bP\".\nrparen.\nidentifier,\"i\".\neof.\n");
  __cil_tmp25 = mainQ("d", uk_0);
  __cil_tmp26 = strcmp(__cil_tmp25, "identifier,\"d\".\neof.\n");
  __cil_tmp27 = mainQ("+G(\"JuedsjB1,!Iaal", uk_0);
  __cil_tmp28 = strcmp(__cil_tmp27, "error,\"+G\".\nlparen.\nerror,\"\"JuedsjB1,!Iaal\".\neof.\n");
  __cil_tmp29 = mainQ("?*A q,u~^\\;&", uk_0);
  __cil_tmp30 = strcmp(__cil_tmp29, "error,\"?*A\".\nidentifier,\"q\".\ncomma.\nerror,\"u~^\\\".\neof.\n");
  __cil_tmp31 = mainQ(":.yjCBq\\L-QIKpVrV$T", uk_0);
  __cil_tmp32 = strcmp(__cil_tmp31, "error,\":.yjCBq\\L-QIKpVrV$T\".\neof.\n");
  __cil_tmp33 = mainQ("Ts-U.AmP/Zh^p;0Htf,", uk_0);
  __cil_tmp34 = strcmp(__cil_tmp33, "error,\"Ts-U.AmP/Zh^p\".\neof.\n");
  __cil_tmp35 = mainQ("s/Ji", uk_0);
  __cil_tmp36 = strcmp(__cil_tmp35, "error,\"s/Ji\".\neof.\n");
  __cil_tmp37 = mainQ("D}FWp+d4", uk_0);
  __cil_tmp38 = strcmp(__cil_tmp37, "error,\"D}FWp+d4\".\neof.\n");
  __cil_tmp39 = mainQ("MA?", uk_0);
  __cil_tmp40 = strcmp(__cil_tmp39, "error,\"MA?\".\neof.\n");
  __cil_tmp41 = mainQ(")(=u", uk_0);
  __cil_tmp42 = strcmp(__cil_tmp41, "rparen.\nlparen.\nerror,\"=u\".\neof.\n");
  __cil_tmp43 = mainQ("h3=1]nS36=h%", uk_0);
  __cil_tmp44 = strcmp(__cil_tmp43, "error,\"h3=1\".\nrsquare.\nerror,\"nS36=h%\".\neof.\n");
  __cil_tmp45 = mainQ("6l", uk_0);
  __cil_tmp46 = strcmp(__cil_tmp45, "error,\"6l\".\neof.\n");
  __cil_tmp47 = mainQ("FZ0k>4e~", uk_0);
  __cil_tmp48 = strcmp(__cil_tmp47, "error,\"FZ0k>4e~\".\neof.\n");
  __cil_tmp49 = mainQ("dt9y", uk_0);
  __cil_tmp50 = strcmp(__cil_tmp49, "identifier,\"dt9y\".\neof.\n");
  __cil_tmp51 = mainQ("i+WsS\"@73JA.mB9", uk_0);
  __cil_tmp52 = strcmp(__cil_tmp51, "error,\"i+WsS\"@73JA.mB9\".\neof.\n");
  __cil_tmp53 = mainQ("KZfc[o|&al1D\\", uk_0);
  __cil_tmp54 = strcmp(__cil_tmp53, "identifier,\"KZfc\".\nlsquare.\nerror,\"o|&al1D\\\".\neof.\n");
  __cil_tmp55 = mainQ("c4U{9.", uk_0);
  __cil_tmp56 = strcmp(__cil_tmp55, "error,\"c4U{9.\".\neof.\n");
  __cil_tmp57 = mainQ("-bIGe:boThra0yw", uk_0);
  __cil_tmp58 = strcmp(__cil_tmp57, "error,\"-bIGe:boThra0yw\".\neof.\n");
  __cil_tmp59 = mainQ("prL", uk_0);
  __cil_tmp60 = strcmp(__cil_tmp59, "identifier,\"prL\".\neof.\n");
  __cil_tmp61 = mainQ("iox|HC?^$-NAP,YY_", uk_0);
  __cil_tmp62 = strcmp(__cil_tmp61, "error,\"iox|HC?^$-NAP\".\ncomma.\nerror,\"YY_\".\neof.\n");
  __cil_tmp63 = mainQ(" r`?#(kKe2N", uk_0);
  __cil_tmp64 = strcmp(__cil_tmp63, "identifier,\"r\".\nbquote.\nerror,\"?#\".\nlparen.\nidentifier,\"kKe2N\".\neof.\n");
  __cil_tmp65 = mainQ("D^6cKf SB8irS", uk_0);
  __cil_tmp66 = strcmp(__cil_tmp65, "error,\"D^6cKf\".\nidentifier,\"SB8irS\".\neof.\n");
  __cil_tmp67 = mainQ("c", uk_0);
  __cil_tmp68 = strcmp(__cil_tmp67, "identifier,\"c\".\neof.\n");
  __cil_tmp69 = mainQ("o", uk_0);
  __cil_tmp70 = strcmp(__cil_tmp69, "identifier,\"o\".\neof.\n");
  __cil_tmp71 = mainQ(".NSW^XwB_o", uk_0);
  __cil_tmp72 = strcmp(__cil_tmp71, "error,\".NSW^XwB_o\".\neof.\n");
