...
{ 
  ...
  __cil_tmp5 = mainQ("(@ncHU$42fa&/ri1g%", uk_0);
  __cil_tmp6 = strcmp(__cil_tmp5, "lparen.\nerror,\"@ncHU$42fa&/ri1g%\".\neof.\n");
  __cil_tmp7 = mainQ("N*_N,[y`s", uk_0);
  __cil_tmp8 = strcmp(__cil_tmp7, "error,\"N*_N\".\ncomma.\nlsquare.\nidentifier,\"y\".\nbquote.\nidentifier,\"s\".\neof.\n");
  __cil_tmp9 = mainQ("(Q[@)\\-,V8l=`3(", uk_0);
  __cil_tmp10 = strcmp(__cil_tmp9, "lparen.\nidentifier,\"Q\".\nlsquare.\nerror,\"@\".\nrparen.\nerror,\"\\-\".\ncomma.\nerror,\"V8l=\".\nbquote.\nnumeric,3.\nlparen.\neof.\n");
  __cil_tmp11 = mainQ("/pG4K1c-T2\\", uk_0);
  __cil_tmp12 = strcmp(__cil_tmp11, "error,\"/pG4K1c-T2\\\".\neof.\n");
  __cil_tmp13 = mainQ("r_JOEVU\"m#{sd", uk_0);
  __cil_tmp14 = strcmp(__cil_tmp13, "error,\"r_JOEVU\"m#{sd\".\neof.\n");
  __cil_tmp15 = mainQ("cw}q_2P", uk_0);
  __cil_tmp16 = strcmp(__cil_tmp15, "error,\"cw}q_2P\".\neof.\n");
  __cil_tmp17 = mainQ(">", uk_0);
  __cil_tmp18 = strcmp(__cil_tmp17, "error,\">\".\neof.\n");
  __cil_tmp19 = mainQ("ylrB^W(=COG", uk_0);
  __cil_tmp20 = strcmp(__cil_tmp19, "error,\"ylrB^W\".\nlparen.\nerror,\"=COG\".\neof.\n");
  __cil_tmp21 = mainQ("u}TF-", uk_0);
  __cil_tmp22 = strcmp(__cil_tmp21, "error,\"u}TF-\".\neof.\n");
  __cil_tmp23 = mainQ("2AI:KY#ceaG`", uk_0);
  __cil_tmp24 = strcmp(__cil_tmp23, "error,\"2AI:KY#ceaG\".\nbquote.\neof.\n");
  __cil_tmp25 = mainQ("RH~s;@LX%3QBt1", uk_0);
  __cil_tmp26 = strcmp(__cil_tmp25, "error,\"RH~s\".\neof.\n");
  __cil_tmp27 = mainQ("p8aQPDn8-<CGXuu`E,`-", uk_0);
  __cil_tmp28 = strcmp(__cil_tmp27, "error,\"p8aQPDn8-<CGXuu\".\nbquote.\nidentifier,\"E\".\ncomma.\nbquote.\nerror,\"-\".\neof.\n");
  __cil_tmp29 = mainQ("==)/y2~~C(!Z", uk_0);
  __cil_tmp30 = strcmp(__cil_tmp29, "error,\"==\".\nrparen.\nerror,\"/y2~~C\".\nlparen.\nerror,\"!Z\".\neof.\n");
  __cil_tmp31 = mainQ("w=gw*m%Q_KSO", uk_0);
  __cil_tmp32 = strcmp(__cil_tmp31, "error,\"w=gw*m%Q_KSO\".\neof.\n");
  __cil_tmp33 = mainQ("; *E%4`3h<$AIpq7fVH:", uk_0);
  __cil_tmp34 = strcmp(__cil_tmp33, "eof.\n");
  __cil_tmp35 = mainQ("c+7_HnpS\\_DIa", uk_0);
  __cil_tmp36 = strcmp(__cil_tmp35, "error,\"c+7_HnpS\\_DIa\".\neof.\n");
  __cil_tmp37 = mainQ("BY", uk_0);
  __cil_tmp38 = strcmp(__cil_tmp37, "identifier,\"BY\".\neof.\n");
  __cil_tmp39 = mainQ("<Yy#05;i{N&(RQoq\\K", uk_0);
  __cil_tmp40 = strcmp(__cil_tmp39, "error,\"<Yy#05\".\neof.\n");
  __cil_tmp41 = mainQ("WFk)O78r|<", uk_0);
  __cil_tmp42 = strcmp(__cil_tmp41, "identifier,\"WFk\".\nrparen.\nerror,\"O78r|<\".\neof.\n");
  __cil_tmp43 = mainQ("!W\\_$0H\\r8p6IFik9Aj^", uk_0);
  __cil_tmp44 = strcmp(__cil_tmp43, "error,\"!W\\_$0H\\r8p6IFik9Aj^\".\neof.\n");
  __cil_tmp45 = mainQ("ye*5XgRo!+", uk_0);
  __cil_tmp46 = strcmp(__cil_tmp45, "error,\"ye*5XgRo!+\".\neof.\n");
  __cil_tmp47 = mainQ("q ,\"`at\\]7V", uk_0);
  __cil_tmp48 = strcmp(__cil_tmp47, "identifier,\"q\".\ncomma.\nerror,\"\"`at\\]7V\".\neof.\n");
  __cil_tmp49 = mainQ("\\KYKvBy>Y=", uk_0);
  __cil_tmp50 = strcmp(__cil_tmp49, "error,\"\\KYKvBy>Y=\".\neof.\n");
  __cil_tmp51 = mainQ("Hf8xzqX!", uk_0);
  __cil_tmp52 = strcmp(__cil_tmp51, "error,\"Hf8xzqX!\".\neof.\n");
  __cil_tmp53 = mainQ("_!*;E{Y1uc^6{1Q0_A<E", uk_0);
  __cil_tmp54 = strcmp(__cil_tmp53, "error,\"_!*\".\neof.\n");
  __cil_tmp55 = mainQ("Xo0", uk_0);
  __cil_tmp56 = strcmp(__cil_tmp55, "identifier,\"Xo0\".\neof.\n");
  __cil_tmp57 = mainQ("/xI2HY", uk_0);
  __cil_tmp58 = strcmp(__cil_tmp57, "error,\"/xI2HY\".\neof.\n");
  __cil_tmp59 = mainQ("Z?1;$G;7Xwj", uk_0);
  __cil_tmp60 = strcmp(__cil_tmp59, "error,\"Z?1\".\neof.\n");
  __cil_tmp61 = mainQ("}ESN@RGI6\\\"CD{XMm=u", uk_0);
  __cil_tmp62 = strcmp(__cil_tmp61, "error,\"}ESN@RGI6\\\"CD{XMm=u\".\neof.\n");
  __cil_tmp63 = mainQ(";z^^h56#}et6|lUb7\"D", uk_0);
  __cil_tmp64 = strcmp(__cil_tmp63, "eof.\n");
  __cil_tmp65 = mainQ("4v.&sT0OwsnuNJh1{-EO", uk_0);
  __cil_tmp66 = strcmp(__cil_tmp65, "error,\"4v.&sT0OwsnuNJh1{-EO\".\neof.\n");
  __cil_tmp67 = mainQ("y%JO{ @157{PG~k1PBGa", uk_0);
  __cil_tmp68 = strcmp(__cil_tmp67, "error,\"y%JO{\".\nerror,\"@157{PG~k1PBGa\".\neof.\n");
  __cil_tmp69 = mainQ("%e;N<OeNg go", uk_0);
  __cil_tmp70 = strcmp(__cil_tmp69, "error,\"%e\".\neof.\n");
  __cil_tmp71 = mainQ("??<i{WPfa5wCK", uk_0);
  __cil_tmp72 = strcmp(__cil_tmp71, "error,\"??<i{WPfa5wCK\".\neof.\n");
