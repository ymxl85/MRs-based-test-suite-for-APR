...
entry:
  ...
  store i8* %argv12, i8** %tp.i, align 4, !dbg !210
  call fastcc void @get_token(i8** %tp.i) nounwind
  %8 = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  %9 = icmp eq i8 %8, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %9, label %mainQ.exit, label %bb.i, !dbg !213
...
!1 = metadata !{i32 589865, metadata !"v4.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v4/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v4.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v4/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_com
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v4/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v4/", metadata !2} ; [ DW_TAG_file_type ]
...
!210 = metadata !{i32 533, i32 0, metadata !211, metadata !212}
!211 = metadata !{i32 589835, metadata !45, i32 531, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!212 = metadata !{i32 553, i32 0, metadata !206, null}
!213 = metadata !{i32 536, i32 0, metadata !211, metadata !212}
!214 = metadata !{i32 555, i32 0, metadata !206, null}
