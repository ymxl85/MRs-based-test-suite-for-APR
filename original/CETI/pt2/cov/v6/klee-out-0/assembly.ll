...
entry:
  ...
  %argv12 = getelementptr inbounds [50 x i8]* %argv1, i32 0, i32 0, !dbg !208
  call void @klee_make_symbolic(i8* %argv12, i32 50, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !208
  %1 = load i8* %argv12, align 1, !dbg !209
  %2 = icmp ne i8 %1, 0, !dbg !209
  %3 = zext i1 %2 to i32, !dbg !209
  call void @klee_assume(i32 %3) nounwind, !dbg !209
  %4 = getelementptr inbounds [50 x i8]* %argv1, i32 0, i32 49, !dbg !210
  %5 = load i8* %4, align 1, !dbg !210
  %6 = icmp eq i8 %5, 0, !dbg !210
  %7 = zext i1 %6 to i32, !dbg !210
  call void @klee_assume(i32 %7) nounwind, !dbg !210
  store i8* %argv12, i8** %tp.i, align 4, !dbg !211
  ...
  br i1 %9, label %mainQ.exit, label %bb.i, !dbg !214
...
bb.i:                                             ; preds = %entry, %bb.i
  ...
  %11 = icmp eq i8 %10, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %11, label %mainQ.exit, label %bb.i, !dbg !214
...
entry:
  %0 = icmp eq i32 %count, 0, !dbg !216
  br i1 %0, label %bb2, label %bb.lr.ph, !dbg !216

bb.lr.ph:                                         ; preds = %entry
  %1 = trunc i32 %s to i8, !dbg !217
  br label %bb

bb:                                               ; preds = %bb, %bb.lr.ph
  %indvar = phi i32 [ 0, %bb.lr.ph ], [ %indvar.next, %bb ]
  %a.05 = getelementptr i8* %dst, i32 %indvar
  volatile store i8 %1, i8* %a.05, align 1, !dbg !217
  %indvar.next = add i32 %indvar, 1
  %exitcond1 = icmp eq i32 %indvar.next, %count
  br i1 %exitcond1, label %bb2, label %bb, !dbg !216
...
!1 = metadata !{i32 589865, metadata !"v6.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v6/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v6.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v6/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_com
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v6/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v6/", metadata !2} ; [ DW_TAG_file_type ]
...
!211 = metadata !{i32 533, i32 0, metadata !212, metadata !213}
!212 = metadata !{i32 589835, metadata !45, i32 531, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!213 = metadata !{i32 553, i32 0, metadata !207, null}
!214 = metadata !{i32 536, i32 0, metadata !212, metadata !213}
!215 = metadata !{i32 555, i32 0, metadata !207, null}
!216 = metadata !{i32 14, i32 0, metadata !108, null}
!217 = metadata !{i32 15, i32 0, metadata !108, null}
!218 = metadata !{i32 16, i32 0, metadata !108, null}
