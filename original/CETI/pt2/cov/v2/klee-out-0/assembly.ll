...
entry:
  ...
  %argv12 = getelementptr inbounds [50 x i8]* %argv1, i32 0, i32 0, !dbg !209
  call void @klee_make_symbolic(i8* %argv12, i32 50, i8* getelementptr inbounds ([6 x i8]* @.str30, i32 0, i32 0)) nounwind, !dbg !209
  %1 = load i8* %argv12, align 1, !dbg !210
  %2 = icmp ne i8 %1, 0, !dbg !210
  %3 = zext i1 %2 to i32, !dbg !210
  call void @klee_assume(i32 %3) nounwind, !dbg !210
  %4 = getelementptr inbounds [50 x i8]* %argv1, i32 0, i32 49, !dbg !211
  %5 = load i8* %4, align 1, !dbg !211
  %6 = icmp eq i8 %5, 0, !dbg !211
  %7 = zext i1 %6 to i32, !dbg !211
  call void @klee_assume(i32 %7) nounwind, !dbg !211
  %8 = load i8* %argv12, align 1
  %9 = icmp eq i8 %8, 0
  %fp.0.i.i = select i1 %9, i8* null, i8* %argv12
  store i8* %fp.0.i.i, i8** %tp.i, align 4, !dbg !212
  call fastcc void @get_token(i8** %tp.i) nounwind
  %10 = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  %11 = icmp eq i8 %10, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %11, label %mainQ.exit, label %bb.i, !dbg !215

bb.i:                                             ; preds = %entry, %bb.i
  call fastcc void @get_token(i8** %tp.i) nounwind
  %12 = load i8* getelementptr inbounds ([81 x i8]* @buffer, i32 0, i32 0), align 32
  %13 = icmp eq i8 %12, 0
  call fastcc void @print_token(i8* %rr1) nounwind
  br i1 %13, label %mainQ.exit, label %bb.i, !dbg !215
...
entry:
  %0 = icmp eq i32 %count, 0, !dbg !217
  br i1 %0, label %bb2, label %bb.lr.ph, !dbg !217

bb.lr.ph:                                         ; preds = %entry
  %1 = trunc i32 %s to i8, !dbg !218
  br label %bb

bb:                                               ; preds = %bb, %bb.lr.ph
  %indvar = phi i32 [ 0, %bb.lr.ph ], [ %indvar.next, %bb ]
  %a.05 = getelementptr i8* %dst, i32 %indvar
  volatile store i8 %1, i8* %a.05, align 1, !dbg !218
  %indvar.next = add i32 %indvar, 1
  %exitcond1 = icmp eq i32 %indvar.next, %count
  br i1 %exitcond1, label %bb2, label %bb, !dbg !217
...
!1 = metadata !{i32 589865, metadata !"v2.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v2/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"v2.c", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v2/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_com
...
!13 = metadata !{i32 589865, metadata !"stream.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v2/", metadata !2} ; [ DW_TAG_file_type ]
...
!22 = metadata !{i32 589865, metadata !"tokens.h", metadata !"/home/mingyue/experiments/ceti/printtoken2/coverageTC/v2/", metadata !2} ; [ DW_TAG_file_type ]
...
!212 = metadata !{i32 538, i32 0, metadata !213, metadata !214}
!213 = metadata !{i32 589835, metadata !45, i32 532, i32 0, metadata !1, i32 19} ; [ DW_TAG_lexical_block ]
!214 = metadata !{i32 559, i32 0, metadata !208, null}
!215 = metadata !{i32 541, i32 0, metadata !213, metadata !214}
!216 = metadata !{i32 561, i32 0, metadata !208, null}
!217 = metadata !{i32 14, i32 0, metadata !108, null}
!218 = metadata !{i32 15, i32 0, metadata !108, null}
!219 = metadata !{i32 16, i32 0, metadata !108, null}
