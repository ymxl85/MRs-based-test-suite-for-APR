# 1 "pt/MFCC/MR3/v6/pt6.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "pt/MFCC/MR3/v6/pt6.c"
# 14 "pt/MFCC/MR3/v6/pt6.c"
...
# 17 "pt/MFCC/MR3/v6/pt6.c" 2
# 1 "pt/MFCC/MR3/v6/tokens.h" 1



# 1 "pt/MFCC/MR3/v6/stream.h" 1
# 9 "pt/MFCC/MR3/v6/stream.h"
typedef
       char * character_stream;
typedef
       int BOOLEAN;
typedef
       char CHARACTER;
...
# 5 "pt/MFCC/MR3/v6/tokens.h" 2
# 15 "pt/MFCC/MR3/v6/tokens.h"
typedef
    char * token_stream;
typedef
    char * token;
...
# 18 "pt/MFCC/MR3/v6/pt6.c" 2
# 33 "pt/MFCC/MR3/v6/pt6.c"
...
{ int type;
 ...
 if(type==2)print_spec_symbol(tok,r);
 if(type==3)
   {
    strcat(r,"identifier,\"");
     strcat(r,tok);
    ...
    token str;
{
  ...
  if ( ((*__ctype_b_loc ())[(int) ((*str))] & (unsigned short int) _ISdigit))
    ...
    while ( *(str+i) != '\0' )
      {
       if(((*__ctype_b_loc ())[(int) ((*(str+i+1)))] & (unsigned short int) _ISdigit))
         i++;
       else
         return(0);
      }
  ...
  if ( ((*__ctype_b_loc ())[(int) ((*str))] & (unsigned short int) _ISalpha) )
     {
        while( *(str+i) !='\0' )
           {
            if(((*__ctype_b_loc ())[(int) ((*(str+i)))] & (unsigned short int) _ISalpha) || ((*__ctype_b_loc ())[(int) ((*(str+i)))] & (unsigned short int) _ISdigit))
               i++;
            else
               return(0);
           }
