	  ...
	  int Climb_Inhibit)
{
  ...
  */
  ...
  else return 640; //tvn  : temp change
			      ...
			      int Climb_Inhibit)
{
  ...
  if (upward_preferred)
    {
////result = !(Own_Below_Threat(Cur_Vertical_Sep,---deleted
////High_Confidence,---deleted
////Two_of_Three_Reports_Valid,---deleted
////Own_Tracked_Alt,---deleted
////Own_Tracked_Alt_Rate,---deleted
////Other_Tracked_Alt,---deleted
////Alt_Layer_Value,---deleted
////Up_Separation,---deleted
////Down_Separation,---deleted
////Other_RAC,---deleted
////Other_Capability,---deleted
////Climb_Inhibit)) || ((Own_Below_Threat(Cur_Vertical_Sep,---deleted
////High_Confidence,---deleted
////Two_of_Three_Reports_Valid,---deleted
////Own_Tracked_Alt,---deleted
////Own_Tracked_Alt_Rate,---deleted
...
////Other_RAC,---deleted
////Other_Capability,---deleted
////Climb_Inhibit)) && (!(Down_Separation >= ALIM(Cur_Vertical_Sep,---deleted
////High_Confidence,---deleted
////Two_of_Three_Reports_Valid,---deleted
////Own_Tracked_Alt,---deleted
////Own_Tracked_Alt_Rate,---deleted
...
////Other_RAC,---deleted
////Other_Capability,---deleted
////Climb_Inhibit))));---deleted
      result = (Down_Separation <= 705);////---added
    }
  else
    {	
