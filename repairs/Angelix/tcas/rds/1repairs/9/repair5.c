...
////upward_preferred = Inhibit_Biased_Climb(Cur_Vertical_Sep,---deleted
...
////Climb_Inhibit) >= Down_Separation;/*tvn: operator mutation > */---deleted
  upward_preferred = (Down_Separation < 207);/*tvn: operator mutation > */////---added
  if (upward_preferred)
    {
