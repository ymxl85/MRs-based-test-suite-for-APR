...
public class GenPTRepair {

	public String prog;
	public String patch;
	public String repair;
	private ArrayList<String> linesofprog;
	public GenPTRepair(String a,String b,String c)
	{
		this.prog=a;
		this.patch=b;
		this.repair=c;
	...
	public void generation() throws IOException
	{
		...
		for(i=0;i<this.linesofprog.size();i++)
		{
			...
			{
				bw.write("    printf(\"%s\",mainQ(argv[1]));");bw.newLine();
			}
	...
	{
		GenPTRepair gtr=new GenPTRepair(args[0],args[1],args[2]);
		gtr.generation();
	}
}
