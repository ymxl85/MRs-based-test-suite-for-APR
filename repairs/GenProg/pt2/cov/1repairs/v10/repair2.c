...
{ int tmp ;
  ...
  __repair_app_235__aef: /* CIL Label */ 
  {
  if (tmp___1) {
    return (3);
  } else {
...
{ int i ;
  ...
  i = 1;
  if ((int )*str == 34) {
    __repair_app_9__af0: /* CIL Label */ 
    {
    while ((int )*str != 0) {
      if ((int )*(str + i) == 34) {
        return (1);
      } else {
        __repair_app_321__af1: /* CIL Label */ 
        {
        i ++;
        return (0);
        }
...
{ 
  ...
  {
  __repair_del_260__af2: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  __repair_app_264__af3: /* CIL Label */ 
  {
  if (tmp___5) {
