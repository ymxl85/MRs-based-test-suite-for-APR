...
{ char ch1[2] ;
  ...
  if (tmp == 1) {
    __repair_swap1_241__b9: /* CIL Label */ 
    return (1);
  } else {
    __repair_del_93__b8: /* CIL Label */ 
    {
...
{ int tmp ;
  ...
  if (tmp___3) {
    __repair_del_128__ba: /* CIL Label */ 
    {
...
{ int type ;
  ...
  if (type == 42) {
    ...
    __repair_del_172__bb: /* CIL Label */ 
    {
...
{ int i ;
  ...
  if ((int )*str == 34) {
    ...
    __repair_swap1_92__bc: /* CIL Label */ 
    return (1);
  } else {
    return (0);
  }
