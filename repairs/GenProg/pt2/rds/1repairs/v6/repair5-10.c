...
{ int tmp ;
  ...
  __repair_swap1_146__813: /* CIL Label */ 
  ...
  if (tmp___3) {
    ...
    __repair_swap1_223__814: /* CIL Label */ ;
  }
  __repair_swap1_141__815: /* CIL Label */ 
  if (tmp___1) {
    return (3);
  } else {
...
{ int i ;
  ...
  if ((int const   )*(*tmp___0 + (int )*str) & 2048) {
    __repair_del_229__816: /* CIL Label */ 
    {
...
{ int i ;
  ...
  {
  i = 1;
  __repair_app_242__817: /* CIL Label */ 
  {
  if ((int )*str == 34) {
    while ((int )*(str + i) != 0) {
      if ((int )*(str + i) == 34) {
