...
{ int tmp ;
  ...
  if (tmp___2) {
    ...
    __repair_swap1_166__1fe: /* CIL Label */ ;
  }
  ...
  if (tmp___6) {
    ...
    __repair_swap1_303__1ff: /* CIL Label */ ;
  }
  return (0);
}
}
...
{ int type ;
  ...
  if (type == 3) {
    ...
    __repair_swap1_127__200: /* CIL Label */ ;
  }
  if (type == 41) {
...
{ int i ;
  ...
  if ((int const   )*(*tmp___0 + (int )*str) & 2048) {
    __repair_swap1_227__201: /* CIL Label */ 
    tmp = __ctype_b_loc();
    return (1);
  } else {
    return (0);
...
{ int tmp ;
  ...
  tmp___4 = strcmp((char const   *)str, "`");
  if (tmp___4) {
    __repair_swap1_135__202: /* CIL Label */ ;
  } else {
    return (1);
  }
