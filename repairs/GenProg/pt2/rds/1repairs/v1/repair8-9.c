...
{ int i ;
  ...
  __repair_swap1_52__1132: /* CIL Label */ 
  if ((int )ch == 0) {
    unget_error(*tp);
  } else {
  ...
  __repair_del_76__1133: /* CIL Label */ 
  {
  ...
  if (tmp___3 == 1) {
    ch = unget_char(ch, tp);
    __repair_swap1_63__1135: /* CIL Label */ 
    ch1[0] = (char )'\000';
    return (buffer);
  } else {
    __repair_app_59__1134: /* CIL Label */ 
    {
...
{ char ch1[2] ;
  ...
  if (str_com_id == 2) {
    ...
    __repair_swap1_109__1136: /* CIL Label */ 
    if ((int )ch == 32) {
      return (1);
    } else {
      if ((int )ch == 10) {
        ...
        if ((int )ch == 59) {
          __repair_app_120__1137: /* CIL Label */ 
          {
          return (1);
  ...
  __repair_swap1_92__1138: /* CIL Label */ ;
  return (0);
}
}
static int token_type(token tok ) 
{ int tmp ;
  ...
  if (tmp___0) {
    ...
    __repair_swap1_151__1139: /* CIL Label */ ;
  }
  __repair_app_128__113a: /* CIL Label */ 
  {
...
{ int type ;
  ...
  if (type == 1) {
    ...
    __repair_swap1_114__113b: /* CIL Label */ ;
  }
  if (type == 2) {
  ...
  if (type == 6) {
    ...
    __repair_app_151__113c: /* CIL Label */ 
    {
...
{ int i ;
  ...
  if ((int const   )*(*tmp___0 + (int )*str) & 2048) {
    ...
    __repair_del_222__113d: /* CIL Label */ 
    {
...
{ char *fname ;
  ...
  __repair_app_252__113e: /* CIL Label */ 
  {
  tok = get_token(& tp);
  ...
  while (1) {
    ...
    __repair_app_294__113f: /* CIL Label */ 
    {
    if (tmp == 0) {
