...
{ int i ;
  ...
  __repair_swap1_52__1cb: /* CIL Label */ 
  if ((int )ch == 0) {
    unget_error(*tp);
  } else {
  ...
  if (tmp___3 == 1) {
    ch = unget_char(ch, tp);
    __repair_swap1_76__1cc: /* CIL Label */ 
    ch1[0] = ch;
    return (buffer);
  } else {
...
{ char ch1[2] ;
  ...
  if (str_com_id == 1) {
    __repair_del_87__1cd: /* CIL Label */ 
    {
  ...
  if ((int )ch == 32) {
    ...
    if ((int )ch == 10) {
      ...
      if ((int )ch == 59) {
        __repair_app_95__1ce: /* CIL Label */ 
        {
        return (1);
        return (1);
        }
...
{ int i ;
  ...
  if ((int const   )*(*tmp___0 + (int )*str) & 2048) {
    ...
    __repair_app_122__1cf: /* CIL Label */ 
    {
    return (0);
