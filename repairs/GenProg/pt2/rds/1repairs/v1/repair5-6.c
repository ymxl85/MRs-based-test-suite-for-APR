...
{ int i ;
  ...
  if (tmp___2 == 1) {
    __repair_swap1_58__866: /* CIL Label */ ;
    if ((int )ch == 0) {
      unget_error(*tp);
    } else {
  ...
  if (id == 1) {
    ...
    __repair_swap1_45__867: /* CIL Label */ 
    ch = unget_char(ch, tp);
  }
  return (buffer);
}
...
{ 
  ...
  {
  if ((int )*tok == 0) {
    __repair_app_157__868: /* CIL Label */ 
    {
    return (1);
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        ...
        if (tmp___2) {
          ...
          if (tmp___3) {
            __repair_del_191__869: /* CIL Label */ 
            {
...
{ int i ;
  ...
  __repair_app_47__86a: /* CIL Label */ 
  {
