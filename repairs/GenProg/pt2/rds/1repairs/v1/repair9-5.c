...
{ int i ;
  ...
  if (tmp == 1) {
    __repair_app_42__2db: /* CIL Label */ 
    {
    return (buffer);
    ch = get_char(tp);
    }
  ...
  if (tmp___0 == 1) {
    ...
    __repair_app_77__2dc: /* CIL Label */ 
    {
  ...
  ch1[0] = ch;
  __repair_swap1_45__2dd: /* CIL Label */ 
  ch = unget_char(ch, tp);
  if (tmp___2 == 1) {
    __repair_swap1_77__2de: /* CIL Label */ 
    tmp___2 = is_eof_token(ch1);
    if ((int )ch == 0) {
      unget_error(*tp);
    } else {
...
{ int i ;
  ...
  if ((int const   )*(*tmp___0 + (int )*str) & 2048) {
    ...
    __repair_app_287__2df: /* CIL Label */ 
    {
    return (0);
    return (1);
    }
