...
{ int i ;
  ...
  ch1[0] = (char )'\000';
  __repair_swap1_30__a06: /* CIL Label */ ;
  ch = get_char(tp);
  while (1) {
    if ((int )ch == 32) {
  ...
  if (tmp == 1) {
    __repair_del_29__a08: /* CIL Label */ 
    {

    }
  } else {
    __repair_swap1_64__a07: /* CIL Label */ 
    ch1[1] = (char )'\000';
  }
...
{ int tmp ;
  ...
  {
  tmp = is_keyword(tok);
  __repair_swap1_122__a09: /* CIL Label */ ;
  ...
  if (tmp___4) {
    ...
    __repair_swap1_128__a0a: /* CIL Label */ 
    if (tmp) {
      return (1);
    } else {
...
{ int tmp ;
  ...
  {
  tmp = strcmp((char const   *)str, "(");
  __repair_swap1_303__a0b: /* CIL Label */ 
  if (tmp___1) {
  ...
  tmp___1 = strcmp((char const   *)str, "[");
  __repair_swap1_299__a0c: /* CIL Label */ 
  if (tmp) {
  ...
  tmp___3 = strcmp((char const   *)str, "\'");
  if (tmp___3) {
    __repair_app_303__a0d: /* CIL Label */ 
    {
