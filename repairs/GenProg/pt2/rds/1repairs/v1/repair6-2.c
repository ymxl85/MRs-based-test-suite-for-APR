...
{ int i ;
  ...
  {
  i = 0;
  __repair_swap1_77__143: /* CIL Label */ 
  ...
  ch1[0] = ch;
  __repair_swap1_60__144: /* CIL Label */ 
  id = 0;
  if (tmp___2 == 1) {
    ch = unget_char(ch, tp);
    if ((int )ch == 0) {
...
{ char ch1[2] ;
  ...
  __repair_swap1_184__145: /* CIL Label */ 
  return (0);
}
}
static int token_type(token tok ) 
{ int tmp ;
  ...
  __repair_app_165__146: /* CIL Label */ 
  {
  return (0);
...
{ 
  ...
  if ((int )*tok == 0) {
    ...
    __repair_swap1_110__147: /* CIL Label */ 
    return (0);
  }
}
}
