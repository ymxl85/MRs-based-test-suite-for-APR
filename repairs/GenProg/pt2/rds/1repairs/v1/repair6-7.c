...
{ char c ;
  ...
  c = ch;
  if ((int )ch != 0) {
    __repair_app_216__10d2: /* CIL Label */ 
    {
    (*fp) --;
    return (0);
    }
...
{ int i ;
  ...
  __repair_del_76__10d3: /* CIL Label */ 
  {
  ...
  if (tmp___3 == 1) {
    __repair_del_51__10d4: /* CIL Label */ 
    {
...
{ int tmp ;
  ...
  if (tmp___6) {
    ...
    __repair_app_236__10d5: /* CIL Label */ 
    {
...
{ int tmp ;
  ...
  if (tmp) {
    __repair_app_290__10d6: /* CIL Label */ 
    {
