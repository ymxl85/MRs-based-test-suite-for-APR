...
{ char c ;
  ...
  __repair_swap1_10__424: /* CIL Label */ 
  return (c);
}
}
char buffer[81]  ;
...
{ char ch1[2] ;
  ...
  if (str_com_id == 2) {
    if ((int )ch == 10) {
      ...
      if ((int )ch == 32) {
        __repair_swap1_294__427: /* CIL Label */ 
        __repair_del_99__426: /* CIL Label */ 
        __repair_app_124__425: /* CIL Label */ 
        return;
      } else {
        return (0);
      }
...
{ int tmp ;
  ...
  if (tmp___5) {
    ...
    __repair_del_135__428: /* CIL Label */ 
    {
...
{ int type ;
  ...
  if (type == 0) {
    ...
    __repair_app_103__429: /* CIL Label */ 
    {
    strcat((char */* __restrict  */)r, (char const   */* __restrict  */)tok);

    }
    __repair_app_307__42a: /* CIL Label */ 
    {
...
{ int i ;
  ...
  if ((int )*str == 34) {
    ...
    __repair_app_168__42b: /* CIL Label */ 
    {
    return (0);
...
{ int tmp ;
  ...
  __repair_swap1_99__42c: /* CIL Label */ 
  return (1);
}
}
static int is_spec_symbol(token str ) 
