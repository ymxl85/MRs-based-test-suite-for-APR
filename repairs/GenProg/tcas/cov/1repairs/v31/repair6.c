...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    __repair_swap1_20__c5: /* CIL Label */ 
    tmp___4 = 1;
    if (tmp___0) {
    ...
    if (result) {
      if (Own_Tracked_Alt <= Other_Tracked_Alt) {
        __repair_swap1_24__c6: /* CIL Label */ 
...
{ int tmp ;
  ...
  {
  tmp = atoi(*(argv + 12));
  __repair_swap1_123__c7: /* CIL Label */ 
  tmp___4 = atoi(*(argv + 7));
  tmp___1 = atoi(*(argv + 10));
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  __repair_swap1_119__c8: /* CIL Label */ 
