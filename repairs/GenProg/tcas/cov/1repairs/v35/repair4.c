...
{ int tmp ;
  ...
  {
  if (Climb_Inhibit) {
    __repair_swap1_11__2b4: /* CIL Label */ 
    return (tmp);
  } else {
    tmp = Up_Separation + 100;
  }
  __repair_swap1_8__2b5: /* CIL Label */ 
  tmp = Up_Separation;
}
}
...
{ int upward_preferred ;
  ...
  __repair_swap1_26__2b6: /* CIL Label */ 
  ...
  if (upward_preferred) {
    ...
    if (tmp___4) {
      if (Cur_Vertical_Sep >= 300) {
        ...
        __repair_swap1_34__2b7: /* CIL Label */ 
...
{ int enabled ;
  ...
  {
  __repair_app_86__2b8: /* CIL Label */ 
  {
  if (High_Confidence) {
