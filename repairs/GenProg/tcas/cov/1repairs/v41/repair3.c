...
{ int upward_preferred ;
  ...
  {
  __repair_swap1_23__25c: /* CIL Label */ 
  tmp___5 = 1;
  ...
  if (upward_preferred) {
    ...
    if (Cur_Vertical_Sep >= 300) {
      ...
      if (Up_Separation >= tmp___4) {
        __repair_swap1_30__25e: /* CIL Label */ 
        __repair_app_23__25d: /* CIL Label */ 
    ...
    __repair_del_29__25f: /* CIL Label */ 
    {
...
{ int enabled ;
  ...
  __repair_del_101__260: /* CIL Label */ 
  {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_del_79__261: /* CIL Label */ 
          {
