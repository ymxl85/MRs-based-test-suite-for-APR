...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_swap1_14__7af: /* CIL Label */ 
    tmp___2 = 1;
    result = tmp___2;
  } else {
    __repair_swap1_25__7ad: /* CIL Label */ 
    ...
    if (tmp___3) {
      __repair_swap1_27__7ae: /* CIL Label */ 
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    tmp___0 = Own_Below_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
    if (tmp___0) {
      __repair_del_39__7b4: /* CIL Label */ 
      {
    ...
    tmp___3 = Own_Above_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
    if (tmp___3) {
      __repair_swap1_44__7b1: /* CIL Label */ 
      __repair_swap1_44__7b0: /* CIL Label */ 
      tmp___6 = 1;
      if (tmp___4) {
        ...
        if (Up_Separation >= tmp___5) {
          __repair_swap1_49__7b3: /* CIL Label */ 
          __repair_swap1_49__7b2: /* CIL Label */ 
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          __repair_app_79__7b5: /* CIL Label */ 
          {
        ...
        if (need_upward_RA) {
          __repair_del_78__7b7: /* CIL Label */ 
          __repair_del_78__7b6: /* CIL Label */ 
          {
