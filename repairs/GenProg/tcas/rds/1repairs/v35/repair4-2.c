...
{ int tmp ;
  ...
  {
  if (Climb_Inhibit) {
    __repair_swap1_11__15f: /* CIL Label */ 
    return (tmp);
  } else {
    tmp = Up_Separation + 100;
  }
  __repair_swap1_8__160: /* CIL Label */ 
  tmp = Up_Separation;
}
}
...
{ int enabled ;
  ...
  {
  __repair_app_90__161: /* CIL Label */ 
  {
  if (High_Confidence) {
...
{ int tmp ;
  ...
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
  __repair_swap1_124__162: /* CIL Label */ 
  tmp___10 = atoi(*(argv + 1));
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
  __repair_swap1_121__163: /* CIL Label */ 
  tmp___7 = atoi(*(argv + 4));
