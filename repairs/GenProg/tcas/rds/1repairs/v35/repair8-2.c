  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      if (Alt_Layer_Value == 2) {
        ...
        __repair_swap1_127__2de: /* CIL Label */ 
        return (0);
      }
    }
  }
  ...
  if (upward_preferred) {
    ...
    if (tmp___4) {
      if (Cur_Vertical_Sep >= 300) {
        __repair_app_29__2df: /* CIL Label */ 
        {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_swap1_49__2e0: /* CIL Label */ 
    tmp___5 = ALIM(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
    result = tmp___6;
  }
  return (result);
...
{ int enabled ;
  ...
  if (High_Confidence) {
    if (Own_Tracked_Alt_Rate <= 600) {
      __repair_app_92__2e1: /* CIL Label */ 
      {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          ...
          if (tmp___2) {
            ...
            __repair_del_76__2e2: /* CIL Label */ 
            {
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_4__2e3: /* CIL Label */ 
  return (740);
}
}
