  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      if (Alt_Layer_Value == 2) {
        ...
        __repair_swap1_127__3db: /* CIL Label */ 
        return (0);
      }
    }
  }
  ...
  if (upward_preferred) {
    ...
    if (tmp___4) {
      if (Cur_Vertical_Sep >= 300) {
        __repair_app_28__3dc: /* CIL Label */ 
        {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          __repair_swap1_80__3dd: /* CIL Label */ 
          tmp___6 = 1;
          if (tmp___2) {
            tmp___3 = 1;
          } else {
        ...
        if (tmp___4) {
          ...
          if (tmp___5) {
            __repair_swap1_77__3de: /* CIL Label */ 
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_4__3df: /* CIL Label */ 
  return (740);
}
}
