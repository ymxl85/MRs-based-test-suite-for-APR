  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      if (Alt_Layer_Value == 2) {
        ...
        __repair_swap1_127__2ff: /* CIL Label */ 
        return (0);
      }
    }
  }
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      if (Cur_Vertical_Sep >= 300) {
        ...
        __repair_swap1_52__301: /* CIL Label */ 
        tmp___4 = Own_Above_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
      } else {
        tmp___2 = 0;
      }
    ...
    if (tmp___3) {
      __repair_swap1_40__300: /* CIL Label */ 
  ...
  if (High_Confidence) {
    if (Own_Tracked_Alt_Rate <= 600) {
      if (Cur_Vertical_Sep > 600) {
        __repair_del_64__302: /* CIL Label */ 
        {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          __repair_swap1_91__303: /* CIL Label */ 
          if (need_upward_RA) {
            alt_sep = 1;
          } else {
            if (need_downward_RA) {
        ...
        if (need_upward_RA) {
          ...
          __repair_swap1_77__304: /* CIL Label */ 
          _L: /* CIL Label */ 
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_4__305: /* CIL Label */ 
  return (740);
}
}
