...
{ int tmp ;
  ...
  {
  __repair_app_102__393: /* CIL Label */ 
  {
  if (Climb_Inhibit) {
    tmp = Up_Separation;
  } else {
...
{ int upward_preferred ;
  ...
  {
  tmp = Inhibit_Biased_Climb(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
  __repair_del_59__394: /* CIL Label */ 
  {
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      if (Cur_Vertical_Sep >= 300) {
        __repair_app_99__395: /* CIL Label */ 
        {
...
{ int tmp ;
  ...
  {
  __repair_del_113__396: /* CIL Label */ 
  {

  }
  __repair_swap1_117__397: /* CIL Label */ 
  tmp___3 = atoi(*(argv + 8));
  tmp___1 = atoi(*(argv + 10));
  tmp___2 = atoi(*(argv + 9));
  __repair_swap1_114__398: /* CIL Label */ 
