...
{ 
  ...
  {
  __repair_swap1_6__1ab: /* CIL Label */ 
  if (Alt_Layer_Value == 1) {
    __repair_del_2__1ac: /* CIL Label */ 
    {
...
{ int enabled ;
  ...
  if (enabled) {
    if (tcas_equipped) {
      __repair_del_74__1ad: /* CIL Label */ 
      {
...
{ int tmp ;
  ...
  __repair_swap1_122__1ae: /* CIL Label */ 
  tmp___8 = atoi(*(argv + 3));
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
  tmp___7 = atoi(*(argv + 4));
  __repair_swap1_116__1af: /* CIL Label */ 
  tmp___2 = atoi(*(argv + 9));
  tmp___9 = atoi(*(argv + 2));
