...
{ 
  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      __repair_swap1_127__13c: /* CIL Label */ 
      return (0);
    } else {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      if (Cur_Vertical_Sep >= 300) {
        __repair_swap1_61__13d: /* CIL Label */ 
        return (result);
  ...
  __repair_swap1_39__13e: /* CIL Label */ 
...
{ int enabled ;
  ...
  __repair_del_106__13f: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_2__140: /* CIL Label */ 
  return (501);
}
}
