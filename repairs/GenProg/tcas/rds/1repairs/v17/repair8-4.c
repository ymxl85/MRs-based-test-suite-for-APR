...
{ int upward_preferred ;
  ...
  {
  __repair_del_33__378: /* CIL Label */ 
  {

  }
  upward_preferred = tmp > Down_Separation;
  __repair_del_35__379: /* CIL Label */ 
  {
...
{ 
  ...
  {
  __repair_app_62__37a: /* CIL Label */ 
  {
...
{ int enabled ;
  ...
  if (enabled) {
    if (tcas_equipped) {
      __repair_del_74__37b: /* CIL Label */ 
      {
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  __repair_swap1_120__37c: /* CIL Label */ 
  tmp___6 = atoi(*(argv + 5));
  tmp___5 = atoi(*(argv + 6));
  __repair_swap1_118__37e: /* CIL Label */ 
  __repair_del_120__37d: /* CIL Label */ 
  tmp___4 = atoi(*(argv + 7));
  tmp___7 = atoi(*(argv + 4));
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
