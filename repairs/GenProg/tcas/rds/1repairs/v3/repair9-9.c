...
{ 
  ...
  if (Alt_Layer_Value == 0) {
    __repair_swap1_127__10b: /* CIL Label */ 
    __repair_swap1_6__10a: /* CIL Label */ 
    __repair_swap1_5__109: /* CIL Label */ 
    return (0);
  } else {
    __repair_swap1_1__108: /* CIL Label */ 
    return (400);
  }
}
}
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_1__10c: /* CIL Label */ 
  return (400);
}
}
