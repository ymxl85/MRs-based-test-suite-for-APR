  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      if (Alt_Layer_Value == 2) {
        __repair_swap1_127__115b: /* CIL Label */ 
        return (0);
      } else {
        return (740);
      }
...
{ int upward_preferred ;
  ...
  {
  __repair_app_15__115c: /* CIL Label */ 
  {
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        ...
        if (Down_Separation >= tmp___2) {
          ...
          __repair_del_13__115d: /* CIL Label */ 
          {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    tmp___0 = Own_Below_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
    if (tmp___0) {
      __repair_swap1_39__115e: /* CIL Label */ 
  ...
  __repair_del_61__115f: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  {
  __repair_app_111__1160: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  {
  __repair_swap1_121__1162: /* CIL Label */ 
  __repair_swap1_114__1161: /* CIL Label */ 
  tmp___7 = atoi(*(argv + 4));
  __repair_swap1_113__1163: /* CIL Label */ 
  tmp = atoi(*(argv + 12));
  ...
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
  __repair_swap1_113__1164: /* CIL Label */ 
  tmp = atoi(*(argv + 12));
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
  ...
  printf("%d\n", tmp___11);
  __repair_del_127__1166: /* CIL Label */ 
  __repair_swap1_3__1165: /* CIL Label */ 
  {
