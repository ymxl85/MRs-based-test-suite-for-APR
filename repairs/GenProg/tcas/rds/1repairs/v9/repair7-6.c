...
{ 
  ...
  if (Alt_Layer_Value == 0) {
    ...
    __repair_app_127__2cc: /* CIL Label */ 
    {
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        ...
        if (Down_Separation >= tmp___2) {
          ...
          __repair_app_30__2ce: /* CIL Label */ 
          {
          tmp___3 = 1;
...
{ int upward_preferred ;
  ...
  __repair_app_61__2cf: /* CIL Label */ 
  {
  return (result);
  return (result);
  }
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          ...
          if (tmp___5) {
            ...
            __repair_del_81__2d0: /* CIL Label */ 
            {
