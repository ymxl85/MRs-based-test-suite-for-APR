...
{ int tmp ;
  ...
  __repair_del_11__273: /* CIL Label */ 
  {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      ...
      __repair_app_15__274: /* CIL Label */ 
      {
      if (tmp___1) {
...
{ int tmp ;
  ...
  __repair_swap1_117__275: /* CIL Label */ 
  tmp___3 = atoi(*(argv + 8));
  __repair_swap1_116__276: /* CIL Label */ 
  tmp___2 = atoi(*(argv + 9));
  tmp___4 = atoi(*(argv + 7));
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
