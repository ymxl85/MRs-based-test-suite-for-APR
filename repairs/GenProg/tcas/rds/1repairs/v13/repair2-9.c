...
{ 
  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      __repair_swap1_127__1007: /* CIL Label */ 
      return (0);
    } else {
...
{ int enabled ;
  ...
  {
  if (High_Confidence) {
    if (Own_Tracked_Alt_Rate <= 700) {
      if (Cur_Vertical_Sep > 600) {
        __repair_swap1_96__1008: /* CIL Label */ 
        if (tmp___4) {
  ...
  enabled = tmp;
  __repair_app_72__1009: /* CIL Label */ 
  {
  ...
  if (Two_of_Three_Reports_Valid) {
    __repair_swap1_108__100a: /* CIL Label */ 
    alt_sep = 0;
  } else {
    tmp___0 = 0;
  }
  intent_not_known = tmp___0;
  __repair_swap1_72__100b: /* CIL Label */ 
  if (Other_RAC == 0) {
    tmp___0 = 1;
  } else {
    tmp___0 = 0;
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_64__100c: /* CIL Label */ 
        tmp = 1;
...
{ int tmp ;
  ...
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  __repair_swap1_120__100d: /* CIL Label */ 
  tmp___6 = atoi(*(argv + 5));
  __repair_swap1_119__100e: /* CIL Label */ 
  tmp___5 = atoi(*(argv + 6));
  tmp___7 = atoi(*(argv + 4));
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_2__100f: /* CIL Label */ 
  return (500);
}
}
