...
{ int upward_preferred ;
  ...
  __repair_del_32__1a4: /* CIL Label */ 
  {
...
{ int upward_preferred ;
  ...
  {
  tmp = Inhibit_Biased_Climb(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
  __repair_swap1_53__1a5: /* CIL Label */ 
  if (tmp___3) {
  ...
  if (upward_preferred) {
    ...
    __repair_swap1_56__1a6: /* CIL Label */ 
    upward_preferred = tmp > Down_Separation;
    result = tmp___6;
  }
  return (result);
...
{ 
  ...
  {
  __repair_del_60__1a7: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
  __repair_app_120__1a8: /* CIL Label */ 
  {
  ...
  __repair_app_110__1a9: /* CIL Label */ 
  {
  printf("%d\n", tmp___11);
  tmp = atoi(*(argv + 12));
  }
