...
{ int upward_preferred ;
  ...
  __repair_del_34__860: /* CIL Label */ 
  {
...
{ int enabled ;
  ...
  __repair_app_66__861: /* CIL Label */ 
  {
  alt_sep = 0;
  if (Cur_Vertical_Sep > 600) {
    tmp = 1;
  ...
  if (enabled) {
    if (tcas_equipped) {
      __repair_del_74__866: /* CIL Label */ 
      {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_83__862: /* CIL Label */ 
        if (tmp___5) {
          tmp___6 = 1;
        } else {
          tmp___6 = 0;
        ...
        __repair_app_82__863: /* CIL Label */ 
        {
        if (tmp___4) {
          __repair_del_82__864: /* CIL Label */ 
          {

          }
          __repair_swap1_94__865: /* CIL Label */ 
...
{ int tmp ;
  ...
  __repair_app_111__867: /* CIL Label */ 
  {
  return (tmp);
  tmp = alt_sep_test(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
  }
...
{ int tmp ;
  ...
  {
  tmp = atoi(*(argv + 12));
  __repair_app_121__868: /* CIL Label */ 
  {
