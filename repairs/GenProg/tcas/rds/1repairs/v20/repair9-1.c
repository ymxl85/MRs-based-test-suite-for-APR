...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      __repair_del_17__2e7: /* CIL Label */ 
      {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_83__2e8: /* CIL Label */ 
        if (tmp___5) {
          tmp___6 = 1;
        } else {
          tmp___6 = 0;
        ...
        if (tmp___4) {
          ...
          __repair_swap1_93__2e9: /* CIL Label */ 
          if (tmp___1) {
...
{ int tmp ;
  ...
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
  __repair_swap1_123__2ea: /* CIL Label */ 
  tmp___9 = atoi(*(argv + 2));
  tmp___8 = atoi(*(argv + 3));
  __repair_swap1_121__2eb: /* CIL Label */ 
  tmp___7 = atoi(*(argv + 4));
