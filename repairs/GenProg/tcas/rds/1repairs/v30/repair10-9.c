  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      if (Alt_Layer_Value == 2) {
        ...
        __repair_swap1_124__217: /* CIL Label */ 
        __repair_del_4__216: /* CIL Label */ 
        return (0);
      }
    }
  }
...
{ int upward_preferred ;
  ...
  __repair_app_33__218: /* CIL Label */ 
  {
  return (result);
  return (result);
  }
...
{ int enabled ;
  ...
  if (Two_of_Three_Reports_Valid) {
    if (Other_RAC == 0) {
      __repair_swap1_92__219: /* CIL Label */ 
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_67__21a: /* CIL Label */ 
        tmp___0 = 1;
        if (tmp___4) {
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_4__21b: /* CIL Label */ 
  return (740);
}
}
