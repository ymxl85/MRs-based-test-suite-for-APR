...
{ 
  ...
  if (Alt_Layer_Value == 0) {
    __repair_swap1_127__4ac: /* CIL Label */ 
    __repair_app_5__4ab: /* CIL Label */ 
    return (0);
  } else {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      ...
      __repair_app_31__4ad: /* CIL Label */ 
      {
      if (tmp___1) {
...
{ int upward_preferred ;
  ...
  {
  tmp = Inhibit_Biased_Climb(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
  __repair_swap1_40__4ae: /* CIL Label */ 
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      if (Cur_Vertical_Sep >= 300) {
        ...
        __repair_swap1_59__4af: /* CIL Label */ 
        upward_preferred = tmp > Down_Separation;
      } else {
        tmp___2 = 0;
      }
...
{ int enabled ;
  ...
  __repair_app_70__4b0: /* CIL Label */ 
  {
  alt_sep = 0;
  tmp___0 = 1;
  }
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  __repair_app_116__4b1: /* CIL Label */ 
  {
  tmp___3 = atoi(*(argv + 8));
  tmp___2 = atoi(*(argv + 9));
  }
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_1__4b2: /* CIL Label */ 
  return (401);
}
}
