...
{ 
  ...
  {
  __repair_app_6__4f6: /* CIL Label */ 
  {
  if (Alt_Layer_Value == 0) {
    __repair_swap1_127__4f7: /* CIL Label */ 
    return (0);
  } else {
...
{ int tmp ;
  ...
  {
  __repair_swap1_11__4f8: /* CIL Label */ 
  return (tmp);
  __repair_swap1_10__4f9: /* CIL Label */ 
  if (Climb_Inhibit) {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    __repair_del_20__4fa: /* CIL Label */ 
    {
...
{ int upward_preferred ;
  ...
  {
  tmp = Inhibit_Biased_Climb(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
  __repair_app_38__4fb: /* CIL Label */ 
  {
  upward_preferred = tmp > Down_Separation;
  tmp___2 = 0;
  }
...
{ int enabled ;
  ...
  if (enabled) {
    if (tcas_equipped) {
      __repair_app_65__4fc: /* CIL Label */ 
      {
      if (intent_not_known) {
        goto _L___0;
      } else {
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_1__4fd: /* CIL Label */ 
  return (401);
}
}
