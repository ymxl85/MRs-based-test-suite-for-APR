...
{ int upward_preferred ;
  ...
  __repair_swap1_22__5fa: /* CIL Label */ 
  result = tmp___3;
  return (result);
}
}
...
{ int upward_preferred ;
  ...
  upward_preferred = tmp > Down_Separation;
  if (upward_preferred) {
    __repair_swap1_37__5fb: /* CIL Label */ 
    tmp___2 = 1;
    if (tmp___0) {
      if (Cur_Vertical_Sep >= 300) {
        ...
        if (Down_Separation >= tmp___1) {
          __repair_swap1_44__5fd: /* CIL Label */ 
          __repair_del_37__5fc: /* CIL Label */ 
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          ...
          if (tmp___5) {
            ...
            __repair_del_81__5fe: /* CIL Label */ 
            {
...
{ int a ;
  ...
  a = tmp___11;
  printf("%d\n", a);
  __repair_del_128__5ff: /* CIL Label */ 
  {
