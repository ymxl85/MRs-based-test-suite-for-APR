...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_app_17__1ca: /* CIL Label */ 
    {
    if (tmp) {
...
{ int enabled ;
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      _L___1: /* CIL Label */ 
      if (! tcas_equipped) {
        __repair_swap1_81__1cb: /* CIL Label */ 
        _L___0: /* CIL Label */ 
        ...
        if (tmp___4) {
          __repair_swap1_91__1cc: /* CIL Label */ 
          ...
          __repair_del_82__1cd: /* CIL Label */ 
          {
...
{ int tmp ;
  ...
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  __repair_app_98__1ce: /* CIL Label */ 
  {
  tmp___5 = atoi(*(argv + 6));
