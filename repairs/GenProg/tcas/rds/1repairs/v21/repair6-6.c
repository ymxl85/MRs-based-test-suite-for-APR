...
{ 
  ...
  {
  __repair_swap1_1__e63: /* CIL Label */ 
  __repair_swap1_1__e62: /* CIL Label */ 
  return (400);
}
}
...
{ int upward_preferred ;
  ...
  {
  __repair_del_33__e64: /* CIL Label */ 
  {
...
{ int upward_preferred ;
  ...
  __repair_swap1_55__e66: /* CIL Label */ 
  __repair_swap1_55__e65: /* CIL Label */ 
  if (tmp___3) {
    ...
    __repair_del_53__e67: /* CIL Label */ 
    {
...
{ int enabled ;
  ...
  if (Two_of_Three_Reports_Valid) {
    __repair_swap1_94__e68: /* CIL Label */ 
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_71__e69: /* CIL Label */ 
        if (Other_RAC == 0) {
          tmp___0 = 1;
        } else {
          tmp___0 = 0;
...
{ int tmp ;
  ...
  {
  __repair_swap1_123__e6a: /* CIL Label */ 
  tmp___10 = atoi(*(argv + 1));
  tmp___0 = atoi(*(argv + 11));
  __repair_del_114__e6b: /* CIL Label */ 
  {
  ...
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
  __repair_swap1_112__e6c: /* CIL Label */ 
  tmp = atoi(*(argv + 12));
