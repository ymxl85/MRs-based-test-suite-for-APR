...
{ int tmp ;
  ...
  {
  __repair_app_10__3e7: /* CIL Label */ 
  {
  if (Climb_Inhibit) {
...
{ int upward_preferred ;
  ...
  {
  __repair_swap1_20__3e8: /* CIL Label */ 
  ...
  if (upward_preferred) {
    __repair_swap1_33__3e9: /* CIL Label */ 
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_del_54__3ea: /* CIL Label */ 
    {
...
{ int tmp ;
  ...
  tmp___6 = atoi(*(argv + 5));
  tmp___7 = atoi(*(argv + 4));
  __repair_app_101__3eb: /* CIL Label */ 
  {
  tmp___8 = atoi(*(argv + 3));
  ...
  __repair_app_124__3ec: /* CIL Label */ 
  {
