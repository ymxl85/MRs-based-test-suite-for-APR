...
{ int upward_preferred ;
  ...
  __repair_swap1_60__528: /* CIL Label */ 
  return (result);
  if (upward_preferred) {
    tmp___0 = Own_Below_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
    if (tmp___0) {
  ...
  __repair_swap1_58__529: /* CIL Label */ 
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          ...
          if (tmp___2) {
            __repair_app_105__52a: /* CIL Label */ 
            {
            tmp___3 = 1;
            if (Two_of_Three_Reports_Valid) {
              if (Other_RAC == 0) {
...
{ int tmp ;
  ...
  {
  tmp = atoi(*(argv + 12));
  __repair_app_124__52b: /* CIL Label */ 
  {
  ...
  __repair_del_114__52c: /* CIL Label */ 
  {
  ...
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  __repair_swap1_119__52d: /* CIL Label */ 
  tmp___6 = atoi(*(argv + 5));
  __repair_del_119__52f: /* CIL Label */ 
  __repair_swap1_118__52e: /* CIL Label */ 
  {
