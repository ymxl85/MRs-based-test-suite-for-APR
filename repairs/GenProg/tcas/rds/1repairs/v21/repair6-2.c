...
{ int upward_preferred ;
  ...
  __repair_swap1_14__72a: /* CIL Label */ 
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_app_41__72b: /* CIL Label */ 
    {
    ...
    if (tmp___3) {
      ...
      __repair_del_53__72c: /* CIL Label */ 
      {

      }
    }
    __repair_del_56__72d: /* CIL Label */ 
    {
...
{ int enabled ;
  ...
  if (High_Confidence) {
    if (Own_Tracked_Alt_Rate <= 600) {
      __repair_app_101__72e: /* CIL Label */ 
      {
  ...
  __repair_app_63__72f: /* CIL Label */ 
  {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_del_81__730: /* CIL Label */ 
          {
