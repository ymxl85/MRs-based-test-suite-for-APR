...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp) {
      __repair_swap1_35__be: /* CIL Label */ 
      return (result);
      if (tmp___0) {
  ...
  __repair_swap1_17__bf: /* CIL Label */ 
...
{ int enabled ;
  ...
  if (Two_of_Three_Reports_Valid) {
    __repair_swap1_77__c0: /* CIL Label */ 
    if (tmp___2) {
      tmp___3 = 1;
    } else {
      tmp___3 = 0;
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          ...
          __repair_swap1_71__c1: /* CIL Label */ 
          if (Other_RAC == 0) {
            tmp___0 = 1;
          } else {
            tmp___0 = 0;
