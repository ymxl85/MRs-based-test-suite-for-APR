...
{ int upward_preferred ;
  ...
  {
  __repair_app_18__c68: /* CIL Label */ 
  {
  ...
  __repair_app_99__c69: /* CIL Label */ 
  {
  upward_preferred = tmp > Down_Separation;

  }
  __repair_app_22__c6a: /* CIL Label */ 
  {
  if (upward_preferred) {
    ...
    if (tmp___4) {
      ...
      __repair_del_29__c6b: /* CIL Label */ 
      {
...
{ int upward_preferred ;
  ...
  {
  __repair_del_58__c6c: /* CIL Label */ 
  {

  }
  __repair_app_99__c6d: /* CIL Label */ 
  {
  upward_preferred = tmp > Down_Separation;

  }
  __repair_swap1_55__c6e: /* CIL Label */ 
...
{ int enabled ;
  ...
  if (Two_of_Three_Reports_Valid) {
    if (Other_RAC == 0) {
      __repair_swap1_82__c6f: /* CIL Label */ 
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_swap1_70__c70: /* CIL Label */ 
          tmp___0 = 1;
          if (tmp___5) {
            tmp___6 = 1;
          } else {
            __repair_app_106__c71: /* CIL Label */ 
            {
            tmp___6 = 0;
            if (Two_of_Three_Reports_Valid) {
              if (Other_RAC == 0) {
        ...
        if (need_upward_RA) {
          ...
          if (need_upward_RA) {
            ...
            if (need_downward_RA) {
              ...
              __repair_app_66__c72: /* CIL Label */ 
              {
              alt_sep = 0;
              if (Cur_Vertical_Sep > 600) {
                tmp = 1;
...
{ int tmp ;
  ...
  __repair_app_118__c73: /* CIL Label */ 
  {
  ...
  tmp___3 = atoi(*(argv + 8));
  tmp___4 = atoi(*(argv + 7));
  __repair_app_116__c74: /* CIL Label */ 
  {
  tmp___5 = atoi(*(argv + 6));
  tmp___2 = atoi(*(argv + 9));
  }
