...
{ int tmp ;
  ...
  if (Climb_Inhibit == 0) {
    ...
    __repair_swap1_11__416: /* CIL Label */ 
    return (tmp);
  }
  __repair_swap1_9__417: /* CIL Label */ 
  tmp = Up_Separation;
}
}
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___3) {
      ...
      __repair_app_42__418: /* CIL Label */ 
      {
      tmp___6 = 1;
      if (Cur_Vertical_Sep >= 300) {
        tmp___1 = ALIM(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
...
{ 
  ...
  {
  __repair_del_63__419: /* CIL Label */ 
  {
  ...
  if (High_Confidence) {
    if (Own_Tracked_Alt_Rate <= 600) {
      if (Cur_Vertical_Sep > 600) {
        __repair_app_97__41a: /* CIL Label */ 
        {
        tmp = 1;
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_del_82__41b: /* CIL Label */ 
          {
        ...
        if (need_upward_RA) {
          ...
          if (need_upward_RA) {
            ...
            __repair_del_90__41c: /* CIL Label */ 
            {
