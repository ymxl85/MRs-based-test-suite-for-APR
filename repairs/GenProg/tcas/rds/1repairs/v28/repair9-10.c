...
{ 
  ...
  if (Alt_Layer_Value == 0) {
    __repair_app_102__50b: /* CIL Label */ 
    {
    return (400);
...
{ int tmp ;
  ...
  if (Climb_Inhibit == 0) {
    ...
    __repair_swap1_11__50c: /* CIL Label */ 
    return (tmp);
  }
  __repair_swap1_9__50d: /* CIL Label */ 
  tmp = Up_Separation;
}
}
...
{ int upward_preferred ;
  ...
  {
  __repair_del_33__50e: /* CIL Label */ 
  {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        __repair_swap1_82__50f: /* CIL Label */ 
        ...
        if (tmp___4) {
          __repair_swap1_93__510: /* CIL Label */ 
          if (tmp___1) {
            __repair_app_97__511: /* CIL Label */ 
            {
          ...
          if (tmp___5) {
            ...
            __repair_del_81__512: /* CIL Label */ 
            {
