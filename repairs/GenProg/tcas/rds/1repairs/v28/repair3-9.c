...
{ int tmp ;
  ...
  if (Climb_Inhibit == 0) {
    ...
    __repair_swap1_11__12c0: /* CIL Label */ 
    return (tmp);
  }
  __repair_swap1_9__12c1: /* CIL Label */ 
  tmp = Up_Separation;
}
}
...
{ int upward_preferred ;
  ...
  __repair_app_32__12c2: /* CIL Label */ 
  {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_swap1_61__12c3: /* CIL Label */ 
    return (result);
  }
  __repair_swap1_57__12c4: /* CIL Label */ 
  result = tmp___6;
}
}
int Own_Below_Threat(int Cur_Vertical_Sep , int High_Confidence , int Two_of_Three_Reports_Valid , int Own_Tracked_Alt , int Own_Tracked_Alt_Rate , int Other_Tracked_Alt , int Alt_Layer_Value , int Up_Separation , int Down_Separation , int Other_RAC , int Other_Capability , int Climb_Inhibit ) 
...
{ 
  ...
  {
  __repair_app_2__12c5: /* CIL Label */ 
  {
...
{ int enabled ;
  ...
  if (Two_of_Three_Reports_Valid) {
    __repair_del_72__12c6: /* CIL Label */ 
    {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_app_77__12c7: /* CIL Label */ 
          {
        ...
        __repair_app_105__12c8: /* CIL Label */ 
        {
...
{ int tmp ;
  ...
  {
  __repair_swap1_123__12c9: /* CIL Label */ 
  tmp___9 = atoi(*(argv + 2));
  __repair_del_114__12ca: /* CIL Label */ 
  {
  ...
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  __repair_app_118__12cb: /* CIL Label */ 
  {
  tmp___4 = atoi(*(argv + 7));
  tmp___4 = atoi(*(argv + 7));
  }
  ...
  tmp___7 = atoi(*(argv + 4));
  tmp___8 = atoi(*(argv + 3));
  __repair_swap1_113__12cc: /* CIL Label */ 
  tmp = atoi(*(argv + 12));
