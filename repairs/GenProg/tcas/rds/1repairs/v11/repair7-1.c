...
{ 
  ...
  {
  __repair_del_7__a0f: /* CIL Label */ 
  __repair_swap1_6__a0e: /* CIL Label */ 
  {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      __repair_app_17__a10: /* CIL Label */ 
      {
      ...
      if (tmp___1) {
        __repair_del_14__a11: /* CIL Label */ 
        {
    ...
    __repair_del_22__a12: /* CIL Label */ 
    {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    tmp___0 = Own_Below_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
    if (tmp___0) {
      __repair_app_57__a13: /* CIL Label */ 
      {
      if (Cur_Vertical_Sep >= 300) {
...
{ int enabled ;
  ...
  __repair_swap1_85__a15: /* CIL Label */ 
  __repair_app_92__a14: /* CIL Label */ 
  alt_sep = 0;
  __repair_app_81__a16: /* CIL Label */ 
  {
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          ...
          if (tmp___2) {
            __repair_app_90__a17: /* CIL Label */ 
            {
            tmp___3 = 1;
            if (need_upward_RA) {
              alt_sep = 1;
        ...
        if (tmp___4) {
          ...
          __repair_app_84__a18: /* CIL Label */ 
          {
          tmp___6 = 0;
          tmp___6 = 0;
          }
        ...
        if (need_upward_RA) {
          __repair_swap1_105__a19: /* CIL Label */ 
