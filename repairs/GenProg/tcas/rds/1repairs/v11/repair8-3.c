...
{ 
  ...
  {
  __repair_swap1_5__2d8: /* CIL Label */ 
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_del_21__2d9: /* CIL Label */ 
    {
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          ...
          if (tmp___2) {
            __repair_app_90__2da: /* CIL Label */ 
            {
            tmp___3 = 1;
            if (need_upward_RA) {
              alt_sep = 1;
        ...
        if (tmp___4) {
          ...
          __repair_app_78__2db: /* CIL Label */ 
          {
          tmp___6 = 0;
          if (tmp___2) {
            tmp___3 = 1;
        ...
        if (need_upward_RA) {
          __repair_del_85__2dc: /* CIL Label */ 
          {
