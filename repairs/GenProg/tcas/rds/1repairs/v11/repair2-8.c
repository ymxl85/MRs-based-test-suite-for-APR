...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        __repair_swap1_22__524: /* CIL Label */ 
        result = tmp___3;
    ...
    __repair_swap1_14__525: /* CIL Label */ 
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      if (Cur_Vertical_Sep >= 300) {
        ...
        if (Down_Separation >= tmp___1) {
          ...
          __repair_swap1_46__526: /* CIL Label */ 
          result = tmp___2;
        }
      } else {
        tmp___2 = 0;
    ...
    __repair_swap1_38__527: /* CIL Label */ 
    tmp___2 = 0;
  } else {
...
{ 
  ...
  {
  __repair_del_62__528: /* CIL Label */ 
  {
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          ...
          __repair_del_78__529: /* CIL Label */ 
          {
        ...
        if (need_upward_RA) {
          __repair_app_90__52a: /* CIL Label */ 
          {
          alt_sep = 0;
          if (need_upward_RA) {
            alt_sep = 1;
