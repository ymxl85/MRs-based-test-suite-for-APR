    ...
    if (tmp___0) {
      if (Cur_Vertical_Sep >= 300) {
        ...
        if (Down_Separation >= tmp___1) {
          ...
          __repair_del_38__5fe: /* CIL Label */ 
          {
...
{ int enabled ;
  ...
  __repair_swap1_84__5ff: /* CIL Label */ 
  tmp___6 = 0;
  alt_sep = 0;
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          ...
          __repair_del_84__602: /* CIL Label */ 
          __repair_swap1_106__601: /* CIL Label */ 
          __repair_app_81__600: /* CIL Label */ 
          {
        ...
        if (need_upward_RA) {
          __repair_app_90__603: /* CIL Label */ 
          {
          alt_sep = 0;
          if (need_upward_RA) {
            alt_sep = 1;
