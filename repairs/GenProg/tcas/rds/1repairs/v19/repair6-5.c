...
{ 
  ...
  if (Alt_Layer_Value == 0) {
    ...
    if (Alt_Layer_Value == 1) {
      ...
      __repair_app_127__2b6: /* CIL Label */ 
      {
      if (Alt_Layer_Value == 2) {
        return (640);
      } else {
        __repair_swap1_127__2b7: /* CIL Label */ 
        return (0);
      }
      return (0);
      }
...
{ int tmp ;
  ...
  __repair_del_11__2b9: /* CIL Label */ 
  {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___0) {
      ...
      if (tmp___1) {
        __repair_app_17__2ba: /* CIL Label */ 
        {
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_4__2bb: /* CIL Label */ 
  return (760);
}
}
