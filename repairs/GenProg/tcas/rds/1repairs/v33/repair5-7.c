  ...
  if (Alt_Layer_Value == 1) {
    ...
    if (Alt_Layer_Value == 2) {
      ...
      if (Alt_Layer_Value == 3) {
        __repair_del_3__2d1: /* CIL Label */ 
        {

        }
      } else {
        __repair_swap1_127__2d0: /* CIL Label */ 
        __repair_app_4__2cf: /* CIL Label */ 
        return (0);
      }
    }
  }
...
{ int enabled ;
  ...
  alt_sep = 0;
  __repair_app_99__2d2: /* CIL Label */ 
  {
  if (enabled) {
    if (tcas_equipped) {
      if (intent_not_known) {
...
{ int tmp ;
  ...
  printf("%d\n", tmp___11);
  __repair_swap1_4__2d3: /* CIL Label */ 
  return (740);
}
}
