...
{ int tmp ;
  ...
  {
  __repair_app_10__19e: /* CIL Label */ 
  {
  if (Climb_Inhibit) {
      ...
      if (! tcas_equipped) {
        ...
        if (need_upward_RA) {
          ...
          if (need_upward_RA) {
            ...
            __repair_del_90__19f: /* CIL Label */ 
            {
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  __repair_del_118__1a0: /* CIL Label */ 
  {

  }
  tmp___5 = atoi(*(argv + 6));
  __repair_swap1_124__1a1: /* CIL Label */ 
  tmp___10 = atoi(*(argv + 1));
  tmp___7 = atoi(*(argv + 4));
  tmp___8 = atoi(*(argv + 3));
  tmp___9 = atoi(*(argv + 2));
  __repair_swap1_120__1a2: /* CIL Label */ 
  tmp___6 = atoi(*(argv + 5));
