...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    tmp___0 = Own_Below_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
    __repair_swap1_40__266: /* CIL Label */ 
...
{ int tmp ;
  ...
  {
  __repair_del_113__268: /* CIL Label */ 
  __repair_swap1_118__267: /* CIL Label */ 
  {
  ...
  tmp___2 = atoi(*(argv + 9));
  tmp___3 = atoi(*(argv + 8));
  __repair_swap1_113__269: /* CIL Label */ 
  tmp = atoi(*(argv + 12));
  tmp___5 = atoi(*(argv + 6));
  tmp___6 = atoi(*(argv + 5));
  tmp___7 = atoi(*(argv + 4));
