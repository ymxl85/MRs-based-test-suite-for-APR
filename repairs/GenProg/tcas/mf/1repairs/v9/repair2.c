...
{ int tmp ;
  ...
  __repair_app_10__bfc: /* CIL Label */ 
  {
  return (tmp);
  if (Climb_Inhibit) {
    tmp = 100 + Up_Separation;
...
{ int upward_preferred ;
  ...
  {
  __repair_app_36__bfd: /* CIL Label */ 
  {
...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    if (tmp___3) {
      ...
      __repair_swap1_61__bfe: /* CIL Label */ 
      return (result);
    }
    result = tmp___6;
  }
  __repair_swap1_54__bff: /* CIL Label */ 
  tmp___6 = 1;
}
}
int Own_Below_Threat(int Cur_Vertical_Sep , int High_Confidence , int Two_of_Three_Reports_Valid , int Own_Tracked_Alt , int Own_Tracked_Alt_Rate , int Other_Tracked_Alt , int Alt_Layer_Value , int Up_Separation , int Down_Separation , int Other_RAC , int Other_Capability , int Climb_Inhibit ) 
...
{ int enabled ;
  ...
  __repair_del_108__c00: /* CIL Label */ 
  {
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_del_82__c01: /* CIL Label */ 
          {
...
{ int tmp ;
  ...
  tmp___2 = atoi(*(argv + 9));
  __repair_app_120__c02: /* CIL Label */ 
  {
  tmp___3 = atoi(*(argv + 8));
  tmp___6 = atoi(*(argv + 5));
  }
