...
{ int tmp ;
  ...
  {
  __repair_swap1_9__e91: /* CIL Label */ 
  tmp = Up_Separation;
  return (tmp);
}
}
...
{ int upward_preferred ;
  ...
  __repair_swap1_36__e92: /* CIL Label */ 
  return (result);
  if (upward_preferred) {
  ...
  __repair_swap1_34__e94: /* CIL Label */ 
  __repair_del_36__e93: /* CIL Label */ 
...
{ int enabled ;
  ...
  __repair_swap1_75__e95: /* CIL Label */ 
  tmp___3 = 1;
  alt_sep = 0;
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___1) {
          ...
          if (tmp___2) {
            __repair_swap1_107__e96: /* CIL Label */ 
        ...
        if (tmp___4) {
          ...
          __repair_app_83__e97: /* CIL Label */ 
          {
          if (tmp___5) {
            tmp___6 = 1;
          } else {
            __repair_del_81__e98: /* CIL Label */ 
            {
        ...
        if (need_upward_RA) {
          ...
          _L: /* CIL Label */ 
          if (need_upward_RA) {
            __repair_app_77__e99: /* CIL Label */ 
            {
            alt_sep = 1;
            tmp___2 = Own_Below_Threat(Cur_Vertical_Sep, High_Confidence, Two_of_Three_Reports_Valid, Own_Tracked_Alt, Own_Tracked_Alt_Rate, Other_Tracked_Alt, Alt_Layer_Value, Up_Separation, Down_Separation, Other_RAC, Other_Capability, Climb_Inhibit);
            }
...
{ int tmp ;
  ...
  tmp___6 = atoi(*(argv + 5));
  tmp___7 = atoi(*(argv + 4));
  __repair_app_125__e9a: /* CIL Label */ 
  {
  tmp___8 = atoi(*(argv + 3));
  ...
  tmp___11 = mainQ(tmp___10, tmp___9, tmp___8, tmp___7, tmp___6, tmp___5, tmp___4, tmp___3, tmp___2, tmp___1, tmp___0, tmp);
  __repair_app_119__e9b: /* CIL Label */ 
  {
  printf("%d\n", tmp___11);
  tmp___5 = atoi(*(argv + 6));
  }
