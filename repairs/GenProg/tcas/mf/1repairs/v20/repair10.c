...
{ int upward_preferred ;
  ...
  if (upward_preferred) {
    ...
    __repair_swap1_36__23a: /* CIL Label */ 
    return (result);
  } else {
  ...
  __repair_swap1_22__23b: /* CIL Label */ 
  result = tmp___3;
}
}
    ...
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          ...
          __repair_del_83__23d: /* CIL Label */ 
          {
...
{ int tmp ;
  ...
  __repair_app_119__23e: /* CIL Label */ 
  {
