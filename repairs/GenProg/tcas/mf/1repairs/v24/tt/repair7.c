...
{ int upward_preferred ;
  ...
  {
  __repair_del_58__2d0: /* CIL Label */ 
  {
...
{ 
  ...
  {
  __repair_del_62__2d1: /* CIL Label */ 
  {
...
{ int enabled ;
  ...
  __repair_swap1_81__2d2: /* CIL Label */ 
  ...
  if (enabled) {
    if (tcas_equipped) {
      ...
      if (! tcas_equipped) {
        ...
        if (tmp___4) {
          __repair_swap1_107__2d3: /* CIL Label */ 
          alt_sep = 0;
          if (tmp___5) {
            tmp___6 = 1;
          } else {
...
printf("tmp=%d\n",tmp);
  __repair_del_111__2d5: /* CIL Label */ 
  __repair_del_111__2d4: /* CIL Label */ 
  {
