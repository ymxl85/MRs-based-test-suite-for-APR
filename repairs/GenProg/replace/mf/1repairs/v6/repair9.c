...
{ bool result ;
  ...
  {
  __repair_app_238__196: /* CIL Label */ 
  {
  if (*j >= maxset) {
    result = (char)0;
  } else {
...
{ int k ;
  ...
  while (1) {
    if ((int )*(src + *i) != (int )delim) {
      if ((int )*(src + *i) != 0) {
        __repair_swap1_48__197: /* CIL Label */ 
        if ((int )*(src + (*i + 1)) == 0) {
          ...
          if (tmp___4) {
            ...
            tmp___3 = addstr((char )'-', dest, j, maxset);
            __repair_swap1_52__198: /* CIL Label */ 
            if ((int )*(src + (*i - 1)) == 64) {
              escjunk = esc(src, i);
              ...
              if ((int )*(src + *i) != 45) {
                ...
                __repair_swap1_48__199: /* CIL Label */ 
                if ((int )*(src + (*i + 1)) == 0) {
                  tmp___1 = addstr((char )'-', dest, j, maxset);
                  junk = (char )tmp___1;
                } else {
    ...
    __repair_swap1_45__19a: /* CIL Label */ 
    junk = (char )tmp___3;
    (*i) ++;
  }
  return;
...
{ int result ;
  ...
  j = 0;
  i = start;
  __repair_app_150__19b: /* CIL Label */ 
  {
  lastj = 0;
  j = 0;
  }
...
{ string pat ;
  ...
  {
  __repair_app_317__19c: /* CIL Label */ 
  {
