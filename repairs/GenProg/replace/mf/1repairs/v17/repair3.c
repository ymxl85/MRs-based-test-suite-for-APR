...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_swap1_14__b55: /* CIL Label */ 
    if ((int )*(s + *i) == 110) {
      result = (char)10;
    } else {
      __repair_swap1_14__b56: /* CIL Label */ 
      if ((int )*(s + *i) == 110) {
        result = (char)10;
      } else {
        if ((int )*(s + *i) == 116) {
          ...
          __repair_app_204__b57: /* CIL Label */ 
          {
          result = *(s + *i);
...
{ int result ;
  ...
  i = start;
  lastj = 0;
  __repair_del_153__b58: /* CIL Label */ 
  {
  ...
  while (1) {
    ...
    __repair_app_148__b59: /* CIL Label */ 
    {
    lastj = lj;
    if (! junk) {
      result = 0;
...
{ char advance ;
  ...
  advance = (char)-1;
  if ((int )*(lin + *i) == 0) {
    __repair_del_194__b5b: /* CIL Label */ 
    {
    ...
    if (tmp___1) {
      ...
      case 63: 
      if ((int )*(lin + *i) != 10) {
        __repair_app_199__b5a: /* CIL Label */ 
        {
        advance = (char)1;
        advance = (char)1;
        }
  ...
  if ((int )advance >= 0) {
    *i += (int )advance;
    ...
    __repair_del_224__b5c: /* CIL Label */ 
    {
