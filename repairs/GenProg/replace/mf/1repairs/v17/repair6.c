  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + (*i + 1)) == 0) {
      ...
      if ((int )*(s + *i) == 110) {
        ...
        __repair_swap1_17__1e0: /* CIL Label */ 
        __repair_app_17__1df: /* CIL Label */ 
        return (result);
      }
    }
  }
  __repair_swap1_12__1e1: /* CIL Label */ 
  if ((int )*(s + *i) == 116) {
    result = (char)9;
  } else {
    result = *(s + *i);
...
{ char *tmp ;
  ...
  {
  __repair_app_104__1e2: /* CIL Label */ 
  {
