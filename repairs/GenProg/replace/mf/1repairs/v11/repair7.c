  ...
  while (1) {
    ...
    if ((int )*(src + (*i - 1)) == 64) {
      ...
      if ((int )*(src + *i) != 45) {
        ...
        __repair_app_42__46f: /* CIL Label */ 
        {
        junk = (char )tmp___0;
        ...
        if (*j <= 1) {
          ...
          if ((int )*(src + (*i + 1)) == 0) {
            ...
            if (tmp___4) {
              __repair_del_42__46e: /* CIL Label */ 
              {

              }
              if (tmp___5) {
                if ((int )*(src + (*i - 1)) > (int )*(src + *i)) {
                  k = (int )*(src + (*i - 1)) + 1;
                  while (k <= (int )*(src + (*i + 1))) {
...
{ int jstart ;
  ...
  __repair_app_204__470: /* CIL Label */ 
  {
  junk = (char )tmp___1;
...
{ int result ;
  ...
  {
  __repair_app_153__471: /* CIL Label */ 
  {
  j = 0;
  done = (char)0;
  }
  ...
  while (1) {
    if (! done) {
      if ((int )*(arg + i) != (int )delim) {
        __repair_del_105__472: /* CIL Label */ 
        {
