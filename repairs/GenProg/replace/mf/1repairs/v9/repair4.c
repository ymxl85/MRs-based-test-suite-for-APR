      ...
      if ((int )*(src + *i) != 45) {
        ...
        if (*j <= 1) {
          ...
          if ((int )*(src + (*i + 1)) == 0) {
            ...
            __repair_del_43__294: /* CIL Label */ 
            {
...
{ int tmp ;
  ...
  if ((int )c == 99) {
    ...
    if ((int )c == 37) {
      ...
      __repair_del_97__295: /* CIL Label */ 
      {
...
{ int result ;
  ...
  j = 0;
  i = start;
  __repair_app_193__296: /* CIL Label */ 
  {
  lastj = 0;
...
{ int result ;
  ...
  i = from;
  while (1) {
    __repair_swap1_166__297: /* CIL Label */ 
    ...
    __repair_swap1_165__298: /* CIL Label */ 
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
