      ...
      if ((int )*(src + *i) != 45) {
        ...
        if (*j <= 1) {
          ...
          if ((int )*(src + (*i + 1)) == 0) {
            ...
            __repair_swap1_35__785: /* CIL Label */ 
            while (k <= (int )*(src + (*i + 1))) {
            ...
            if (tmp___4) {
              ...
              if (tmp___5) {
                k = (int )*(src + (*i - 1)) + 1;
                __repair_swap1_43__786: /* CIL Label */ 
...
{ int jstart ;
  ...
  *(pat + jstart) = (char )((*j - jstart) - 1);
  __repair_app_56__787: /* CIL Label */ 
  {
...
{ int tmp ;
  ...
  if ((int )c == 99) {
    ...
    __repair_swap1_100__78a: /* CIL Label */ 
    __repair_swap1_95__789: /* CIL Label */ 
    __repair_swap1_100__788: /* CIL Label */ 
    return ((char )tmp);
  }
  __repair_swap1_98__78c: /* CIL Label */ 
  __repair_swap1_98__78b: /* CIL Label */ 
  if ((int )c == 37) {
    tmp = 1;
  } else {
    if ((int )c == 36) {
      ...
      if ((int )c == 63) {
        ...
        __repair_swap1_98__78d: /* CIL Label */ 
        if ((int )c == 37) {
          tmp = 1;
        } else {
          if ((int )c == 36) {
...
{ int result ;
  ...
  while (1) {
    __repair_app_201__78e: /* CIL Label */ 
    {
    if (! done) {
      __repair_swap1_137__78f: /* CIL Label */ 
      lj = j;
    } else {
      break;
    }
    ...
    __repair_swap1_103__790: /* CIL Label */ 
    ...
    if (! done) {
      ...
      __repair_app_127__791: /* CIL Label */ 
      {
...
{ char advance ;
  ...
  if ((int )*(lin + *i) == 0) {
    ...
    __repair_app_288__792: /* CIL Label */ 
    {
