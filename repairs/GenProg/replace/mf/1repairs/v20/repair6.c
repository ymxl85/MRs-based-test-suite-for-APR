...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + (*i + 1)) == 0) {
      __repair_swap1_11__f98: /* CIL Label */ 
      result = *(s + *i);
    } else {
      (*i) ++;
      __repair_swap1_11__f97: /* CIL Label */ 
      result = *(s + *i);
    }
  }
  return (result);
...
{ int jt ;
  ...
  {
  jp = *j - 1;
  __repair_app_300__f99: /* CIL Label */ 
  {
  while (jp >= lastj) {
    jt = jp + 1;
...
{ int tmp ;
  ...
  {
  __repair_swap1_97__f9a: /* CIL Label */ 
  if ((int )c == 33) {
    tmp = 1;
  } else {
    __repair_swap1_91__f9b: /* CIL Label */ 
    tmp = 1;
  }
  return ((char )tmp);
}
...
{ int result ;
  ...
  junk = (char )tmp___5;
  __repair_del_157__f9c: /* CIL Label */ 
  {
...
{ int result ;
  ...
  while (1) {
    ...
    if ((unsigned int )*(arg + i) == 38U) {
      ...
      escjunk = esc(arg, & i);
      __repair_app_209__f9d: /* CIL Label */ 
      {
    ...
    if ((int )*(pat + j) == 42) {
      ...
      while (1) {
        ...
        if (! result) {
          ...
          __repair_del_244__f9f: /* CIL Label */ 
          {
      ...
      if (! result) {
        ...
        __repair_app_244__f9e: /* CIL Label */ 
        {
...
{ int i ;
  ...
  __repair_app_138__fa0: /* CIL Label */ 
  {
  if (OL < 2000) {
    O[OL] = (char )'\000';
  } else {
