...
{ char result ;
  ...
  {
  if ((int )*(s + *i) != 64) {
    __repair_swap1_12__401: /* CIL Label */ 
    if ((int )*(s + *i) == 116) {
      result = (char)9;
    } else {
      result = *(s + *i);
    ...
    if ((int )*(s + (*i + 1)) == 0) {
      ...
      if ((int )*(s + *i) == 110) {
        ...
        __repair_swap1_7__400: /* CIL Label */ 
        __repair_swap1_17__3ff: /* CIL Label */ 
        __repair_swap1_17__3fe: /* CIL Label */ 
        result = *(s + *i);
      }
    }
  }
  __repair_swap1_12__403: /* CIL Label */ 
  __repair_swap1_12__402: /* CIL Label */ 
  if ((int )*(s + *i) == 116) {
    result = (char)9;
  } else {
    result = *(s + *i);
...
{ int tmp ;
  ...
  {
  __repair_del_86__404: /* CIL Label */ 
  {
  ...
  while (1) {
    ...
    if ((int )*(pat + j) == 42) {
      ...
      while (1) {
        if (! done) {
          if (i >= offset) {
            __repair_app_271__405: /* CIL Label */ 
            {
        ...
        __repair_app_244__406: /* CIL Label */ 
        {
        tmp___0 = patsize(pat, j);

        }
        k = amatch(lin, i, pat, j + tmp___0);
        __repair_app_55__407: /* CIL Label */ 
        {
        if (k >= 0) {
          done = (char)1;
        } else {
