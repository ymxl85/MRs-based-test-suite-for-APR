...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + *i) == 0) {
      ...
      __repair_del_13__5b8: /* CIL Label */ 
      {
...
{ int result ;
  ...
  __repair_swap1_148__5b9: /* CIL Label */ 
  if (! junk) {
    result = 0;
  } else {
    result = i;
  ...
  if (done) {
    ...
    if ((int )*(arg + i) != (int )delim) {
      ...
      __repair_swap1_156__5ba: /* CIL Label */ 
      junk = (char )tmp___5;
    }
  }
  return (result);
...
{ int result ;
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      __repair_swap1_161__5bb: /* CIL Label */ ;
    } else {
      break;
    }
