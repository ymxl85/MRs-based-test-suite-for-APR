...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_swap1_8__520: /* CIL Label */ 
    result = (char)10;
  }
  __repair_del_17__521: /* CIL Label */ 
  {
...
{ int makeres ;
  ...
  {
  __repair_app_241__522: /* CIL Label */ 
  {
...
{ int result ;
  ...
  i = from;
  while (1) {
    __repair_app_179__523: /* CIL Label */ 
    {
    if ((int )*(arg + i) != (int )delim) {
      __repair_app_175__524: /* CIL Label */ 
      {
      if ((int )*(arg + i) != 0) {
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    __repair_del_174__525: /* CIL Label */ 
    {
...
{ int i ;
  ...
  while ((int )*(sub + i) != 0) {
    if ((int )*(sub + i) == -1) {
      ...
      if (*OL < 2000) {
        __repair_app_248__526: /* CIL Label */ 
        {
        *(output + *OL) = *(sub + i);
