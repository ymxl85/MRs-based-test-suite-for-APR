...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_swap1_8__2a5: /* CIL Label */ 
    result = (char)10;
  }
  __repair_swap1_8__2a6: /* CIL Label */ 
  result = (char)10;
}
}
...
{ int makeres ;
  ...
  __repair_app_55__2a7: /* CIL Label */ 
  {
...
{ int i ;
  ...
  {
  __repair_app_239__2a8: /* CIL Label */ 
  {
  i = 0;
  ...
  while ((int )*(lin + i) != 0) {
    ...
    if (m == -1) {
      ...
      if (m == i) {
        ...
        if (OL < 2000) {
          O[OL] = *(lin + i);
          __repair_app_104__2a9: /* CIL Label */ 
          {
          OL ++;
