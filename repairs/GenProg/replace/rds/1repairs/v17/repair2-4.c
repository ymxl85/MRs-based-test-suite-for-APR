...
{ char result ;
  ...
  {
  __repair_swap1_7__ca1: /* CIL Label */ 
  result = *(s + *i);
  return (result);
}
}
...
{ int result ;
  ...
  while (1) {
    __repair_swap1_106__ca2: /* CIL Label */ 
  ...
  __repair_app_161__ca3: /* CIL Label */ 
  {
  ...
  if (done) {
    ...
    if ((int )*(arg + i) != (int )delim) {
      ...
      __repair_app_128__ca4: /* CIL Label */ 
      {
      if (! junk) {
        result = 0;
      } else {
  ...
  __repair_del_158__ca5: /* CIL Label */ 
  {
...
{ int result ;
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    __repair_app_175__ca6: /* CIL Label */ 
    {
...
{ int i ;
  ...
  {
  __repair_swap1_273__ca8: /* CIL Label */ 
  __repair_swap1_273__ca7: /* CIL Label */ 
  while (1) {
    if (! done) {
      if ((int )*(pat + j) != 0) {
  ...
  __repair_swap1_272__caa: /* CIL Label */ 
  __repair_swap1_272__ca9: /* CIL Label */ 
  done = (char)0;
  return (offset);
}
}
...
{ int i ;
  ...
  while ((int )*(lin + i) != 0) {
    ...
    if (m >= 0) {
      if (lastm != m) {
        ...
        __repair_del_297__cab: /* CIL Label */ 
        {
  ...
  __repair_swap1_312__cad: /* CIL Label */ 
  __repair_app_295__cac: /* CIL Label */ 
  O[OL] = (char )'\000';
  return (O);
}
}
...
{ string pat ;
  ...
  __repair_app_295__cae: /* CIL Label */ 
  {
  result = (char )tmp;
