...
{ char result ;
  ...
  {
  __repair_swap1_7__206: /* CIL Label */ 
  result = *(s + *i);
  return (result);
}
}
...
{ int makeres ;
  ...
  __repair_del_160__207: /* CIL Label */ 
  {
...
{ int result ;
  ...
  i = from;
  while (1) {
    __repair_swap1_165__208: /* CIL Label */ 
    escjunk = esc(arg, & i);
    if ((unsigned int )*(arg + i) == 38U) {
      tmp = addstr((char)-1, sub, & j, 100);
      junk = (char )tmp;
    } else {
      __repair_swap1_168__209: /* CIL Label */ 
      if ((int )*(arg + i) != (int )delim) {
        if ((int )*(arg + i) != 0) {
...
{ char *tmp ;
  ...
  __repair_app_55__20a: /* CIL Label */ 
  {
