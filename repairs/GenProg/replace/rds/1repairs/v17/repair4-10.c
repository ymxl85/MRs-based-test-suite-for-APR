...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_swap1_8__604: /* CIL Label */ 
    result = (char)10;
  }
  __repair_swap1_8__605: /* CIL Label */ 
  result = (char)10;
}
}
...
{ int result ;
  ...
  j = 0;
  i = start;
  __repair_del_152__606: /* CIL Label */ 
  {

  }
  done = (char)0;
  while (1) {
    __repair_swap1_106__607: /* CIL Label */ 
...
{ int i ;
  ...
  {
  __repair_app_312__608: /* CIL Label */ 
  {
  OL = 0;
  O[OL] = (char )'\000';
  }
  __repair_app_316__609: /* CIL Label */ 
  {
  lastm = -1;
  i = 0;
  }
