...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_app_138__19d: /* CIL Label */ 
    {
    if ((int )*(s + (*i + 1)) == 0) {
      __repair_app_7__19e: /* CIL Label */ 
      {
      result = (char)10;
      result = *(s + *i);
      }
...
{ int i ;
  ...
  __repair_app_268__19f: /* CIL Label */ 
  {
  return (offset);
  result = omatch(lin, & offset, pat, j);
  }
...
{ string pat ;
  ...
  {
  __repair_swap1_324__1a0: /* CIL Label */ 
  result = getsub(argv2, sub);
  result = (char )tmp;
  __repair_swap1_322__1a1: /* CIL Label */ 
