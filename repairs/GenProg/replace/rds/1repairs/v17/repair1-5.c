...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_swap1_8__1b8: /* CIL Label */ 
    result = (char)10;
  }
  __repair_swap1_8__1b9: /* CIL Label */ 
  result = (char)10;
}
}
  ...
  if (done) {
    ...
    if ((int )*(arg + i) != (int )delim) {
      ...
      if (! junk) {
        ...
        __repair_app_275__1ba: /* CIL Label */ 
        {
        result = i;
...
{ int result ;
  ...
  j = 0;
  i = from;
  __repair_app_174__1bb: /* CIL Label */ 
  {
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
...
{ int i ;
  ...
  __repair_del_294__1bc: /* CIL Label */ 
  {
