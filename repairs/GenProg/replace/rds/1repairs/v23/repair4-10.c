...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + *i) == 0) {
      ...
      __repair_del_13__53c: /* CIL Label */ 
      {
...
{ int result ;
  ...
  {
  __repair_app_156__53d: /* CIL Label */ 
  {
  j = 0;
  junk = (char )tmp___5;
  }
  i = start;
  __repair_swap1_149__53e: /* CIL Label */ 
  ...
  while (1) {
    __repair_app_131__53f: /* CIL Label */ 
    {
    if (! done) {
      if ((int )*(arg + i) != (int )delim) {
        if ((int )*(arg + i) != 0) {
  ...
  if (done) {
    ...
    __repair_swap1_152__540: /* CIL Label */ 
    lastj = 0;
  }
  return (result);
}
...
{ int result ;
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
        __repair_del_161__541: /* CIL Label */ 
        {
...
{ int i ;
  ...
  while (1) {
    __repair_app_266__542: /* CIL Label */ 
    {
    if (! done) {
      if ((int )*(pat + j) != 0) {
