...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + *i) == 0) {
      ...
      __repair_del_13__abc: /* CIL Label */ 
      {
...
{ int result ;
  ...
  __repair_swap1_157__abd: /* CIL Label */ 
  if (done) {
    result = 0;
  } else {
    if ((int )*(arg + i) != (int )delim) {
  ...
  __repair_swap1_156__abe: /* CIL Label */ 
  junk = (char )tmp___5;
  return (result);
}
}
...
{ string pat ;
  ...
  __repair_swap1_319__abf: /* CIL Label */ 
  result = getsub(argv2, sub);
  __repair_swap1_318__ac0: /* CIL Label */ 
  result = (char )tmp;
...
{ char *tmp ;
  ...
  __repair_del_324__ac1: /* CIL Label */ 
  {
