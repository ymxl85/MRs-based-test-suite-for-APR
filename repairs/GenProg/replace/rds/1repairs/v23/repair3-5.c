...
{ char result ;
  ...
  {
  __repair_swap1_14__cc7: /* CIL Label */ 
  if ((int )*(s + *i) == 110) {
    result = (char)10;
  } else {
    if ((int )*(s + *i) == 116) {
...
{ int result ;
  ...
  j = 0;
  i = start;
  __repair_app_149__cc8: /* CIL Label */ 
  {
  lastj = 0;
  ...
  while (1) {
    __repair_swap1_105__cc9: /* CIL Label */ 
    if ((int )*(arg + i) != 0) {
        ...
        if ((int )*(arg + i) == 36) {
          ...
          if ((int )*(arg + i) == 91) {
            ...
            if ((int )*(arg + i) == 42) {
              ...
              tmp___3 = addstr((char )'c', pat, & j, 100);
              __repair_swap1_132__cca: /* CIL Label */ 
              junk = (char )tmp___4;
              escjunk = esc(arg, & i);
              tmp___4 = addstr(escjunk, pat, & j, 100);
              __repair_swap1_129__ccb: /* CIL Label */ 
              junk = (char )tmp___3;
            }
          }
        }
...
{ int i ;
  ...
  while (1) {
    ...
    if ((int )*(pat + j) == 42) {
      ...
      __repair_app_184__ccc: /* CIL Label */ 
      {
