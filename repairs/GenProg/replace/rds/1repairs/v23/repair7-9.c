...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + *i) == 0) {
      ...
      __repair_del_13__4f8: /* CIL Label */ 
      {
...
{ int result ;
  ...
  __repair_app_248__4f9: /* CIL Label */ 
  {
  while (1) {
    if (! done) {
...
{ int result ;
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      __repair_app_176__4fa: /* CIL Label */ 
      {
      if ((int )*(arg + i) != 0) {
    ...
    if ((unsigned int )*(arg + i) == 38U) {
      ...
      escjunk = esc(arg, & i);
      __repair_app_163__4fb: /* CIL Label */ 
      {
      tmp___0 = addstr(escjunk, sub, & j, 100);
      tmp = addstr((char)-1, sub, & j, 100);
      }
      __repair_swap1_173__4fc: /* CIL Label */ 
      result = i;
    }
    i ++;
  }
  if ((int )*(arg + i) != (int )delim) {
    ...
    if (! junk) {
      ...
      __repair_swap1_167__4fd: /* CIL Label */ 
      junk = (char )tmp___0;
    }
  }
  return (result);
...
{ int i ;
  ...
  __repair_app_69__4fe: /* CIL Label */ 
  {
  O[OL] = (char )'\000';
