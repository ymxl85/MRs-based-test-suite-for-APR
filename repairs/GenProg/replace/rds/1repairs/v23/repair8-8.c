...
{ char result ;
  ...
  {
  __repair_del_16__645: /* CIL Label */ 
  {

  }
  __repair_swap1_11__646: /* CIL Label */ 
  result = *(s + *i);
}
}
...
{ int result ;
  ...
  if (done) {
    ...
    __repair_del_149__647: /* CIL Label */ 
    {
...
{ int result ;
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    __repair_app_296__648: /* CIL Label */ 
    {
    ...
    if (! junk) {
      ...
      __repair_del_173__649: /* CIL Label */ 
      {
...
{ int i ;
  ...
  while ((int )*(sub + i) != 0) {
    ...
    __repair_app_291__64a: /* CIL Label */ 
    {
    i ++;
...
{ char *tmp ;
  ...
  __repair_app_322__64b: /* CIL Label */ 
  {
  return (0);
  tmp = mainQ(*(argv + 1), *(argv + 2), *(argv + 3));
  }
