...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + *i) == 0) {
      ...
      __repair_swap1_12__dbd: /* CIL Label */ 
      __repair_swap1_12__dbc: /* CIL Label */ 
      if ((int )*(s + *i) == 116) {
        result = (char)9;
      } else {
        __repair_app_17__dbe: /* CIL Label */ 
        {
        result = *(s + *i);
        return (result);
        }
      ...
      if ((int )*(s + *i) == 110) {
        ...
        __repair_swap1_13__dc0: /* CIL Label */ 
        __repair_swap1_13__dbf: /* CIL Label */ 
        (*i) ++;
      }
    }
  }
...
{ int result ;
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
        __repair_swap1_176__dc2: /* CIL Label */ 
        __repair_del_161__dc1: /* CIL Label */ 
        if (! junk) {
          result = 0;
        } else {
          result = i;
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    junk = (char )tmp___1;
    __repair_swap1_161__dc3: /* CIL Label */ ;
  }
  return (result);
}
}
...
{ char *tmp ;
  ...
  __repair_app_324__dc4: /* CIL Label */ 
  {
  return (tmp);
  return (0);
  }
...
{ string pat ;
  ...
  __repair_swap1_319__dc5: /* CIL Label */ 
  result = getsub(argv2, sub);
  __repair_swap1_318__dc6: /* CIL Label */ 
  result = (char )tmp;
