...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + *i) == 0) {
      ...
      __repair_del_13__556: /* CIL Label */ 
      {
      ...
      if ((int )*(s + *i) == 110) {
        ...
        if ((int )*(s + *i) == 116) {
          ...
          __repair_app_18__557: /* CIL Label */ 
          {
          result = *(s + *i);
        ...
        if ((int )*(arg + i) == 36) {
          ...
          if ((int )*(arg + i) == 91) {
            ...
            if ((int )*(arg + i) == 42) {
              ...
              tmp___3 = addstr((char )'c', pat, & j, 100);
              __repair_swap1_147__558: /* CIL Label */ 
              result = i;
              escjunk = esc(arg, & i);
              tmp___4 = addstr(escjunk, pat, & j, 100);
              junk = (char )tmp___4;
  ...
  if (done) {
    ...
    if ((int )*(arg + i) != (int )delim) {
      ...
      if (! junk) {
        ...
        __repair_swap1_129__559: /* CIL Label */ 
        junk = (char )tmp___3;
      }
    }
  }
...
{ int result ;
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
        __repair_del_161__55a: /* CIL Label */ 
        {
...
{ int i ;
  ...
  __repair_app_296__55b: /* CIL Label */ 
  {
  while (1) {
    if (! done) {
      if ((int )*(pat + j) != 0) {
    ...
    if ((int )*(pat + j) == 42) {
      ...
      if (! result) {
        __repair_app_18__55c: /* CIL Label */ 
        {
        offset = -1;
