...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    __repair_swap1_14__731: /* CIL Label */ 
    if ((int )*(s + *i) == 110) {
      result = (char)10;
    } else {
      if ((int )*(s + *i) == 116) {
...
{ int result ;
  ...
  __repair_app_173__732: /* CIL Label */ 
  {
  if ((int )*(arg + i) != (int )delim) {
    result = 0;
  } else {
    ...
    junk = (char )tmp___1;
    __repair_del_176__733: /* CIL Label */ 
    {
...
{ int i ;
  ...
  {
  OL = 0;
  __repair_del_310__734: /* CIL Label */ 
  {
...
{ string pat ;
  ...
  {
  __repair_del_317__736: /* CIL Label */ 
  __repair_swap1_318__735: /* CIL Label */ 
  {

  }
  __repair_swap1_317__737: /* CIL Label */ 
