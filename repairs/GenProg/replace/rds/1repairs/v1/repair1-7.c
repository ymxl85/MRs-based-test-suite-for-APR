...
{ int k ;
  ...
  while (1) {
    if ((int )*(src + *i) != (int )delim) {
      __repair_swap1_23__198: /* CIL Label */ 
      tmp___0 = addstr(*(src + *i), dest, j, maxset);
    } else {
      break;
    }
    if ((int )*(src + *i) == 64) {
      __repair_del_20__19c: /* CIL Label */ 
      __repair_del_20__19b: /* CIL Label */ 
      {
      ...
      if ((int )*(src + *i) != 45) {
        __repair_swap1_19__199: /* CIL Label */ 
        if ((int )*(src + *i) != 0) {
          __repair_swap1_104__19a: /* CIL Label */ ;
        } else {
          break;
        }
        junk = (char )tmp___0;
...
{ int jstart ;
  ...
  __repair_swap1_66__19d: /* CIL Label */ 
  dodash((char )']', arg, i, pat, j, 100);
  __repair_swap1_65__19e: /* CIL Label */ 
  junk = (char )tmp___1;
...
{ int tmp ;
  ...
  if ((int )c == 99) {
    ...
    if ((int )c == 37) {
      ...
      __repair_swap1_92__19f: /* CIL Label */ 
      tmp = 1;
    }
  }
  return ((char )tmp);
  ...
  while (1) {
    if (! done) {
      if ((int )*(arg + i) != (int )delim) {
        if ((int )*(arg + i) != 0) {
          __repair_swap1_18__1a0: /* CIL Label */ ;
        } else {
          break;
        }
      } else {
...
{ int i ;
  ...
  while ((int )*(lin + i) != 0) {
    ...
    __repair_app_301__1a1: /* CIL Label */ 
    {
    if (m >= 0) {
      if (lastm != m) {
