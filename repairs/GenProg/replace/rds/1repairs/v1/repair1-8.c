...
{ bool result ;
  ...
  if (*j >= maxset) {
    ...
    __repair_app_196__507: /* CIL Label */ 
    {
    *(outset + *j) = c;
    ...
    if ((int )*(s + (*i + 1)) == 0) {
      ...
      if ((int )*(s + *i) == 110) {
        ...
        if ((int )*(s + *i) == 116) {
          ...
          __repair_app_198__508: /* CIL Label */ 
          {
          result = *(s + *i);
...
{ int k ;
  ...
  while (1) {
    ...
    __repair_swap1_50__50a: /* CIL Label */ 
    __repair_swap1_22__509: /* CIL Label */ 
    if ((int )*(src + *i) != 45) {
      __repair_swap1_50__50b: /* CIL Label */ 
      if ((int )*(src + *i) != 45) {
        tmp___0 = addstr(*(src + *i), dest, j, maxset);
        __repair_app_21__50c: /* CIL Label */ 
        {
        junk = (char )tmp___0;
