...
{ char result ;
  ...
  {
  if ((int )*(s + *i) != 64) {
    __repair_swap1_8__fbe: /* CIL Label */ 
    result = (char )'\000';
  } else {
    if ((int )*(s + (*i + 1)) == 0) {
      __repair_swap1_7__fbd: /* CIL Label */ 
      __repair_swap1_17__fbc: /* CIL Label */ 
      result = *(s + *i);
    } else {
      (*i) ++;
      if ((int )*(s + *i) == 110) {
  ...
  __repair_swap1_8__fbf: /* CIL Label */ 
  result = (char )'\000';
}
}
...
{ int result ;
  ...
  __repair_app_138__fc0: /* CIL Label */ 
  {
  while (1) {
    if (! done) {
...
{ int result ;
  ...
  while (1) {
    ...
    if ((unsigned int )*(arg + i) == 38U) {
      ...
      __repair_app_161__fc1: /* CIL Label */ 
      {
      junk = (char )tmp___0;
