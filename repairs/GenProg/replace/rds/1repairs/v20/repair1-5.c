...
{ bool result ;
  ...
  __repair_app_202__4ad: /* CIL Label */ 
  {
  return ((int )result);
...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + (*i + 1)) == 0) {
      __repair_app_11__4ae: /* CIL Label */ 
      {
      result = (char )'\000';
      result = *(s + *i);
      }
...
{ int result ;
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      __repair_del_162__4af: /* CIL Label */ 
      {
    ...
    __repair_app_196__4b0: /* CIL Label */ 
    {
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    junk = (char )tmp___1;
    __repair_del_176__4b1: /* CIL Label */ 
    {
