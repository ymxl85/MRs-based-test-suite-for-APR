...
{ int result ;
  ...
  i = from;
  while (1) {
    __repair_swap1_169__296: /* CIL Label */ 
    ...
    __repair_swap1_168__297: /* CIL Label */ 
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    __repair_app_295__298: /* CIL Label */ 
    {
    junk = (char )tmp___1;
...
{ int i ;
  ...
  while ((int )*(sub + i) != 0) {
    if ((int )*(sub + i) == -1) {
      ...
      if (*OL < 2000) {
        __repair_app_18__299: /* CIL Label */ 
        {
        *(output + *OL) = *(sub + i);
