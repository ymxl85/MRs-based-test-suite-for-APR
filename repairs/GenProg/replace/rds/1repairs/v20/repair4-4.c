...
{ char result ;
  ...
  {
  __repair_swap1_7__370: /* CIL Label */ 
  result = *(s + *i);
  return (result);
}
}
  ...
  while (1) {
    if (! done) {
      if ((int )*(arg + i) != (int )delim) {
        __repair_app_140__371: /* CIL Label */ 
        {
        if ((int )*(arg + i) != 0) {
...
{ int i ;
  ...
  while ((int )*(lin + i) != 0) {
    ...
    if (m >= 0) {
      ...
      __repair_del_300__372: /* CIL Label */ 
      {
...
{ char *tmp ;
  ...
  __repair_app_198__373: /* CIL Label */ 
  {
  fprintf((FILE */* __restrict  */)stdout, (char const   */* __restrict  */)"%s\n", tmp);

  }
  __repair_swap1_295__374: /* CIL Label */ ;
}
}
void Caseerror(int n ) 
{ 
