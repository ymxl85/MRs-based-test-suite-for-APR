...
{ bool result ;
  ...
  {
  __repair_app_18__cd7: /* CIL Label */ 
  {
  if (*j >= maxset) {
    result = (char)0;
  } else {
...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + (*i + 1)) == 0) {
      __repair_app_14__cd8: /* CIL Label */ 
      {
      result = (char )'\000';
      if ((int )*(s + *i) == 110) {
        result = (char)10;
...
{ int result ;
  ...
  j = 0;
  i = start;
  __repair_swap1_149__cd9: /* CIL Label */ 
  if ((int )*(arg + i) != (int )delim) {
    result = 0;
  } else {
    __repair_del_148__cda: /* CIL Label */ 
    {
  ...
  if (done) {
    ...
    __repair_swap1_152__cdb: /* CIL Label */ 
    lastj = 0;
  }
  return (result);
}
