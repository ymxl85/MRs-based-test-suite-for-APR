...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + (*i + 1)) == 0) {
      __repair_app_14__7f6: /* CIL Label */ 
      {
      result = (char )'\000';
      if ((int )*(s + *i) == 110) {
        result = (char)10;
...
{ int result ;
  ...
  j = 0;
  i = start;
  __repair_swap1_157__7f7: /* CIL Label */ 
  if (done) {
    result = 0;
  } else {
  ...
  junk = (char )tmp___5;
  __repair_swap1_152__7f8: /* CIL Label */ 
  lastj = 0;
  return (result);
}
}
...
{ int result ;
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    __repair_del_175__7f9: /* CIL Label */ 
    {
...
{ int makeres ;
  ...
  {
  __repair_app_161__7fa: /* CIL Label */ 
  {
...
{ int i ;
  ...
  lastm = -1;
  i = 0;
  __repair_app_300__7fb: /* CIL Label */ 
  {
  while ((int )*(lin + i) != 0) {
    ...
    __repair_app_161__7fc: /* CIL Label */ 
    {
    if (m == -1) {
      goto _L;
    } else {
...
{ char *tmp ;
  ...
  __repair_app_329__7fd: /* CIL Label */ 
  {
