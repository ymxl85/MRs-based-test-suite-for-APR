...
{ int result ;
  ...
  __repair_swap1_157__ca8: /* CIL Label */ 
  if (done) {
    result = 0;
  } else {
    if ((int )*(arg + i) != (int )delim) {
  ...
  __repair_swap1_156__caa: /* CIL Label */ 
  __repair_app_161__ca9: /* CIL Label */ 
  junk = (char )tmp___5;
  return (result);
}
}
...
{ int result ;
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    __repair_swap1_176__cab: /* CIL Label */ 
    if (! junk) {
      result = 0;
    } else {
      result = i;
    }
    __repair_swap1_175__cac: /* CIL Label */ 
    junk = (char )tmp___1;
  }
  return (result);
}
...
{ char *tmp ;
  ...
  __repair_swap1_275__cad: /* CIL Label */ ;
}
}
void Caseerror(int n ) 
{ 
