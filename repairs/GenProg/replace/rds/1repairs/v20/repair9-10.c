...
{ char result ;
  ...
  {
  __repair_swap1_7__3c7: /* CIL Label */ 
  result = *(s + *i);
  return (result);
}
}
...
{ int result ;
  ...
  if (done) {
    ...
    __repair_app_248__3c8: /* CIL Label */ 
    {
    if ((int )*(arg + i) != (int )delim) {
      result = 0;
    } else {
      __repair_del_148__3c9: /* CIL Label */ 
      {
...
{ int i ;
  ...
  {
  OL = 0;
  __repair_swap1_297__3ca: /* CIL Label */ 
  lastm = m;
  i = 0;
  while ((int )*(lin + i) != 0) {
    ...
    if (m >= 0) {
      if (lastm != m) {
        ...
        __repair_swap1_315__3cb: /* CIL Label */ 
        lastm = -1;
      } else {
  ...
  __repair_app_306__3cc: /* CIL Label */ 
  {
  return (O);
  i = m;
  }
