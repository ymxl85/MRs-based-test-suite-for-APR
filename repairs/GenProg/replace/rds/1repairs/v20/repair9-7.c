...
{ char result ;
  ...
  {
  __repair_swap1_7__637: /* CIL Label */ 
  result = *(s + *i);
  return (result);
}
}
...
{ int result ;
  ...
  if (done) {
    ...
    if ((int )*(arg + i) != (int )delim) {
      ...
      if (! junk) {
        ...
        __repair_del_147__638: /* CIL Label */ 
        {
  ...
  __repair_del_158__639: /* CIL Label */ 
  {
...
{ int result ;
  ...
  {
  __repair_app_69__63a: /* CIL Label */ 
  {
  j = 0;
  ...
  while (1) {
    ...
    if ((unsigned int )*(arg + i) == 38U) {
      ...
      __repair_del_167__63c: /* CIL Label */ 
      __repair_app_138__63b: /* CIL Label */ 
      {
...
{ int i ;
  ...
  lastm = -1;
  i = 0;
  __repair_app_275__63d: /* CIL Label */ 
  {
  while ((int )*(lin + i) != 0) {
