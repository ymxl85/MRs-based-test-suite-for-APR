...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + (*i + 1)) == 0) {
      __repair_app_12__483: /* CIL Label */ 
      {
      result = (char )'\000';
      if ((int )*(s + *i) == 116) {
        result = (char)9;
...
{ int result ;
  ...
  __repair_del_156__484: /* CIL Label */ 
  {
...
{ int makeres ;
  ...
  __repair_del_160__485: /* CIL Label */ 
  {
...
{ int result ;
  ...
  if ((int )*(arg + i) != (int )delim) {
    ...
    junk = (char )tmp___1;
    __repair_app_69__486: /* CIL Label */ 
    {
    if (! junk) {
      result = 0;
    } else {
...
{ int i ;
  ...
  {
  __repair_app_292__487: /* CIL Label */ 
  {
  i = 0;
  i = 0;
  }
  while ((int )*(sub + i) != 0) {
    ...
    __repair_app_275__488: /* CIL Label */ 
    {
    i ++;
...
{ int i ;
  ...
  __repair_app_301__489: /* CIL Label */ 
  {
  if (OL < 2000) {
    O[OL] = (char )'\000';
  } else {
