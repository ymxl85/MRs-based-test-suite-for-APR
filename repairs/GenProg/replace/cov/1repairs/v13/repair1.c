  ...
  while (1) {
    ...
    if ((int )*(arg + i) == 63) {
      ...
      if ((int )*(arg + i) == 37) {
        if (i == start) {
          tmp___0 = addstr((char )'%', pat, & j, 100);
          __repair_del_110__398: /* CIL Label */ 
          {
        ...
        if ((int )*(arg + i) == 36) {
          ...
          if ((int )*(arg + i) == 91) {
            ...
            if ((int )*(arg + i) == 42) {
              if (i > start) {
                __repair_app_239__397: /* CIL Label */ 
                {
                lj = lastj;
...
{ int result ;
  ...
  while (1) {
    if ((int )*(arg + i) != (int )delim) {
      if ((int )*(arg + i) != 0) {
        __repair_swap1_198__399: /* CIL Label */ ;
      } else {
        break;
      }
    } else {
  ...
  if ((int )*(lin + *i) == 0) {
    ...
    if (tmp___1) {
      ...
      if (*i == 0) {
        ...
        __repair_swap1_161__39a: /* CIL Label */ ;
      }
      break;
      case 63: 
      if ((int )*(lin + *i) != 10) {
  ...
  while ((int )*(lin + i) != 0) {
    ...
    if (m == -1) {
      ...
      if (m == i) {
        ...
        O[OL] = *(lin + i);
        OL ++;
        __repair_swap1_297__39b: /* CIL Label */ 
        i ++;
      } else {
        i = m;
      }
