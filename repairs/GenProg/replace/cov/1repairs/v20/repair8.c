...
{ char result ;
  ...
  if ((int )*(s + *i) != 64) {
    ...
    if ((int )*(s + (*i + 1)) == 0) {
      __repair_app_14__de1: /* CIL Label */ 
      {
      result = (char )'\000';
      if ((int )*(s + *i) == 110) {
        result = (char)10;
...
{ int tmp ;
  ...
  if ((int )c == 99) {
    ...
    __repair_app_275__de2: /* CIL Label */ 
    {
    if ((int )c == 37) {
      tmp = 1;
    } else {
...
{ int result ;
  ...
  while (1) {
    if (! done) {
      __repair_swap1_105__de3: /* CIL Label */ 
      if ((int )*(arg + i) != 0) {
    ...
    __repair_swap1_148__de4: /* CIL Label */ 
    if (! junk) {
      result = 0;
    } else {
      result = i;
  ...
  if (done) {
    ...
    if ((int )*(arg + i) != (int )delim) {
      ...
      __repair_swap1_142__de5: /* CIL Label */ 
      lastj = lj;
    }
  }
  return (result);
...
{ int result ;
  ...
  i = from;
  while (1) {
    __repair_swap1_169__de6: /* CIL Label */ 
    ...
    __repair_swap1_168__de7: /* CIL Label */ 
    if ((int )*(arg + i) != (int )delim) {
      __repair_del_162__de8: /* CIL Label */ 
      {
...
{ int i ;
  ...
  {
  __repair_swap1_273__de9: /* CIL Label */ 
  while (1) {
    if (! done) {
      if ((int )*(pat + j) != 0) {
  ...
  __repair_swap1_272__dea: /* CIL Label */ 
  done = (char)0;
  return (offset);
}
}
...
{ int i ;
  ...
  __repair_app_244__deb: /* CIL Label */ 
  {
  return (O);
