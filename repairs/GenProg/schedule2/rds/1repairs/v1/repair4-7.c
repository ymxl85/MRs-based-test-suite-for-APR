...
{ int command ;
  ...
  {
  __repair_app_223__33a: /* CIL Label */ 
  {
  value[0] = (char )'\000';
...
{ int status ;
  ...
  {
  status = 0;
  __repair_swap1_90__33b: /* CIL Label */ 
  *ratio = tmp___1;
  value[1] = (char)0;
  value[2] = (char)0;
  value[3] = (char)0;
  ...
  if ((int )*(argv + *pos) != 0) {
    ...
    *prio = atoi(value);
    ...
    __repair_swap1_108__33d: /* CIL Label */ 
    value[0] = (char )'\000';
    break;
    }
    while (1) {
    ...
    __repair_swap1_225__33c: /* CIL Label */ ;
  }
}
}
...
{ int pid ;
  ...
  if (status) {
    ...
    __repair_del_130__33e: /* CIL Label */ 
    {
...
{ struct process *job ;
  ...
  if (job) {
    current_job = (struct process *)0;
    reschedule(0);
    __repair_swap1_170__33f: /* CIL Label */ 
    strcat(r___0, " ");
    __repair_swap1_169__340: /* CIL Label */ 
