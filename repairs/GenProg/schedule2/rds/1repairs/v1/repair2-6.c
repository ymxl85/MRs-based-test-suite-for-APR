...
{ int status ;
  ...
  {
  status = 0;
  __repair_swap1_90__171: /* CIL Label */ 
  *ratio = tmp___1;
  value[1] = (char)0;
  value[2] = (char)0;
  value[3] = (char)0;
  ...
  if ((int )*(argv + *pos) != 0) {
    ...
    *prio = atoi(value);
    ...
    __repair_swap1_108__172: /* CIL Label */ 
    value[0] = (char )'\000';
    break;
    }
    while (1) {
...
{ int pid ;
  ...
  if (! new_process) {
    ...
    __repair_swap1_125__173: /* CIL Label */ 
    new_process->priority = prio;
    __repair_swap1_124__174: /* CIL Label */ 
...
{ int status ;
  ...
  __repair_app_309__175: /* CIL Label */ 
  {
  job->priority = prio + 1;
  return;
  }
