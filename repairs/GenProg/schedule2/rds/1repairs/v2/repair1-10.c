...
{ int command ;
  ...
  value[9] = (char)0;
  pos = 0;
  __repair_swap1_59__538: /* CIL Label */ 
  getAdata(argv, & pos, value);
  a3 = atoi(value);
  __repair_swap1_57__539: /* CIL Label */ 
  getAdata(argv, & pos, value);
  a2 = atoi(value);
  getAdata(argv, & pos, value);
  a1 = atoi(value);
...
{ int status ;
  ...
  if ((int )*(argv + *pos) != 0) {
    ...
    *prio = atoi(value);
    ...
    case 4: 
    getAdata(argv, pos, value);
    __repair_swap1_96__53a: /* CIL Label */ ;
    *ratio = tmp___0;
    break;
    case 2: 
    getAdata(argv, pos, value);
    ...
    *ratio = tmp___1;
    ...
    if ((int )*(argv + *pos) == 10) {
      ...
      __repair_swap1_84__53b: /* CIL Label */ 
...
{ struct process *job ;
  ...
  job = get_current();
  if (job) {
    __repair_app_272__53c: /* CIL Label */ 
    {
    current_job = (struct process *)0;
  ...
  *job = *next;
  if (*job) {
    *next = (*next)->next;
    ...
    (prio_queue[prio].length) --;
    __repair_app_178__53d: /* CIL Label */ 
    {
    return (1);
    return (0);
    }
