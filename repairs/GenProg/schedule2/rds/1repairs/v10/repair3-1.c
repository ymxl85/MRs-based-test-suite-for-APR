...
{ struct process *job ;
  ...
  s[3] = (char)0;
  s[4] = (char)0;
  __repair_swap1_184__2da: /* CIL Label */ 
  s[7] = (char)0;
  s[6] = (char)0;
  __repair_swap1_182__2db: /* CIL Label */ 
  s[5] = (char)0;
  s[8] = (char)0;
  s[9] = (char)0;
  job = get_current();
  if (job) {
    ...
    strcat(r___0, " ");
    strcat(r___0, s);
    __repair_del_174__2dc: /* CIL Label */ 
    {
...
{ 
  ...
  {
  __repair_del_210__2dd: /* CIL Label */ 
  {
...
{ struct process **next ;
  ...
  {
  if (prio > 3) {
    __repair_del_223__2de: /* CIL Label */ 
    {
