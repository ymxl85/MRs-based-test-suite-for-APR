...
{ int command ;
  ...
  __repair_swap1_26__2db: /* CIL Label */ ;
  prio = 1;
  if (a1 < 0) {
    exit_here(-2);
  } else {
  ...
  while (a1 > 0) {
    ...
    if (status) {
      ...
      __repair_swap1_65__2dc: /* CIL Label */ 
      while (a2 > 0) {
        status = new_job(prio);
        if (status) {
          exit_here(status);
...
{ int status ;
  ...
  value[1] = (char)0;
  value[2] = (char)0;
  __repair_app_17__2dd: /* CIL Label */ 
  {
  value[3] = (char)0;
  ...
  if ((int )*(argv + *pos) != 0) {
    tmp = -1;
    *command = tmp;
    __repair_swap1_79__2de: /* CIL Label */ 
    *prio = atoi(value);
    *ratio = (float )(- 1.0);
    getAdata(argv, pos, value);
    *command = atoi(value);
    ...
    case 1: 
    getAdata(argv, pos, value);
    __repair_swap1_96__2df: /* CIL Label */ 
    *prio = tmp;
    break;
    case 4: 
    getAdata(argv, pos, value);
    tmp___0 = getOperand(value);
    __repair_app_176__2e0: /* CIL Label */ 
    {
    *ratio = tmp___0;
    return (1);
    }
...
{ int length ;
  ...
  if ((double )ratio < 0.0) {
    ...
    __repair_del_243__2e1: /* CIL Label */ 
    {
