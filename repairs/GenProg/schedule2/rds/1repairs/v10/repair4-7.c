...
{ int status ;
  ...
  if ((int )*(argv + *pos) != 0) {
    ...
    *ratio = (float )(- 1.0);
    getAdata(argv, pos, value);
    __repair_swap1_100__1b3: /* CIL Label */ 
    while (1) {
      if ((int )*(argv + *pos) != 0) {
        if ((int )*(argv + *pos) != 10) {
    ...
    *ratio = tmp___1;
    ...
    __repair_swap1_99__1b4: /* CIL Label */ 
    *command = atoi(value);
    if ((int )*(argv + *pos) == 10) {
      (*pos) ++;
    } else {
      __repair_del_93__1b5: /* CIL Label */ 
      {
...
{ int pid ;
  ...
  if (status) {
    ...
    __repair_swap1_207__1b6: /* CIL Label */ ;
  }
  return (status);
}
}
...
{ 
  ...
  if (current_job) {
    if (prio > current_job->priority) {
      ...
      __repair_swap1_127__1b7: /* CIL Label */ ;
    }
  } else {
