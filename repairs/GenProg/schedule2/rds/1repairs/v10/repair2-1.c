...
{ struct process *job ;
  ...
  if (job) {
    ...
    strcat(r___0, " ");
    __repair_app_225__1df: /* CIL Label */ 
    {
    strcat(r___0, s);

    }
    __repair_app_187__1e0: /* CIL Label */ 
    {
    free(job);
    job = get_current();
    }
...
{ int tmp ;
  ...
  __repair_swap1_272__1e2: /* CIL Label */ 
  __repair_swap1_205__1e1: /* CIL Label */ ;
}
}
struct process *get_current(void) 
{ int prio ;
...
{ 
  ...
  if (current_job) {
    if (prio > current_job->priority) {
      __repair_swap1_193__1e3: /* CIL Label */ 
      return (0);
      current_job = (struct process *)0;
    } else {
