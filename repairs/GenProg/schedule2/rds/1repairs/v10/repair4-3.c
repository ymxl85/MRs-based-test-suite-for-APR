...
{ int command ;
  ...
  if (a1 < 0) {
    ...
    __repair_swap1_88__16e: /* CIL Label */ ;
  }
  while (a1 > 0) {
    status = new_job(prio);
    if (status) {
...
{ int status ;
  ...
  {
  __repair_swap1_84__16f: /* CIL Label */ 
  *prio = atoi(value);
  value[0] = (char )'\000';
  value[1] = (char)0;
  value[2] = (char)0;
  ...
  if ((int )*(argv + *pos) != 0) {
    ...
    *ratio = tmp___0;
    ...
    case 2: 
    getAdata(argv, pos, value);
    __repair_swap1_104__170: /* CIL Label */ 
    status = 0;
    getAdata(argv, pos, value);
    ...
    *ratio = tmp___1;
    ...
    while (1) {
      if ((int )*(argv + *pos) != 0) {
        if ((int )*(argv + *pos) != 10) {
          __repair_swap1_23__171: /* CIL Label */ ;
        } else {
          break;
        }
      } else {
