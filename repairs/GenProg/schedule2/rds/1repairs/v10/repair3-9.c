...
{ int pid ;
  ...
  {
  __repair_app_225__6eb: /* CIL Label */ 
  {
  status = 0;
...
{ struct process *job ;
  ...
  s[1] = (char)0;
  s[2] = (char)0;
  __repair_swap1_169__6ed: /* CIL Label */ 
  current_job = (struct process *)0;
  s[4] = (char)0;
  __repair_swap1_187__6ef: /* CIL Label */ 
  __repair_app_212__6ee: /* CIL Label */ 
  job = get_current();
  s[6] = (char)0;
  s[7] = (char)0;
  s[8] = (char)0;
  s[9] = (char)0;
  __repair_swap1_182__6f0: /* CIL Label */ 
  s[5] = (char)0;
  __repair_app_184__6f1: /* CIL Label */ 
  {
  if (job) {
    __repair_swap1_180__6f2: /* CIL Label */ 
    s[3] = (char)0;
    reschedule(0);
