  ...
  if ((int )*(argv + *pos) != 0) {
    ...
    *ratio = tmp___1;
    ...
    if ((int )*(argv + *pos) == 10) {
      ...
      __repair_swap1_211__4e8: /* CIL Label */ 
      get_current();
    }
    return (1);
  } else {
...
{ struct process *job ;
  ...
  s[4] = (char)0;
  s[5] = (char)0;
  __repair_del_183__4e9: /* CIL Label */ 
  {
  ...
  if (job) {
    current_job = (struct process *)0;
    __repair_del_170__4ea: /* CIL Label */ 
    {
...
{ 
  ...
  __repair_swap1_93__4eb: /* CIL Label */ ;
  return (0);
}
}
int schedule(int command , int prio , float ratio , char *r___0 ) 
...
{ struct process **next ;
  ...
  {
  if (prio > 3) {
    __repair_app_202__4ec: /* CIL Label */ 
    {
    return (-4);
