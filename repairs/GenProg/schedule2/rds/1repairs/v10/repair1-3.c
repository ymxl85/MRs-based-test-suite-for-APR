...
{ int command ;
  ...
  while (a3 > 0) {
    __repair_app_51__6b0: /* CIL Label */ 
    {
    status = new_job(prio);
    value[8] = (char)0;
    }
    __repair_swap1_12__6b1: /* CIL Label */ 
    a3 --;
    __repair_swap1_11__6b2: /* CIL Label */ 
    if (status) {
      exit_here(status);
    } else {
...
{ int tmp ;
  ...
  {
  __repair_app_206__6b3: /* CIL Label */ 
  {
  while (1) {
    tmp = finish(r___0);
    if (tmp) {
  ...
  __repair_swap1_206__6b4: /* CIL Label */ 
  current_job = (struct process *)0;
}
}
struct process *get_current(void) 
...
{ 
  ...
  if (current_job) {
    if (prio > current_job->priority) {
      __repair_del_205__6b5: /* CIL Label */ 
      {

      }
      __repair_swap1_193__6b6: /* CIL Label */ 
      return (0);
    } else {
...
{ struct process **next ;
  ...
  {
  if (prio > 3) {
    __repair_app_23__6b7: /* CIL Label */ 
    {
    return (-4);
