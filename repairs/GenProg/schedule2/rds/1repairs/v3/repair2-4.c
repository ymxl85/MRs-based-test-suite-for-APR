...
{ int command ;
  ...
  value[5] = (char)0;
  value[6] = (char)0;
  __repair_swap1_54__82f: /* CIL Label */ 
  value[8] = (char)0;
  __repair_swap1_53__830: /* CIL Label */ 
  value[7] = (char)0;
  value[9] = (char)0;
  pos = 0;
...
{ int status ;
  ...
  value[3] = (char)0;
  value[4] = (char)0;
  __repair_del_113__831: /* CIL Label */ 
  {
  ...
  if ((int )*(argv + *pos) != 0) {
    ...
    *ratio = tmp___1;
    ...
    __repair_app_17__832: /* CIL Label */ 
    {
    if ((int )*(argv + *pos) == 10) {
      (*pos) ++;
    } else {
...
{ int status ;
  ...
  __repair_del_151__833: /* CIL Label */ 
  {
...
{ struct process **next ;
  ...
  {
  if (prio > 3) {
    __repair_app_142__834: /* CIL Label */ 
    {
    return (-4);
