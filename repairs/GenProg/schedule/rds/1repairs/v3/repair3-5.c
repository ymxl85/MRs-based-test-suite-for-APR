...
{ List *list ;
  ...
  list = (List *)tmp;
  __repair_app_99__e22: /* CIL Label */ 
  {
  list->first = (Ele *)0;
...
{ char s[10] ;
  ...
  s[9] = (char)0;
  if (cur_proc) {
    __repair_app_67__e23: /* CIL Label */ 
    {
    ...
    strcat(r, " ");
    free_ele(cur_proc);
    __repair_app_58__e24: /* CIL Label */ 
    {
    num_processes --;
    s[0] = (char )'\000';
    }
...
{ int i ;
  ...
  {
  __repair_app_114__e25: /* CIL Label */ 
  {
  total = num_processes;
...
{ int i ;
  ...
  while (i > 0) {
    if ((prio_queue[i])->mem_count > 0) {
      ...
      __repair_del_82__e26: /* CIL Label */ 
      {
...
{ int command ;
  ...
  value[6] = (char)0;
  value[7] = (char)0;
  __repair_swap1_205__e27: /* CIL Label */ 
  initialize();
  value[9] = (char)0;
  __repair_swap1_203__e28: /* CIL Label */ 
  value[8] = (char)0;
