...
{ List *list ;
  ...
  list = (List *)tmp;
  list->first = (Ele *)0;
  __repair_swap1_11__de6: /* CIL Label */ 
  list->mem_count = 0;
  __repair_swap1_10__de7: /* CIL Label */ 
  list->last = (Ele *)0;
  return (list);
}
}
...
{ int count ;
  ...
  if (prio >= 3) {
    ...
    __repair_swap1_137__de8: /* CIL Label */ ;
  }
  src_queue = prio_queue[prio];
  dest_queue = prio_queue[prio + 1];
  __repair_del_103__de9: /* CIL Label */ 
  {
...
{ Ele *proc ;
  ...
  __repair_app_86__dea: /* CIL Label */ 
  {
  prio_queue[prio] = append_ele(prio_queue[prio], proc);
  cur_proc = (Ele *)0;
  }
  __repair_swap1_70__deb: /* CIL Label */ ;
}
}
...
{ int command ;
  ...
  while ((int )*(argv + pos) != 0) {
    ...
    if ((int )*(argv + pos) != 0) {
      ...
      ratio = tmp;
      __repair_del_154__dec: /* CIL Label */ 
      {
    ...
    __repair_swap1_160__ded: /* CIL Label */ 
