...
{ char s[10] ;
  ...
  s[1] = (char)0;
  s[2] = (char)0;
  __repair_app_137__442: /* CIL Label */ 
  {
  s[3] = (char)0;
...
{ int count ;
  ...
  __repair_del_103__443: /* CIL Label */ 
  {
...
{ 
  ...
  {
  alloc_proc_num = 0;
  __repair_del_148__444: /* CIL Label */ 
  {
...
{ int command ;
  ...
  while ((int )*(argv + pos) != 0) {
    ...
    if ((int )*(argv + pos) != 0) {
      getAdata(argv, & pos, value);
      __repair_app_152__445: /* CIL Label */ 
      {
      prio = atoi(value);
      tmp = getOperand(value);
      }
