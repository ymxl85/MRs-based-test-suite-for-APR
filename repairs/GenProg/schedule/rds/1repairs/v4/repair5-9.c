...
{ 
  ...
  __repair_del_18__a8b: /* CIL Label */ 
  {
...
{ 
  ...
  if (! d_list) {
    ...
    if (! d_ele) {
      ...
      __repair_swap1_261__a8c: /* CIL Label */ ;
    }
  }
  if (d_ele->next) {
...
{ int count ;
  ...
  {
  __repair_swap1_102__a8d: /* CIL Label */ 
  dest_queue = prio_queue[prio + 1];
  src_queue = prio_queue[prio];
  __repair_swap1_100__a8e: /* CIL Label */ 
  if (prio >= 3) {
    return;
  } else {

  }
  __repair_del_103__a8f: /* CIL Label */ 
  {
...
{ List *queue ;
  ...
  i = 0;
  while (i < num_proc) {
    __repair_app_54__a90: /* CIL Label */ 
    {
    proc = new_process(prio);
    free_ele(cur_proc);
    }
...
{ int command ;
  ...
  while ((int )*(argv + pos) != 0) {
    ...
    if ((int )*(argv + pos) != 0) {
      getAdata(argv, & pos, value);
      __repair_app_193__a91: /* CIL Label */ 
      {
      prio = atoi(value);
      OL = 0;
      }
