...
{ int count ;
  ...
  __repair_swap1_103__b77: /* CIL Label */ 
  __repair_swap1_99__b76: /* CIL Label */ 
  __repair_del_101__b75: /* CIL Label */ 
  __repair_swap1_99__b74: /* CIL Label */ 
  count = src_queue->mem_count;
  dest_queue = prio_queue[prio + 1];
  __repair_swap1_101__b78: /* CIL Label */ 
  src_queue = prio_queue[prio];
  __repair_app_147__b79: /* CIL Label */ 
  {
  if (count > 1) {
    ...
    __repair_swap1_101__b7b: /* CIL Label */ 
    __repair_swap1_101__b7a: /* CIL Label */ 
    src_queue = prio_queue[prio];
  }
  alloc_proc_num = 0;
  }
...
{ int command ;
  ...
  OL = 0;
  pos = 0;
  __repair_del_195__b7c: /* CIL Label */ 
  {
  ...
  value[6] = (char)0;
  value[7] = (char)0;
  __repair_app_99__b7d: /* CIL Label */ 
  {
  value[8] = (char)0;
  ...
  while ((int )*(argv + pos) != 0) {
    ...
    if ((int )*(argv + pos) != 0) {
      getAdata(argv, & pos, value);
      __repair_del_160__b7e: /* CIL Label */ 
      {
    ...
    if (prio > 3) {
      ...
      if (prio <= 0) {
        __repair_app_126__b7f: /* CIL Label */ 
        {
        strcat(r, "** invalid priority\n");
        if (cur_proc) {
          block_queue = append_ele(block_queue, cur_proc);
