...
{ List *list ;
  ...
  list->first = (Ele *)0;
  list->last = (Ele *)0;
  __repair_del_11__97b: /* CIL Label */ 
  {
...
{ 
  ...
  {
  __repair_app_149__97c: /* CIL Label */ 
  {
  free(ptr);
  return;
  }
...
{ char s[10] ;
  ...
  s[0] = (char )'\000';
  s[1] = (char)0;
  __repair_swap1_64__97d: /* CIL Label */ 
  s[6] = (char)0;
  s[3] = (char)0;
  s[4] = (char)0;
  s[5] = (char)0;
  __repair_swap1_60__97e: /* CIL Label */ 
  s[2] = (char)0;
  s[7] = (char)0;
  s[8] = (char)0;
  s[9] = (char)0;
...
{ int i ;
  ...
  i = 0;
  while (i < total) {
    __repair_app_91__97f: /* CIL Label */ 
    {
    finish_process(r, OL);
...
{ int i ;
  ...
  while (i > 0) {
    if ((prio_queue[i])->mem_count > 0) {
      ...
      __repair_swap1_137__980: /* CIL Label */ ;
    }
    i --;
  }
  return (0);
...
{ int count ;
  ...
  __repair_del_103__981: /* CIL Label */ 
  {
...
{ int prio ;
  ...
  if (cur_proc) {
    ...
    __repair_del_119__982: /* CIL Label */ 
    {
...
{ 
  ...
  {
  alloc_proc_num = 0;
  __repair_del_148__983: /* CIL Label */ 
  {
