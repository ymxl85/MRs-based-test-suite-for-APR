...
{ Ele *f_ele ;
  ...
  while (1) {
    ...
    __repair_app_34__c25: /* CIL Label */ 
    {
    f_ele = f_ele->next;
    while (1) {
      if (f_ele) {
...
{ char s[10] ;
  ...
  s[1] = (char)0;
  s[2] = (char)0;
  __repair_swap1_55__c26: /* CIL Label */ 
  num_processes --;
  s[4] = (char)0;
  s[5] = (char)0;
  __repair_app_60__c27: /* CIL Label */ 
  {
  s[6] = (char)0;
  s[2] = (char)0;
  }
  ...
  if (cur_proc) {
    ...
    strcat(r, " ");
    free_ele(cur_proc);
    __repair_swap1_61__c29: /* CIL Label */ 
    s[3] = (char)0;
  } else {
    __repair_app_90__c28: /* CIL Label */ 
    {
...
{ int i ;
  ...
  while (i > 0) {
    if ((prio_queue[i])->mem_count > 0) {
      __repair_app_229__c2a: /* CIL Label */ 
      {
  ...
  __repair_del_89__c2b: /* CIL Label */ 
  {
...
{ int count ;
  ...
  __repair_app_14__c2c: /* CIL Label */ 
  {
...
{ int command ;
  ...
  {
  intF = (float )1.0;
  __repair_del_192__c2d: /* CIL Label */ 
  {
  ...
  while ((int )*(argv + pos) != 0) {
    ...
    case 2: 
    if ((int )*(argv + pos) != 0) {
      __repair_app_91__c2e: /* CIL Label */ 
      {
      getAdata(argv, & pos, value);
