...
{ 
  ...
  if (! a_list) {
    ...
    __repair_swap1_21__c90: /* CIL Label */ 
  ...
  a_list->last = a_ele;
  __repair_swap1_14__c91: /* CIL Label */ ;
  (a_list->mem_count) ++;
  return (a_list);
}
}
...
{ List *queue ;
  ...
  queue = new_list();
  i = 0;
  __repair_app_38__c92: /* CIL Label */ 
  {
  while (i < num_proc) {
    proc = new_process(prio);
...
{ int command ;
  ...
  {
  __repair_del_191__c93: /* CIL Label */ 
  {
  ...
  value[2] = (char)0;
  value[3] = (char)0;
  __repair_app_214__c94: /* CIL Label */ 
  {
  value[4] = (char)0;
