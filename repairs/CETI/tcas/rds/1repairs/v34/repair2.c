		 ...
		 int Climb_Inhibit)
{
  ...
  tcas_equipped = (Other_Capability < 1) + (Other_Capability > 1) + Other_Capability >= 1;
  intent_not_known = Two_of_Three_Reports_Valid && Other_RAC == 0;
    //tcas_equipped = Other_Capability == 1; ===> tcas_equipped = (((uk_0 * (Other_Capability < 1) + uk_1 * (Other_Capability > 1)) + uk_2 * (Other_Capability <= 1)) + uk_3 * (Other_Capability >= 1)) + uk_4 * (Other_Capability != 1); ===> uk_0 1, uk_1 1, uk_2 0, uk_3 1, uk_4 0
  alt_sep = 0;
