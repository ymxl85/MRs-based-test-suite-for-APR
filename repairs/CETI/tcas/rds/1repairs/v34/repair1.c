...
//tcas_equipped = Other_Capability == 1; ===> tcas_equipped = (((uk_0 * (Other_Capability < 1) + uk_1 * (Other_Capability > 1)) + uk_2 * (Other_Capability <= 1)) + uk_3 * (Other_Capability >= 1)) + uk_4 * (Other_Capability != 1); ===> uk_0 0, uk_1 0, uk_2 1, uk_3 0, uk_4 0
