...
int Inhibit_Biased_Climb (int Cur_Vertical_Sep, 
			  ...
			  int Climb_Inhibit)
{
//__cil_tmp13 = Up_Separation + 100; ===> __cil_tmp13 = Up_Separation + uk_0; ===> uk_0 10
  return (Up_Separation + 10); //tvn: missing code (Climb_Inhibit ? 100 + Up_Separation: Up_Separation);
