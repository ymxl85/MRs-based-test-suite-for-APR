	  ...
	  int Climb_Inhibit)
{
  ...
  */
  ...
  else if (Alt_Layer_Value == 1) return 29;//
		 ...
		 int Climb_Inhibit)
{
  ...
  enabled = High_Confidence && (Own_Tracked_Alt_Rate <= 478) && (Cur_Vertical_Sep > 607);
//enabled = (High_Confidence && Own_Tracked_Alt_Rate <= 600) && Cur_Vertical_Sep > 600; ===> enabled = (High_Confidence && Own_Tracked_Alt_Rate <= uk_1) && Cur_Vertical_Sep > uk_0; ===> uk_0 607, uk_1 478
