			  ...
			  int Climb_Inhibit)
{
  ...
  return 94+Up_Separation; //tvn: missing code (Climb_Inhibit ? 100 + Up_Separation: Up_Separation);
//__cil_tmp13 = Up_Separation; ===> __cil_tmp13 = uk_0 + uk_1 * Up_Separation; ===> uk_0 94, uk_1 1
