...
//upward_preferred = tmp >= Down_Separation; ===> upward_preferred = (((uk_0 * (tmp < Down_Separation) + uk_1 * (tmp > Down_Separation)) + uk_2 * (tmp <= Down_Separation)) + uk_3 * (tmp == Down_Separation)) + uk_4 * (tmp != Down_Separation); ===> uk_0 0, uk_1 0, uk_2 0, uk_3 0, uk_4 1
  if (upward_preferred)
    {
