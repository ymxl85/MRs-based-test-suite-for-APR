...
//Up_Separation > Down_Separation; ===> upward_preferred = (((uk_0 * (Up_Separation < Down_Separation) + uk_1 * (Up_Separation <= Down_Separation)) + uk_2 * (Up_Separation >= Down_Separation)) + uk_3 * (Up_Separation == Down_Separation)) + uk_4 * (Up_Separation != Down_Separation); ===> uk_0 0, uk_1 0, uk_2 0, uk_3 0, uk_4 1
  if (upward_preferred)
    {
