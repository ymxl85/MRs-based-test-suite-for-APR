...
char c;
{
  return (c == 37 || c == 37 || c == 37 || c == 37);//fault ccl   //////////////// __cil_tmp2 = (bool )((((int )c == 37 || (int )c == 36) || (int )c == 42) || (int )c == 91); ===> __cil_tmp2 = (bool )((((int )c == uk_3 || (int )c == uk_2) || (int )c == uk_1) || (int )c == uk_0); ===> uk_0 37, uk_1 37, uk_2 37, uk_3 37
}      
