...
char c;
{
  return (c == 100000 || c == 100000 || c == 100000 || c!=63); //fault litchar
//_cil_tmp2 = (bool )((((int )c == 37 || (int )c == 36) || (int )c == 42) || (int )c != 99); ===> __cil_tmp2 = (bool )((((int )c == uk_3 || (int )c == uk_2) || (int )c == uk_1) || (int )c != uk_0); ===> uk_0 63, uk_1 100000, uk_2 100000, uk_3 100000
}      
