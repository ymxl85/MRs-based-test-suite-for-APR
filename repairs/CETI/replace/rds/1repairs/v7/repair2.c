...
char c;
{
  return (c == 100000 || c == 100000 || c == 100000);//fault || c=EOL || //__cil_tmp2 = (bool )(((int )c == 37 || (int )c == 63) || (int )c == 42); ===> __cil_tmp2 = (bool )(((int )c == uk_2 || (int )c == uk_1) || (int )c == uk_0); ===> uk_0 100000, uk_1 100000, uk_2 100000
}      
