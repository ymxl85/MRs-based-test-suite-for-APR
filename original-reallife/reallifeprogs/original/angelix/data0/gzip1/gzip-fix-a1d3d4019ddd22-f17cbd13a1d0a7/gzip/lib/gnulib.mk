...
# Reproduce by: gnulib-tool --import --dir=. --local-dir=gl --lib=libgzip --source-base=lib --m4-base=m4 --doc-base=doc --tests-base=tests --aux-dir=build-aux --avoid=getline --avoid=rpmatch --no-libtool --macro-prefix=gl closein fcntl fcntl-safer fdl getopt-gnu git-version-gen gitlog-to-changelog gnu-make gnumakefile maintainer-makefile stat-time sys_stat time update-copyright utimens xalloc yesno
